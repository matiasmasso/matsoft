        ...
        RoleManager<ApplicationRole> roleManager)
    {
        ...
        if (client == null)
        {
            client = new OdbcClient
            {
                ...
                RedirectUrisJson = "[\"https://localhost:5001/auth/callback\"]",
                PostLogoutRedirectUrisJson = "[\"https://localhost:5001/logout/callback\"]",
                AllowedCorsOriginsJson = "[\"https://localhost:5001\"]",
