...
{
    /// <inheritdoc />
    public partial class InitialAppsUsersRolesSecrets : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAppRoles", x => new { x.UserId, x.AppRoleId });
                    table.ForeignKey(
