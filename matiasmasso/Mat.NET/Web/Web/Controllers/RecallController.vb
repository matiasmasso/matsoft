Public Class RecallController
        ...
        Else
            Select Case oUser.Rol.Id
                Case DTORol.Ids.CliFull, DTORol.Ids.CliLite, DTORol.Ids.Rep, DTORol.Ids.Comercial, DTORol.Ids.SuperUser
                    ...
                    Dim Model = Await FEB2.RecallCli.Factory(exs, oUser, oRecall)
    ...
    Public Async Function Save() As Threading.Tasks.Task(Of JsonResult)
        ...
        Dim oUser = ContextHelper.GetUser()
        Dim oRecall As DTORecall = DTORecall.Wellknown(DTORecall.Wellknowns.DualfixR44)
        Dim oRecallCli = Await FEB2.RecallCli.Factory(exs, oUser, oRecall)
        With oRecallCli
        ...
        If Await FEB2.RecallCli.Update(exs, oRecallCli) Then
            If FEB2.RecallCli.Load(exs, oRecallCli) Then
                Dim oPdfStream As Byte() = LegacyHelper.PdfRecallLabel.Factory(oRecallCli)
                Dim oMailMessage As DTOMailMessage = Await FEB2.RecallCli.MailMessage(oRecallCli, oPdfStream, exs)
