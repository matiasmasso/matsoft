Public Class SubscripcionsController
    ...
    Public Async Function Index() As Threading.Tasks.Task(Of ActionResult)
        ...
        Dim model = Await FEB2.Subscriptions.All(exs, oUser)
        If exs.Count = 0 Then
            ViewBag.Title = Mvc.ContextHelper.Tradueix("Subscripciones", "Subscripcions", "Subscriptions", "Subscrições")
    ...
    Public Async Function UpdateSubscripcions(subscripcions As String) As Threading.Tasks.Task(Of String)
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.Subscriptions.Update(exs, ContextHelper.GetUser, oSscs) Then
