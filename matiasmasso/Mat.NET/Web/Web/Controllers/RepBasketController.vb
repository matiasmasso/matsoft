Public Class RepBasketController
    ...
    Function Index() As ActionResult
        ...
        Else
            ViewBag.Title = Mvc.ContextHelper.Tradueix("Pedido de Representante", "Comanda de Representant", "Sales Order")
    ...
    Async Function ForCustomer(customer As Guid) As Threading.Tasks.Task(Of ActionResult)
        ...
        Else
            ...
            Dim oTarifa = Await FEB2.CustomerBasket.Tarifa(exs, oUser, oCustomer)
            ViewBag.Title = Mvc.ContextHelper.Tradueix("Pedido de Representante", "Comanda de Representant", "Sales Order")
