...
Public Module RouteConfig
    ...
    Private sBrandsConstrain As String = FEB2.ProductBrands.RoutingConstraint(GlobalVariables.Emp)
    ...
    Public Sub RegisterRoutes(ByVal routes As RouteCollection)
        ...
        routes.MapRoute(
                name:="Eci Sales Report",
                url:="EciSalesReport",
                defaults:=New With {.Controller = "EciSalesReport", .Action = "Index"}
            )
        routes.MapRoute(
                name:="Rep Neighbours",
                url:="rep/{action}",
