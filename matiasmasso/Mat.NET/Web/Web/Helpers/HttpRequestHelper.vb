Public Class HttpRequestHelper
    ...
    Public Function GetImage(sKey As String) As System.Drawing.Image
        ...
        If oFileValue IsNot Nothing Then
            Using binaryReader As New System.IO.BinaryReader(oFileValue.HttpPostedFile.InputStream)
                ...
                Using oMemoryStream As New System.IO.MemoryStream(oImageBytes)
                    retval = System.Drawing.Image.FromStream(oMemoryStream)
                    'Dim sPath As String = My.Computer.FileSystem.SpecialDirectories.MyDocuments & "\WinMenuItemIcon.Jpg"
                    'retval.Save(sPath)
                End Using
            End Using
        End If
