...
Module ExcelExtensions
    ...
    <Extension()>
    Public Function AddCell(ByVal oRow As ExcelHelper.Row, oAmt As DTOAmt) As ExcelHelper.Cell
    ...
    <Extension()>
    Public Function AddCell(ByVal oRow As ExcelHelper.Row, oEan As DTOEan) As ExcelHelper.Cell
        Dim oCell As New ExcelHelper.Cell
