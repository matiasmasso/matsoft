...
<div class="PageContainer">
    ...
    <div class="PageRow">
        <div class="PageCellYear">
            @Mvc.ContextHelper.lang().Tradueix("año", "any", "year")
        </div>
        <div class="PageCellQuarter">
            @Mvc.ContextHelper.lang().Tradueix("trimestre", "trimestre", "quarter")
        </div>
        <div class="PageCellBase">
            @Mvc.ContextHelper.lang().Tradueix("base","base","base")
        </div>
        <div class="PageCellOnline">
            @Mvc.ContextHelper.lang().Tradueix("online", "online", "online")
        </div>
        <div class="PageCellShare">
            @Mvc.ContextHelper.lang().Tradueix("cuota", "quota", "share")
        </div>
    </div>
