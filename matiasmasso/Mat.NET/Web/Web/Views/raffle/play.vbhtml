...
@Code
    ...
    Dim oUser = If(Model.Src = DTORafflePlayModel.Srcs.app, Model.Participant.User, Mvc.ContextHelper.FindUserSync())
...
<div class="banner">
    <img src="@FEB2.Raffle.ImgBanner600Url(Model.Participant.Raffle)" width="600" height="200" />
</div>
    ...
    Else
        ...
        @<div id="SubmitRequest" hidden>
            ...
            <div class="SubmitComplexRow">
                ...
                <input type="button" class="Submit" value='@Mvc.ContextHelper.Tradueix("Enviar", "Enviar", "Submit")' />
            </div>
        </div>
