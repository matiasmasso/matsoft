...
<div class="Grid">
    ...
    <div class="RowHdr">
        ...
        <div class="CellAmt">
            @Mvc.ContextHelper.Tradueix("IVA", "IVA", "VAT")
        </div>
        <div class="CellAmt">
            @Mvc.ContextHelper.Tradueix("IRPF", "IRPF", "IRPF")
        </div>
        <div class="CellAmt">
            @Mvc.ContextHelper.Tradueix("Líquido", "Liquid", "Cash")
        </div>
    </div>
    ...
    @For Each item As DTORepCertRetencio In Model
        @<div class="Row">
            ...
            <div class="CellIco">
                    <a href="@FEB2.RepCertRetencio.CertFactoryUrl(item)">
