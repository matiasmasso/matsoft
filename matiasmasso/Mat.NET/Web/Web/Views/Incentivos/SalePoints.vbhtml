...
@Code
    ...
    Dim oParticipants = FEB2.Incentiu.ParticipantsSync(exs, Model)
    Dim oProvincia As New DTOAreaProvincia
    ViewBag.Title = Mvc.ContextHelper.Tradueix("puntos de venta participantes", "punts de venda participants", "sale points", "lojas")
End Code
