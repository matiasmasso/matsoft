@Code
    ...
    If oExercicis.Count > 0 Then
        oCcbs = FEB2.Ccbs.LlibreMajorSync(exs, oExercicis.First)
    End If
    Dim sTitle As String = Mvc.ContextHelper.Tradueix("Libro Mayor", "Llibre Major", "Ledger Accounting")
...
<div class="pagewrapper">
    <section class="PageTitle">
        ...
        @If oExercicis.Count > 0 Then
            @<a href='#' title='@(Mvc.ContextHelper.Tradueix("Descargar fichero Excel", "Descarregar fitxer Excel", "Download Excel file")) '>
