...
End Code
    ...
    <h1>@Mvc.ContextHelper.Tradueix("Cambio de contraseña", "Canvi de clau de pass", "Password edit", "Mudar a palavra-passe")</h1>

    <div class="row">
        <div class="label">
            @Mvc.ContextHelper.Tradueix("Entre su contraseña vigente", "entri la seva clau de pas vigent", "please enter your current password", "entre a sua palavra-passe atual")
        </div>
        <div class="control">
            ...
            <img src="~/Media/Img/Ico/empty.gif" />
                ...
                <a href="#" class="IforgotInfo"><img src="~/Media/Img/Ico/info_16.jpg" />&nbsp;@Mvc.ContextHelper.Tradueix("No la recuerdo", "No la recordo", "I forgot")</a>
                <div hidden="hidden" id="Iforgot">
                    <p>
                    @Mvc.ContextHelper.Tradueix("Si no la sabe o no la recuerda pulse el siguiente enlace y se la enviaremos al momento por correo",
                    ...
                    <p>
                        <a href="#" id="mailPassword">
                            @Mvc.ContextHelper.Tradueix("Enviarme la contraseña a ", "Envieu-me la clau de pas a ", "Mail password to ", "Enviar-me a palavra-passe a ")
                            @Model.emailAddress()
                        </a>
                    </p>
                </div>
        ...
        <div class="row">
            <div class="label">
                @Mvc.ContextHelper.Tradueix("entre su nueva contraseña (max 24 caracteres)",
        ...
        <div class="row">
            <div class="label">
                @Mvc.ContextHelper.Tradueix("entre de nuevo su nueva contraseña",
        ...
        <div id="submit" class="row">
            <input id="passwordEditSubmit" type="button" value='@Mvc.ContextHelper.Tradueix("Aceptar", "Acceptar", "Submit", "Aceitar")' />
        </div>
