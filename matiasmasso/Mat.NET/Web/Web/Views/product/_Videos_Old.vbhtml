...
@Code
    ...
    Dim oMovies As List(Of DTOYouTubeMovie) = FEB2.YouTubeMovies.FromProductGuidSync(Model.Guid, Mvc.ContextHelper.lang(), exs).Where(Function(x) x.Obsoleto = False).ToList
