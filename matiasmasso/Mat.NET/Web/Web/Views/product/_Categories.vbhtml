...
@Code
    ...
    FEB2.ProductBrand.Load(Model, exs)

    Dim oCategories = FEB2.ProductCategories.AllSync(exs, Model, Nothing, False, DTOProductCategory.SortOrders.Custom).Where(Function(x) x.HideUntil < Today).ToList
End Code
