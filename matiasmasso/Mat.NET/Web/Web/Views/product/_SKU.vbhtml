...
@Code
    ...
    FEB2.ProductSku.Load(Model, exs)

    Dim sUrlImageZoom As String = FEB2.ProductSku.UrlImageZoom(Model)
...
<div class="wrapper">
    <div class="pill-content-wrapper">
        ...
        <div class="product-description-feature-image">
            <a href="javascript:window.open('@sUrlImageZoom','','height=820,width=720')" title='@Mvc.ContextHelper.Tradueix("ampliar la imagen", "amplia la imatge", "image zoom")'>
            ...
            @If Model.hereda Then
                @<div>
                    <h2>
                        @Model.CategoryNom
                        <br />
                        @Model.nom.Tradueix(Mvc.ContextHelper.Lang)
                        <br />
