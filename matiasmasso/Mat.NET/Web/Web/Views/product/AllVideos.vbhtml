...
<h1 class="Title">@ViewBag.Title</h1>
        ...
        <div>
            @Mvc.ContextHelper.Tradueix("¿De qué producto buscas videos?", "De quin producte vols els videos?", "What product are you looking for videos?", "De que produto procuras videos?")
        </div>

        <div class="ProductSelection">
            <select id="Brands">
                <option selected value=""
                        label='@Mvc.ContextHelper.Tradueix("(Selecciona una marca comercial)", "(Selecciona una marca comercial)", "(Pick a brand name)", "(Seleciona uma marca)")'>
                </option>
            ...
            <select id="Categories">
                <option selected value=""
                        label='@Mvc.ContextHelper.Tradueix("(Selecciona una categoría)", "(selecciona una categoría)", "(Pick a product category)", "(Seleciona uma categoria)")'>
                </option>
            </select>
            <select id="Skus">
                <option selected value=""
                        label='@Mvc.ContextHelper.Tradueix("(Selecciona un producto)", "(Selecciona un producte)", "(Pick a product)", "(Seleciona um produto)")'>
                </option>
            </select>
        </div>
