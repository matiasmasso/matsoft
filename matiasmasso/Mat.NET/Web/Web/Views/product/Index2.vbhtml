...
@Section AdditionalMetaTags
    ...
    <meta property="og:url" content="@Model.Product.GetUrl(Mvc.ContextHelper.Lang)" />
            ...
            Select Case DirectCast(Model.Product, DTOProduct).SourceCod
                Case DTOProduct.SourceCods.Brand
                    ...
                    Else
                        ...
                        'Dim oSprite = oBrand.DeptsSprite(oDepts, Mvc.ContextHelper.lang())
                                                                                    ...
                                                                                    Case DTOProduct.Tabs.accesorios
                                                                                        @Html.Partial("_Accessories", Model.Product)
                                                                                                        Case DTOProduct.Tabs.distribuidores
                                                                                                            Dim oDistributor As DTOContact = Mvc.ContextHelper.GetDistribuidorFromCookie()
...
<div class="accordion_wrapper">
    ...
    @For Each item In FEB2.Product.Accordion(Model.Product, Mvc.ContextHelper.lang())
    ...
    $(document).on('click', "a.OnlineStore", function (event) {
        ...
        function loadTab(panel, tab) {
            ...
            var data = { product: '@Model.Product.Guid.ToString' }
                ...
                var fullUrl = '@Model.Product.GetUrl(Mvc.ContextHelper.Lang, DTOProduct.Tabs.distribuidores)';
