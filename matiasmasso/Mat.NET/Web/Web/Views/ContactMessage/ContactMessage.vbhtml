...
End Code
        ...
        @Using Html.BeginForm()
            @<div>
                <div class="dataRow">
                    <div>
                        <label>@Mvc.ContextHelper.Tradueix("dirección de correo electrónico", "adreça email", "email address")</label>
                    </div>
                    <div>
                ...
                <div class="dataRow">
                    <div>
                        <label>@Mvc.ContextHelper.Tradueix("nombre", "nom", "name")</label>
                    </div>
                    <div>
                ...
                <div class="dataRow">
                    <div>
                        <label>@Mvc.ContextHelper.Tradueix("población", "població", "location")</label>
                    </div>
                    <div>
                ...
                <div class="dataRow">
                    <div>
                        <label>@Mvc.ContextHelper.Tradueix("Su consulta", "La seva consulta", "Your request")</label>
                    </div>
                    <div>
