...
@If Model.result.Count = 0 Then
    @<div>
        ...
        @Mvc.ContextHelper.Tradueix("No nos constan incidencias registradas", "No ens consten incidencies registrades", "No support incidences have been logged")
    </div>  Else
    @<div class="Grid">

    <span class="CellId">
        @Mvc.ContextHelper.Tradueix("Registro", "Registre", "#Id")
    </span>
    <span class="CellFch">
        @Mvc.ContextHelper.Tradueix("Fecha", "Data", "Date")
    </span>
    <span class="CellIco">
        @Mvc.ContextHelper.Tradueix("Imágenes", "Images", "Images")
    </span>
    <span class="CellIco">
    ...
    <span class="CellTxt">
        @Mvc.ContextHelper.Tradueix("Nº de serie", "Nª de serie", "Serial number")
    </span>
    <span class="CellTxt">
        @Mvc.ContextHelper.Tradueix("Fecha fabricación", "Data fabricació", "Manuf.date")
    </span>
    <span class="CellTxt">
        @Mvc.ContextHelper.Tradueix("Concepto", "Concepte", "Concept")
    </span>
    <span class="CellFch">
        @Mvc.ContextHelper.Tradueix("Cierre", "Tancament", "Closed")
    </span>


    @For Each item As DTOIncidencia In Model.result
        @<div class="Item" data-url='@FEB2.UrlHelper.Factory(False, item.UrlSegment)'>
    <span Class="CellId">
        @item.num
    </span>
    <span class="CellFch">
    ...
    <span class="CellTxt">
        @If item.codi IsNot Nothing Then
            @<span>@item.codi.nom.Tradueix(Mvc.ContextHelper.Lang)</span>
        End If
    </span>
    <span class="CellFch">
