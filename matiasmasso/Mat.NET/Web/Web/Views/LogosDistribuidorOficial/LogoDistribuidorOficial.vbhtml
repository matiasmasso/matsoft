...
@Code
    ...
    Dim oExclusivas = FEB2.CliProductsBlocked.Allsync(exs, Model.Customer)
    Dim oBrand As DTOProductBrand = DirectCast(Model.Product, DTOProductBrand)
    Dim validated As Boolean = FEB2.CliProductsBlocked.IsAllowed(oExclusivas, Model.Product)
    If validated Then Mvc.ContextHelper.SetDistribuidorCookie(exs, Me.Context, Model.Customer.Guid)
