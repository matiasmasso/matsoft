...
@Code
    ...
    Dim sFch As String = Mvc.ContextHelper.lang().WeekDay(Model.Fch) & " " & Model.Fch.ToString("d", System.Globalization.CultureInfo.CreateSpecificCulture("es-ES"))
    ViewBag.Title = Mvc.ContextHelper.Tradueix("Diario de pedidos", "Diari de Comandes", "Diary orders") & " " & sFch
End Code
...
<div class="Grid">
    ...
    @For Each item As DTODiariItem In FEB2.Diari.Orders(Model, EXS)
        ...
        @<div class="Row">
            ...
            <div class="CellTxt">
                <a href="@FEB2.Contact.Url(oOrder.Customer)">
