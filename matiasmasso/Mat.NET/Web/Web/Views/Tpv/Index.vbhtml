...
<div class="LeftSide">
    ...
    <p>
        @Html.Raw(Mvc.ContextHelper.Tradueix("al pulsar 'Siguiente' será reenviado a la página segura de nuestra entidad bancaria",
    ...
    @Using (Html.BeginForm())
        ...
        @<div class="row">
            <div Class='label'>
                @Mvc.ContextHelper.Tradueix("concepto del pago", "concepte del pago", "payment concept")
            </div>
            <div Class="control">
    ...
    @If Model.Mode = DTOTpvRequest.Modes.Free And Model.Eur = 0 Then
     @Html.TextBoxFor(Function(Model) Model.Eur, New With {.style = "text-align:right;", .Value = DTOAmt.Factory(Model.Eur).CurFormatted()})
    Else
    ...
    End If
        ...
        @<div id="submit" Class="SubmitRow">
            <input type="submit" Class="Submit" value='@Mvc.ContextHelper.Tradueix("Siguiente", "Següent", "Next")' />
        </div>
