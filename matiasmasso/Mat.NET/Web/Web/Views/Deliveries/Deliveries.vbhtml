...
@Code
    ...
    Dim oCentros = FEB2.Deliveries.CentrosSync(exs, oUser)
End Code
...
<div class="Store">
    <select>
        <option value="@System.Guid.Empty.ToString">@Mvc.ContextHelper.Tradueix("Todos los centros", "Tots els centres", "All stores")</option>
...
@If Model.Count = 0 Then
    @<div>
        @Mvc.ContextHelper.Tradueix("No nos constan albaranes registrados", "No ens consten albarans registrats", "No deliveries have been logged")
    </div>
Else
