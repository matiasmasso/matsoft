...
@Code
    ...
    Dim domainLang = Mvc.ContextHelper.Domain.DefaultLang()
End Code
...
@Section AdditionalMetaTags
    ...
    <meta property="og:locale" content="@Mvc.ContextHelper.Domain.TopLevelTag" />
...
<div hidden class="Error">
    ...
    @Mvc.ContextHelper.Tradueix("Error al descargar los sorteos", "Error al descarregar els sortejos", "Error downloading raffles")
</div>
