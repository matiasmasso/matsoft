...
End Code
    ...
    <fieldset class="formWrap">
        ...
        <br/>
        @Mvc.ContextHelper.Tradueix("Gracias por registrarse","Gracies per registrar-se","Thanks for signing up")
        <br /><br />
        @Mvc.ContextHelper.Tradueix("Acabamos de enviarle un correo para validar su dirección email.", _
        ...
        <br /><br/>
        @Mvc.ContextHelper.Tradueix("Por favor ábralo y siga las instrucciones para activar su cuenta", _
