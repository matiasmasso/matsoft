@ModelType Mvc.BlogConsultaModel
@Code
...
<div class="PageWrapperHorizontal">
    ...
    <div class="MainContent">
        ...
        <div class="Info">
            @Mvc.ContextHelper.Tradueix("Escribe aquí tu Consulta:", "Escriu aquí la teva consulta:", "Write here your request:", "Deixa-nos aquí a tua consulta:")
        </div>
