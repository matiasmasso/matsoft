...
@Code
    ...
    Dim oAllContactClasses = FEB2.ContactClasses.AllWithChannelSync(exs).ToList
...
<div class="narrowForm">
    ...
    <div class="PageTitle">@Mvc.ContextHelper.Tradueix("Registro de Profesional", "Registre de Professional", "Professional Application Request", "Registo de Profissional")</div>

    <div class="formulari">

        <div>
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("Persona de contacto", "Persona de contacte", "Contact person", "Pessoa de contacto")</div>
        ...
        <div>
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("Razón social de facturación", "Rao Social de facturació", "Corporate name", "Razão social de facturação")</div>
        ...
        <div>
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("Nombre Comercial del establecimiento", "Nom Comercial de l'establiment", "Commercial name", "Nome comercial do estabelecimento")</div>
        ...
        <div>
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("Dirección del establecimiento", "Adreça de l'establiment", "Store address", "Direção do estabelecimento")</div>
            ...
            <div class="editor-field Country">
                <select>
                    @For Each oCountry As DTOCountry In FEB2.Countries.AllSync(Mvc.ContextHelper.lang(), exs)
                        If oCountry.Equals(Mvc.GlobalVariables.Emp.DefaultCountry) Then
                            @<option selected value="@oCountry.Guid.ToString">@DTOCountry.NomTraduit(oCountry, Mvc.ContextHelper.lang())</option>
                        Else
        ...
        <div>
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("telefonos de contacto", "telefons de contacte", "contact phone numbers", "telefones de contacto")</div>
        ...
        <div>
            ...
            <div>
                <div class="editor-label">@Mvc.ContextHelper.Tradueix("Actividad", "Activitat", "Activity", "Actividade")</div>
                    ...
                    <select>
                        @For Each oContactClass As DTOContactClass In oContactClasses
                            If oContactClass.Equals(Model.ContactClass) Then
                                @<option selected value="@oContactClass.Guid.ToString">@oContactClass.Nom.Tradueix(Mvc.ContextHelper.lang())</option>
                            Else
                                @<option value="@oContactClass.Guid.ToString">@oContactClass.Nom.Tradueix(Mvc.ContextHelper.lang())</option>
                            End If
                        Next
                    </select>
                </div>
            ...
            <div class="ShowIfPresencial" hidden="hidden">
                <div class="editor-label">@Mvc.ContextHelper.Tradueix("Superficie aproximada de exposición", "Superficie aproximada d'exposició", "Approximated surface", "Superfície aproximada de exposição")</div>
                    ...
                    @For i As DTOCliApertura.CodsSuperficie = 1 To [Enum].GetValues(GetType(DTOCliApertura.CodsSuperficie)).Length - 1
                        @<div>
                            <Label Class="radioLabel">
                                ...
                                <span Class="wrappable">@DTOCliApertura.CodSuperficieText(i, Mvc.ContextHelper.lang())</span>
                            </Label>
                        </div>
                    Next
                </div>
            ...
            <div>
                <div class="editor-label">@Mvc.ContextHelper.Tradueix("Volumen de facturación anual previsto", "Volum previst de facturació anual", "Expected yearly turnover", "Facturação anual esperada")</div>
                    ...
                    @For i As DTOCliApertura.CodsVolumen = 1 To [Enum].GetValues(GetType(DTOCliApertura.CodsVolumen)).Length - 1
                        @<div>
                            <Label Class="radioLabel">
                                ...
                                <span Class="wrappable">@DTOCliApertura.CodVolumenText(i, Mvc.ContextHelper.lang())</span>
                            </Label>
                        </div>
                    Next
                </div>
            ...
            <div class="ShowIfPuericultura" hidden="hidden">
                <div class="editor-label ShowIfPuericultura" hidden="hidden">@Mvc.ContextHelper.Tradueix("¿Vende algo más que puericultura en su establecimiento? (textil, mobiliario, jugueteria...)", "Ven algo més que puericultura al seu establiment? (textil, mobiliari, jogueteria...)", "Are you selling alternative goods in your store? (textile, furniture, toys...)", "Vende algum outro produto além de puericultura no seu estabelecimento? (textil, mobiliário, brinquedos...)")</div>
            ...
            <div class="ShowIfPresencial" hidden="hidden">
                <div class="editor-label">@Mvc.ContextHelper.Tradueix("¿Cuantos puntos de venta gestiona o piensa abrir en breve?", "Quants punts de venda gestiona o pensa obrir a curt termini?", "How many sale points do you manage or expect to manage at short term?", "Quantos pontos de venda gere ou pensa abrir em breve?")</div>
                    ...
                    @For i As DTOCliApertura.CodsSalePoint = 1 To [Enum].GetValues(GetType(DTOCliApertura.CodsSalePoint)).Length - 1
                        @<div>
                            <Label Class="radioLabel">
                                ...
                                <span Class="wrappable">@DTOCliApertura.CodSalePointText(i, Mvc.ContextHelper.lang())</span>
                            </Label>
                        </div>
                    Next
                </div>
            ...
            <div>
                <div class="editor-label">@Mvc.ContextHelper.Tradueix("¿Qué antigüedad tiene su negocio?", "Quina antiguitat té el seu negoci?", "How long has your business been running?", "Que antiguidade tem o seu negócio?")</div>
                    ...
                    @For i As DTOCliApertura.CodsAntiguedad = 1 To [Enum].GetValues(GetType(DTOCliApertura.CodsAntiguedad)).Length - 1
                        @<div>
                            <Label Class="radioLabel">
                                ...
                                <span Class="wrappable">@DTOCliApertura.CodAntiguedadText(i, Mvc.ContextHelper.lang())</span>
                            </Label>
                        </div>
                    Next
                </div>
            ...
            <div>
                <div class="editor-label">@Mvc.ContextHelper.Tradueix("Fecha inicio actividad o apertura prevista", "Data inici activitat o apertura prevista", "Start date or expected opening date", "Data de abertura")</div>
        ...
        <div class="ShowIfPuericultura" hidden="hidden">
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("¿Tiene alguna experiencia previa?", "Disposa de alguna experiencia previa?", "Any previous experience?", "Tem alguma experiência prévia?")</div>
                ...
                @For i As DTOCliApertura.CodsExperiencia = 1 To [Enum].GetValues(GetType(DTOCliApertura.CodsExperiencia)).Length - 1
                    @<div>
                        <Label Class="radioLabel">
                            ...
                            <span Class="wrappable">@DTOCliApertura.CodExperienciaText(i, Mvc.ContextHelper.lang())</span>
                        </Label>
                    </div>
                Next
            </div>
        ...
        <div class="ShowIfPuericultura" hidden="hidden">
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("¿Comercializa ya o piensa comercializar otras marcas de puericultura? Por favor cite cuales", "¿Comercialitza ja o pensa comercialitzar altres marques de puericultura? Si us plau citi quines", "Do you distribute or plan to distribute alternative brands? Please let us know which ones", "Actualmente já comercializa ou pensa comercializar outras marcas de puericultura? Por favor cite quais")</div>
        ...
        <div>
            <div class="editor-label">@Mvc.ContextHelper.Tradueix("Detalle cualquier otra información que considere relevante de su negocio", "Exposi qualsevol altre informació que consideri rellevant del seu negoci", "Let us know whatever info you feel relevant for your business", "Detalhe qualquer outra informação que considere relevante sobre o seu negócio")</div>
        ...
        <div hidden="hidden" id="errors">
            @Mvc.ContextHelper.Tradueix("Por favor solvente los siguientes errores:", "Si us plau solventi els següents errors", "Please amend next fields:", "Por favor solvente os seguintes erros:")
            <div id="errorsEnum">
        ...
        <div>
            <div class="editor-submit">
                <button>
                    @Mvc.ContextHelper.Tradueix("Aceptar", "Acceptar", "Submit", "Aceitar")
                </button>
            </div>
        </div>
    ...
    <div class="Thanks" hidden="hidden">
        <p>
            @Mvc.ContextHelper.Tradueix("Gracias por su interés en nuestras marcas", "Gracies per el seu interés en les nostres marques", "Thanks for your interest on our brands", "Agradecemos o seu interesse pelas nossas marcas")
        </p>
        <p>
            @Mvc.ContextHelper.Tradueix("Nuestro comercial de zona se pondrá en contacto en breve para concertar una entrevista", "El nostre comercial de zona el contactará per concertar una entrevista", "A sales representative will contact you for an interview", "O nosso comercial da sua zona, brevemente entrará em contacto consigo para agendar uma entrevista")
        </p>
            </div>
