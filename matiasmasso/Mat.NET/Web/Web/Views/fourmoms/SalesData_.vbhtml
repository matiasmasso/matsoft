...
@Code
    ...
    Dim oSales As List(Of DTOProductAreaQty) = FEB2.FourMoms.SalesSync(Model, exs)
    Dim oSalePoints As List(Of DTOProductAreaQty) = FEB2.FourMoms.SalePointsSync(Model, exs)
    Dim oStocks As List(Of DTOProductAreaQty) = FEB2.FourMoms.StocksSync(Model, exs)
