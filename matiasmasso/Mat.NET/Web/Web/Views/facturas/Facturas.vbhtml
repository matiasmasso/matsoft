...
@Code
    ...
    ViewBag.Title = Mvc.ContextHelper.Tradueix("Mis facturas", "Les meves factures", "My invoices")
...
@If Model.Count = 0 Then
    @<span>@Mvc.ContextHelper.Tradueix("No hay facturas registradas", "No hi han dades registrades", "Not records available")</span>
Else
    @<div id="Contact">
