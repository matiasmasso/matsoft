...
<div class="Catalog">
    ...
    <div class="Grid Brands" data-contextmenu="Brands">
        <div class="HeaderRow">
            <div>@Mvc.ContextHelper.Tradueix("Marca", "Marca", "Brand")</div>
        </div>
    </div>

    <div class="Grid Categories" data-contextmenu="Categories">
        <div class="HeaderRow">
            <div>@Mvc.ContextHelper.Tradueix("Categoría", "Categoría", "Category")</div>
        </div>
    </div>
    ...
    <div class="Grid Skus" data-contextmenu="Skus">
        <div class="HeaderRow">
            ...
            <div class="Stk">@Mvc.ContextHelper.Tradueix("Stock")</div>
            <div class="Pvp">@Mvc.ContextHelper.Tradueix("PVP", "PVP", "RRPP")</div>
        </div>
    </div>
</div>
