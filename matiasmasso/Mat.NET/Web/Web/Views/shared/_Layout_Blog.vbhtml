...
<body>
    <div class="body-content">
        @If Not Mvc.ContextHelper.isTrimmed() Then
            @<header>
                ...
                <div Class="banner">
                    <a href="/blog" title='@Mvc.ContextHelper.Tradueix("El blog de Matías Massó", "El blog de Matías Massó", "Matías Massó blog", "O blog de Matias Massó")'>
                        <img src="~/Media/Img/Portada/BlogBanner-950.jpg" width="950" height="338" alt='@Mvc.ContextHelper.Tradueix("El blog de Matías Massó", "El blog de Matías Massó", "Matías Massó blog", "O blog de Matias Massó")' />
                        <div class="BlogTitle">@Mvc.ContextHelper.Tradueix("El blog de Matías Massó", "El blog de Matías Massó", "Matías Massó blog", "O blog de Matias Massó")</div>
                    </a>
            ...
            @<div class="popSidenav popdown">
                <div class="popButtonsBar">
                    ...
                    <a href="#" class="searchbtn">
                        <img src="~/Media/Img/Ico/magnifying-glass.jpg" alt='@Mvc.ContextHelper.Tradueix("Buscar", "Cercar", "Search")' width="20" height="20" />
                    </a>
                ...
                @Html.Partial("_SideNav-Blog", Mvc.ContextHelper.NavViewModel().SideNav(lang))
            </div>
    ...
    <script>
                                                                                                    ...
                                                                                                    function loadStoreLocatorCalltoAction() {
                                                                                                        $('.StoreLocatorCallToAction a').html('@Mvc.ContextHelper.Tradueix("¿Dónde comprar?", "On comprar?", "Where to buy?", "Onde comprar")')
                                                                                                    }
