        ...
        <div class="Text">
            ...
            <div class="ShortenedText">
                ...
                @if Model.ShortenedText.EndsWith("...") Then
                    @<a href="#" class="ReadMore">
                        @Mvc.ContextHelper.Tradueix("(leer más)", "(llegir-ne més)", "(read more)", "(ler mais)")
                    </a>
                End If
            </div>
            ...
            <div class="CompleteText">
                ...
                <a href="#" class="ReadLess">
                    @Mvc.ContextHelper.Tradueix("(leer menos)", "(llegir-ne menys)", "(read less)", "(leia menos)")
                </a>
            </div>

            <div class="Feedback">
                <a href="#" class="CallToAnswer">
                    @Mvc.ContextHelper.Tradueix("responder", "respon", "reply", "(leia menos)")
                </a>
            </div>
