...
@Code
    ...
    Dim oNextEvento = FEB2.Eventos.NextEventoSync(exs, Model)
    Dim oPostOfTheDay = FEB2.BloggerPosts.PostOfTheDaySync(Mvc.GlobalVariables.Emp, Mvc.ContextHelper.lang(), exs)
End Code
