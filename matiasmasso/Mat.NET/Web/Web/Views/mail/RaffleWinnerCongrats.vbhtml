    ...
    <li>
        ...
        <ul>
            <li>
                ...
                @Html.Raw(FEB2.RaffleParticipant.DistributorNameAndAddressHtml(Model))
            </li>
            <li>
