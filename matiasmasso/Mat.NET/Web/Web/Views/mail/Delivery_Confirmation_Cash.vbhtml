...
@Code
    ...
    'Dim oAmt As DTOAmt = FEB2.Delivery.TotalSync(exs,Model)
...
<p>
    ...
    <a href="@FEB2.Delivery.UrlTpv(Model, True)">
...
@Html.Raw(FEB2.Banc.BancTransfersReceptionHtml(Mvc.GlobalVariables.Emp))
            </p>
            <p>
            ...
            <table style="font-family:Arial,helvetica,sans-serif;font-size:1em;line-height:1.2em;width:100%">
                ...
                @For i As Integer = 0 To Model.Items.Count - 1
                    ...
                    @<tr>
                        ...
                        <td style="padding-left:10px;"><a href="@Item.Sku.GetUrl(Mvc.ContextHelper.Lang,, True)">@Item.Sku.NomLlarg.Tradueix(Mvc.ContextHelper.Lang)</a></td>
                    </tr>
                Next
            </table>
