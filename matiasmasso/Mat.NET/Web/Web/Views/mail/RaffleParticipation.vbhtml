...
@Code
    ...
    Dim oBrand = FEB2.Product.BrandSync(Model.Raffle.Product)
End Code
...
<table cellpadding="20" style="font-family: arial, sans-serif; font-size: 12pt;">
        ...
        <td>
            <table cellpadding="0" style="font-family: arial, sans-serif; font-size: 12pt;">
                ...
                <tr>
                    ...
                    <td><a href="@Html.Raw(FEB2.Raffle.BasesUrl(Model.Raffle, True))">@Html.Raw(oLang.Tradueix("(ver bases del sorteo)", "(veure bases del sorteig)", "(see raffle terms)", "(ver bases do sorteio)"))</a></td>
                </tr>
                @if Model.Raffle.RightAnswer > 0 Then
                    ...
                    @<tr>
                        ...
                        <td><b>@Html.Raw(FEB2.Contact.HtmlNameComercialAndAddress(Model.Distribuidor))</b></td>
                    </tr>
                End If
            </table>
        </td>
        ...
        <td colspan=" 2">
            ...
            @If (oBrand.Is4moms() Or oBrand.IsBritaxRoemer) Then
                ...
                Else
                    If oBrand.IsBritaxRoemer Then
                        @<br />
                        @<a href="@FEB2.Raffle.FacebookPage(Model.Raffle, oLang)">@FEB2.Raffle.FacebookPageLabel(Model.Raffle, oLang)</a>
                        @<br />
    ...
    <tr>
        ...
        @Html.Raw(oLang.Tradueix("en", "a", "at", "em"))
                        <a href="@FEB2.Raffles.Url(oLang, True)">@FEB2.Raffles.Url(oLang, True)</a>
                                    </p>
                                    <p>
