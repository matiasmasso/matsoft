...
@Code
    ...
    Dim Years As List(Of Integer) = FEB2.SumasYSaldos.YearsSync(exs, Mvc.GlobalVariables.Emp, Model)
    ...
    If Years.Count > 0 Then
        oExercici = DTOExercici.FromYear(Mvc.GlobalVariables.Emp, Years(0))
        If Model Is Nothing Then
            oSaldos = FEB2.SumasYSaldos.SummarySync(exs, oExercici)
        Else
            oSaldos = FEB2.SumasYSaldos.AllSync(exs, oExercici, False, DTO.Defaults.ContactRange.OnlyThisContact, Model)
