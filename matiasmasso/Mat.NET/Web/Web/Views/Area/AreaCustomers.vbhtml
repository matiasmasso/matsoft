...
End Code
    ...
    <div class="pagewrapper">
        ...
        <div class="Grid">
            ...
            <div class="RowHdr">
                <div class="CellNum Progress">@Mvc.ContextHelper.Tradueix("Progreso", "Progrés", "Progress")</div>
                <div class="CellTxt">@Mvc.ContextHelper.Tradueix("Cliente", "Client", "Customer")</div>
                <div class="CellAmt">@Mvc.ContextHelper.Tradueix("90-0 dias", "90-0 dies", "90-0 days")</div>
                <div class="CellAmt Previous">@Mvc.ContextHelper.Tradueix("180-90 dias", "180-90 dies", "180-90 days")</div>
            </div>
            ...
            @For Each item As DTOPeriodProgress In Model
                ...
                @<div class="Row">
                    ...
                    <div class="CellTxt">
                        <a href="@FEB2.Contact.Url(item.Contact)">
