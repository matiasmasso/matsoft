...
<div class="pagewrapper">
    <div class="PageTitle">
        @Mvc.ContextHelper.Tradueix("Historial de linea de pedido","Historial de linia de comanda","Order line history")
    </div>
    <div>
   ...
   <div class="Grid">
        ...
        <div class="Row">
            ...
            <div class="CellTxt">
                <a href="@FEB2.PurchaseOrder.Url(Model.PurchaseOrder)" target="_blank">
        ...
        @For Each item As DTODeliveryItem In Model.Deliveries
            ...
            @<div class="Row">
                ...
                <div class="CellTxt">
                    <a href="@FEB2.Delivery.Url(item.Delivery)">
                        @String.Format("{0} {1}", Mvc.ContextHelper.Tradueix("albarán ", "albarà ", "delivery note "), item.Delivery.Id)
                    </a>
                    @If item.Delivery.Invoice IsNot Nothing Then
                    @<a href="@FEB2.Invoice.Url(item.Delivery.Invoice)">
                        @String.Format("{0} {1}", Mvc.ContextHelper.Tradueix("factura ", "factura ", "invoice "), item.Delivery.Invoice.Num)
                    </a>
                    End If
                </div>
