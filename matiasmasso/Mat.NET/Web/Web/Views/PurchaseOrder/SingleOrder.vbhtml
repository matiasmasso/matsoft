...
<div class="pagewrapper">
    <section class="PageTitle ToolStrip">
        @If Model.DocFile IsNot Nothing Then
            @<a href='@FEB2.PurchaseOrder.PdfUrl(Model)' title='@(Mvc.ContextHelper.Tradueix("Descargar fichero Pdf", "Descarregar fitxer Pdf", "Download Pdf file")) '>
                <img class="Download" src="~/Media/Img/48x48/Pdf48.png" />
            </a>
        End If
        <a href='@FEB2.PurchaseOrder.ExcelUrl(Model)' title='@(Mvc.ContextHelper.Tradueix("Descargar fichero Excel", "Descarregar fitxer Excel", "Download Excel file")) '>
            <img src="~/Media/Img/48x48/Excel48.png" />
        </a>

        @If Model.Cod = DTOPurchaseOrder.Codis.proveidor Then
            @Mvc.ContextHelper.Lang().Tradueix("Pedido a Proveedor", "Comanda a Proveidor", "Purchase Order to supplier")
        ElseIf Model.Cod = DTOPurchaseOrder.Codis.client Then
            @Mvc.ContextHelper.Lang().Tradueix("Pedido de Cliente", "Comanda de Client", "Customer Purchase Order")
        End If
    </section>
    ...
    <div>
        @Model.caption(Mvc.ContextHelper.Lang())
    </div>

    @If Model.Cod = DTOPurchaseOrder.Codis.client Then
        @<div>
            @Mvc.ContextHelper.Tradueix("Confirmación de pedido", "Confirmació de comanda", "Purchase Order Confirmation") @Model.Num
        </div>
    End If

    @If Model.FchDeliveryMin <> Nothing Then
        @<div>
            @Mvc.ContextHelper.Tradueix("Fecha de servicio:", "Data de servei:", "Delivery date:") @Model.FchDeliveryMin.ToString("d", System.Globalization.CultureInfo.CreateSpecificCulture("es-ES"))
        </div>
    End If
    ...
    <div Class="Grid">
        <div Class="RowHdr">
            <div Class="CellNum">
                @Mvc.ContextHelper.Tradueix("Pedido", "Demanat", "Ordered")
            </div>
            <div class="CellTxt">
            ...
            @If DTOPurchaseOrder.discountsExist(Model) Then
                @<div Class="CellDto">
                    @Mvc.ContextHelper.Tradueix("Descto", "Descte", "Discount")
                </div>
            End If
            <div Class="CellAmt">
            ...
            <div class="CellNum Servido">
                @Mvc.ContextHelper.Tradueix("Servido", "Servit", "Shipped")
            </div>
            <div class="CellNum Pendiente">
                @Mvc.ContextHelper.Tradueix("Pendiente", "Pendent", "Pending")
            </div>
        </div>
        @For Each item As DTOPurchaseOrderItem In Model.Items
            @<div class="Row">
                ...
                <div class="CellTxt">
                    <a href="@item.Sku.GetUrl(Mvc.ContextHelper.Lang)" target="_blank">
                ...
                <div class="CellNum Servido">
                    <a href="@FEB2.PurchaseOrderItem.Url(item)" target="_blank">
        ...
        <div class="Row">
            ...
            <div class="CellTxt">
                @Mvc.ContextHelper.lang().Tradueix("Suma de importes", "Suma de imports", "Sum")
            </div>
        ...
        @If DTOPurchaseOrder.DevengaIva(Model) Then
            @<div class="Row">
                <div class="CellNum">&nbsp;</div>
                <div class="CellTxt">
                    @Mvc.ContextHelper.lang().Tradueix("IVA", "IVA", "VAT")
            ...
            @If DTOPurchaseOrder.DevengaReq(Model) Then
                @<div class="Row">
                    <div class="CellNum">&nbsp;</div>
                    <div class="CellTxt">
                        @Mvc.ContextHelper.lang().Tradueix("Recargo de equivalencia", "Recarrec d'equivalencia", "VAT")
            ...
            @<div class="Row">
                <div class="CellNum">&nbsp;</div>
                <div class="CellTxt">
                    @Mvc.ContextHelper.lang().Tradueix("Total IVA incluido", "Total IVA inclos", "VAT Included")
                </div>
    ...
    <div>
        <a href="@FEB2.PurchaseOrders.Url(Model.Contact)">
            @Mvc.ContextHelper.Tradueix("Ver el historial de pedidos de", "Veure l'historial de comandes de", "Browse order history from")
            @Model.Contact.FullNom
        </a>
    </div>
</div>
