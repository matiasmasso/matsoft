...
End Code
    ...
    <div class="pagewrapper">
        <div class="PageTitle">
            @Mvc.ContextHelper.Tradueix("Historial de pedido", "Historial de comanda", "Order history")
        </div>
        <div>
        ...
        <div class="Grid">
            <div class="RowHdr">
                ...
                <div class="CellNum">
                    @Mvc.ContextHelper.Tradueix("Precio", "Preu", "Price")
                </div>

                @If DtoExists Then
                    @<div Class="CellNum">
                        @Mvc.ContextHelper.Tradueix("Descuento", "Descompte", "Discount")
                    </div>
                End If
                ...
                <div class="CellNum">
                    @Mvc.ContextHelper.Tradueix("Albaran", "Albarà", "Delivery note")
                </div>
                <div class="CellNum">
                    @Mvc.ContextHelper.Tradueix("Factura", "Factura", "Invoice")
                </div>
                <div class="CellNum">
                    @Mvc.ContextHelper.Tradueix("Liquidacion", "Liquidació", "Balance")
                </div>
            </div>
            ...
            @For Each item As DTOPurchaseOrderItem In Model.items
                For Each item2 As DTODeliveryItem In item.deliveries
                    @<div class="Row">
                        ...
                        <div class="CellNum">
                            <a href="@FEB2.Delivery.Url(item2.delivery)">@item2.delivery.id</a>
                        </div>
                        <div class="CellNum">
                            @If item2.delivery.invoice IsNot Nothing Then
                                @<a href="@FEB2.Invoice.Url(item2.delivery.invoice)">@item2.delivery.invoice.num</a>
                            Else
                                @Html.Raw("&nbsp;")
                            End If
                        </div>
                        <div class="CellNum">
                            @If item2.repComLiquidable IsNot Nothing AndAlso item2.repComLiquidable.repLiq IsNot Nothing Then
                                @<a href="@FEB2.Repliq.DownloadUrl(item2.repComLiquidable.repLiq)">@item2.repComLiquidable.repLiq.id</a>
                            Else
                                @Html.Raw("&nbsp;")
                            End If
                        </div>
