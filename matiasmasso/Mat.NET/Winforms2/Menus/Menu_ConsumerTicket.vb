Public Class Menu_ConsumerTicket
    ...
    Private Function MenuItem_Invoice() As ToolStripMenuItem
        ...
        Dim oDeliveries = _ConsumerTickets.Where(Function(x) x.Delivery IsNot Nothing).Select(Function(y) y.Delivery).ToList()
        If oDeliveries.Count = 0 Then
            oMenuItem.Enabled = False
        Else
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            ...
            If Await FEB.ConsumerTicket.Delete(exs, _ConsumerTickets.First) Then
