...
Public Class Menu_Spv
    ...
    Private Async Sub Do_TrpAlb(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim oTrp = FEB.Default.ContactSync(GlobalVariables.Emp, DTODefault.Codis.SpvTrp, exs)
        Dim oTaller = FEB.Default.ContactSync(GlobalVariables.Emp, DTODefault.Codis.Taller, exs)
    ...
    Private Async Sub Do_Del(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.Spv.Delete(_Spvs.First, exs) Then
