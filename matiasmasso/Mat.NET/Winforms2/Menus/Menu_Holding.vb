Public Class Menu_Holding
    ...
    Private Sub AddMenuItems()
        ...
        MyBase.AddMenuItem(MenuItem_Margins())
    ...
    Private Async Sub Do_SellOut(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If exs.Count = 0 Then
            FEB.SellOut.AddFilterValues(oSellout, DTOSellOut.Filter.Cods.Holding, {_Holding})
    ...
    Private Sub Do_Margins()
        Dim oFrm As New Frm_Margins(Models.MarginsModel.Modes.Holding, _Holding)
        oFrm.Show()
    End Sub

    Private Sub Do_ExcelEciPending(sender As Object, e As System.EventArgs)
        Dim exs As New List(Of Exception)
        'Dim oSheet = Await FEB.Holding.ExcelEciPending(exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.Holding.Delete(exs, _Holdings.First) Then
