Public Class Menu_PriceListItem_Supplier
    ...
    Private Async Sub OnCustomerPriceListSelected(sender As Object, e As MatEventArgs)
        ...
        If FEB.PriceListCustomer.Load(exs, oPriceList, True) Then
            For Each src As DTOPriceListItem_Supplier In _Items
                Await FEB.PriceListItemCustomer.AddFromPriceListItemSupplier(oPriceList, src, exs)
            Next

            If exs.Count = 0 Then
                If Await FEB.PriceListCustomer.Update(exs, oPriceList) Then
