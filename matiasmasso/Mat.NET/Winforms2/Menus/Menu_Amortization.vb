Public Class Menu_Amortization
    ...
    Private Async Sub Do_Amortitza(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Await FEB.Amortization.Amortitza(exs, Current.Session.User, oExercici.Emp, oExercici.Year, _Amortization) Then
    ...
    Private Async Sub Do_RevertBaixa(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            ...
            If item IsNot Nothing Then
                If Await FEB.AmortizationItem.Delete(item, exs) Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.Amortization.Delete(_Amortizations.First, exs) Then
                MyBase.RefreshRequest(Me, MatEventArgs.Empty)
            Else
