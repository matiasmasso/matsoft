...
Public Class Menu_Delivery
    ...
    Private Async Sub Do_ExcelSkuSummary()
        ...
        Dim query = items.GroupBy(Function(g) New With {Key g.Sku.Id, Key g.Sku.NomLlarg.Esp}).
    ...
    Private Async Sub Do_Factura(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        Dim oInvoice = Await FEB.Invoice.Factory(exs, Current.Session.Emp, _Deliveries)
        If exs.Count = 0 Then
