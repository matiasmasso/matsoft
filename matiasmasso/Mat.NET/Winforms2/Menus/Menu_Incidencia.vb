Public Class Menu_Incidencia
    ...
    Private Function MenuItem_CopyAsin() As ToolStripMenuItem
        Dim oMenuItem As New ToolStripMenuItem
        oMenuItem.Text = "Copiar Asin"
        oMenuItem.Image = My.Resources.Copy
        AddHandler oMenuItem.Click, AddressOf Do_CopyAsin
        Return oMenuItem
    End Function
    ...
    Private Async Sub Do_MailConfirmation(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        If FEB.Incidencia.Load(exs, _Incidencia) Then
            If FEB.Contact.Load(_Incidencia.Customer, exs) Then
                ...
                With oMailMessage
                    .bcc = Await FEB.Subscriptors.Recipients(exs, GlobalVariables.Emp, DTOSubscription.Wellknowns.NovaIncidencia,)
                    .Subject = "M+O: " & oLang.Tradueix("Registro de Incidencia Postventa", "Registre de Incidencia Postvenda", "Service incident", "Registo de Incidência Pós-venda") & " " & _Incidencia.AsinOrNum() & " " & _Incidencia.NomRemitent()
                    .BodyUrl = FEB.Mailing.BodyUrl(DTODefault.MailingTemplates.Incidencia, _Incidencia.Guid.ToString())
                End With
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("Eliminem la incidencia " & _Incidencia.AsinAndNum() & "?", MsgBoxStyle.OkCancel)
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.Incidencia.Delete(exs, _Incidencia) Then
                MsgBox("Incidencia " & _Incidencia.AsinAndNum() & " eliminada", MsgBoxStyle.Information, "M+O")
