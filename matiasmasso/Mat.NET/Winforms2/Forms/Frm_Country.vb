Public Class Frm_Country
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.Country.Load(_Country, exs) Then
            With _Country
                TextBoxISO.Text = .ISO
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB.Country.Update(_Country, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            ...
            Dim exs As New List(Of Exception)
            If Await FEB.Country.Delete(_Country, exs) Then
    ...
    Private Async Sub refrescaZonas()
        Dim exs As New List(Of Exception)
        Dim oZonas = Await FEB.Zonas.All(_Country, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub refrescaAreaProvincias()
        Dim exs As New List(Of Exception)
        Dim oAreaProvincias = Await FEB.AreaProvincias.All(_Country, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub refrescaAreaRegions()
        Dim exs As New List(Of Exception)
        Dim oAreaRegions = Await FEB.AreaRegions.All(_Country, exs)
        If exs.Count = 0 Then
