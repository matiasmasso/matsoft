Public Class Frm_Incentius
    ...
    Private Sub Xl_Incentius1_RequestToToggleProgressBar(sender As Object, e As MatEventArgs) Handles Xl_Incentius1.RequestToToggleProgressBar
    ...
    Private Async Function refresca() As Task
        ...
        Dim oIncentius = Await FEB.Incentius.Headers(exs, oUser, BlIncludeObsolets:=BlDisplayObsolets, BlIncludeFutureIncentius:=BlDisplayObsolets)
        If exs.Count = 0 Then
