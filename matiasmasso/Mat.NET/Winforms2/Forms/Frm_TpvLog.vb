Public Class Frm_TpvLog
    ...
    Private Async Sub Frm_TpvLog_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        With _TpvLog
            ...
            TextBoxTitular.Text = Await FEB.TpvLog.TitularNom(_TpvLog, exs)
            TextBoxConcept.Text = FEB.TpvLog.Purpose(exs, _TpvLog)
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        Dim exs As New List(Of Exception)
        If Await FEB.TpvLog.Delete(_TpvLog, exs) Then
