Public Class Frm_User
    ...
    Private Sub Control_Changed(sender As Object, e As EventArgs) Handles _
       Xl_Sex1.AfterUpdate,
          Xl_Country1.AfterUpdate,
           Xl_ZipCod1.AfterUpdate,
            TextBoxTelefon.TextChanged,
             TextBoxPassword.TextChanged,
              Xl_Yea1.AfterUpdate,
               Xl_Langs1.AfterUpdate,
                Xl_LookupRol1.AfterUpdate,
                 ComboBoxSource.SelectedIndexChanged,
                  DateTimePickerFchCreated.ValueChanged,
                   DateTimePickerFchActivated.ValueChanged,
                      DateTimePickerFchDeleted.ValueChanged,
                       TextBoxNom.TextChanged,
                        TextBoxCognoms.TextChanged,
