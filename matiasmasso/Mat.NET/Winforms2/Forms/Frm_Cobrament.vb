Public Class Frm_Cobrament
    ...
    Private Async Sub Frm_Cobrament_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.Contact.Load(_Contact, exs) Then
            ...
            Dim oAllPnds = Await FEB.Pnds.All(exs, GlobalVariables.Emp, _Contact)
            If exs.Count = 0 Then
                ...
                If exs.Count = 0 Then
                    ...
                    Try
                        Xl_Cobrament1.XecIBAN = Await FEB.Iban.FromContact(exs, _Contact, DTOIban.Cods.Client)
    ...
    Private Async Function Save(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        Select Case Xl_Cobrament1.CodiFpg
            Case Xl_Cobrament.Fpgs.Cash, Xl_Cobrament.Fpgs.Transfer
                _Cca = Await GetCca(oPnds, oImpagats)
                ...
                With oCobrament
                    ...
                    .Impagats = oImpagats
                End With
                retval = Await FEB.Cobrament.Update(exs, oCobrament)
    ...
    Private Async Function SaveXec(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        If Await FEB.Xec.Cobrament(exs, Current.Session.User, oXec) Then
    ...
    Private Async Function GetCca(oPnds As List(Of DTOPnd), oImpagats As List(Of DTOImpagat)) As Task(Of DTOCca)
        Dim exs As New List(Of Exception)
        Dim oSum = DTOAmt.Empty

        Dim oCtas = Await FEB.PgcCtas.All(exs)
        Dim oCtaImpagats = oCtas.FirstOrDefault(Function(x) x.Codi = DTOPgcPlan.Ctas.Impagats)
        Dim oCtaIngresosDespesesImpagats = oCtas.FirstOrDefault(Function(x) x.Codi = DTOPgcPlan.Ctas.ImpagosRecuperacioDespeses)
        ...
        With oCca
            ...
            For Each oPnd In oPnds
                Select Case oPnd.Cod
                    ...
                    Case DTOPnd.Codis.Creditor
                        ...
                        oCca.AddDebit(oPnd.Amt, oPnd.Cta, oPnd.Contact)
            ...
            Dim oBanc = Xl_Cobrament1.ComboBoxBancs.SelectedItem
            oCca.AddSaldo(Xl_Cobrament1.Cta, oBanc)
        End With
        Return oCca
    End Function
