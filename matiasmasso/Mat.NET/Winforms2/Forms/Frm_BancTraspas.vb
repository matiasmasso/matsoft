Public Class Frm_BancTraspas
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim oBancs = Await FEB.Bancs.AllActive(Current.Session.Emp, exs)
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Validate(exs) Then
            ...
            Dim oTraspas As DTOBancTransferPool = Await FEB.BancTransferPool.Traspas(
            ...
            If exs.Count = 0 Then
                Dim CcaId = Await FEB.BancTransferPool.Save(exs, oTraspas)
                If exs.Count = 0 Then
                    RaiseEvent AfterUpdate(Me, New MatEventArgs(oTraspas))
                    Dim XMLSource As String = Await FEB.SepaCreditTransfer.XML(Current.Session.Emp, oTraspas, exs)
                    If exs.Count = 0 Then
    ...
    Private Shadows Function Validate(exs As List(Of Exception)) As Boolean
        ...
        End If
        If DateTimePicker1.Value < DTO.GlobalVariables.Today() Then
