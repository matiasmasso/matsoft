Public Class Frm_ProveidorVtos
    ...
    Private Async Sub Frm_ProveidorVtos_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        _values = Await FEB.Pnds.All(exs, GlobalVariables.Emp, oContact:=Nothing, onlyPendents:=True)
        If exs.Count = 0 Then
    ...
    Private Sub ExcelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExcelToolStripMenuItem.Click
        Dim exs As New List(Of Exception)
        Dim oSheet As MatHelper.Excel.Sheet = Xl_ProveidorVtos1.Excel("Proveidors pendents de pagament", Current.Session.Lang)
