Public Class Frm_IbanCcc
    ...
    Private _IbanStructures As List(Of DTOIban.Structure)
    ...
    Private Async Sub Frm_IbanCcc_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        _IbanStructures = Await FEB.IbanStructures.All(exs)
        If exs.Count = 0 Then
            TextBoxCcc.Text = _Iban.Digits
            Dim src As String = CleanSrc()
            If src.Length >= 2 Then Dim oStructure As DTOIban.Structure = GetStructure()
        Else
    ...
    Private Async Sub TextBoxCcc_TextChanged(sender As Object, e As EventArgs) Handles TextBoxCcc.TextChanged
        ...
        With _Iban
            ...
            .IsLoaded = True
        End With
        PictureBox1.Image = LegacyHelper.ImageHelper.Converter(Await FEB.Iban.Img(exs, _Iban, Current.Session.Lang))
    End Sub
    ...
    Private Async Function GetBankBranch(exs As List(Of Exception)) As Task(Of DTOBankBranch)
        ...
        If oBank Is Nothing Then
            _BankBranch = Nothing
        Else
            Dim oStructure As DTOIban.Structure = GetStructure()
            If oStructure IsNot Nothing Then
                ...
                If (src.Length = iBranchLen Or (_BankBranch Is Nothing And src.Length >= iBranchLen)) Then
                    ...
                    _BankBranch = Await FEB.BankBranch.Find(oBank, Id, exs)
    ...
    Private Async Function GetBank(exs As List(Of Exception)) As Task(Of DTOBank)
        ...
        If oStructure IsNot Nothing Then
            ...
            If src.Length = iLen Or (_Bank Is Nothing And src.Length >= iLen) Then
                ...
                _Bank = Await FEB.Bank.FromCodi(oCountry, Id, exs)
    ...
    Private Function GetStructure() As DTOIban.Structure
        Static retval As DTOIban.Structure = Nothing
        Dim src As String = CleanSrc()
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If _Iban.FchFrom = Nothing Then _Iban.FchFrom = DTO.GlobalVariables.Today()
        ...
        If Await FEB.Iban.Update(_Iban, exs) Then
            If _PreviousIban IsNot Nothing Then
                ...
                If Not Await FEB.Iban.Update(_PreviousIban, exs) Then
