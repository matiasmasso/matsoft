...
Public Class Frm_ProductSku
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        With _ProductSku
            ...
            If FEB.ProductSku.Load(_ProductSku, exs, oMgz:=GlobalVariables.Emp.Mgz) Then
                ...
                If .Category IsNot Nothing Then
                    ...
                    Xl_LookupCategory.Load(oProducts, DTOProduct.SelectionModes.SelectCategory, True)
                End If
