Public Class Frm_CustomerCluster
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.CustomerCluster.Load(exs, _CustomerCluster) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB.CustomerCluster.Update(exs, _CustomerCluster) Then
            UIHelper.ToggleProggressBar(PanelButtons, True)
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.CustomerCluster.Delete(exs, _CustomerCluster) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_CustomerCluster))
                Me.Close()
            Else
        ...
        Select Case TabControl1.SelectedIndex
            Case Tabs.Children
                If Not _ChildrenLoaded Then
                    Dim oCustomers = Await FEB.CustomerCluster.Children(exs, _CustomerCluster)
                    If exs.Count = 0 Then
