Public Class Frm_Emp
    ...
    Private Async Function Refresca() As Task
        ...
        If FEB.Emp.Load(_Emp, exs) Then
            With _Emp
                TextBoxNom.Text = .Nom
                TextBoxAlias.Text = .Abr
                Await Xl_Contact2_Mgz.Load(exs, .Mgz)
                Xl_ContactOrg.Emp = _Emp
                Await Xl_ContactOrg.Load(exs, .Org)
                TextBoxIp.Text = .Ip
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB.Emp.Update(exs, _Emp, Current.Session.User) Then
