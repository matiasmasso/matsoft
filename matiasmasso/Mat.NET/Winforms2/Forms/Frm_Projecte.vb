Public Class Frm_Projecte
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.Projecte.Load(exs, _Projecte) Then
            With _Projecte
                TextBoxNom.Text = .Nom
            ...
            Dim items = Await FEB.Projecte.Items(exs, _Projecte)
            If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.Projecte.Update(exs, _Projecte) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.Projecte.Delete(exs, _Projecte) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Projecte))
                Me.Close()
            Else
