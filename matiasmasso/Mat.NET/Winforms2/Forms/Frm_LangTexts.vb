Public Class Frm_LangTexts
    ...
    Private Async Function refresca() As Task
        ...
        Dim oMissingWebMenuGroups = Await FEB.LangTexts.MissingWebMenuGroups(_Lang, exs)
        Dim oMissingWebMenuItems = Await FEB.LangTexts.MissingWebMenuItems(_Lang, exs)
        Dim oMissingWinMenuItems = Await FEB.LangTexts.MissingWinMenuItems(Current.Session.Emp, _Lang, exs)
        Dim oMissingCategories = Await FEB.LangTexts.MissingCategories(_Lang, exs)
        Dim oMissingSkus = Await FEB.LangTexts.MissingSkus(_Lang, exs)
