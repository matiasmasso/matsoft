Public Class Frm_PremiumCustomer
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.premiumCustomer.Load(_PremiumCustomer, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Else
            ...
            If Await FEB.premiumCustomer.Update(exs, _PremiumCustomer) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.premiumCustomer.Delete(_PremiumCustomer, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_PremiumCustomer))
                Me.Close()
            Else
