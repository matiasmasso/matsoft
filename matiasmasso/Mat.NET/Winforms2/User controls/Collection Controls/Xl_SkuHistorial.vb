Public Class Xl_SkuHistorial
    ...
    Private Function FilteredValues() As List(Of DTODeliveryItem)
        ...
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) x.purchaseOrderItem.sku.nom.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
        ...
        If oCurrentControlItem IsNot Nothing Then
            ...
            Select Case _SelectionMode
                Case DTO.Defaults.SelectionModes.Browse
                    'Dim oFrm As New Frm_DeliveryItem(oSelectedValue)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTODeliveryItem)
            ...
            _Source = value
            With value
                _Nom = value.purchaseOrderItem.sku.nom.Tradueix(Current.Session.Lang)
            End With
        End Sub
