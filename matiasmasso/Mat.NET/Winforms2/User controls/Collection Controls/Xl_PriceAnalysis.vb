Public Class Xl_PriceAnalysis
    ...
    Private Async Function Refresca() As Task
        ...
        Dim oCustomCosts = Await FEB.PriceListItemsCustomer.Active(exs, _Customer, _Fch)
        ...
        If oCustomCost Is Nothing Then
            item = Await FEB.PriceListItemCustomer.Search(exs, _Sku, _Fch)
            If exs.Count = 0 Then
                ...
                Dim oDtos = Await FEB.CustomerTarifaDtos.Active(exs, _Customer, _Fch)
        ...
        oCliProductDtos = Await FEB.CliProductDtos.All(_Customer, exs)
        If exs.Count = 0 Then
