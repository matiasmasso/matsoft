Public Class Xl_VisaCards
    ...
    Public Shadows Sub Load(values As List(Of DTOVisaCard), Optional oDefaultValue As DTOVisaCard = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Private Sub Refresca()
        ...
        For Each oItem As DTOVisaCard In _Values
            If _MenuItem_Obsolets.Checked Or oItem.IsActive() Then
