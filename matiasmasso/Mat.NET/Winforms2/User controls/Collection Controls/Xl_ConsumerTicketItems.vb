Public Class Xl_ConsumerTicketItems
    ...
    Private Sub Refresca()
        _AllowEvents = False
        Dim oFilteredValues As List(Of DTOPurchaseOrderItem) = _Values
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Template As New Menu_PurchaseOrderItem(SelectedItems.First)
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles MyBase.RowPrePaint
        ...
        'Dim oControlItem As ControlItem = oRow.DataBoundItem
        'Dim oTemplate As DTOPurchaseOrderItem = oControlItem.Source
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOPurchaseOrderItem)
            ...
            _Source = value
            With value
                _Nom = .Sku.FullNom(Current.Session.Lang)
                _Qty = .Qty
