Public Class Xl_Importacions
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            ...
            AddHandler oMenu_Importacio.RequestToToggleProgressBar, AddressOf ToggleProgressBarRequest
    ...
    Private Async Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        Dim oControlItem As ControlItem = CurrentControlItem()
        Dim oImportacio = Await FEB.Importacio.Find(exs, oControlItem.Source.Guid)
        If exs.Count = 0 Then
