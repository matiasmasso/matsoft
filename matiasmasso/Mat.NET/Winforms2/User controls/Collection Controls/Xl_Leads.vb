Public Class Xl_Leads
    ...
    Private Function FilteredValues() As List(Of DTOUser)
        ...
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) x.Nom.ToLower.Contains(_Filter.ToLower) Or x.EmailAddress.ToLower.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
    ...
    Private Sub SetProperties()
        ...
        End With
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
        With MyBase.Columns(Cols.cognoms)
            .HeaderText = "cognoms"
            .DataPropertyName = "cognoms"
            .AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        End With
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
