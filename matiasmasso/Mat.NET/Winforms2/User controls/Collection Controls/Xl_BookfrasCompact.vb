Public Class Xl_BookfrasCompact
    ...
    Private Sub SetProperties()
        ...
        'MyBase.RowBookFra.DefaultCellStyle.BackColor = Color.Transparent
    ...
    Private Sub Datagridview1_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles MyBase.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.ico
                ...
                Dim oDocFile As DTODocFile = oBookFra.cca.DocFile
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOBookFra)
            MyBase.New()
            _Source = value
            With value
                _Fch = .Cca.Fch
