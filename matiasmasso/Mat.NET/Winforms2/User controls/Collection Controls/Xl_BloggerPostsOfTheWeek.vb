Public Class Xl_BloggerPostsOfTheWeek
    ...
    Public Shadows Sub Load(values As List(Of DTOBloggerPost), Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Private Sub Xl_BloggerPostsOfTheWeek_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles Me.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.ico
                ...
                ElseIf oPost.HighlightTo < DTO.GlobalVariables.Today() Then
                    e.Value = My.Resources.del
                ElseIf oPost.HighlightFrom > DTO.GlobalVariables.Today() Then
