Public Class Xl_Repliqs
    ...
    Public Shadows Sub Load(values As List(Of DTORepLiq), Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Private Function FilteredValues() As List(Of DTORepLiq)
        Dim retval As List(Of DTORepLiq) = Nothing
        If _Filter = "" Then
            retval = _Values
        Else
