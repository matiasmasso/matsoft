Public Class Xl_Zips
    ...
    Private _Values As IEnumerable(Of DTOZip)
    ...
    Public Shadows Sub Load(values As IEnumerable(Of DTOZip), Optional oDefaultValue As DTOZip = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
