Public Class Xl_Forecasts
    ...
    Private Async Sub Do_Paste()
        ...
        If Await FEB.Forecasts.Insert(oPastedForecasts, exs) Then
        ...
        Select Case e.ColumnIndex
            ...
            Case Cols.M1 To Cols.M12
                ...
                If formatcell Then
                    ...
                    If _Year = DTO.GlobalVariables.Today().Year And iCurrentMonth = DTO.GlobalVariables.Today().Month Then
                        daysFactor = DTO.GlobalVariables.Today().Day / 31
                    End If
    ...
    Private Function isActiveMonth(iYear As Integer, iMonth As Integer) As Boolean
        ...
        Select Case iYear
            Case < DTO.GlobalVariables.Today().Year
                retval = True
            Case = DTO.GlobalVariables.Today().Year
                retval = iMonth <= DTO.GlobalVariables.Today().Month
            Case > DTO.GlobalVariables.Today().Year
                retval = False
        End Select
        Return retval
