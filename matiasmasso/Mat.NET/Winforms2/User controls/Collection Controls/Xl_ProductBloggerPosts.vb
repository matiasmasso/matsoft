Public Class Xl_ProductBloggerPosts
    Inherits _Xl_ReadOnlyDatagridview

    Private _Values As List(Of DTOBloggerPost)
    Private _DefaultValue As DTOBloggerPost
    ...
    Public Shadows Sub Load(values As List(Of DTOBloggerPost), Optional oDefaultValue As DTOBloggerPost = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
        _Values = values
    ...
    Private Sub Refresca()
        ...
        For Each oItem As DTOBloggerPost In oFilteredValues
    ...
    Private Sub SetProperties()
        ...
        'MyBase.RowBloggerPost.DefaultCellStyle.BackColor = Color.Transparent
        ...
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
        With MyBase.Columns(Cols.Blogger)
            .HeaderText = "Blogger"
            .DataPropertyName = "Blogger"
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOBloggerPost)
            ...
            With value
                _Fch = .Fch
                '_Blogger = .Blogger.Author.Nom
                _Blogger = .Blogger.Title
                _Title = .Title
            End With
        End Sub
