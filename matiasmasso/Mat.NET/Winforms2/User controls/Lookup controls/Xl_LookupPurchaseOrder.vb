    ...
    Private Sub refresca()
        ...
        Else
            If _PurchaseOrder.IsNew Then
                MyBase.Text = String.Format("{0} del {1:dd/MM/yy}", _PurchaseOrder.Concept, _PurchaseOrder.Fch)
            Else
                MyBase.Text = String.Format("{0} del {1:dd/MM/yy} {2}", _PurchaseOrder.Num, _PurchaseOrder.Fch, _PurchaseOrder.Concept)
            End If
