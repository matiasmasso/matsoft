Public Class Xl_LookupVehicleMarcayModel
    ...
    Private _VehicleModelValue As DTOVehicle.ModelClass

    Public Event AfterUpdate(ByVal sender As Object, ByVal e As MatEventArgs)

    Public Shadows Property VehicleModelValue() As DTOVehicle.ModelClass
        Get
            Return _VehicleModelValue
        End Get
        Set(ByVal value As DTOVehicle.ModelClass)
