Public Class Xl_EciPlatformDeliveries
    ...
    Public Shadows Event AfterUpdate(sender As Object, e As MatEventArgs)
    ...
    Public Function CheckedOrders() As List(Of DTOPurchaseOrder)
        ...
        For Each oGroupNode As TreeNode In MyBase.Nodes
            'If oGroupNode.Checked Then
            For Each oCentroNode As TreeNode In oGroupNode.Nodes
                ' If oCentroNode.Checked Then
    ...
    Private Async Sub Xl_EciPlatformDeliveries_NodeSelectedChanged(sender As Object, e As MatEventArgs) Handles Me.NodeSelectedChanged
        If _AllowEvents Then
