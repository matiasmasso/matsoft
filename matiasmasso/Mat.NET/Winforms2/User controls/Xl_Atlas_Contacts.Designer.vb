...
Partial Class Xl_Atlas_Contacts
    ...
    Private Sub InitializeComponent()
        Me.Xl_Countries_Grid1 = New Xl_Countries()
        Me.Xl_Zonas_Grid1 = New Xl_Zonas_Grid()
        Me.Xl_Locations_Grid1 = New Xl_Locations_Grid()
        Me.Xl_Contacts_Grid1 = New Xl_Contacts_Grid()
        Me.SuspendLayout()
        '
        'Xl_Countries_Grid1
        '
    ...
    End Sub
    Friend WithEvents Xl_Countries_Grid1 As Xl_Countries
    Friend WithEvents Xl_Zonas_Grid1 As Xl_Zonas_Grid
    Friend WithEvents Xl_Locations_Grid1 As Xl_Locations_Grid
    Friend WithEvents Xl_Contacts_Grid1 As Xl_Contacts_Grid
