...
Public Class Xl_FtpExplorer
    ...
    Public Shadows Sub Load(oFtpClient As FTPclient) 'Optional sRootUrl As String = "")
        _Ftp = oFtpClient
    ...
    Private Sub LoadNode(oParentNode As TreeNode)
        ...
        Dim oFtpDirectory As FTPdirectory = _Ftp.ListDirectoryDetail(sUrl)
        For Each sNom As String In _Ftp.Directoris(exs, sUrl)
