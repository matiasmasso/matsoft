Public Class Xl_Pnds
                ...
                If oPnd.Amt IsNot Nothing Then
                    If oPnd.Amt.Cur IsNot Nothing Then
                        If oPnd.Amt.Cur.UnEquals(DTOCur.Eur) Then
                            MyBase.Columns(Cols.DivDeb).Visible = True
                            MyBase.Columns(Cols.DivHab).Visible = True
                            Exit For
                        End If
                    End If
                End If
    ...
    Private Sub refresca()
        ...
        If oFilteredPnds IsNot Nothing Then
            MyBase.Columns(Cols.DivDeb).Visible = IsDivisaVisible(oFilteredPnds)
            MyBase.Columns(Cols.DivHab).Visible = IsDivisaVisible(oFilteredPnds)
        End If
    ...
    Private Sub SetProperties()
        ...
        End With
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
        With MyBase.Columns(Cols.DivDeb)
            .DataPropertyName = "divDeb"
            .HeaderText = "Deutor"
            .Width = 90
            .AutoSizeMode = DataGridViewAutoSizeColumnMode.None
        ...
        End With
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
        With MyBase.Columns(Cols.DivHab)
            .DataPropertyName = "divHab"
            .HeaderText = "Creditor"
            .Width = 90
            .AutoSizeMode = DataGridViewAutoSizeColumnMode.None
            .DefaultCellStyle.Format = "#,##0.00;-#,##0.00;"
        ...
        End With
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
        With MyBase.Columns(Cols.EurDeb)
            .DataPropertyName = "EurDeb"
            .HeaderText = "Deutor"
            .Width = 90
            .AutoSizeMode = DataGridViewAutoSizeColumnMode.None
            .DefaultCellStyle.Format = "#,##0.00 €;-#,##0.00 €;#"
        ...
        End With
        MyBase.Columns.Add(New DataGridViewTextBoxColumn)
        With MyBase.Columns(Cols.EurHab)
            .DataPropertyName = "EurHab"
            .HeaderText = "Creditor"
            .Width = 90
            .AutoSizeMode = DataGridViewAutoSizeColumnMode.None
            .DefaultCellStyle.Format = "#,##0.00 €;-#,##0.00 €;#"
    ...
    Protected Class ControlItem
        ...
        Property DivDeb As Decimal
        Property DivHab As Decimal
        Property EurDeb As Decimal
        Property EurHab As Decimal
        ...
        Public Sub New(value As DTOImpagat)
            ...
            With value
                ...
                _Vto = .Csb.Vto
                _DivDeb = .Csb.Amt.Val
                _EurDeb = DTOImpagat.Pendent(value).Eur + value.Gastos.Eur
                _Cta = DTOPgcCta.FullNom(FEB.PgcCta.FromCodSync(DTOPgcPlan.Ctas.impagats, Current.Session.Emp, exs), Current.Session.User.Lang)
                _Fra = .Csb.FraNum
                _Fch = .Csb.Vto
                _Obs = .Obs
            End With
