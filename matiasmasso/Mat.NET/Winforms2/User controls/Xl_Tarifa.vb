Public Class Xl_Tarifa
    ...
    Private Sub Do_Web()
        Dim sUrl As String = FEB.CustomerTarifa.Url(_Tarifa, True)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        ...
        If TypeOf oProduct Is DTOProductBrand Then
            ...
            oFrm.Show()
        ElseIf TypeOf oProduct Is DTOProductCategory Then
            Dim oFrm As New Frm_Stp(oProduct, Defaults.SelectionModes.browse)
            'Dim oFrm As New Frm_ProductCategory(oProduct) Ojo, es carrega les url i les descripcions
            AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
            oFrm.Show()
        ElseIf TypeOf oProduct Is DTOProductSku Then
