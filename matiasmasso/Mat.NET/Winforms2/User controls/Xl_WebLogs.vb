Public Class Xl_WebLogs
    ...
    Public Shadows Sub Load(values As List(Of DTOWebLogBrowse))
        ...
        If DataGridView1.CurrentCell IsNot Nothing Then
            iRowIndex = DataGridView1.CurrentCell.RowIndex
            iColIndex = DataGridView1.CurrentCell.ColumnIndex
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles DataGridView1.RowPrePaint
        ...
        Select Case oControlItem.Source.User.Rol.Id
            Case DTORol.Ids.Admin, DTORol.Ids.SalesManager, DTORol.Ids.Accounts
