Public Class Xl_LocationsCombo
    ...
    Private _values As List(Of DTOLocation)
    Private _ControlItems As ControlItems
    Private _AllowEvents As Boolean

    Public Event AfterUpdate(sender As Object, e As MatEventArgs)

    Public Shadows Sub Load(values As List(Of DTOLocation), Optional oSelectedArea As DTOArea = Nothing)
        _ControlItems = New ControlItems
        _ControlItems.Add(ControlItem.AllLocations)
        For Each oLocation As DTOLocation In values
        ...
        If oSelectedArea IsNot Nothing Then
            For i As Integer = 1 To _ControlItems.Count - 1
                Dim oLocation As DTOLocation = oSelectedArea
    ...
    Protected Class ControlItem
        ...
        Public Sub New(Optional oLocation As DTOLocation = Nothing)
            MyBase.New()
        ...
        Shared Function AllLocations() As ControlItem
            ...
            retval.Nom = Current.Session.Lang.Tradueix("(todas las poblaciones)", "(totes les poblacions)", "(any location)")
            Return retval
        End Function
    End Class
