...
#End Region
    ...
    Public Property Address As DTOAddress
        Get
            Return Xl_Adr1.Address
        End Get
        Set(ByVal value As DTOAddress)
    ...
    Private Sub Xl_Adr1_Changed(ByVal sender As Object, ByVal e As MatEventArgs) Handles Xl_Adr1.AfterUpdate
