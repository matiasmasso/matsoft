Public Class Xl_Subscripcio
    ...
    Private Async Function Refresca() As Task
        ...
        If FEB.Subscription.Load(exs, _Subscription) Then
            With _Subscription
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        UIHelper.ToggleProggressBar(Panel1, True)
        If Await FEB.Subscription.Update(exs, _Subscription) Then
            UIHelper.ToggleProggressBar(Panel1, False)
    ...
    Private Async Function LoadSubscriptors() As Task
        ...
        Dim oSubscriptors = Await FEB.Subscriptors.All(exs, _Subscription)
        If exs.Count = 0 Then
    ...
    Private Async Sub Do_Excel()
        ...
        If exs.Count = 0 Then
            ...
            For Each oSubscriptor In oSubscriptors
                ...
                oRow.AddCell(oSubscriptor.Lang.Tag)
            Next
