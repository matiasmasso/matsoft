...
#End Region
    ...
    Public Function Directoris(sUrl As String) As List(Of String)
...
Public Class FtpHelper
    Shared Function DownloadImageFromFtp(source As Uri, Optional sUserName As String = "", Optional sPassword As String = "") As System.Drawing.Image
        Dim retval As System.Drawing.Image = Nothing

        If source.Scheme = Uri.UriSchemeFtp Then
            Dim oRequest As System.Net.FtpWebRequest = System.Net.FtpWebRequest.Create(source)
            oRequest.Credentials = New System.Net.NetworkCredential(sUserName, sPassword)
            ...
            retval = System.Drawing.Image.FromStream(oStream)
        ElseIf source.Scheme = Uri.UriSchemeHttp Then
            Dim oRequest As System.Net.HttpWebRequest = System.Net.HttpWebRequest.Create(source)
            'oRequest.Credentials = New System.Net.NetworkCredential(sUserName, sPassword)
            oRequest.Method = System.Net.WebRequestMethods.Http.Get
            Dim oResponse As System.Net.HttpWebResponse = oRequest.GetResponse()
            Dim oStream As System.IO.Stream = oResponse.GetResponseStream()
            retval = System.Drawing.Image.FromStream(oStream)
        End If
