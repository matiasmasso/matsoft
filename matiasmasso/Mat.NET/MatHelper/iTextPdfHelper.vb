...
Public Class iTextPdfHelper
            ...
            Try
                ...
                For Each oObject In oObjectsToAdd
                    ...
                    ElseIf TypeOf oObject Is MatPdfText Then
                        ...
                        Dim oImageByteArray = converter.ConvertTo(oPdfImage.Image, GetType(Byte()))
    ...
    Public Class MatPdfImage
        ...
        Shared Function Factory(oImage As System.Drawing.Image, rectangle As Rectangle) As MatPdfImage
        ...
        Shared Function Factory(oImageUri As Uri, rectangle As Rectangle) As MatPdfImage
            Dim retval As New MatPdfImage
            With retval
                .Image = ImageHelper.DownloadFromWebsite(oImageUri.AbsoluteUri)
                .rectangle = rectangle
            End With
            Return retval
        End Function
