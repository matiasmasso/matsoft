...
namespace MatHelper.Excel
{
    public class Row
    {
        ...
        public Cell AddCell(string content = "", string url = "", MatHelper.Excel.Cell.NumberFormats numberFormat = MatHelper.Excel.Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
        ...
        public Cell AddCell(DateTime fch, string url = "", MatHelper.Excel.Cell.NumberFormats numberFormat = MatHelper.Excel.Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
            if (fch != DateTime.MinValue)
            {
                ...
                if (!string.IsNullOrEmpty(url))
                    retval.Url = url;
                retval.NumberFormat = MatHelper.Excel.Cell.NumberFormats.DDMMYY;
            }
            Cells.Add(retval);
            return retval;
        }
        public Cell AddCell(int content, string url = "", MatHelper.Excel.Cell.NumberFormats numberFormat = MatHelper.Excel.Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
            retval.Content = content;
            if (!string.IsNullOrEmpty(url))
        ...
        public Cell AddCell(decimal content, string url = "", MatHelper.Excel.Cell.NumberFormats numberFormat = MatHelper.Excel.Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
            retval.Content = content;
            if (!string.IsNullOrEmpty(url))
        ...
        public Cell AddCell(double content, string url = "", MatHelper.Excel.Cell.NumberFormats numberFormat = MatHelper.Excel.Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
            retval.Content = content;
            if (!string.IsNullOrEmpty(url))
        ...
        public Cell AddFormula(string formulaR1C1, string url = "", MatHelper.Excel.Cell.NumberFormats numberFormat = MatHelper.Excel.Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
        ...
        {
            var retval = 0;
            if (Cells.Count > cellIdx && Cells[cellIdx].Content != null)
                retval = (int)Cells[cellIdx].Content;
            return retval;
        }
        ...
        public decimal GetDecimal(int cellIdx)
        {
            decimal retval = 0;
            if (Cells.Count > cellIdx && Cells[cellIdx].Content != null)
                retval = (decimal)Cells[cellIdx].Content;
            return retval;
        }
        ...
        {
            var retval = -1;
            for (int idx = 0; idx <= Sheet.Columns.Count - 1; idx++)
            {
        ...
        {
            return string.Join(", ", Cells.Select(x=>x.ToString()));
        }
    }
}
