...
Public Class CryptoHelper
    ...
    Shared Function HashMD5(oImage As Image) As String
        Dim Md5 As New System.Security.Cryptography.MD5CryptoServiceProvider()
        'Compute the hash value from the source
        Dim oByteArray As Byte() = ImageHelper.GetByteArrayFromImg(oImage)
    ...
    Shared Function UrFriendlyBase64(source As String) As String
    ...
    Shared Function UrlFriendlyBase64Json(oParameters As Dictionary(Of String, String)) As String
        ...
        Dim retval As String = UrFriendlyBase64(sBase64)
        Return retval
    End Function
