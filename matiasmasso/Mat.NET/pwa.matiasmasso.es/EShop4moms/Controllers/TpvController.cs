...
namespace Shop4moms.Controllers
{
    ...
    public class TpvController : Controller
    {
        ...
        DTO.Integracions.Shop4moms.Cache _cache;
            ...
            Blazor.Analytics.IAnalytics analytics)
        {
            ...
            _http = http;
            _catalog = catalog;
            _cache = (DTO.Integracions.Shop4moms.Cache)_catalog.Cache;
        ...
        async Task CheckPostAsync()
        {
            ...
            try
            {
                ...
                body = response == null ? "no response" : TpvService.HtmlReport(response, _cache.Tpv);
                subject = response == null ? "4moms TPV NotifyCTO:no response" : _cache.Tpv.IsValidSignature(response) ? "4moms TPV NotifyCTO: Tpv success" : "4moms TPV NotifyCTO: Tpv error";
            }
        ...
        {
            var body = response == null ? "no response" : TpvService.HtmlReport(response, _cache.Tpv);
            var subject = response == null ? "4moms TPV NotifyCTO:no response" : _cache.Tpv.IsValidSignature(response) ? "4moms TPV NotifyCTO: Tpv success" : "4moms TPV NotifyCTO: Tpv error";
            var msgTo = "matias@matiasmasso.es";
        ...
        async Task NotifyConsumerAsync(ShoppingBasketModel basket)
        {
            try
            {
                var body = CorporateBody(basket.HtmlReport(_cache));
        ...
        {
            var body = response == null ? "no response" : TpvService.HtmlReport(response, _cache.Tpv, problemDetails);
