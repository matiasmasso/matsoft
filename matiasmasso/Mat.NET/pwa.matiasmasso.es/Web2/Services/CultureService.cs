...
namespace Web.Services
{
    ...
    public class CultureService:IDisposable
    {
        ...
        public CultureService(NavigationManager navigationManager, StringsLocalizerService localizer)
        {
            ...
            _localizer.OnChange += NotifyChange;
        }
        ...
        public string CanonicalUrl(LangDTO? lang = null, string? absolutePath = null)
        {
            ...
            if (absolutePath == null) absolutePath = CurrentUri()?.AbsolutePath;
        ...
        public Tlds TopLevelDomain()
        {
            var uri = new Uri(_navigationManager.Uri);
            return uri.Host.EndsWith(".pt") ? Tlds.pt : Tlds.es;
        }
        ...
        public async Task<bool> ReloadLocalizerStrings()
        {
            await _localizer.FetchAsync();
            return true;
        }
