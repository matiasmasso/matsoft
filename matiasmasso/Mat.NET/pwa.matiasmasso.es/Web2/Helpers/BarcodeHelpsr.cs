...
namespace Web.Helpers
{
    ...
    {
        public static DTO.Media EAN13(string value, int width = 100, int height = 24, BarcodeWriterEncoding encoding = BarcodeWriterEncoding.EAN13)
        {
            var barcode = BarcodeWriter.CreateBarcode(value, BarcodeWriterEncoding.EAN13).ResizeTo(width, height);
            var retval = new Media(Media.MimeCods.Jpg,barcode.ToJpegBinaryData());
            return retval;
        }
