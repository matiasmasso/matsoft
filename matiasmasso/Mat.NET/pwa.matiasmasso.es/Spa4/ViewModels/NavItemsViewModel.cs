...
namespace Spa4.ViewModels
{
    public class NavItemsViewModel
    {
        ...
        public MenuItemModel.Modes Mode(ExpandableItem item)
        {
            MenuItemModel? menuItem = item.Tag as MenuItemModel;
            return menuItem == null ? MenuItemModel.Modes.None : menuItem.Mode;
        }
