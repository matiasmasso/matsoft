...
namespace Spa4.Entities
{
    ...
    public partial class Arc
    {
        ...
        public virtual Incentiu? IncentiuNavigation { get; set; }
        public virtual Pdc? PdcGu { get; set; }
        public virtual Rp? RepComLiquidableNavigation { get; set; }
        public virtual CliGral? RepGu { get; set; }
        public virtual Spv? SpvGu { get; set; }
