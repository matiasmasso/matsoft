...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=sql.matiasmasso.es;Initial Catalog=Maxi;Persist Security Info=True;User ID=sa_cXJSQYte;Password=CC1SURJQXHyfem27Bc");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Arc>(entity =>
            {
                ...
                entity.HasOne(d => d.IncentiuNavigation)
                    ...
                    .HasConstraintName("FK_Arc_Incentiu");
                ...
                entity.HasOne(d => d.RepComLiquidableNavigation)
                    .WithMany(p => p.Arcs)
                    .HasForeignKey(d => d.RepComLiquidable)
                    .HasConstraintName("FK_Arc_RepComLiquidable");

                entity.HasOne(d => d.RepGu)
                    .WithMany(p => p.Arcs)
                    .HasForeignKey(d => d.RepGuid)
                    .HasConstraintName("FK_Arc_Rep");

                entity.HasOne(d => d.SpvGu)
                    .WithMany(p => p.Arcs)
                    .HasForeignKey(d => d.SpvGuid)
                    .HasConstraintName("FK_Arc_Spv");
            });
            ...
            modelBuilder.Entity<EdiInvrptHeader>(entity =>
            {
                ...
                entity.HasOne(d => d.CustomerNavigation)
                    .WithMany(p => p.EdiInvrptHeaders)
                    .HasForeignKey(d => d.Customer)
                    .HasConstraintName("FK_EdiInvrptHeader_CliGral");
            });
            ...
            modelBuilder.Entity<EdiInvrptItem>(entity =>
            {
                ...
                entity.HasOne(d => d.SkuNavigation)
                    ...
                    .HasForeignKey(d => d.Sku)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_EdiInvrptItem_Art");
            });
            ...
            modelBuilder.Entity<Msg>(entity =>
            {
                ...
                entity.Property(e => e.Id).HasComment("Message sequential number");
            ...
            modelBuilder.Entity<VwStat>(entity =>
            {
                ...
                entity.Property(e => e.Eur).HasColumnType("numeric(38, 10)");
            });
