...
namespace Spa4.Entities
{
    ...
    public partial class Incentiu
    {
        public Incentiu()
        {
            ...
            IncentiuProducts = new HashSet<IncentiuProduct>();
            IncentiuQtyDtos = new HashSet<IncentiuQtyDto>();
            Pdcs = new HashSet<Pdc>();
            DistributionChannels = new HashSet<DistributionChannel>();
        }
        ...
        public virtual ICollection<IncentiuProduct> IncentiuProducts { get; set; }
        public virtual ICollection<IncentiuQtyDto> IncentiuQtyDtos { get; set; }
