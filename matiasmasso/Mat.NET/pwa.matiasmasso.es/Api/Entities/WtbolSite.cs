...
namespace Api.Entities
{
    ...
    public partial class WtbolSite
    {
        public WtbolSite()
        {
            WtbolBaskets = new HashSet<WtbolBasket>();
            WtbolCtrs = new HashSet<WtbolCtr>();
            WtbolLandingPages = new HashSet<WtbolLandingPage>();
        ...
        public virtual ICollection<WtbolBasket> WtbolBaskets { get; set; }
        public virtual ICollection<WtbolCtr> WtbolCtrs { get; set; }
        public virtual ICollection<WtbolLandingPage> WtbolLandingPages { get; set; }
