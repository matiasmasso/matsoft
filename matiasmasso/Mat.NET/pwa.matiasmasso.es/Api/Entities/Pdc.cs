...
namespace Api.Entities
{
    ...
    public partial class Pdc
    {
        public Pdc()
        {
            ...
            EdiversaDesadvHeaders = new HashSet<EdiversaDesadvHeader>();
            EdiversaOrderHeaders = new HashSet<EdiversaOrderHeader>();
        ...
        /// </summary>
        public DateTime? FchMin { get; set; }
        /// <summary>
        /// Don&apos;t deliver after this date, if any
        /// </summary>
        public DateTime? FchMax { get; set; }
        /// <summary>
        ...
        public virtual ICollection<EdiversaDesadvHeader> EdiversaDesadvHeaders { get; set; }
        public virtual ICollection<EdiversaOrderHeader> EdiversaOrderHeaders { get; set; }
