...
namespace Api.Entities
{
    ...
    public partial class Spv
    {
        public Spv()
        {
            Incidencies = new HashSet<Incidency>();
        }
        ...
        public virtual Alb? AlbGu { get; set; }
        ...
        public virtual Email? UsrOutOfSpvInGu { get; set; }
        public virtual Email? UsrOutOfSpvOutGu { get; set; }
        public virtual Email? UsrRegisterGu { get; set; }
        public virtual Email? UsrTecnicGu { get; set; }
        public virtual Zip? ZipNavigation { get; set; }
        public virtual ICollection<Incidency> Incidencies { get; set; }
    }
}
