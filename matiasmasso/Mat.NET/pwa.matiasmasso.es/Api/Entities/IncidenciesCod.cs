...
namespace Api.Entities
{
    ...
    {
        public IncidenciesCod()
        {
            IncidencyCodiAperturaNavigations = new HashSet<Incidency>();
            IncidencyCodiTancamentNavigations = new HashSet<Incidency>();
        }
        ...
        public virtual ICollection<Incidency> IncidencyCodiAperturaNavigations { get; set; }
        public virtual ICollection<Incidency> IncidencyCodiTancamentNavigations { get; set; }
    }
}
