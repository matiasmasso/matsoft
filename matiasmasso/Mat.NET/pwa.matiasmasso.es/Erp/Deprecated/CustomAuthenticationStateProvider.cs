...
namespace Erp.Deprecated
{
    ...
    public class CustomAuthenticationStateProvider : AuthenticationStateProvider
    {
        ...
        public async Task Login(string token)
        {
            ...
            await SecureStorage.SetAsync("accounttoken", token); //to persist authentication
            DTO.Globals.Token = token;
        ...
        public void Logout()
        {
            DTO.Globals.Token = null; //to avoid overhead of async lookup 
