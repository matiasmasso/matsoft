...
namespace Components
{
    public class _Base : ComponentBase
    {
        ...
        //[Inject] public CultureService_Deprecated Culture { get; set; }
        ...
        protected async Task<ApiResponse<T>> PostMultipartAsync<U, T>(U payload, Media? media = null, params string[] segments)
        {
            return await HttpService.PostMultipartAsync<U, T>(http, payload, media, segments);
        }
        protected async Task<ApiResponse<T>> PostMultipartAsync<U, T>(U payload, DocFileModel? docfile = null, params string[] segments)
        {
            return await HttpService.PostMultipartAsync<U, T>(http, payload, docfile, segments);
        }
        ...
        public async Task MailUserAsync(string subject, string body, bool copyToInfo)
        {
            ...
            await MailService.SendEmailAsync(user!.EmailAddress!, subject, body, copyToInfo);
        }
        #endregion
