...
namespace DTO
{
    public class CacheDTO
    {
        ...
        #region Tpv
        public DTO.Integracions.Redsys.Tpv Tpv { get; set; }
        private DTO.Integracions.Redsys.Common.Environments tpvEnvironment = DTO.Integracions.Redsys.Common.Environments.Development;
        private DTO.Integracions.Redsys.Tpv.Ids tpvOwner = DTO.Integracions.Redsys.Tpv.Ids.MatiasMasso;
        #endregion
