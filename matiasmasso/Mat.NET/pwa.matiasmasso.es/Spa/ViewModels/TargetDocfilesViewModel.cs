...
{
    public class TargetDocfilesViewModel
    {
        ...
        public TargetDocfilesViewModel(Shared.AppState appstate, BaseGuid target)
        {
            AppState = appstate;
            Target = target;
        }
        ...
        public async void Fetch(HttpClient http)
        {
            ...
            try
            {
                var url = AppState.ApiUrl("Docfiles",Target.Guid.ToString());
            ...
            catch (Exception ex)
            {
                ...
                {
                    Title = "Error on reading Target Docfiles",
                    Detail = ex.Message
                };
                LoadStatus = Globals.LoadStatusEnum.Failed;
            }
