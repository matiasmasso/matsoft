...
public partial class DocFile
{
    ...
    public virtual ICollection<Pdc> PdcEtiquetesTransportNavigations { get; set; } = new List<Pdc>();

    public virtual ICollection<Pdc> PdcHashNavigations { get; set; } = new List<Pdc>();
