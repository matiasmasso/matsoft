...
public partial class MaxiContext : DbContext
{
    ...
    public virtual DbSet<Actiu> Actius { get; set; }

    public virtual DbSet<ActiuMov> ActiuMovs { get; set; }

    public virtual DbSet<Aeat> Aeats { get; set; }

    public virtual DbSet<AeatMod> AeatMods { get; set; }

    public virtual DbSet<Aecoc> Aecocs { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    {
        modelBuilder.Entity<Actiu>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("Actiu");

            entity.HasIndex(e => e.Nom, "IX_Actiu_Nom").IsUnique();
            ...
            entity.HasOne(d => d.CtaNavigation).WithMany(p => p.Actius)
                .HasForeignKey(d => d.Cta)
                .HasConstraintName("FK_Actiu_PgcCta");
        });

        modelBuilder.Entity<ActiuMov>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("ActiuMov");

            entity.HasIndex(e => new { e.Emp, e.Actiu, e.Fch }, "IX_ActiuMov_EmpActiuFch");
            ...
            entity.HasOne(d => d.ActiuNavigation).WithMany(p => p.ActiuMovs)
                .HasForeignKey(d => d.Actiu)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ActiuMov_Actiu");

            entity.HasOne(d => d.ContraparteNavigation).WithMany(p => p.ActiuMovs)
                .HasForeignKey(d => d.Contraparte)
                .HasConstraintName("FK_ActiuMov_CliGral");
        });
        ...
        {
            entity.HasKey(e => e.Ean).HasName("PK_AECOC_1");

            entity.ToTable("AECOC", tb => tb.HasComment("EAN numbers assigned from our own range (AECOC=Asociación Española de Codificiación Comercial)"));
        ...
        modelBuilder.Entity<CcaSched>(entity =>
        {
            ...
            entity.Property(e => e.Concept)
                .HasMaxLength(62)
                .IsUnicode(false);
            entity.Property(e => e.Emp).HasDefaultValue(1);
        ...
        modelBuilder.Entity<CcaSchedItem>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())");
            entity.Property(e => e.Dh).HasDefaultValue(1);
            entity.Property(e => e.Eur).HasColumnType("decimal(9, 2)");
        ...
        modelBuilder.Entity<CliCert>(entity =>
        {
            ...
            entity.Property(e => e.Caduca)
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.DataMime).HasDefaultValue(33);
            ...
            entity.Property(e => e.Image)
                ...
                .HasColumnType("image");
            entity.Property(e => e.ImageMime).HasDefaultValue(1);
        ...
        modelBuilder.Entity<CliDoc>(entity =>
        {
            ...
            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.CliDocs)
                .HasForeignKey(d => d.Contact)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<DocFile>(entity =>
        {
            ...
            entity.Property(e => e.Hash)
                .HasMaxLength(24)
                .IsUnicode(false)
                .HasDefaultValue("123456789012345678901234")
                .IsFixedLength()
            ...
            entity.Property(e => e.Thumbnail)
                ...
                .HasColumnType("image");
            entity.Property(e => e.ThumbnailMime).HasDefaultValue(1);
        ...
        modelBuilder.Entity<DocFileLog>(entity =>
        {
            ...
            entity.Property(e => e.Pk).HasDefaultValueSql("(newid())");
            entity.Property(e => e.Fch)
                .HasDefaultValueSql("(getdate())")
        ...
        modelBuilder.Entity<N43template>(entity =>
        {
            ...
            entity.Property(e => e.Concepte)
                .HasMaxLength(62)
                .IsUnicode(false);
            entity.Property(e => e.Emp).HasDefaultValue(6);
        ...
        modelBuilder.Entity<Pdc>(entity =>
        {
            ...
            entity.HasOne(d => d.EtiquetesTransportNavigation).WithMany(p => p.PdcEtiquetesTransportNavigations)
                .HasForeignKey(d => d.EtiquetesTransport)
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.PdcHashNavigations)
                .HasForeignKey(d => d.Hash)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PDD");
        ...
        modelBuilder.Entity<PremiumCustomer>(entity =>
        {
            ...
            entity.HasOne(d => d.DocfileNavigation).WithMany(p => p.PremiumCustomers)
        ...
        modelBuilder.Entity<Tpv>(entity =>
        {
            ...
            entity.Property(e => e.MerchantCode)
                .HasMaxLength(10)
                .IsUnicode(false);
            entity.Property(e => e.MerchantTerminal).HasDefaultValue(1);
            ...
            entity.Property(e => e.SignatureVersion)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasDefaultValue("HMAC_SHA256_V1");
        ...
        {
            entity.HasKey(e => e.Rol).IsClustered(false);
        ...
        modelBuilder.Entity<VisaCard>(entity =>
        {
            ...
            entity.Property(e => e.Digits)
                .HasMaxLength(16)
                .IsUnicode(false)
                .HasDefaultValue("1111222233334444")
                .IsFixedLength()
        ...
        modelBuilder.Entity<WinMenuItem>(entity =>
        {
            ...
            entity.Property(e => e.Icon)
                ...
                .HasColumnType("image");
            entity.Property(e => e.Mime).HasDefaultValue(1);
            entity.Property(e => e.NomCat)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Caption, Catalan language");
