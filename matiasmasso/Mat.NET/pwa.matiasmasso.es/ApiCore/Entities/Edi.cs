...
public partial class Edi
{
    ...
    public virtual EdiRemadvHeader? EdiRemadvHeader { get; set; }

    public virtual EdiversaDesadvHeader? EdiversaDesadvHeader { get; set; }

    public virtual ICollection<EdiversaOrdrspHeader> EdiversaOrdrspHeaderEdiversaOrderNavigations { get; set; } = new List<EdiversaOrdrspHeader>();

    public virtual EdiversaOrdrspHeader? EdiversaOrdrspHeaderGu { get; set; }
}
