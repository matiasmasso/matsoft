...
public partial class Alb
{
    ...
    /// </summary>
    public int RetencioCod { get; set; }
    ...
    public virtual ICollection<CliReturn> CliReturns { get; set; } = new List<CliReturn>();
    ...
    public virtual Fra? Fra { get; set; }

    public virtual CliGral? Mgz { get; set; }

    public virtual CliGral? Platform { get; set; }
    ...
    public virtual Transm? Transm { get; set; }
