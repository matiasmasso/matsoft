Public Class ContactController
    ...
    <HttpPost>
    <Route("api/NearestNeighbours2")>
    Public Function NearestNeighbours2(oUserLocation As DUI.UserLocation) As List(Of DTOCompactNeighbour)
        Dim retval As New List(Of DTOCompactNeighbour)
        ...
        For Each oContact As DTONeighbour In oNeighbours
            Dim dui As New DTOCompactNeighbour
            With dui
                .guid = oContact.Guid
                .raoSocial = oContact.Nom
                .nomCom = oContact.NomComercial
                .nif = oContact.Nif
                .address = oContact.Address.Text
                .latitude = oContact.Address.Coordenadas.Latitud
                .longitude = oContact.Address.Coordenadas.Longitud
                .zipGuid = oContact.Address.Zip.Guid
                .zipCod = oContact.Address.Zip.ZipCod
                .locationGuid = oContact.Address.Zip.Location.Guid
                .locationNom = oContact.Address.Zip.Location.Nom
                .zonaGuid = oContact.Address.Zip.Location.Zona.Guid
                .zonaNom = oContact.Address.Zip.Location.Zona.Nom
                .countryGuid = oContact.Address.Zip.Location.Zona.Country.Guid
                .countryNom = oContact.Address.Zip.Location.Zona.Country.Nom.Tradueix(oUser.Lang)
                .tels = New List(Of DTOCompactContact.tel)
                .emails = New List(Of DTOCompactContact.email)
