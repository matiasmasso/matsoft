...
Namespace Areas.HelpPage
    ...
    Public Class ObjectGenerator
        ...
        Private Function GenerateObject(type As Type, createdObjectReferences As Dictionary(Of Type, Object)) As Object
            Try
                ...
                If (type.IsGenericType) Then
                    Return GenerateGeneriDirectCast(type, DefaultCollectionSize, createdObjectReferences)
                End If
        ...
        Private Shared Function GenerateGeneriDirectCast(type As Type, collectionSize As Integer, createdObjectReferences As Dictionary(Of Type, Object)) As Object
