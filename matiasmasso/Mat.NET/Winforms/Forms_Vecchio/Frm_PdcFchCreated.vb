...
Public Class Frm_PdcFchCreated
    ...
    Private Sub LoadGrid()
        ...
        Dim oDrd As SqlDataReader = Dal.SQLHelper.GetDataReader(SQL, "@EMP", BLLApp.Emp.Id, "@YEA", CurrentYea, "@FCH1", Fch1, "@FCH2", Fch2)
        Do While oDrd.Read
        ...
        CheckBoxAverage.Text = "valors en promig diari (" & Math.Round(iWeeks, 0, MidpointRounding.AwayFromZero) & " setmanes)"
        For j As Integer = Cols.w1 To Cols.w7
            iSum = 0
