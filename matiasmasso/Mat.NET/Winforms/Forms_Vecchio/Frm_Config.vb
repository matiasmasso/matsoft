...
Public Class Frm_Config
    ...
    Private Async Sub Frm_Config_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim s As String = Await FEB2.Default.EmpValue(Current.Session.Emp, DTODefault.Codis.MinAlbDate, exs)
        TextBoxLASTBLOCKEDCCAYEA.Text = Await FEB2.Default.EmpValue(Current.Session.Emp, DTODefault.Codis.LastBlockedCcaYea, exs)
        If exs.Count = 0 Then
            If IsDate(s) Then
