...
Public Class Frm_Art_Promo
    ...
    Private Sub LoadGrid()
        Dim SQL As String = "SELECT P.ART, A.MYD, P.QTYAMBCARREC, P.QTYNOCARREC, P.PVP, P.DTO, ROUND(P.QTYAMBCARREC*P.PVP*(100-P.DTO)/100,2) As DTOAmt " _
            ...
            Select Case e.ColumnIndex
                ...
                Case Cols.ArtNom
                    ...
                    If oSku IsNot Nothing Then
                        oRow.Cells(Cols.ArtNom).Value = oSku.NomLlarg
