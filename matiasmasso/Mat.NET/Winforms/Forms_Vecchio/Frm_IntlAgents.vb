...
Public Class Frm_IntlAgents
    Private mContact As DTOContact
    ...
    Public Sub New(oContact As DTOContact, oMode As BLL.Defaults.SelectionModes)
        MyBase.New()
        ...
        Select Case mMode
            Case Modes.Representades
                SQL = "SELECT Principal as Contact, Clx.Clx, IntlAgents.Area, Area.Nom FROM IntlAgents INNER JOIN " _
                    ...
                    & "CLX ON CLIGRAL.Guid=CLX.Guid inner join " _
                    & "AREA ON IntlAgents.Area=Area.Guid " _
                    & "WHERE AGENT = '" & mContact.Guid.ToString & "' " _
                    & "ORDER BY CLX.CLX"
            Case Modes.Representants
                SQL = "SELECT Agent as Contact, Clx.Clx, IntlAgents.Area, Area.Nom FROM IntlAgents INNER JOIN " _
                    ...
                    & "CLX ON CLIGRAL.Guid=CLX.Guid inner join " _
                    & "AREA ON IntlAgents.Area=Area.Guid " _
                    & "WHERE Principal = '" & mContact.Guid.ToString & "' " _
                    & "ORDER BY CLX.CLX"
        End Select

        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "Guid", mContact.Guid.ToString)
    ...
    Private Function CurrentItm() As IntlAgent
        ...
        If oRow IsNot Nothing Then
            ...
            Dim oPrincipal As DTOContact = Nothing
            Dim oAgent As DTOContact = Nothing
            Select Case mMode
                Case Modes.Representades
                    oAgent = mContact
                    oPrincipal = New DTOContact(oCliGuid)
                Case Modes.Representants
                    oPrincipal = mContact
                    oAgent = New DTOContact(oCliGuid)
            End Select
    ...
    Private Sub SetContextMenu()
        ...
        If oItm IsNot Nothing Then
            ...
            Dim oContact As DTOContact = IIf(mMode = Modes.Representants, oItm.Agent, oItm.Principal)
