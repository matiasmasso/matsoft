...
Public Class Frm_Cataleg_Upload
    ...
    Private Sub SetProduct(sender As Object, e As System.EventArgs)
        Dim oFrm As New Frm_Cataleg(, Frm_Cataleg.SelModes.SelectProduct)
        'Dim oFrm As New Frm_Arts(Frm_Arts.SelModes.SelectProduct)
        AddHandler oFrm.onItemSelected, AddressOf onProductSet
        oFrm.Show()
    End Sub
    ...
    Private Function ImportFile(sr As StreamReader) as List(Of exception)
        ...
        Dim sExpectedTitleRow As String = "MARCA;CATEGORIA;REF;NOM;PRV;MYD;COST;PVP;EAN"
    ...
    Private Sub ButtonOk_Click(sender As System.Object, e As System.EventArgs) Handles ButtonOk.Click
        ...
        For i As Integer = 0 To DataGridView1.Rows.Count - 1
            ...
            If iArt = 0 Then
                ...
                oArt.Cost = BLLApp.GetAmt(CDec(oRow.Cells(Cols.Cost).Value))
                oArt.Pvp = BLLApp.GetAmt(CDec(oRow.Cells(Cols.Pvp).Value))
