...
Partial Class Frm_PricelistItemCustomer
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_PercentMarginRetail = New Winforms.Xl_Percent()
        Me.Xl_AmtCostBrutEur = New Winforms.Xl_Amount()
        Me.Xl_AmtCostNet = New Winforms.Xl_Amount()
        ...
        Me.Xl_AmtRetail = New Winforms.Xl_Amount()
    ...
    Friend WithEvents Xl_AmtRetail As Winforms.Xl_Amount
    ...
    Friend WithEvents Xl_AmtCostNet As Winforms.Xl_Amount
    Friend WithEvents Label8 As System.Windows.Forms.Label
    Friend WithEvents Xl_AmtCostBrutEur As Winforms.Xl_Amount
    Friend WithEvents Label9 As System.Windows.Forms.Label
    Friend WithEvents Xl_PercentMarginRetail As Winforms.Xl_Percent
