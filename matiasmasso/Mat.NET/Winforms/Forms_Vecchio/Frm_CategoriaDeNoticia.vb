Public Class Frm_CategoriaDeNoticia
    ...
    Private _CategoriaDeNoticia As DTOCategoriaDeNoticia
    Private _AllowEvent As Boolean

    Public Event AfterUpdate(sender As Object, e As MatEventArgs)

    Public Sub New(value As DTOCategoriaDeNoticia)
        MyBase.New()
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.CategoriaDeNoticia.Update(_CategoriaDeNoticia, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.CategoriaDeNoticia.Delete(_CategoriaDeNoticia, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_CategoriaDeNoticia))
                Me.Close()
            Else
