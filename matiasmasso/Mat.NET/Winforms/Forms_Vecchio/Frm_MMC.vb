...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Xl_Rols_Allowed1 = New Winforms.Xl_Rols_Allowed()
...
#End Region
    ...
    Private Sub SetControls()
        With mMMC
            ...
            TextBoxAction.Enabled = (.Cod = DTOWinMenuItem.Cods.Item)
    ...
    Private Sub ComboBoxCod_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ComboBoxCod.SelectedIndexChanged
        ...
        TextBoxAction.Visible = (oCod = DTOWinMenuItem.Cods.Item)
        TextBoxAction.Enabled = (oCod = DTOWinMenuItem.Cods.Item)
    End Sub
End Class
