...
Public Class Frm_CliPreusXProduct
    ...
    Private Sub refresca()
        ...
        TextBoxTarifa.Text = mProduct.tarifaA.CurFormatted
        ...
        Dim oDs As DataSet = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@EMP", BLLApp.Emp.Id, "@PRODUCT", mProduct.Guid.ToString)
    ...
    Private Sub UpdateRows()
        ...
        maxisrvr.executenonquery(SQL, maxisrvr.Databases.Maxi, "@EMP", BLLApp.Emp.Id, "@PRODUCT", mProduct.Guid.ToString)
        ...
        Dim oDa As SqlDataAdapter = maxisrvr.GetSQLDataAdapter(SQL, oConn, "@EMP", BLLApp.Emp.Id, "@PRODUCT", mProduct.Guid.ToString)
