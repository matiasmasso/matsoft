...
Public Class Frm_Last_Albs
    ...
    Private Sub LoadGrid()
        ...
        sb.AppendLine("SELECT Alb.Guid,Alb.ALB,Alb.FCH,Clx.CLX,Alb.Eur+Alb.Pt2,Alb.CASHCOD,Alb.FACTURABLE, (CASE WHEN Transm.Transm IS NULL THEN '' ELSE CAST(Transm.Transm AS VARCHAR) END) AS STRANSM, Fra.Fra ")
        ...
        sb.AppendLine("LEFT JOIN Transm ON ALB.TransmGuid=Transm.Guid ")
        ...
        sb.AppendLine("WHERE ALB.EMP=" & BLLApp.Emp.Id & " ")
        sb.AppendLine("AND ALB.YEA=" & CurrentYea() & " ")
