...
Public Class Frm_Impagats_Old
    ...
    Private Sub Extracte()
        Dim oContact As DTOContact = CurrentImpagat.Csb.Client.ToNewContact
        Dim oCta As DTOPgcCta = BLL.BLLPgcCta.FromCod(DTOPgcPlan.Ctas.impagats)
        Dim oExercici As DTOExercici = BLL.BLLExercici.Current()
    ...
    Private Sub Do_Insolvencia()
        Dim oContact As Contact = Nothing
        Dim oImpagat As Impagat = Nothing
        Dim oNominal As DTOAmt = BLLApp.EmptyAmt
        ...
        Dim oTmp As DTOAmt = oNominal.Clone
        oTmp.Add(oGastos)
        Dim oComisio As DTOAmt = oTmp.Percent(20)
