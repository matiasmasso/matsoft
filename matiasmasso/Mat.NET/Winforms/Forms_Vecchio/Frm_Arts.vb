...
Public Class Frm_Arts
    ...
    Public Sub LoadStps()
        ...
        Xl_ProductCategories1.Load(oCategories, oSelectionMode:=oSelMode)
    End Sub
    ...
    Private Function CurrentStp() As Stp
        ...
        If Xl_ProductCategories1.Value IsNot Nothing Then
            retval = New Stp(Xl_ProductCategories1.Value.Guid)
        End If
        Return retval
    End Function
    ...
    Private Sub ShowArtSubPanel(Optional ByVal oArt As Art = Nothing)
        ...
        Else
            ...
            'TextBoxTarifaA.Clear()
            'Else
            'TextBoxTarifaA.Text = oArt.TarifaA.CurFormatted
            'End If
            If oArt.Pvp Is Nothing Then
                TextBoxPvp.Clear()
            Else
                TextBoxPvp.Text = oArt.Pvp.CurFormatted
            End If
    ...
    Private Sub Xl_ProductBrands1_RequestToAddNew(sender As Object, e As MatEventArgs) Handles Xl_ProductBrands1.RequestToAddNew
        Dim oTpa As New Tpa(BLLApp.Emp)
