...
Public Class Frm_BookFras
    ...
    Private Sub Frm_BookFras_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        ComboBoxBookFraMode.SelectedIndex = DTOBookFra.Modes.OnlyIva
    ...
    Private Sub LoadBookFras()
        Dim oBookFras As List(Of DTOBookFra) = BLL.BLLBookFras.All(CurrentMode, CurrentExercici, CurrentMes)
        Xl_BookFras1.Load(oBookFras)
    End Sub

    Private Function CurrentMode() As DTOBookFra.Modes
        Dim retval As DTOBookFra.Modes = ComboBoxBookFraMode.SelectedIndex
        Return retval
    End Function
    ...
    Private Sub LoadCtas()
        ...
        Dim oDs As DataSet = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@Emp", BLLApp.Emp.Id, "@Yea", CurrentYea)
    ...
    Private Sub Load347()
        ...
        Dim oDs As DataSet = MaxiSrvr.GetDataset(SQL, MaxiSrvr.Databases.Maxi, "@MinValue", CInt(BLLAeatMod347.MinimDeclarable))
        Dim oTb As DataTable = oDs.Tables(0)
    ...
    Private Sub ButtonExcel_Click(sender As Object, e As EventArgs) Handles ButtonExcel.Click
        Dim sFilename As String = BLLBookFras.Filename(CurrentExercici, CurrentMes)
        Dim oExcelSheet As New DTOExcelSheet(sFilename)
        BLLBookFras.LoadExcel(oExcelSheet, Xl_BookFras1.Values, Nothing)
