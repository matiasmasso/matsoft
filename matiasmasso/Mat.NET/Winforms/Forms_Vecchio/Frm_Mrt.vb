...
Public Class Frm_Mrt
    ...
    Public WriteOnly Property Mrt() As Mrt
        Set(ByVal Value As Mrt)
            ...
            With mMrt
                mEmp = .Emp
                Me.Text = Me.Text & " #" & .Id
                Xl_LookupCca1.Cca = .Alta.ToDTO(BLL.BLLSession.Current.User)
                DateTimePicker1.Value = .Fch
                TextBoxDsc.Text = .Nom
                Xl_Cta1.Cta = New DTOPgcCta(.Cta.Guid)
    ...
    Private Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        With mMrt
            ...
            .Alta = Cca.FromDTO(Xl_LookupCca1.Cca)
            .Nom = TextBoxDsc.Text
            .Amt = Xl_AmtCur1.Amt
            .Cta = New PgcCta(Xl_Cta1.Cta.Guid)
