...
Public Class Frm_StpHistorial
    ...
    Private Sub LoadGrid()
        ...
        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@Guid", mStp.Guid.ToString)
    ...
    Private Sub onExcel()
        ...
        For Each oRow As DataGridViewRow In oRows
            Dim oExcelRow As DTOExcelRow = oSheet.AddRow
            oExcelRow.AddCell(oRow.Cells(Cols.Clx).Value)
        Next
