...
Public Class Frm_Tel_Search
    ...
    Private Sub LoadGrid()
        'començat a sustituiir per contactloader.Search
        ...
        Select Case CurrentMode()
            Case Modes.email
                ...
                & "CLX ON EMAIL_CLIS.ContactGuid = CLX.Guid " _
            ...
            Case Modes.tel
                ...
                & "CLX ON CLITEL.CliGuid=CLX.Guid " _
                & "INNER JOIN CliGral ON Clx.Guid=CliGral.Guid " _
                & "WHERE " _
                & "CliGral.EMP=@EMP AND " _
            ...
            Case Modes.adr
                ...
                & "CLX ON CLIADR.SrcGuid=CLX.Guid " _
                & "INNER JOIN CliGral ON Clx.Guid=CliGral.Guid " _
                & "WHERE " _
                & "CliGral.EMP=@EMP AND " _
            ...
            Case Modes.nif
                ...
                & "CLX ON CLIGRAL.Guid=CLX.Guid " _
                & "WHERE " _
                & "CLIGRAL.EMP=@EMP AND " _
            ...
            Case Modes.SubContact
                ...
                & "CLX ON CLICONTACT.ContactGuid=CLX.Guid INNER JOIN " _
                & "CliGral ON Clx.Guid=CliGral.Guid " _
                & "WHERE " _
                & "CliGral.EMP=@EMP AND " _
        ...
        mDs = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@EMP", BLLApp.Emp.Id, "@CLAU", "%" & Str & "%")
