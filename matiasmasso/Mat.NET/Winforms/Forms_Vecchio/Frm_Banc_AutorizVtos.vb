...
Public Class Frm_Banc_AutorizVtos
    ...
    Public WriteOnly Property Banc() As DTOBanc
        Set(ByVal value As DTOBanc)
            mBanc = value
            PictureBoxBancLogo.Image = mBanc.Logo
    ...
    Private Sub LoadGrid()
        ...
        & "PND.cfp =" & DTOPaymentTerms.CodsFormaDePago.DomiciliacioBancaria & " " _
    ...
    Private Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        Dim oPnd As Pnd
        Dim oMail As New DTOCorrespondencia()
        oMail.Fch = Today
        ...
        With oMail
            ...
            If BLLDocFile.LoadFromStream(oPdf.Stream, oDocFile, exs) Then
                .DocFile = oDocFile
            End If

            If BLLCorrespondencia.Update(oMail, exs) Then
