...
Public Class Frm_FraPrvRectificativa
    ...
    Private Function GetFraOriginalText()
        ...
        sB.AppendLine("base " & mFra.Bas.Formatted & " + IVA " & mFra.Iva.CurFormatted & " = " & mFra.Liq.Formatted & " Vto." & mFra.Vto.ToShortDateString)
