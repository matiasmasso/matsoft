...
#End Region
    ...
    Private Sub LoadTree()
        Dim SQL As String = "SELECT Pnc.Guid AS PncGuid, TPA.TPA, TPA.DSC AS tpadsc, STP.stp, STP.dsc AS stpdsc, PNC.ArtGuid, ART.ORD, PNC.Pn2, PNC.PdcGuid, Pdc.pdc, PDC.FCH, PNC.LIN " _
        ...
        Do While oDrd.Read
            ...
            oPnc = New LineItmPnc(CType(oDrd("PncGuid"), Guid))
            oPnc.SetItm()
            oPnc.Art = oArt
