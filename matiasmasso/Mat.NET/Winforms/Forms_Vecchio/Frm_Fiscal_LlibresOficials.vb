...
Public Class Frm_Fiscal_LlibresOficials
    ...
    Private Sub ButtonRenum_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonRenum.Click
        Dim oFrm As New Frm_CcaRenum
        oFrm.Show()


        'Dim oExercici As DTOExercici = CurrentExercici.ToDTO
    ...
    Private Sub ButtonDiari_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        'Dim oLlibre As New Llibre_Diari(CurrentExercici)
        'SaveFile(oLlibre, FileFormats.Pdf)
    End Sub

    Private Sub ButtonDiariExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim oLlibre As New Llibre_Diari(CurrentExercici)
        'SaveFile(oLlibre, FileFormats.Csv)
    End Sub

    Private Sub ButtonMajor_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        'Dim oExercici As DTOExercici = CurrentExercici()
        'Dim oLlibre As New Llibre_Major(oExercici.Emp, BLLExercici.FchEnd(oExercici))
        'SaveFile(oLlibre, FileFormats.Pdf)
    End Sub

    Private Sub ButtonMajorExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim oExercici As DTOExercici = BLLExercici.Current
        Dim oCsv As DTOCsv = BLL.BLLLlibreMajor.Csv(oExercici, BLL.BLLSession.Current.Lang, AddressOf ShowProgress)
        UIHelper.SaveCsvDialog(oCsv, "Llibre Major de Comptes " & oExercici.Year)
    End Sub
    ...
    Private Sub ButtonFresEmeses_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Function CurrentExercici() As DTOExercici
        Dim retVal As New DTOExercici(BLL.BLLApp.Emp, NumericUpDownYea.Value)
        Return retVal
    End Function

    Private Sub SaveFile(ByVal oLlibre As Llibre_Comptable, ByVal oFormat As FileFormats)
        Dim oExercici As DTOExercici = oLlibre.Exercici
        Dim sExtension As String = oFormat.ToString
        Dim oDlg As New SaveFileDialog
        With oDlg
            .DefaultExt = sExtension
            .AddExtension = True
            .FileName = MaxiSrvr.Emp.FromDTOEmp(oExercici.Emp).Org.NIF & "." & oExercici.Year.ToString & "." & oLlibre.FilenameRoot & "." & sExtension
