...
Public Class Frm_ArtxStp_Ranking
    ...
    Private Sub LoadGrid()
        ...
        For i = 0 To oTb.Rows.Count - 1
            oRow = oTb.Rows(i)
            oRow("PCT") = Math.Round(100 * oRow(Cols.Qty) / mTot, 0, MidpointRounding.AwayFromZero)
        Next
    ...
    Private Function CurrentArt() As DTOProductSku
    ...
    Private Sub SetContextMenu()
        ...
        Dim oSku As DTOProductSku = CurrentArt()
