...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Xl_LookupVisa1 As Winforms.Xl_LookupVisaCard
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Xl_CtaExentoIva = New Winforms.Xl_Cta()
        Me.Label16 = New System.Windows.Forms.Label()
        Me.Label15 = New System.Windows.Forms.Label()
        Me.Label14 = New System.Windows.Forms.Label()
        Me.Label13 = New System.Windows.Forms.Label()
        Me.Xl_BaseQuotaIva = New Winforms.Xl_BaseQuota()
        Me.Xl_CtaBaseIva = New Winforms.Xl_Cta()
        Me.Xl_LookupProjecte1 = New Winforms.Xl_LookupProjecte()
        Me.Label8 = New System.Windows.Forms.Label()
        Me.Xl_ContactPrv = New Winforms.Xl_Contact2()
        ...
        DirectCast(Me.PictureBoxVISA, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        DirectCast(Me.PictureBoxLogo, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'ButtonPrevious
        '
        Me.ButtonPrevious.Anchor = System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left
        ...
        'ButtonEnd
        '
        Me.ButtonEnd.Anchor = System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right
        ...
        'ButtonNext
        '
        Me.ButtonNext.Anchor = System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Right
        ...
        'PictureBoxVISA
        '
        Me.PictureBoxVISA.Image = DirectCast(resources.GetObject("PictureBoxVISA.Image"), System.Drawing.Image)
        ...
        'PictureBoxLogo
        '
        Me.PictureBoxLogo.Anchor = System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right
        ...
        DirectCast(Me.PictureBoxVISA, System.ComponentModel.ISupportInitialize).EndInit()
        ...
        DirectCast(Me.PictureBoxLogo, System.ComponentModel.ISupportInitialize).EndInit()
...
#End Region
    ...
    Private Async Sub Wz_Proveidor_NewFra_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        _Ctas = Await FEB2.PgcCtas.All(exs)
        If exs.Count = 0 Then
            ...
            If FEB2.Contact.Load(_Proveidor, exs) Then
                If FEB2.Proveidor.Load(_Proveidor, exs) Then
                    ...
                    If _Proveidor.DefaultCtaCarrec IsNot Nothing Then
                        If FEB2.PgcCta.Load(_Proveidor.DefaultCtaCarrec, exs) Then
    ...
    Private Async Function Grabacion(exs As List(Of Exception)) As Task(Of DTOCca)
        ...
        Dim oCtaTotalCod As DTOPgcPlan.Ctas
        Select Case CurrentCfp()
            Case Cfps.Cash
                oCtaTotalCod = DTOPgcPlan.Ctas.caixa
            Case Cfps.Banc
                oContact = Xl_Bancs_Select2.Banc
                oCtaTotalCod = DTOPgcPlan.Ctas.bancs
            Case Cfps.Credit
                oContact = _Proveidor
                oCtaTotalCod = DTOPgcCta.GetCtaProveedors(Xl_AmtCurBaseExento.Amt.Cur)
            Case Cfps.Visa
                Dim oTitular As DTOContact = Xl_LookupVisa1.VisaCard.Titular
                oContact = oTitular
                oCtaTotalCod = DTOPgcPlan.Ctas.VisasPagadas
        End Select

        Dim oCtaTotal = FEB2.PgcCta.FromCodSync(oCtaTotalCod, Current.Session.Emp, exs)
        AddTotal(oCca, oCtaTotal, oContact)
        ...
        If _Importacio IsNot Nothing Then
            If FEB2.Importacio.Load(exs, _Importacio) Then
                ...
                If FEB2.PgcCta.Load(oCtaCarrec, exs) Then
        ...
        Dim retval As DTOCca = Await FEB2.Proveidor.SaveFactura(exs, oCca, oPnds, _Importacio)
        Return retval
    End Function
    ...
    Private Async Sub TextBoxFra_Validated(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxFra.Validated
        Dim exs As New List(Of Exception)
        Dim oDuplicada As DTOCca = Await FEB2.Proveidor.CheckFacturaAlreadyExists(exs, _Proveidor, DTOExercici.Current(Current.Session.Emp), TextBoxFra.Text)
    ...
    Private Sub LoadIRPFcuentas()
        ...
        If Not Loaded Then
            Loaded = True
            mIRPFCtas.Add(FEB2.PgcCta.FromCodSync(DTOPgcPlan.Ctas.IrpfTreballadors, Current.Session.Emp, exs))
            mIRPFCtas.Add(FEB2.PgcCta.FromCodSync(DTOPgcPlan.Ctas.IrpfProfessionals, Current.Session.Emp, exs))
            mIRPFCtas.Add(FEB2.PgcCta.FromCodSync(DTOPgcPlan.Ctas.IrpfLloguers, Current.Session.Emp, exs))
            Dim i As Integer
    ...
    Private Async Function Wizard_AfterTabSelect() As Task
        ...
        Select Case oTabIdx
            ...
            Case Tabs.Credit
                ...
                TextBoxPndObs.Text = FEB2.PaymentTerms.Text(_Proveidor.PaymentTerms, _Lang, DtVto)
                EnableButtons()
            Case Tabs.Fi
    ...
    Private Sub refrescaDivisa()
        ...
        'CurExchangeRate = Await FEB2.CurExchangeRate.Closest(oCur, DateTimePickerFch.Value, exs)
        'If exs.Count = 0 Then
        RefrescaBase()
        _AllowEvents = BlAllowEventsBackup
        'End If
