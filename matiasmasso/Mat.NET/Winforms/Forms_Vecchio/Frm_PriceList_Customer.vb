Public Class Frm_PriceList_Customer
    ...
    Private Sub Frm_PriceList_Customer_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.PriceListCustomer.Load(exs, _PriceList) Then
            With _PriceList
                If .IsNew Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As System.EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.PriceListCustomer.Update(exs, _PriceList) Then
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Dim exs As New List(Of Exception)
        If FEB2.PriceListCustomer.Load(exs, _PriceList) Then
            Dim oSheet As MatHelperStd.ExcelHelper.Sheet = DTOPricelistCustomer.ExcelSheet(_PriceList)
    ...
    Private Sub refrescaItems()
        Dim exs As New List(Of Exception)
        If FEB2.PriceListCustomer.Load(exs, _PriceList, True) Then
            Xl_PriceListItems_Customer1.Load(_PriceList.Items)
        Else
            UIHelper.WarnError(exs)
        End If
            ...
            If FEB2.PriceListCustomer.Load(exs, _PriceList, True) Then
                ...
                For Each oRow As DTOCsvRow In oCsv.Rows
                    ...
                    If IsNumeric(sRef) Then
                        Dim oSku = Await FEB2.ProductSku.FromId(exs, Current.Session.Emp, sRef)
                        If exs.Count = 0 Then
                            ...
                            Else
                                ...
                                If Decimal.TryParse(sPvp, dcPvp) Then
                                    ...
                                    item.Sku = Await FEB2.ProductSku.Find(exs, oSku.Guid)
                                    If exs.Count = 0 Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.PriceListCustomer.Delete(exs, _PriceList) Then
    ...
    Private Async Sub Xl_PriceListItems_Customer1_RequestToRefresh(sender As Object, e As MatEventArgs) Handles Xl_PriceListItems_Customer1.RequestToRefresh
        Dim exs As New List(Of Exception)
        _PriceList = Await FEB2.PriceListCustomer.Find(exs, _PriceList.Guid)
        If exs.Count = 0 Then
        Else
            UIHelper.WarnError(exs)
        End If
