...
Public Class Frm_Geo_Pdcs
    ...
    Private Sub LoadGrid()
        ...
        Dim oDs As DataSet = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@EMP", BLLApp.Emp.Id, "@YEA", CurrentYea, "@CIT", sCurrentCit)
    ...
    Private Sub LoadTree(oSelectedLevel As GeoLevels, sSelectedText As String)
        ...
        Try
            ...
            Dim oDrd As SqlClient.SqlDataReader = maxisrvr.GetDataReader(SQL, maxisrvr.Databases.Maxi, "@EMP", BLLApp.Emp.Id, "@YEA", CurrentYea)
            Do While oDrd.Read
    ...
    Private Sub LoadTpas(Optional iSelectedTpa As Integer = 0)
        ...
        Dim oDrd As SqlDataReader = maxisrvr.GetDataReader(SQL, maxisrvr.Databases.Maxi, "@EMP", BLLApp.Emp.Id, "@YEA", CurrentYea)
        Do While oDrd.Read
