...
Public Class frm_Aeat_Mod349
    ...
    Private Sub LoadGrid()
        ...
        & "PgcCta ON Ccb.CtaGuid= PgcCta.Guid AND PgcCta.Id LIKE '6%' INNER JOIN " _
        ...
        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(sql, New List(Of Exception), "@EMP", mEmp.Id, "@YEA", CurrentYear, "@QM3", iQM3)
