...
Public Class Frm_PrvPrevisions
    ...
    Private Sub LoadGrid()
        ...
        oTb.Columns.Add("ARTGUID", System.Type.GetType("System.Guid"))
        ...
        For Each oItm In mPrevisio.Itms
            oRow = oTb.NewRow()
            oRow(Cols.ArtGuid) = oItm.Art.Guid
        ...
        If oSku IsNot Nothing Then
            ...
            With oMenuItem
                ...
                If DataGridView1.SelectedRows.Count = 1 Then
                    ...
                    .DropDownItems.AddRange(oMenu_Sku.Range)
                Else
                    .Enabled = False
                End If
            End With
    ...
    Private Function SelectedItms() As LineItmPncs
        ...
        For Each oRow In DataGridView1.SelectedRows
            oItm = New LineItmPnc(CType(oRow.Cells(Cols.ArtGuid).Value, Guid))
            With oItm
                .Art = New Art(CType(oRow.Cells(Cols.ArtGuid).Value, Guid))
    ...
    Private Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        For Each oRow In oTb.Rows
            oItm = New LineItmPnc(Guid.NewGuid)
            oItm.Qty = oRow(Cols.Qty)
            oItm.Art = New Art(CType(oRow(Cols.ArtGuid), Guid))
            oItms.Add(oItm)
        Next
        ...
        If mDirtyCell Then
            ...
            Select Case e.ColumnIndex
                Case Cols.Dsc
                    ...
                    Else
                        Dim oSku As DTOProductSku = Finder.FindSku(e.FormattedValue, BLL.BLLApp.Mgz)
            ...
            Select Case e.ColumnIndex
                Case Cols.Dsc
                    ...
                    If oArt Is Nothing Then
                        oRow.Cells(Cols.ArtGuid).Value = Nothing
