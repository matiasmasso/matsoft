...
Public Class Frm_Mgz_AvisCamion
    ...
    Private Sub Frm_Mgz_AvisCamion_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.Contact.Load(mProveidor, exs) Then
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        Dim sSendTo As String = Await FEB2.Default.EmpValue(Current.Session.Emp, DTODefault.Codis.EmailTransmisioVivace, exs)
            ...
            Select Case e.ColumnIndex
                Case Cols.Id
                    If IsNumeric(e.FormattedValue) Then
                        Dim oSku = Await FEB2.ProductSku.FromId(exs, Current.Session.Emp, e.FormattedValue)
                        If exs.Count = 0 Then
