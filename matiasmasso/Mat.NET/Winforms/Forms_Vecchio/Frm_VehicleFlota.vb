...
Public Class Frm_VehicleFlota
    ...
    Private Sub LoadGrid()
        ...
        & "FROM VEHICLE_FLOTA F " _
        & "INNER JOIN VEHICLE_MODELS ML ON ML.Guid=F.MODELGuid " _
        & "INNER JOIN VEHICLE_MARCAS MC ON MC.Guid=ML.MARCAGuid " _
        & "LEFT OUTER JOIN CLX ON CLX.Guid=F.CONDUCTORGuid " _
        & "WHERE F.EMP=" & BLLApp.Emp.Id & " "
    ...
    Private Function CurrentItm() As DTOVehicle
        Dim oItm As DTOVehicle = Nothing
        Dim oRow As DataGridViewRow = DataGridView1.CurrentRow
        If oRow IsNot Nothing Then
            Dim oGuid As System.Guid = oRow.Cells(Cols.Guid).Value
            oItm = New DTOVehicle(oGuid)
        End If
        Return oItm
    End Function
    ...
    Private Sub SetContextMenu()
        ...
        Dim oItm As DTOVehicle = CurrentItm()
    ...
    Private Sub AddNewItm(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim oVehicle As New DTOVehicle
        oVehicle.Alta = Today
