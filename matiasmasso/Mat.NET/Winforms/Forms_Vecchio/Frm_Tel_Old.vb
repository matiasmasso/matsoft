Public Class Frm_Tel_Old
    ...
    Public Sub New(ByRef oTel As Tel)
        ...
        With mTel
            ...
            Xl_Pais1.Country = .Country
            TextBoxNum.Text = .Num
            TextBoxObs.Text = .Obs
            CheckBoxPrivat.Checked = (.Privat = DTOEnums.TriState.Verdadero)
        End With
    End Sub
    ...
    Private Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        With mTel
            .Num = TextBoxNum.Text
            .Obs = TextBoxObs.Text
            .Privat = IIf(CheckBoxPrivat.Checked, DTOEnums.TriState.Verdadero, DTOEnums.TriState.Falso)
            .Country = Xl_Pais1.Country
