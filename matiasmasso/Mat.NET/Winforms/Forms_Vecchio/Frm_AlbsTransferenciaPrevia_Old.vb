...
Public Class Frm_AlbsTransferenciaPrevia_Old
    ...
    Private Sub LoadGrid()
        ...
        Dim SQL As String = "SELECT Alb.Guid, YEA,ALB,FCH,CLX,EUR+PT2, " _
        ...
        & "WHERE ALB.EMP=" & BLLApp.Emp.Id & " AND YEA>2006 AND (ALB.COD=2 or alb.cod=" & CInt(DTOPurchaseOrder.Codis.Reparacio) & ") AND " _
