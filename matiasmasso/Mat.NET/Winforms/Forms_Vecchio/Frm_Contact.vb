...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Xl_Contact_Banc1 = New Winforms.Xl_Contact_Banc()
        Me.TabPageMAIL = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Mail1 = New Winforms.Xl_Contact_Mail()
        Me.TabPageSTAFF = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Staff1 = New Winforms.Xl_Contact_Staff()
        Me.TabPageCLI = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Cli1 = New Winforms.Xl_Contact_Cli()
        Me.TabPageREP = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Rep1 = New Winforms.Xl_Contact_Rep()
        Me.TabPagePRV = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Prv1 = New Winforms.Xl_Contact_Prv()
        Me.TabPageTrp = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Trp1 = New Winforms.Xl_Contact_Trp()
        Me.TabPageGRAL = New System.Windows.Forms.TabPage()
        Me.Xl_Contact_Gral1 = New Winforms.Xl_Contact_Gral()
...
#Region "LoadData"
    ...
    Private Async Function LoadTabs(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        _Tabs = Await FEB2.Contact.Tabs(exs, _Contact)
        If exs.Count = 0 Then
    ...
    Private Async Function AddTab(exs As List(Of Exception), oTab As DTOContact.Tabs) As Task
        Select Case oTab
            ...
            Case DTOContact.Tabs.Staff
                If FEB2.User.IsAllowedToRead(Current.Session.User, _Contact) Then
                    Await loadStaff(exs)
                End If
    ...
    Private Sub loadGral(exs As List(Of Exception))
        ...
        'If FEB2.Contact.Load(_Contact, exs, includeLogo:=True) Then
    ...
    Private Async Function loadStaff(exs As List(Of Exception)) As Task
        ...
        If FEB2.Staff.Load(exs, oStaff) Then
    ...
    Private Async Function loadRep(exs As List(Of Exception)) As Task
        ...
        Dim oRep = Await FEB2.Rep.Find(_Contact.Guid, exs)
    ...
    Private Sub loadTrp(exs As List(Of Exception))
        ...
        If FEB2.Transportista.Load(oTrp, exs) Then
    ...
    Private Sub loadBanc(exs As List(Of Exception))
        ...
        If FEB2.Banc.Load(oBanc, exs) Then
...
#End Region
    ...
    Private Async Function UpdateChanges(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        If mDirtyAdrEntregas Then
            ...
            If oDlvrAdr Is Nothing Then
                ...
                Await FEB2.Address.Delete(oDlvrAdr, exs)
            ...
            Else
                ...
                Else
                    ...
                    Await FEB2.Address.Update(oDlvrAdr, exs)
                End If
            End If
        End If
        ...
        If mDirtyClient Then
            ...
            exs = New List(Of Exception)
            If Not Await FEB2.Customer.Update(exs, oCustomer) Then
                MsgBox("Error al desar la fitxa de client" & vbCrLf & ExceptionsHelper.ToFlatString(exs))
            End If
        End If
        ...
        If mDirtyPrv Then
            ...
            exs = New List(Of Exception)
            If Not Await FEB2.Proveidor.Update(oProveidor, exs) Then
        ...
        If mDirtyRep Then
            ...
            exs = New List(Of Exception)
            If Not Await FEB2.Rep.Update(exs, oRep) Then
                MsgBox("Error al desar la fitxa de representant" & vbCrLf & ExceptionsHelper.ToFlatString(exs))
            End If
        End If
        ...
        If mDirtyBanc Then
            ...
            exs = New List(Of Exception)
            If Not Await FEB2.Banc.Update(oBanc, exs) Then
        ...
        If mDirtyTrp Then
            ...
            exs = New List(Of Exception)
            If Not Await FEB2.Transportista.Update(oTrp, exs) Then
        ...
        If mDirtyStaff Then
            ...
            exs = New List(Of Exception)
            If Not Await FEB2.Staff.Update(exs, oStaff) Then
    ...
    Private Async Function DeleteTab(oTab As DTOContact.Tabs, exs As List(Of Exception)) As Task
        Select Case oTab
            Case DTOContact.Tabs.Client
                ...
                End If
                If Not Await FEB2.Customer.Delete(exs, oCustomer) Then
                    UIHelper.WarnError(exs)
                End If
            Case DTOContact.Tabs.Proveidor
                Await FEB2.Proveidor.Delete(_Contact, exs)
            Case DTOContact.Tabs.Rep
                Await FEB2.Rep.Delete(exs, _Contact)
            Case DTOContact.Tabs.Banc
                If Not Await FEB2.Banc.Delete(_Contact, exs) Then
                    UIHelper.WarnError(exs)
                End If
            Case DTOContact.Tabs.Transportista
                If Not Await FEB2.Transportista.Delete(_Contact, exs) Then
                    UIHelper.WarnError(exs)
                End If
            Case DTOContact.Tabs.Staff
                If Not Await FEB2.Staff.Delete(exs, _Contact) Then
                    UIHelper.WarnError(exs)
                End If
        End Select
    End Function
    ...
    Private Sub CheckDuplicatedAddresses()
        ...
        'Dim oContact As New DTOContact(mContact.Guid)
        'If Not FEB2.Address.Delete(oContact, DTOAddress.Codis.Correspondencia, exs) Then
        'UIHelper.WarnError(exs)
        'End If
        'End If
    ...
    Private Async Sub ButtonDel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.Contact.Delete(exs, _Contact) Then
                Me.Close()
            Else
