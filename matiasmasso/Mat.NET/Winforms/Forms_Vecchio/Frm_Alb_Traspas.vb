...
Public Class Frm_Alb_Traspas
    ...
    Private Sub LoadGrid()
        ...
        & "ARC.COD>50 " _
        & "ORDER BY LIN"
        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@Guid", mAlb.Guid.ToString)
    ...
    Private Function CurrentSku() As DTOProductSku
        ...
        If oRow IsNot Nothing Then
            Dim iId As Integer = oRow.Cells(Cols.ArtNum).Value
            retval = BLLProductSku.FromId(iId)
        End If
        Return retval
    End Function
    ...
    Private Sub SetContextMenu()
        ...
        If oSku IsNot Nothing Then
            Dim oMenu_Productsku As New Menu_ProductSku(oSku)
