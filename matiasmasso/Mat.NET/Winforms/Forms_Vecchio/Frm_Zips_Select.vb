...
Public Class Frm_Zips_Select
    ...
    Private mCountries As List(Of DTOCountry)
    ...
    Private Sub LoadGrid()
        ...
        Dim oRow As DataRow
        Dim oCountry As DTOCountry
        Dim oDefaultCountry As DTOCountry = BLLCountry.DefaultCountry
        mCountries = New List(Of DTOCountry)
    ...
    Private Sub AddToCountries(ByVal oCountry As DTOCountry)
        If oCountry.Equals(BLLCountry.DefaultCountry) Then Exit Sub
        For Each nCountry As DTOCountry In mCountries
