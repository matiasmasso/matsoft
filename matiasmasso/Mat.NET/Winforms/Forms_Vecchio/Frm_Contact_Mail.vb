...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.PictureBoxLocked.Image = Global.Winforms.My.Resources.Resources.candado
...
#End Region
    ...
    Private Sub LoadContactGrid()
        ...
        For Each oContact As DTOContact In mMail.Contacts
            Dim oRow As DataRow = oTb.NewRow
            oRow(Cols.Guid) = oContact.Guid
            oRow(Cols.Nom) = oContact.FullNom
            oTb.Rows.Add(oRow)
        Next
    ...
    Private Function GetContactsFromGrid() As List(Of DTOContact)
        Dim oContacts As New List(Of DTOContact)
        For Each oRow As DataGridViewRow In DataGridViewContacts.Rows
            Dim oContact As New DTOContact(oRow.Cells(Cols.Guid).Value)
            oContact.FullNom = oRow.Cells(Cols.Nom).ToString
        ...
        If mDirtyCell Then
            ...
            Select Case e.ColumnIndex
                Case Cols.Nom
                    ...
                    Else
                        Dim oContact As DTOContact = Finder.FindContact2(BLLApp.Emp, e.FormattedValue)
    ...
    Private Sub DataGridView1_CellValidated(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridViewContacts.CellValidated
        If mDirtyCell Then
            ...
            Select Case e.ColumnIndex
                Case Cols.Nom
                    Dim oContact As DTOContact = CType(mLastValidatedObject, DTOContact)
                    oRow.Cells(Cols.Guid).Value = oContact.Guid
                    oRow.Cells(Cols.Nom).Value = oContact.FullNom
                    SetDirty()
            End Select
