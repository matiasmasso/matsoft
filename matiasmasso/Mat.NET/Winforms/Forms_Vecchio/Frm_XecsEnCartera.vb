Public Class Frm_XecsEnCartera
    ...
    Private Async Sub Frm_XecsEnCartera_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim o = Await FEB2.Xecs.All(exs, Current.Session.Emp, DTOXec.StatusCods.EnCartera)
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.XecsPresentacio.Update(exs, oXecsPresentacio) Then
            Me.Close()
        Else
    ...
    Private Async Sub Xl_XecsEnCartera1_RequestToRefresh(sender As Object, e As MatEventArgs) Handles Xl_XecsEnCartera1.RequestToRefresh
        Dim exs As New List(Of Exception)
        Dim oXecs = Await FEB2.Xecs.All(exs, Current.Session.Emp, DTOXec.StatusCods.EnCartera)
        If exs.Count = 0 Then
