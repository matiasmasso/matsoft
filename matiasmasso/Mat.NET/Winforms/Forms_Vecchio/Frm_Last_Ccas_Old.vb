...
Public Class Frm_Last_Ccas_Old
    ...
    Private Sub LoadGrid()
        ...
        mDs = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@Emp", BLLApp.Emp.Id, "@Yea", CurrentYea)
    ...
    Private Function CurrentCcas() As List(Of Cca)
        Dim oCcas As New List(Of Cca)
    ...
    Private Sub SetContextMenu()
        ...
        Dim oCcas As List(Of Cca) = CurrentCcas()
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        Select Case _SelectionMode
            ...
            Case BLL.Defaults.SelectionModes.Selection
                Dim oCca As DTOCca = BLLCca.Find(CurrentCca.Guid)
