...
Public Class frm_arts_select
    ...
    Public WriteOnly Property Arts() As List(Of Art)
        Set(ByVal Value As List(Of Art))
            mArts = Value
            mEmp = mArts(0).Emp
    ...
    Private Function CreateTable(ByVal oKeys As List(Of Art)) As DataTable
        ...
        For Each oArt In mArts
            ...
            oImg = BLL.GetThumbnailToFit(oArt.Image, 48, 48)
