...
Public Class Xl_Fiscal_Irpf
    ...
    Private Sub Do_Excel()
        ...
        Dim oExcelSheet As New ExcelHelper.Sheet(sTitle)
        ...
        With oExcelSheet
            ...
            .AddColumn("Perceptors", ExcelHelper.Sheet.NumberFormats.Integer)
            .AddColumn("Base", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("Quota", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("Base", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("Quota", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("Previsió", ExcelHelper.Sheet.NumberFormats.Euro)
        End With
