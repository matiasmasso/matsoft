Public Class Xl_ProductCategories
    ...
    'Dim oSortOrder = Await FEB2.UserDefaults.GetInt(exs, Current.Session.User, DTOUserDefault.Cods.ProductCategoriesOrder)
    ...
    Private Async Sub Do_SortOrderAlfabetic()
        ...
        If Await FEB2.UserDefaults.SetValue(exs, Current.Session.User, DTOUserDefault.Cods.ProductCategoriesOrder, CInt(DTOProductCategory.SortOrders.Alfabetic)) Then
    ...
    Private Async Sub Do_SortOrderCustom()
        Dim exs As New List(Of Exception)
        If Await FEB2.UserDefaults.SetValue(exs, Current.Session.User, DTOUserDefault.Cods.ProductCategoriesOrder, CInt(DTOProductCategory.SortOrders.Custom)) Then
            ...
            If hit.Type <> DataGridViewHitTestType.None Then
                ...
                If _dragRow >= 0 Then
                    ...
                    If targetRow <> _dragRow Then
                        ...
                        Dim exs As New List(Of Exception)
                        If Not Await FEB2.ProductCategories.Move(exs, itemsToSort) Then
