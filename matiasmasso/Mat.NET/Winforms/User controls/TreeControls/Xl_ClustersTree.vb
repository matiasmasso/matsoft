Public Class Xl_ClustersTree
        ...
        If oNode IsNot Nothing Then
            If oNode.Tag IsNot Nothing Then
                ...
                ElseIf TypeOf oNode.Tag Is DTOCustomer Then
                    ...
                    Dim oMenu_Customer As New Menu_Contact(oCustomer)
    ...
    Private Sub Xl_ClustersTree_NodeMouseClick(sender As Object, e As TreeNodeMouseClickEventArgs) Handles Me.NodeMouseClick
        SetContextMenu()
    End Sub
