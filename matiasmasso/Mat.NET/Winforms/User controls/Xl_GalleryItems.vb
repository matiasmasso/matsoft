Public Class Xl_GalleryItems
    ...
    Private Async Sub DataGridView1_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles DataGridView1.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.Image
                Dim oRow As DataGridViewRow = DirectCast(sender, DataGridView).Rows(e.RowIndex)
                Dim oControlItem As ControlItem = oRow.DataBoundItem
                Dim oGalleryItem = oControlItem.Source
                Dim exs As New List(Of Exception)
                Dim oImage = Await FEB2.GalleryItem.Thumbnail(oGalleryItem.Guid, 70, 70, exs)
                e.Value = oImage
        End Select
    End Sub
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oGalleryItem As DTOGalleryItem)
            ...
            With oGalleryItem
                ...
                _Features = DTOGalleryItem.MultilineText(oGalleryItem)
            End With
        End Sub
