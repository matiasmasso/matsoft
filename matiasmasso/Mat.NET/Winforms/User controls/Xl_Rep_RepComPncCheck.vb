Public Class Xl_Rep_RepComPncCheck
    ...
    Private Async Sub ButtonStart_Click(sender As Object, e As EventArgs) Handles ButtonStart.Click
        ...
        _RepProducts = Await FEB2.RepProducts.All(exs, Current.Session.Emp, , True)
        If exs.Count = 0 Then
            _LiniesDeComandaPendentsDeLiquidar = Await FEB2.PurchaseOrderItems.PendentsDeLiquidacioRep(exs, Current.Session.Emp)
            If exs.Count = 0 Then
                PanelBottomBar.Visible = False
                _RepCliComs = Await FEB2.RepCliComs.All(exs, Current.Session.Emp)
                If exs.Count = 0 Then
    ...
    Private Async Function LoadConflictes() As Task
        ...
        For Each oItem As DTOPurchaseOrderItem In _LiniesDeComandaPendentsDeLiquidar
            Dim oSuggestedRepCom = Await FEB2.PurchaseOrderItem.SuggestedRepCom(exs, GlobalVariables.Emp, oItem, _RepProducts, _RepCliComs)
    ...
    Private Async Sub ButtonSincronitza_Click(sender As Object, e As EventArgs) Handles ButtonSincronitza.Click
        ...
        Await FEB2.RepComLiquidables.sincronitza(exs)
    ...
    Protected Class ControlItem
        ...
        Public Async Function SubmitChanges(exs As List(Of Exception)) As Task(Of Boolean)
            ...
            Dim retval = Await FEB2.PurchaseOrderItem.UpdateRepCom(exs, _LineItmPnc)
