Public Class Xl_AreaProvincias
    ...
    Private _Values As List(Of DTOAreaProvincia)
    ...
    Public Shadows Sub Load(values As List(Of DTOAreaProvincia), Optional oDefaultValue As DTOAreaProvincia = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
        _Values = values
    ...
    Private Sub Refresca()
        _AllowEvents = False
        Dim oFilteredValues As List(Of DTOAreaProvincia) = FilteredValues()
        _ControlItems = New ControlItems
        For Each oItem As DTOAreaProvincia In oFilteredValues
    ...
    Private Function FilteredValues() As List(Of DTOAreaProvincia)
        Dim retval As List(Of DTOAreaProvincia)
        If _Filter = "" Then
            retval = _Values
        Else
    ...
    Private Sub SetProperties()
        ...
        'MyBase.RowAreaProvincia.DefaultCellStyle.BackColor = Color.Transparent
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        If oCurrentControlItem IsNot Nothing Then
            Dim oSelectedValue As DTOAreaProvincia = CurrentControlItem.Source
            Select Case _SelectionMode
                Case DTO.Defaults.SelectionModes.Browse
                    Dim oFrm As New Frm_AreaProvincia(oSelectedValue)
