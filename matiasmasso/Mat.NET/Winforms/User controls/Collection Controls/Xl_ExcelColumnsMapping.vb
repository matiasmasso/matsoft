...
Public Class Xl_ExcelColumnsMapping
    ...
    Public Shadows Function Load(sFields As List(Of String), oSheet As ExcelHelper.Sheet) As DTOTaskResult
    ...
    Public ReadOnly Property Sheet As ExcelHelper.Sheet
        Get
            Dim retval As New ExcelHelper.Sheet
            Dim oCombo As DataGridViewComboBoxColumn = MyBase.Columns(Cols.Result)
            For Each oSrcRow As ExcelHelper.Row In _Sheet.Rows
    ...
    Function Results() As List(Of String)
        ...
        For Each oCell As ExcelHelper.Cell In _Sheet.Rows(0).Cells
