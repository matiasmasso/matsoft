Public Class Xl_SkuPmcs
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTODeliveryItem, ByRef iStk As Integer, ByRef DcInventari As Decimal, ByRef DcPreuMigDeCost As Decimal)
            MyBase.New()
            _Source = value
            ...
            Dim DcEur As Decimal = value.Price.Eur
            Dim DcDto As Decimal = value.Dto
            Dim oDto As DTOAmt = value.Price.Percent(DcDto)
            Dim oNet As DTOAmt = value.Price.Substract(oDto)
            ...
            With value
                _Alb = .Delivery.Id
                _Fch = .Delivery.Fch
                _Nom = .Delivery.Customer.FullNom
