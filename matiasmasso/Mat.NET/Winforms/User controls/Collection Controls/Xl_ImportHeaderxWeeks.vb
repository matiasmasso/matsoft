Public Class Xl_ImportHeaderxWeeks
    ...
    Private Sub Refresca()
        _AllowEvents = False
        Dim oFilteredValues As List(Of DTOImportacio) = FilteredValues()
    ...
    Private Function FilteredValues() As List(Of DTOImportacio)
        Dim retval As List(Of DTOImportacio)
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) x.Proveidor.Nom.ToLower.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
    ...
    Private Function SelectedItems() As List(Of DTOImportacio)
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Importacio As New Menu_Importacio(SelectedItems.First)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        If oCurrentControlItem IsNot Nothing Then
            Dim oSelectedValue As DTOImportacio = CurrentControlItem.Source
    ...
    Private Sub Xl_ImportHeaderxWeeks_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles Me.RowPrePaint
        Dim oRow As DataGridViewRow = MyBase.Rows(e.RowIndex)
        If oRow IsNot Nothing Then
            Dim oControlItem As ControlItem = oRow.DataBoundItem
            If oControlItem.Fch < Today Then
    ...
    Protected Class ControlItem
        Property Source As DTOImportacio
        ...
        Public Sub New(value As DTOImportacio)
            MyBase.New()
            _Source = value
            With value
                _Week = .Week
