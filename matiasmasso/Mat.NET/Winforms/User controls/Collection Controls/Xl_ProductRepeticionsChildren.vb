Public Class Xl_ProductRepeticionsChildren
    ...
    Private Sub Refresca()
        _AllowEvents = False
        Dim oFilteredValues As List(Of DTORepeticio) = FilteredValues()
        _ControlItems = New ControlItems
        For Each oItem As DTORepeticio In oFilteredValues
    ...
    Public ReadOnly Property Value As DTORepeticio
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTORepeticio = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As List(Of DTORepeticio)
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Repeticio As New Menu_Contact(SelectedItems.First)
            AddHandler oMenu_Repeticio.AfterUpdate, AddressOf RefreshRequest
            oContextMenu.Items.AddRange(oMenu_Repeticio.Range)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        If oCurrentControlItem IsNot Nothing Then
            Dim oSelectedValue As DTORepeticio = CurrentControlItem.Source
    ...
    Protected Class ControlItem
        Property Source As DTORepeticio
        ...
        Public Sub New(value As DTORepeticio)
            MyBase.New()
            _Source = value
            With value
                _Orders = .Orders
