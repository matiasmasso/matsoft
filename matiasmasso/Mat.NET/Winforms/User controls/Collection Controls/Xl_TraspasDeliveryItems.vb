Public Class Xl_TraspasDeliveryItems
    ...
    Public Shadows Sub Load(values As List(Of DTODeliveryItem), Optional oDefaultValue As DTODeliveryItem = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Private Function FilteredValues() As List(Of DTODeliveryItem)
        Dim retval As List(Of DTODeliveryItem)
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) (x.Sku.Nom.ToLower.Contains(_Filter.ToLower) Or x.Sku.Category.Nom.ToLower.Contains(_Filter.ToLower)))
        End If
        Return retval
    End Function
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTODeliveryItem)
            ...
            _Source = value
            With value
                _brand = .Sku.Category.Brand.Nom
                _category = .Sku.Category.Nom
                _Nom = .Sku.NomCurt
                _Qty = .Qty
            End With
        End Sub
