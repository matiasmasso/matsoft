Public Class Xl_BookFras
    ...
    Private Async Sub Do_SyncPeriod()
        ...
        If exs.Count = 0 Then
            ...
            Dim oConsultats As List(Of DTOSiiConsulta) = FEB2.Bookfras.Consulta(Current.Session.Emp, DTO.Defaults.Entornos.Produccion, oX509Cert, oExercici, iMes, exs)
            For Each oBookFra In oBookfras
                ...
                If oConsultat IsNot Nothing Then
                    ...
                    End With
                    If Not Await FEB2.BookFra.Update(exs, oBookFra) Then
