Public Class Xl_ImportPrevisio
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            ...
            End If
        End If
        oContextMenu.Items.Add("eliminar linea", Nothing, AddressOf Do_DeleteLine)
    ...
    Private Async Sub Do_ExportXMLSelected()
        ...
        oImportacio = Await FEB2.ImportPrevisions.Load(exs, oImportacio)
        If exs.Count = 0 Then
    ...
    Private Async Sub Do_ExportXML(oPrevisions As List(Of DTOImportPrevisio))
        ...
        Dim XmlSrc As String = FEB2.ImportPrevisions.AvisCamionXml(oPrevisions, exs)
            ...
            Case Cols.Ref, Cols.Txt
                If _LastSkuEntered IsNot Nothing Then
                    ...
                    If oControlItem IsNot Nothing Then
                        ...
                        Else
                            Dim oPncs = Await FEB2.PurchaseOrderItems.Pending(exs, GlobalVariables.Emp, value.Sku, DTOPurchaseOrder.Codis.Proveidor)
                            If exs.Count = 0 Then
