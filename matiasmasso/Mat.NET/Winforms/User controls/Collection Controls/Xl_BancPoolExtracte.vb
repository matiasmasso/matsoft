Public Class Xl_BancPoolExtracte
    ...
    Public ReadOnly Property Value As DTOBancPool
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTOBancPool = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As List(Of DTOBancPool)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        If oCurrentControlItem IsNot Nothing Then
            Dim oSelectedValue As DTOBancPool = CurrentControlItem.Source
            Dim oFrm As New Frm_BancPool(oSelectedValue)
    ...
    Protected Class ControlItem
        Property Source As DTOBancPool
