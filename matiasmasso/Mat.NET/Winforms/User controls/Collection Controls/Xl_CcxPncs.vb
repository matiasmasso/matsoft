...
Public Class Xl_CcxPncs
    ...
    Private Sub Do_Excel()
        Dim oSheet As New ExcelHelper.Sheet("Pedidos pendientes")
        With oSheet
            .AddColumn("Centro", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Pedido", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Fecha", ExcelHelper.Sheet.NumberFormats.DDMMYY)
            .AddColumn("Producto", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Unidades", ExcelHelper.Sheet.NumberFormats.Integer)
        End With
    ...
    Private Async Sub Do_DeletePncs()
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.PurchaseOrderItems.Delete(exs, oSelectedValues) Then
