Public Class Xl_UsuariComments
    ...
    Public Shadows Sub Load(values As List(Of DTOPostComment), Optional oDefaultValue As DTOPostComment = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oPostComment As DTOPostComment, oLang As DTOLang)
            MyBase.New()
