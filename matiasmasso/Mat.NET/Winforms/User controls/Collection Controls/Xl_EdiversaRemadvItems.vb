Public Class Xl_EdiversaRemadvItems
    ...
    Public Shadows Async Function Load(value As List(Of DTOEdiversaRemadvItem)) As Task
        _ControlItems = New ControlItems
        For Each oItem As DTOEdiversaRemadvItem In value
    ...
    Public ReadOnly Property Value As DTOEdiversaRemadvItem
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTOEdiversaRemadvItem = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As List(Of DTOEdiversaRemadvItem)
        Dim retval As New List(Of DTOEdiversaRemadvItem)
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Private Async Function SetContextMenu() As Task
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_EdiRemadvItem As New Menu_EdiversaRemadvItem(SelectedItems.First)
            AddHandler oMenu_EdiRemadvItem.AfterUpdate, AddressOf RefreshRequest
            oContextMenu.Items.AddRange(Await oMenu_EdiRemadvItem.Range)
        End If
    ...
    Protected Class ControlItem
        Public Property Source As DTOEdiversaRemadvItem
        ...
        Public Sub New(oEdiRemadvItem As DTOEdiversaRemadvItem)
            MyBase.New()
