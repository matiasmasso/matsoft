Public Class Xl_WtbolLandingPages
    ...
    Public ReadOnly Property Values As List(Of DTOWtbolLandingPage)
        Get
            Return _Values
        End Get
    End Property
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu As New Menu_WtbolLandingPage(SelectedItems.First)
    ...
    Private Sub Do_Remove()
        Dim values = SelectedItems()
        RaiseEvent RequestToRemove(Me, New MatEventArgs(values))
    End Sub
        ...
        If oCurrentControlItem IsNot Nothing Then
            ...
            Select Case _SelectionMode
                Case DTO.Defaults.SelectionModes.Browse
                    Dim oFrm As New Frm_Art(oSelectedValue.Product)
        ...
        Public Sub New(value As DTOWtbolLandingPage)
            ...
            With value
                ...
                If TypeOf .Product Is DTOProductSku Then
                    ...
                    _Sku = oSku.nom.Tradueix(Current.Session.Lang)
                    _Stk = oSku.Stock
                    If oSku.RRPP IsNot Nothing Then
                        _Price = oSku.RRPP.Eur
                    End If
                End If
            End With
        End Sub
