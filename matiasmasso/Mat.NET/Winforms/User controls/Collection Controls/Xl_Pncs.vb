Public Class Xl_Pncs
    ...
    Private Function FilteredValues() As List(Of DTOPurchaseOrderItem)
        ...
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) x.sku.nom.Contains(_Filter.ToLower) Or x.purchaseOrder.contact.FullNom.ToLower.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOPurchaseOrderItem)
            ...
            With value
                ...
                Dim oAmt As DTOAmt = .PendingAmount
