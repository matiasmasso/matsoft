Public Class Xl_EdiversaOrdersSkus
    ...
    Private Sub Do_Excel()
        ...
        Dim oExcel As New MatHelperStd.ExcelHelper.Sheet
    ...
    Private Sub Xl_EdiversaOrdersSkus_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles Me.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.Stock
                ...
                Dim oControlItem As ControlItem = oRow.DataBoundItem
                e.CellStyle.BackColor = LegacyHelper.ImageHelper.Converter(DTOProductSku.BackColor(oControlItem.Stock, oControlItem.Qty + oControlItem.Pn2))
        End Select
    End Sub
