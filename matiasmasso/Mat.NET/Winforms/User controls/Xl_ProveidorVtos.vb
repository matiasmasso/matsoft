...
Public Class Xl_ProveidorVtos
    ...
    Public Function Excel(sTitle As String, oLang As DTOLang) As ExcelHelper.Sheet

        Dim retval As New ExcelHelper.Sheet(sTitle)
        With retval
            .AddColumn("Deutor/Creditor", ExcelHelper.Sheet.NumberFormats.PlainText)
            .AddColumn("Eur", ExcelHelper.Sheet.NumberFormats.Euro)
            ...
            .AddColumn("Status", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Observacions", ExcelHelper.Sheet.NumberFormats.PlainText)
        End With

        If _ControlItems.Count > 0 Then

            For Each oControlItem In _ControlItems
                Dim oRow = New ExcelHelper.Row(retval)
