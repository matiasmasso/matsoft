Public Class Xl_PurchaseOrderDeliveryItems
    ...
    Public Shadows Sub Load(values As List(Of DTODeliveryItem), Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
        _ControlItems = New ControlItems
        For Each oItem As DTODeliveryItem In values
        ...
        Public Sub New(value As DTODeliveryItem)
            ...
            With value
                ...
                If .Delivery.Invoice IsNot Nothing Then
                    _fra = .Delivery.Invoice.Num
                End If
                _Sku = .purchaseOrderItem.sku.nomLlarg.Tradueix(Current.Session.Lang)
                _Qty = .Qty
