Public Class Xl_Reps
    ...
    Public Shadows Sub Load(values As List(Of DTORep), Optional oDefaultRep As DTORep = Nothing, Optional oMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
        _Mode = oMode
