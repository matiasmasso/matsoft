Public Class Xl_ProductsOld
    ...
    Public Shadows Sub Load(value As Products)
        _ControlItems = New ControlItems
        For Each oItem As Product In value
    ...
    Public ReadOnly Property Value As Product
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As Product = oControlItem.Source
            Return retval
        End Get
    End Property

    Public ReadOnly Property Values As Products
        Get
    ...
    Private Function SelectedItems() As Products
        Dim retval As New Products
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
            retval.Add(oControlItem.Source)
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Product As New Menu_Product_Old(SelectedItems.First)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oSelectedValue As Product = CurrentControlItem.Source
    ...
    Protected Class ControlItem
        Public Property Source As Product
