Public Class Xl_PriceList_Customers_Vigent_Old
    ...
    Public Shadows Sub Load(DtFch As Date)
    ...
    Private Sub LoadGrid()
        Dim SQL As String = "SELECT ART.Guid, P1.Guid AS P1Guid, TPA.DSC AS Brand, STP.dsc AS Category, ART.ord, P2.Retail, P1.Fch " _
