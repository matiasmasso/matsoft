...
Public Class Xl_Asnef_Consultas
    ...
    Private Sub LoadGrid1()
        ...
        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@EMP", mEmp.Id)
    ...
    Private Sub LoadGrid2()
        ...
        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@EMP", mEmp.Id, "@YEA", iYea, "@MES", iMes)
        Dim oTb As DataTable = oDs.Tables(0)
