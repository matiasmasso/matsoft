Public Class Xl_MailingParameters
    ...
    Public Shadows Sub Load(value As List(Of MailingParameter))
    ...
    Public ReadOnly Property Values As List(Of MailingParameter)
        Get
            Dim retval As New List(Of MailingParameter)
    ...
    Private Function SelectedItems() As List(Of MailingParameter)
        Dim retval As New List(Of MailingParameter)
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
            retval.Add(oControlItem.Source)
