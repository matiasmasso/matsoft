...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents Xl_ContactPlatform As Winforms.Xl_Contact2
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Xl_LookupHolding1 = New Winforms.Xl_LookupHolding()
        Me.Xl_ContactPlatform = New Winforms.Xl_Contact2()
        Me.Xl_FormaDePago1 = New Winforms.Xl_FormaDePago()
        Me.Xl_Adr1 = New Winforms.Xl_Address()
        Me.Xl_ContactCcx = New Winforms.Xl_Contact2()
        Me.Xl_LookupCustomerCluster1 = New Winforms.Xl_LookupCustomerCluster()
        ...
        Me.Label11.Location = New System.Drawing.Point(247, 254)
        ...
        '
        Me.ComboBoxPortsCondicions.Anchor = CType((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        Me.ComboBoxPortsCondicions.FormattingEnabled = True
        Me.ComboBoxPortsCondicions.Location = New System.Drawing.Point(311, 254)
        ...
        Me.ComboBoxPortsCondicions.Size = New System.Drawing.Size(184, 21)
        ...
        Me.ComboBoxPorts.Location = New System.Drawing.Point(96, 254)
        ...
        Me.CheckBoxHorarioEntregas.Text = "Horaris entr."
        '
...
#End Region
    ...
    Public Shadows Async Sub load(oCustomer As DTOCustomer)
        ...
        With _Customer
            ...
            'Xl_CustomerSegment1.Load(.Cluster)
            CheckBoxValorarAlbarans.Checked = .AlbValorat
            Await SetPortsCondicions(.PortsCondicio)
            ...
            Dim oAddress As DTOAddress = Await FEB2.Address.Find(oCustomer, DTOAddress.Codis.Entregas, exs)
            If exs.Count = 0 Then
    ...
    Public ReadOnly Property Customer As DTOCustomer
        Get
            With _Customer
                ...
                '.Cluster = Xl_CustomerSegment1.Value
                ...
                .PortsCondicio = ComboBoxPortsCondicions.SelectedIndex
    ...
    Private Async Function SetPortsCondicions(ByVal oCondicions As DTOCustomer.PortsCondicions) As Task
        Dim exs As New List(Of Exception)
        Dim oPortsCondicions As List(Of DTOPortsCondicio) = Await FEB2.PortsCondicions.All(exs)
        If ComboBoxPortsCondicions.Items.Count = 0 Then
            With ComboBoxPortsCondicions
                .DataSource = oPortsCondicions
                .DisplayMember = "Nom"
            End With
        End If
        ComboBoxPortsCondicions.SelectedItem = oPortsCondicions.FirstOrDefault(Function(x) x.id = oCondicions)
    End Function
    ...
    Private Async Sub RefreshCredit(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim oCreditLimit = Await FEB2.Risc.CreditLimit(_Customer, exs)
        ...
        Dim oCreditDisposat = Await FEB2.Risc.CreditDisposat(_Customer, exs)
        If exs.Count = 0 Then
        ...
        Dim oCreditDisponible = Await FEB2.Risc.CreditDisponible(_Customer, exs)
        If exs.Count = 0 Then
