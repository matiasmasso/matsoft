Public Class Xl_Zip_Contacts
    ...
    Public WriteOnly Property Zip As DTOZip
        Set(value As DTOZip)
            _Zip = value
            LoadGrid()
        End Set
    ...
    Private Sub LoadGrid()
        ...
        & "WHERE        CliAdr.Zip = @Zip AND CliGral.Emp=@Emp " _
        & "ORDER BY CLX.ex, CliAdr.adr"

        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@Zip", _Zip.Guid.ToString, "@Emp", BLLApp.Emp.Id)
