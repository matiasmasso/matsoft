...
#End Region
    ...
    Private Sub refresca()
        ...
        For Each oMMC In _MMC.Children
            If oMMC.Cod = DTOWinMenuItem.Cods.Item Then
    ...
    Private Sub refresca_Staff()
        ...
        For Each oStaff As DTOStaff In oStaffs
            ...
            With itm
                If Not oStaff.Avatar Is Nothing Then
                    'SmallImageList.Images.Add(oStaff.Img48)
                    LargeImageList.Images.Add(oStaff.Avatar)
                    .ImageIndex = ImgIdx
                    ImgIdx = ImgIdx + 1
                End If
            End With
        ...
        If ListView1.SelectedItems.Count > 0 Then
            ...
            Select Case _MMC.Tag
                ...
                Case "STAFF"
                    ...
                    If BLL.BLLSession.Current.User.Rol.IsAdmin Or BLL.BLLSession.Current.User.Rol.Id = DTORol.Ids.Accounts Then
                        oMenu.Items.Add("-")
    ...
    Private Sub Do_Models145()
        Dim oItm As MaxiSrvr.ListViewItmObj = ListView1.SelectedItems(0)
        Dim oStaff As DTOStaff = CType(oItm.Obj, DTOStaff)
