...
Public Class Xl_ContactCtas
    ...
    Private Sub LoadCtas()
        Dim SQL As String = "SELECT Ccb.CtaGuid,PgcCta.Id AS Cta,'',PGCCTA.ESP,PGCCTA.CAT,PGCCTA.ENG, " _
        ...
        SQL = SQL & "GROUP BY Ccb.CtaGuid,PgcCta.Id,PGCCTA.ESP,PGCCTA.CAT,PGCCTA.ENG,PGCCTA.COD " _
        & "ORDER BY PgcCta.Id"
