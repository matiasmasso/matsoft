...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Xl_ContactFiscal = New Winforms.Xl_Contact2()
        Me.GroupBoxFacturacio = New System.Windows.Forms.GroupBox()
        Me.Xl_RepProductsTree1 = New Winforms.Xl_RepProductsTree()
        ...
        'Xl_Image1
        '
        Me.Xl_Image1.Anchor = DirectCast((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Right), System.Windows.Forms.AnchorStyles)
        ...
        'Xl_IBAN1
        '
        Me.Xl_IBAN1.Anchor = DirectCast((System.Windows.Forms.AnchorStyles.Bottom Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
        ...
        Me.Xl_RepProductsTree1.Size = New System.Drawing.Size(286, 253)
...
#End Region
    ...
    Public Shadows Async Function Load(oRep As DTORep) As Task
        ...
        _Rep = oRep
        If FEB2.Contact.Load(_Rep, exs) Then
            With _Rep
                ...
                Dim oIban = Await FEB2.Iban.FromContact(exs, _Rep, DTOIban.Cods.Proveidor)
                If exs.Count = 0 Then
                ...
                Xl_Image1.Bitmap = LegacyHelper.ImageHelper.Converter(Await FEB2.Rep.Foto(exs, _Rep))
            End With
    ...
    Public ReadOnly Property Rep As DTORep
        Get
            With _Rep
                ...
                End If
                .foto = LegacyHelper.ImageHelper.Converter(Xl_Image1.Bitmap)
            End With
            Return _Rep
        End Get
    End Property
    ...
    Private Async Function refrescaRepProducts() As Task
        Dim exs As New List(Of Exception)
        Dim oRepProducts = Await FEB2.RepProducts.All(exs, Current.Session.Emp, _Rep, True)
        If exs.Count = 0 Then
    ...
    Private Async Sub RefreshIban(sender As Object, e As MatEventArgs)
        Dim exs As New List(Of Exception)
        Dim oContact As DTOContact = New DTOContact(_Rep.Guid)
        Dim oIban = Await FEB2.Iban.FromContact(exs, oContact, DTOIban.Cods.Proveidor)
        If exs.Count = 0 Then
            Await Xl_IBAN1.Load(oIban)
        Else
            UIHelper.WarnError(exs)
    ...
    Private Async Sub Xl_RepProducts1_RequestToAddNew(sender As Object, e As MatEventArgs)
        Dim exs As New List(Of Exception)
        Dim oRep = Await FEB2.Rep.Find(_Rep.Guid, exs)
        If exs.Count = 0 Then
