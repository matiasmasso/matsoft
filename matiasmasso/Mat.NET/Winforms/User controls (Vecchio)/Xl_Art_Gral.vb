...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        'PictureBox1
        '
        Me.PictureBox1.Image = Global.Winforms.My.Resources.Resources.package
        ...
        'PictureBox2
        '
        Me.PictureBox2.Image = Global.Winforms.My.Resources.Resources.warn_16
...
#End Region
            ...
            With _Sku
                ...
                If exs.Count = 0 Then
                    If _Sku.Image IsNot Nothing Then
                        If _Sku.Image.Height > PictureBoxImg.Height Or _Sku.Image.Width > PictureBoxImg.Width Then
                        ...
                        End If
                    End If
                    PictureBoxImg.Image = LegacyHelper.ImageHelper.Converter(_Sku.image)
                Else
    ...
    Private Sub SetWarning()
        If _Sku.Availability > Today Then
    ...
    Private Sub SetMgz()
        ...
        Dim sTmp As String = ""
        LabelStk.BackColor = LegacyHelper.ImageHelper.Converter(DTOProductSku.BackColor(_Sku))
    ...
    Private Async Function LoadMgzs() As Task
        Dim exs As New List(Of Exception)
        Dim oMgzs = Await FEB2.Mgzs.All(_Sku, exs)
        If exs.Count = 0 Then
            With ComboBoxMgz
                .DisplayMember = "nom"
    ...
    Private Async Function RefrescaChannels() As Task
        Dim exs As New List(Of Exception)
        Dim oProductChannels = Await FEB2.ProductChannels.All(exs, _Sku)
        If exs.Count = 0 Then
