Public Class Xl_Arts
    ...
    Private Sub SetContextMenu()
        ...
        Dim oProduct As DTOProduct = CurrentProduct()
    ...
    Private Sub MenuItemArt_Remove(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Select Case _Related
            ...
            Case DTO.DTOProduct.Relateds.Spares
                sRel = "recanvi"
        End Select
        Dim s As String = BLLProduct.Nom(oProduct) & vbCrLf & "el treiem de " & sRel & " de " & mSrcNom & "?" & vbCrLf & "aixó no l'esborrará del cataleg"
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        ...
        If TypeOf oProduct Is DTOProductBrand Then
            Dim oFrm As New Frm_Tpa(oProduct)
            AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
            oFrm.Show()
        ElseIf TypeOf oProduct Is DTOProductCategory Then
            Dim oFrm As New Frm_Stp(oProduct, BLL.Defaults.SelectionModes.Browse)
            AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
            oFrm.Show()
        Else
            Dim oFrm As New Frm_Art(oProduct)
            AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
            oFrm.Show()
        End If
    End Sub
