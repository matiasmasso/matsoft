Public Class Xl_Contact
    ...
    Public Property Contact() As MaxiSrvr.Contact
        Get
            Return _Contact
        End Get
        Set(ByVal Value As MaxiSrvr.Contact)
            _Contact = Value
            Display()
            _AllowEvents = True
        End Set
    ...
    Private Function ValidateContact() As Boolean
        ...
        ElseIf sKey = "" Then
            ...
            retval = True
        Else
            _Contact = Finder.FindContact(sKey)
    ...
    Private Sub ContactFound(ByVal sender As Object, ByVal e As System.EventArgs)
        _Contact = CType(sender, Contact)
        Display()
        RaiseEvent AfterUpdate(_Contact, New System.EventArgs)
    End Sub
    ...
    Private Sub RefreshRequest(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Else
            'refresca el mateix
            Try
                _Contact = MaxiSrvr.Contact.FromNum(_Contact.Id)
    ...
    Private Sub Display()
        ...
        Else
            TextBox1.Text = _Contact.Clx
            _DefaultBackColor = _Contact.BackColor
            TextBox1.BackColor = _DefaultBackColor
            WarnWrongMail(Not Emails.ExistFromContact(_Contact))
        ...
        Select Case e.KeyCode
            Case Keys.Enter, Keys.Return
                If Not _Contact Is Nothing Then
                    If _Contact.Clx = TextBox1.Text And Not (_Contact.Guid = Nothing And _Contact.Id = 0) Then
    ...
    Private Sub Do_Autocomplete()
        Dim oArray As ArrayList = MaxiSrvr.Contacts.AutoCompleteString(TextBox1.Text)
    ...
    Private Sub SetMenuItems()
        ...
        If _Contact IsNot Nothing Then
            Dim oMenuContact As New Menu_Contact(_Contact.ToDTO)
    ...
    Private Sub AddNew(ByVal sender As Object, ByVal e As System.EventArgs)
        '_Contact = New Contact(BLL.BLLApp.Emp)
        ' _Contact.Address = New DTOAddress()
        '_Contact.Address.Src = New DTOContact(_Contact.Guid)
        '_Contact.Address.Codi = DTOAddress.Codis.Fiscal
        'Dim oFrm As New Frm_Contact(_Contact)
        'AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
        'oFrm.Show()
    ...
    Private Sub AfterCreate(sender As Object, e As MatEventArgs)
        ...
        Me.Contact = Contact.FromDTO(oContact)
...
#Region "DragDrop"
    ...
    Private Sub TextBox1_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles TextBox1.DragDrop
        ...
        If DragDropHelper.GetDroppedDocFiles(e, oDocFiles, exs) Then
            root.ShowFileImport(oDocFiles.First, _Contact.ToDTO)
        Else
