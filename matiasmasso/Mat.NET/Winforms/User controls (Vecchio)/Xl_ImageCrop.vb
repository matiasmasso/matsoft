Public Class Xl_ImageCrop
    ...
    Public Shadows Sub Load(oImage As Image)
        _ThumbnailSource = LegacyHelper.ImageHelper.GetThumbnailToFit(oImage, PictureBox1.Width, PictureBox1.Height)
    ...
    Private Sub PictureBox1_MouseMove(sender As Object, e As MouseEventArgs) Handles PictureBox1.MouseMove
        If e.Button = System.Windows.Forms.MouseButtons.Left And _ThumbnailSource IsNot Nothing Then
