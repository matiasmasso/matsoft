...
Public Class Xl_PrRevista_PropertyPage
    ...
    Public Sub New(ByVal oMode As Modes, ByVal oRevista As PrRevista, Optional ByVal oNumero As PrNumero = Nothing)
        ...
        If oNumero IsNot Nothing Then
            ...
            LoadNumeros()
            'TODO: selecciona numero per defecte oNumero
        End If
        mallowevents = True
    End Sub
    ...
    Private Function CurrentTarifa() As PrTarifa
        ...
        'Dim oRow As DataGridViewRow = Xl_PrNumeros1.value.
    ...
    Private Sub Xl_PrNumeros1_RequestToAddNew(sender As Object, e As MatEventArgs) Handles Xl_PrNumeros1.RequestToAddNew
        ...
        AddHandler oFrm.AfterUpdate, AddressOf LoadNumeros
        oFrm.Show()
    End Sub

    Private Sub Xl_PrNumeros1_RequestToRefresh(sender As Object, e As MatEventArgs) Handles Xl_PrNumeros1.RequestToRefresh
        LoadNumeros()
    End Sub
End Class
