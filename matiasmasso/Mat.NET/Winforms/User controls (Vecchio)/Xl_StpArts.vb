Public Class Xl_StpArts
    ...
    Private Sub SetContextMenu()
        ...
        oContextMenu.Items.Add("Afegir pack", Nothing, AddressOf Do_AddPack)
        ...
        Select Case e.ColumnIndex
            Case Cols.Pn1
                ...
                Else
                    ...
                    'If oArtForDisplay.Id = 21410 Then Stop
    ...
    Public Function Do_AddPack()
        Dim oSku As New DTOProductSku
        With oSku
            .Virtual = True
            .Category = New DTOProductCategory(_Stp.Guid)
            .Category.Nom = _Stp.Nom
            .Category.Brand = New DTOProductBrand(_Stp.Tpa.Guid)
            .Category.Brand.Nom = _Stp.Tpa.Nom
        End With
        Dim oFrm As New Frm_ProductPack(oSku)
        AddHandler oFrm.afterupdate, AddressOf RefreshRequestArts
        oFrm.show
    End Function
