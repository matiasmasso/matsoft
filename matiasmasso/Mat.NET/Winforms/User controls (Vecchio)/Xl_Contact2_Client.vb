...
Public Class Xl_Contact2_Client
    ...
    Public Sub New(ByVal oContact As Contact)
        ...
        With mClient
            ...
            Xl_FormaDePago1.LoadFromContact(DTOIban.Cods.Client, oContact, .FormaDePago)
 ...
 _
    ...
    Private Sub ButtonDtoFixe_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonDtoFixe.Click
        ...
        Dim oFrm As New Frm_CliDtos(oCustomer)
        AddHandler oFrm.AfterUpdate, AddressOf AfterDtosUpdate
        oFrm.Show()
    End Sub

    Private Sub AfterDtosUpdate(ByVal sender As Object, ByVal e As MatEventArgs)
        Dim oCustomer As DTOCustomer = e.Argument
        If mDto <> oCustomer.GlobalDto Then
            mDto = oCustomer.GlobalDto
            SetDirtyGral()
        End If
    End Sub
