...
Public Class Xl_AlbsReembols
    ...
    Private mSelAmt As DTOAmt = BLLApp.EmptyAmt
        ...
        Get
            ...
            For i = 0 To oTb.Rows.Count - 1
                ...
                If oRow(Cols.Chk) Then
                    Dim oGuid As Guid = oRow("AlbGuid")
    ...
    Public ReadOnly Property Amt() As DTOAmt
        Get
            Return mSelAmt
        End Get
    End Property
    ...
    Private Sub LoadGrid()
        Dim SQL As String = "SELECT CAST(0 AS BIT) AS CHECKED, ALB.yea, ALB.alb, ALB.fch, (ALB.Pts + ALB.Pt2) AS Eur, ALB.nom, CIT.CIT, Alb.Guid " _
        ...
        mDs = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@EMP", BLLApp.Emp.Id, "@TRP", mTransportista.Id, "@CASHCOD", DTO.DTOCustomer.CashCodes.Reembols)
        Dim oEur As DTOCur = DTOCur.Eur
        Dim oSum As DTOAmt = BLLApp.EmptyAmt
        Dim oTb As DataTable = mDs.Tables(0)
        Dim oRow As DataRow
        For Each oRow In oTb.Rows
            oSum.Add(BLLApp.GetAmt(oRow(Cols.Eur)))
        Next
        ...
        TextBoxTot.Text = oSum.CurFormatted
        TextBoxSel.Text = ""
