...
Partial Class Xl_AreaMultiCombo
    ...
    Private Sub InitializeComponent()
        Me.Xl_CountriesCombo1 = New Winforms.Xl_CountriesCombo()
        Me.Xl_ZonasCombo1 = New Winforms.Xl_ZonasCombo()
        Me.Xl_LocationsCombo1 = New Winforms.Xl_LocationsCombo()
        Me.Xl_ContactsCombo1 = New Winforms.Xl_ContactsCombo()
        Me.SuspendLayout()
        '
        'Xl_CountriesCombo1
        '
    ...
    End Sub
    Friend WithEvents Xl_CountriesCombo1 As Winforms.Xl_CountriesCombo
    Friend WithEvents Xl_ZonasCombo1 As Winforms.Xl_ZonasCombo
    Friend WithEvents Xl_LocationsCombo1 As Winforms.Xl_LocationsCombo
    Friend WithEvents Xl_ContactsCombo1 As Winforms.Xl_ContactsCombo
