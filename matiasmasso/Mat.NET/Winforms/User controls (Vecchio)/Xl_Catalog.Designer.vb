...
Partial Class Xl_Catalog
    ...
    Private Sub InitializeComponent()
        Me.Xl_ProductBrands1 = New Winforms.Xl_ProductBrands_Vecchio()
        Me.Xl_ProductCategories1 = New Winforms.Xl_ProductCategories_Vecchio()
        Me.Xl_ProductSkus1 = New Winforms.Xl_ProductSkus_Vecchio()
        Me.SuspendLayout()
        '
        'Xl_ProductBrands1
        '
    ...
    End Sub
    Friend WithEvents Xl_ProductBrands1 As Winforms.Xl_ProductBrands_Vecchio
    Friend WithEvents Xl_ProductCategories1 As Winforms.Xl_ProductCategories_Vecchio
    Friend WithEvents Xl_ProductSkus1 As Winforms.Xl_ProductSkus_Vecchio
