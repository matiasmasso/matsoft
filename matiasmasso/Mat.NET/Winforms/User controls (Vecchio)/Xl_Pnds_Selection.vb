Public Class Xl_Pnds_Selection
    ...
    Public WriteOnly Property DataSource As List(Of Pnd)
        Set(value As List(Of Pnd))
    ...
    Public ReadOnly Property SelectedValues As List(Of Pnd)
        Get
            Dim retval As New List(Of Pnd)
    ...
    Private Function SelectedItems() As List(Of Pnd)
        Dim retval As New List(Of Pnd)
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
