...
Public Class Xl_Client_CreditLimit
    Private mClient As DTOCustomer = Nothing
    ...
    Public WriteOnly Property Client() As DTOCustomer
        Set(ByVal value As DTOCustomer)
            mClient = value
            LoadGrid()
        End Set
    End Property
    ...
    Public Sub LoadGrid()
        ...
        Dim oDs As DataSet = DAL.SQLHelper.GetDataset(SQL, New List(Of Exception), "@CliGuid", mClient.Guid.ToString)
