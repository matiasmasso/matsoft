...
Public Class Xl_DocFile_Old
    ...
    Public Shadows Sub Load(oDocFile As DTODocFile)
        ...
        If _DocFile IsNot Nothing Then
            If _DocFile.Thumbnail Is Nothing Then
                ...
                If Not FEB2.DocFile.Load(exs, _DocFile, LoadThumbnail:=True) Then
    ...
    Private Sub refresca()
        ...
        Else
            ...
            If FEB2.DocFile.Exists(_DocFile.hash, _DocFile.fch) Then
        ...
        With oDlg
            ...
            If .ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If exs.Count = 0 Then
                    ...
                    If FEB2.DocFile.Exists(_DocFile.hash, DtFch) Then
