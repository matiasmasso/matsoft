Public Class Xl_Raffles
    ...
    Private Sub Do_Excel()
        Dim oSheet = FEB2.Raffles.Excel(Me.Values)
    ...
    Private Sub Do_AddNewRaffle()
        ...
        If FEB2.Country.Load(oRaffle.Country, exs) Then
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles DataGridView1.RowPrePaint
        ...
        Dim oControlItem As ControlItem = oRow.DataBoundItem
        Dim oRaffle As DTORaffle = oControlItem.Source
        If oRaffle.Codi = DTOContestBase.Codis.Contest Then
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oRaffle As DTORaffle)
            ...
            With oRaffle
                ...
                Select Case .Codi
                    Case DTORaffle.Codis.Contest
                        'Dim oContest As DTOContest = DirectCast(oRaffle, DTOContest)
                    ...
                    Case DTORaffle.Codis.Raffle
                        'Dim oRaffle As DTORaffle = DirectCast(oRaffle, DTORaffle)
