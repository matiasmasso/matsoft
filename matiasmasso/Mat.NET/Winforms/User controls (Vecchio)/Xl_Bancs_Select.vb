...
#End Region
    ...
    Private Async Function GetBancs(oEmp As DTOEmp) As Task(Of List(Of DTOBanc))
        ...
        retval = Await FEB2.Bancs.AllActive(oEmp, exs)
        If exs.Count = 0 Then
            _Sprite = Await FEB2.Bancs.Sprite(Current.Session.Emp, exs)
            If exs.Count > 0 Then
    ...
    Private Sub refresca(Optional oSelectedBanc As DTOBanc = Nothing)
        ...
        For imageIndex As Integer = 0 To _Bancs.Count - 1
            ...
            If mMenuItemObsoletos.Checked Or (Not oBanc.obsoleto) Then
                Dim oImage = MatHelperStd.SpriteHelper.extract(_Sprite, imageIndex, _Bancs.Count)
                ImageList1.Images.Add(LegacyHelper.ImageHelper.Converter(oImage))
