Public Class Xl_Importacions2
    ...
    Public Shadows Sub Load(value As List(Of DTOImportacio))
        _ControlItems = New ControlItems
        For Each oItem As DTOImportacio In value
    ...
    Public ReadOnly Property SelectedValues As List(Of DTOImportacio)
        Get
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oControlItem As ControlItem = CurrentControlItem()
        Dim oImportacio As DTOImportacio = BLLImportacio.Find(oControlItem.Source.Guid)
...
#End Region
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oImportacio As DTOImportacio)
            ...
            Dim oCostMercancia As DTOAmt = BLLImportacio.CostMercancia(oImportacio)
            Dim oCostTransport As DTOAmt = BLLImportacio.CostTransport(oImportacio)
            With oImportacio
                _Yea = .Yea
                _Id = .Id
                _Fch = .FchETA
                If oCostMercancia IsNot Nothing Then
                    _Amt = oCostMercancia.CurFormatted
                End If
                ...
                Dim s As String = ""
                For Each oItm As DTOImportacioItem In .Items
                    If oItm.Intrastat IsNot Nothing Then
                        s = BLLIntrastat.Caption(oItm.Intrastat, BLLSession.Current.Lang)
                        Exit For
                    End If
                Next
                _Intrastat = s
