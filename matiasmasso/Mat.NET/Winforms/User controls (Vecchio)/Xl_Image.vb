...
Public Class Xl_Image
    ...
    Public Shadows Sub Load(oImage As Image, Optional restrictToWidth As Integer = 0, Optional restrictToHeight As Integer = 0, Optional Title As String = "", Optional oMime As MimeCods = MimeCods.NotSet)
        If oImage IsNot Nothing Then
            ...
            If oMime = MimeCods.NotSet Then
                _MimeCod = LegacyHelper.ImageHelper.GetImageMimeCod(oImage)
            Else
                _MimeCod = oMime
            End If
            DisplaySize()
