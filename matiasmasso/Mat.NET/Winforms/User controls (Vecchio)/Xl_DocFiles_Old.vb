Public Class Xl_DocFiles
    ...
    Private Sub SetContextMenu()
        ...
        If oItem IsNot Nothing Then
            Dim oMenu As New Menu_DocFile(oItem.Source)
    ...
    Private Sub Do_Zoom()
        ...
        If oItem IsNot Nothing Then
            Dim oDocFile As DTODocFile = oItem.Source
            BLL.BLLDocFile.Load(oDocFile, False, True)
    ...
    Private Sub Do_ZoomSpecial()
        ...
        If oItem IsNot Nothing Then
            ...
            ' Dim oMail As New DTOCorrespondencia(oSrc.SrcGuid)
            ' Dim oFrmMail As New Frm_Correspondencia(oMail)
            ' oFrmMail.Show()
            ' End Select
            'Else
