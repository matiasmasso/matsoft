Public Class Xl_PriceLists_Customers
    ...
    Public Shadows Sub Load(values As List(Of DTOPricelistCustomer), SelectionMode As DTO.Defaults.SelectionModes)
    ...
    Private Async Sub DataGridView1_DragDrop(sender As Object, e As DragEventArgs) Handles DataGridView1.DragDrop
        Dim oItems As List(Of DTOPriceListItem_Supplier) = Nothing
        If e.Data.GetDataPresent(GetType(DTOPriceListSupplier)) Then
            Dim oParent As DTOPriceListSupplier = e.Data.GetData(GetType(DTOPriceListSupplier))
        ...
        If oItems IsNot Nothing Then
            Await UpdatePriceList_Customers(oItems)
        End If
    End Sub

    Private Async Function UpdatePriceList_Customers(oPriceListItems_Supplier As List(Of DTOPriceListItem_Supplier)) As Task
        ...
        If oPriceList_Customer IsNot Nothing Then
            ...
            If rc = vbOK Then
                Dim oCommercialMargin = DTOProveidor.GetCommercialMargin

                With oPriceList_Customer
                    For Each oSupplierItem As DTOPriceListItem_Supplier In oPriceListItems_Supplier
                        Dim oCustomerItem = DTOPriceListSupplier.GetSalePrice(oSupplierItem, oPriceList_Customer, oCommercialMargin, 0)
                        ...
                        Else
                            ...
                            Else
                                ...
                                With oExistingItem
                                    If Not .Retail.Equals(oCustomerItem.Retail) Then
                                        iModificats += 1
                ...
                If Await FEB2.PriceListCustomer.Update(exs, oPriceList_Customer) Then
