...
Public Class XPSHelper
    ...
    Public Function PageWidth() As Integer
        Dim oSize As Size = mDocumentPaginator.PageSize
    ...
    Public Function GenerateThumbnail(Optional iWidth As Integer = 0, Optional iHeight As Integer = 0) As Image
        ...
        Dim targetBitmap As New RenderTargetBitmap(
            CInt(docPage.Size.Width * imageQualityRatio),
            CInt(docPage.Size.Height * imageQualityRatio),
            96 * imageQualityRatio, 96 * imageQualityRatio,
        ...
        Dim oImage As Image = System.Drawing.Image.FromStream(oStream)
        Dim retval As Image = ImageHelper.GetThumbnailToFit(oImage, iWidth, iHeight)
        Return retval
    End Function
