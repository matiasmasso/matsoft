...
Public Class SessionHelper
    ...
    Shared Async Function GetFromPreviousSession(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        Current.Session = Await FEB2.Session.NextSession(SessionHelper.PreviousSession(), exs)
    ...
    Shared Async Function GetFromLogin(oEmp As DTOEmp, exs As List(Of Exception)) As Task
        ...
        If oFrm.RequestToFbLogin Then
            ...
            If oOauthResult.IsSuccess Then
                ...
                If result IsNot Nothing Then
                    ...
                    Dim oUser = Await FEB2.User.FromEmail(exs, oEmp.trimmed, emailAdddress)
                    oFrm.User = oUser
                End If
            Else
                Stop
        ...
        If oFrm.User IsNot Nothing Then
            ...
            'FEB2.Session.UpdateSync(exs, Current.Session)
            Await FEB2.Session.Update(exs, Current.Session)
            If exs.Count = 0 Then
