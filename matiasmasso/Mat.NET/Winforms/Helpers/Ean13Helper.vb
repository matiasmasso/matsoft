Public Class Ean13Helper
    'winforms  only due to legacy system.drawing reference
...
#Region "Drawing"
    ...
    Shared Function Bitmap(src As String, Optional ByVal BlDrawDigits As Boolean = True, Optional iHeight As Integer = 40, Optional oBgGolor As Color = Nothing) As Bitmap
        SetAreaDefinition()
        Dim sPadding As String = "00000000"
        Dim sCleanDigits As String = CleanDigits(src)
        Dim s1 As String = Encoded(sCleanDigits)
        Dim s2 As String = sPadding & s1 & sPadding
        Dim retval As Bitmap = DrawData(s2, BlDrawDigits, sCleanDigits, iHeight, oBgGolor)
        Return retval
    End Function
