        ...
        With oDocFile
            Select Case .mime
                ...
                Case MimeCods.Txt
                    ...
                    .Thumbnail = LegacyHelper.ImageHelper.Converter(LegacyHelper.ImageHelper.GetThumbnailFromText(src, DTODocFile.THUMB_WIDTH, DTODocFile.THUMB_HEIGHT))
        ...
        Try
            With oDocfile
                ...
                Select Case .mime
                    ...
                    Case MimeCods.Ppt, MimeCods.Pptx
                    Case MimeCods.Docx
                        .Thumbnail = LegacyHelper.ImageHelper.Converter(WordHelper.GetImgFromWordFirstPage(.Stream, exs))
                    Case MimeCods.Xlsx
