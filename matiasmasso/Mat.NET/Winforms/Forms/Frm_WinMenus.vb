Public Class Frm_WinMenus
    ...
    Private Async Function refresca() As Task
        ...
        Dim items = Await FEB2.WinMenuItems.All(Current.Session.User, exs)
        If exs.Count = 0 Then
            Dim oTreeItems = FEB2.WinMenuItems.Tree(items)
        ...
        If e.Data.GetDataPresent("System.Windows.Forms.TreeNode", False) Then
            ...
            Select Case TargetItem.Cod
                Case DTOWinMenuItem.Cods.Folder
                    ...
                    If Await FEB2.WinmenuItem.Update(SourceItem, exs) Then
                ...
                Case DTOWinMenuItem.Cods.Item
                    If SourceItem.Cod = DTOWinMenuItem.Cods.Item Then
                        ...
                        For Each node In oFolder.Nodes
                            items.Add(node.tag)
                        Next
                        If Await FEB2.WinMenuItems.SaveOrder(items, exs) Then
                        Else
                            UIHelper.WarnError(exs)
                        End If
                    Else
