...
Public Class Frm_PgcCta
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.PgcCta.Load(_Cta, exs) Then
            With _Cta
                If .IsNew Then
                    Me.Text = "Nou compte"
                Else
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.PgcCta.Update(_Cta, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.PgcCta.Delete(_Cta, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Cta))
                Me.Close()
            Else
    ...
    Private Async Sub TextBoxId_Validating(sender As Object, e As CancelEventArgs) Handles TextBoxId.Validating
        ...
        If TextHelper.RegexMatch(sId, "^\d{5}$") Then
            Dim oCta = Await FEB2.PgcCta.FromId(_Cta.Plan, sId, exs)
            If exs.Count = 0 Then
