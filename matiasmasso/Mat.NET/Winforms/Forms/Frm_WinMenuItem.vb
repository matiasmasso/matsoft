Public Class Frm_WinMenuItem
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.WinmenuItem.Load(_WinMenuItem, exs) Then
            With _WinMenuItem
                ...
                If Not .Icon Is Nothing Then Xl_ImageBig.Bitmap = LegacyHelper.ImageHelper.Converter(.Icon)
                ...
                Dim allEmps = Await FEB2.Emps.All(exs, Current.Session.User)
                If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Else
            If Await FEB2.WinmenuItem.Update(_WinMenuItem, exs) Then
