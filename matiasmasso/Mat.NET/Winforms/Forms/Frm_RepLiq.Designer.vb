...
Partial Class Frm_RepLiq
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_RepliqFras1 = New Winforms.Xl_RepliqFras()
        Me.Xl_AmtTotalBaseFras = New Winforms.Xl_Amt()
        Me.Xl_AmtTotalComisions = New Winforms.Xl_Amt()
        Me.PictureBoxIcon = New System.Windows.Forms.PictureBox()
        Me.Label1 = New System.Windows.Forms.Label()
        Me.Label2 = New System.Windows.Forms.Label()
        Me.CheckBoxIVA = New System.Windows.Forms.CheckBox()
        Me.Xl_PercentIVA = New Winforms.Xl_Percent()
        Me.Xl_AmtIVA = New Winforms.Xl_Amt()
        Me.Xl_AmtIRPF = New Winforms.Xl_Amt()
        Me.Xl_PercentIRPF = New Winforms.Xl_Percent()
        Me.CheckBoxIRPF = New System.Windows.Forms.CheckBox()
        Me.Xl_AmtLiquid = New Winforms.Xl_Amt()
    ...
    Friend WithEvents Xl_RepliqFras1 As Winforms.Xl_RepliqFras
    Friend WithEvents Xl_AmtTotalBaseFras As Winforms.Xl_Amt
    Friend WithEvents Xl_AmtTotalComisions As Winforms.Xl_Amt
    ...
    Friend WithEvents Xl_PercentIVA As Winforms.Xl_Percent
    Friend WithEvents Xl_AmtIVA As Winforms.Xl_Amt
    Friend WithEvents Xl_AmtIRPF As Winforms.Xl_Amt
    Friend WithEvents Xl_PercentIRPF As Winforms.Xl_Percent
    Friend WithEvents CheckBoxIRPF As System.Windows.Forms.CheckBox
    Friend WithEvents Xl_AmtLiquid As Winforms.Xl_Amt
