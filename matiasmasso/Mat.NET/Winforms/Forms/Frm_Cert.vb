Public Class Frm_Cert
    ...
    Private Async Sub Frm_Cert_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        _Cert = Await FEB2.Cert.Find(_Contact, exs)
        If exs.Count = 0 Then
            If _Cert IsNot Nothing Then
                With _Cert
                    TextBoxPwd.Text = .Pwd
                    DateTimePickerCaduca.Value = .Caduca
                    .Stream = Await FEB2.Cert.Stream(_Contact, exs)
                End With
                Xl_Image1.Bitmap = LegacyHelper.ImageHelper.Converter(Await FEB2.Cert.Image(_Contact, exs))
            End If
        Else
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If TextBoxFilename.Text > "" Then
            ...
            If FEB2.Cert.ImportFromFile(_Cert, TextBoxFilename.Text, TextBoxPwd.Text, DateTimePickerCaduca.Value, exs) Then
                _Cert.Image = LegacyHelper.ImageHelper.Converter(Xl_Image1.Bitmap)
                If Await FEB2.Cert.Update(_Cert, exs) Then
                    Me.Close()
                Else
