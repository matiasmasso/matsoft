Public Class Frm_ProductBrand
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.ProductBrand.Load(_ProductBrand, exs) Then
            With _ProductBrand
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.ProductBrand.Update(_ProductBrand, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.ProductBrand.Delete(_ProductBrand, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_ProductBrand))
                Me.Close()
            Else
        ...
        Select Case DirectCast(TabControl1.SelectedIndex, Tabs)
            Case Tabs.Categories
                If Not _CategoriesLoaded Then
                    ...
                    Dim oCategories = Await FEB2.ProductCategories.All(exs, _ProductBrand, IncludeObsolets:=True)
                    If exs.Count = 0 Then
            ...
            Case Tabs.Zonas
                If Not _ZonasLoaded Then
                    _ZonasLoaded = True
                    Dim oAreas = Await FEB2.BrandAreas.All(_ProductBrand, exs)
                    If exs.Count = 0 Then
            ...
            Case Tabs.Channels
                If Not _ChannelsLoaded Then
                    ...
                    Dim oProductChannels = Await FEB2.ProductChannels.All(exs, _ProductBrand)
                    If exs.Count = 0 Then
            ...
            Case Tabs.Reps
                If Not _RepsLoaded Then
                    _RepsLoaded = True
                    Dim oRepProducts = Await FEB2.RepProducts.All(exs, _ProductBrand, True)
                    If exs.Count = 0 Then
