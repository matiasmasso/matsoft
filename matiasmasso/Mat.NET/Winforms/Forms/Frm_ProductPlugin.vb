Public Class Frm_ProductPlugin
    ...
    Private Sub refresca()
        ...
        If FEB2.ProductPlugin.Load(exs, _ProductPlugin) Then
            With _ProductPlugin
                TextBoxNom.Text = .nom
                Xl_LookupProduct1.Load(.product)
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.ProductPlugin.Update(exs, _ProductPlugin) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.ProductPlugin.Delete(exs, _ProductPlugin) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_ProductPlugin))
                Me.Close()
            Else
    ...
    Private Async Function AddItem() As Task
        ...
        If _ProductPlugin.IsNew Then
            LoadFromForm()
            If Not Await FEB2.ProductPlugin.Update(exs, _ProductPlugin) Then
                UIHelper.WarnError(exs)
                Exit Function
            End If
        End If
