...
Public Class Frm_SalesReport
    ...
    Private Async Sub Frm_SalesReport_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim oYears = Await FEB2.EdiversaSalesReports.Years(exs, GlobalVariables.Emp)
        If exs.Count = 0 Then
            LoadConcepts()
    ...
    Private Async Function LoadData(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        End With
        _SalesReport = Await FEB2.EdiversaSalesReportItems.SalesReport(exs, _SalesReport)
        ProgressBar1.Visible = False
        Return exs.Count = 0
    End Function
    ...
    Private Sub refresca()
        ...
        loadCentros()
        LoadDepts()
        Xl_LookupProduct1.Load(_SalesReport.SelectedProduct, CustomLookup:=True)
    ...
    Private Sub Xl_LookupProduct1_AfterUpdate(sender As Object, e As MatEventArgs) Handles Xl_LookupProduct1.AfterUpdate
        Xl_LookupProduct1.Load(e.Argument)
