Public Class Frm_RepLiq
    ...
    Private Sub Frm_RepLiq_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.Repliq.Load(_RepLiq, exs) Then
            If FEB2.Cca.Load(_RepLiq.Cca, exs) Then
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.Repliq.Delete(_RepLiq, exs) Then
            If FEB2.Rep.Load(exs, _RepLiq.rep) Then
                ...
                With oRepLiq
                    ...
                    .cca = Await FEB2.Repliq.GetCca(exs, oRepLiq, Current.Session.User)
                End With

                If exs.Count = 0 Then
                    oRepLiq = Await FEB2.Repliq.Update(exs, oRepLiq, GlobalVariables.Emp)
                    If exs.Count = 0 Then
    ...
    Private Async Sub Xl_RepliqFras1_AfterUpdate(sender As Object, e As MatEventArgs) Handles Xl_RepliqFras1.AfterUpdate
        ...
        If _RepLiq.Cca IsNot Nothing Then
            _RepLiq.Cca = Await FEB2.Repliq.GetCca(exs, _RepLiq, Current.Session.User)
            If exs.Count = 0 Then
