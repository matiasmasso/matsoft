...
Public Class Frm_EDiversaOrder
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.EdiversaOrder.Load(_EdiversaOrder, exs) Then
            Await refresca()
        Else
    ...
    Private Async Function refresca() As Task
        ...
        With _EdiversaOrder
            ...
            Xl_Contact2Comprador.Contact = .Comprador
            Xl_Contact2ReceptorMercancia.Contact = .ReceptorMercancia
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.EdiversaOrder.Update(_EdiversaOrder, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.EdiversaOrder.Delete(_EdiversaOrder, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_EdiversaOrder))
                Me.Close()
            Else
                UIHelper.WarnError(exs)
        ...
        Select Case TabControl1.SelectedIndex
            Case Tabs.File
                If Not _loadedFile Then
                    Dim oFile = Await FEB2.EdiversaFile.Find(exs, _EdiversaOrder.Guid)
                    If exs.Count = 0 Then
