Public Class Frm_Areas
    ...
    Public Sub New(Optional oArea As DTOArea = Nothing, Optional oSelMode As SelModes = SelModes.Browse, Optional Title As String = "")
        MyBase.New()
    ...
    Public ReadOnly Property Area As DTOArea
        Get
            Return _Area
        End Get
    End Property
    ...
    Private Sub RefrescaCountries()
        Dim oLang As DTOLang = FEBL.Session.Current.Lang
    ...
    Private Sub RefrescaZonas()
        ...
        Else
            ...
            RefrescaLocations(Me, MatEventArgs.Empty)
        End If
    End Sub

    Private Sub RefrescaLocations(sender As Object, e As MatEventArgs)
    ...
    Private Sub Xl_onItemSelected(sender As Object, e As MatEventArgs) Handles _
        Xl_Countries1.onItemSelected,
         Xl_Zonas1.onItemSelected,
          Xl_Locations1.onItemSelected,
    ...
    Private Sub Xl_Zonas1_RequestToAddNew(sender As Object, e As MatEventArgs) Handles Xl_Zonas1.RequestToAddNew
        Dim oCountry As DTOCountry = Xl_Countries1.Value
        Dim oZona As DTOZona = BLL.BLLZona.Factory(oCountry)
