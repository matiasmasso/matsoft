...
Public Class Frm_Cataleg
    ...
    Private Async Sub Frm_Products_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        _CategorySortOrder = Await FEB2.UserDefaults.GetInt(exs, Current.Session.User, DTOUserDefault.Cods.ProductCategoriesOrder)
        If exs.Count = 0 Then
    ...
    Private Async Function ReloadBrands() As Task
        ...
        _Catalog = Await FEB2.ProductCategories.CompactTree(exs, GlobalVariables.Emp, Current.Session.Lang)
    ...
    Private Async Function RefrescaProductBrands(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        Xl_ProductBrands1.Load(oFilteredBrands, oDefaultValue:=oDefaultBrand)
    ...
    Private Async Function RefrescaProductSkus(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        If oProductCategory IsNot Nothing Then
            Dim oSkus = Await FEB2.ProductSkus.All(exs, oProductCategory, Xl_LookupMgz1.Mgz, _ShowObsoletos)
