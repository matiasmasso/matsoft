Public Class Frm_PriceListsxSku
    ...
    Private Async Sub Frm_PriceListsxSku_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.ProductSku.Load(_Sku, exs) Then
            LabelSku.Text = _Sku.nom.Tradueix(Current.Session.Lang)
            Await RefrescaVenda()
    ...
    Private Async Function RefrescaCosts() As Task
        Dim exs As New List(Of Exception)
        Dim items = Await FEB2.PriceListItemsSupplier.All(exs, _Sku)
        If exs.Count = 0 Then
    ...
    Private Async Function RefrescaVenda() As Task
        Dim exs As New List(Of Exception)
        Dim items = Await FEB2.PriceListItemsCustomer.All(exs, _Sku)
        If exs.Count = 0 Then
