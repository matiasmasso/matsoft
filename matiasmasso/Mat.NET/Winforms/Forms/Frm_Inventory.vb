Public Class Frm_Inventory
    ...
    Private Async Sub Frm_Inventory_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Xl_MatDateTimePicker1.Value = TimeHelper.LastDayOfMonth(Today.AddMonths(-1))
    ...
    Private Async Function refresca() As Task
        ...
        If Await LoadMgzs(CurrentFch, exs) Then
            _values = Await FEB2.Mgz.Inventory(exs, _Mgz, Current.Session.User, CurrentFch)
    ...
    Private Async Function LoadMgzs(DtFch As Date, exs As List(Of Exception)) As Task(Of Boolean)
        Dim oMgzs = Await FEB2.Mgzs.Actius(Current.Session.Emp, DtFch, exs)
        If exs.Count = 0 Then
            With ComboBoxMgz
                .DataSource = oMgzs
    ...
    Private Async Sub RECUENTOToolStripButton_Click(sender As Object, e As EventArgs) Handles RECUENTOToolStripButton.Click
        Dim exs As New List(Of Exception)
        Dim oSheet = Await FEB2.Mgz.ExcelInventari(exs, _Mgz, Current.Session.User, Xl_MatDateTimePicker1.Value)
        If exs.Count = 0 Then
