Public Class Frm_Immoble
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.Immoble.Load(_Immoble, exs) Then
            With _Immoble
                TextBoxNom.Text = .Nom
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.Immoble.Update(_Immoble, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.Immoble.Delete(_Immoble, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Immoble))
                Me.Close()
            Else
    ...
    Private Async Sub refrescaDocFileSrcs()
        Dim exs As New List(Of Exception)
        Dim oDocFileSrcs = Await FEB2.DocFileSrcs.All(_Immoble, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub refrescaInventari()
        Dim exs As New List(Of Exception)
        Dim oInventariItems = Await FEB2.InventariItems.All(exs, _Immoble)
        If exs.Count = 0 Then
