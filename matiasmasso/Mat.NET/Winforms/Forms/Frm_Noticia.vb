...
Public Class Frm_Noticia
    ...
    Private Async Sub Frm_Noticia_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.Noticia.Load(exs, _Noticia, IncludeImages:=True) Then
            Await refresca()
        Else
    ...
    Private Async Function refresca() As Task
        ...
        With _Noticia
            ...
            TextBoxUrlRoot.Text = FEB2.Noticia.RootUrl(_Noticia.Src, True) & "/"
            ...
            Dim oAllChannels = Await FEB2.DistributionChannels.Headers(GlobalVariables.Emp, Current.Session.Lang, exs)
            If exs.Count = 0 Then
                ...
                Dim keywords = Await FEB2.KeyWords.All(.Guid, exs)
                If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        If Await ValidateDestacar(exs) Then
            With _Noticia
                ...
                .image265x150 = LegacyHelper.ImageHelper.Converter(Xl_Image265x150.Bitmap)
            ...
            If Await FEB2.Noticia.Update(exs, _Noticia) Then
    ...
    Private Async Function ValidateDestacar(exs As List(Of Exception)) As Task(Of Boolean)
        ...
        If CheckBoxDestacar.Checked Then
            Dim oDestacats = Await FEB2.Noticias.Destacats(exs, DTOContent.Srcs.News, Current.Session.User)
            If exs.Count = 0 Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.Noticia.Delete(exs, _Noticia) Then
