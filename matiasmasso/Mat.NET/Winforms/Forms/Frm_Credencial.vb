Public Class Frm_Credencial
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If exs.Count = 0 Then
            If FEB2.Credencial.Load(_Credencial, exs) Then
                With _Credencial
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.Credencial.Update(_Credencial, exs) Then
            ...
            Case 1
                ...
                If oOwner.Equals(Current.Session.User) Then
                    ...
                    If rc = MsgBoxResult.Ok Then
                        If Await FEB2.Credencial.Delete(_Credencial, exs) Then
                            RaiseEvent AfterUpdate(Me, New MatEventArgs(_Credencial))
                            Me.Close()
                        Else
    ...
    Private Async Sub ButtonAddme_Click(sender As Object, e As EventArgs) Handles ButtonAddUser.Click
        Dim exs As New List(Of Exception)
        Dim oUser As DTOUser = Await FEB2.User.FromEmail(exs, GlobalVariables.Emp, TextBoxEmailAddress.Text)
        If exs.Count = 0 Then
