Public Class Frm_Task
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.Task.Load(_Task, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.Task.Update(_Task, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.Task.Delete(_Task, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Task))
                Me.Close()
            Else
    ...
    Private Async Sub RefrescaTaskSchedules()
        Dim exs As New List(Of Exception)
        _Task.Schedules = Await FEB2.TaskSchedules.All(_Task, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub RefrescaTaskLogs()
        Dim exs As New List(Of Exception)
        Dim oLogs = Await FEB2.TaskLogs.All(_Task, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub Xl_TaskLogs1_ValueChanged(sender As Object, e As MatEventArgs) Handles Xl_TaskLogs1.ValueChanged
        ...
        Dim exs As New List(Of Exception)
        oLog = Await FEB2.TaskLog.Find(oLog.Guid, exs)
        If exs.Count = 0 Then
            TextBoxMsg.Text = oLog.ResultMsg
        Else
            UIHelper.WarnError(exs)
