Public Class Frm_ContactClass
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.ContactClass.Load(_ContactClass, exs) Then
            With _ContactClass
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.ContactClass.Update(_ContactClass, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.ContactClass.Delete(_ContactClass, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_ContactClass))
                Me.Close()
            Else
        ...
        Select Case TabControl1.SelectedIndex
            Case Tabs.Contacts
                If Not _LoadedContacts Then
                    ...
                    Dim oContacts = Await FEB2.Contacts.All(exs, oUser, _ContactClass)
                    If exs.Count = 0 Then
