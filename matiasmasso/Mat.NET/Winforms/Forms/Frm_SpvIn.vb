Public Class Frm_SpvIn
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.SpvIn.Load(_SpvIn, exs) Then
            With _SpvIn
                ...
                Dim oSpvs = Await FEB2.Spvs.All(exs, _SpvIn)
                If exs.Count = 0 Then
                    Xl_Spvs1.Load(oSpvs)
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim id = Await FEB2.SpvIn.Update(_SpvIn, exs)
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.SpvIn.Delete(_SpvIn, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_SpvIn))
                Me.Close()
            Else
