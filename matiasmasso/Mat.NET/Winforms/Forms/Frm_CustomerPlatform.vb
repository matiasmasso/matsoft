Public Class Frm_CustomerPlatform
    ...
    Private Sub Frm_CustomerPlatform_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.CustomerPlatform.Load(_CustomerPlatform, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.CustomerPlatform.Update(_CustomerPlatform, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.CustomerPlatform.Delete(_CustomerPlatform, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_CustomerPlatform))
                Me.Close()
            Else
