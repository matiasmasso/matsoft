Public Class Frm_DistributionChannel
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.DistributionChannel.Load(_DistributionChannel, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.DistributionChannel.Update(_DistributionChannel, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.DistributionChannel.Delete(_DistributionChannel, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_DistributionChannel))
                Me.Close()
            Else
    ...
    Private Async Sub onContactClassSelected(sender As Object, e As MatEventArgs)
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.ContactClass.Update(oContactClass, exs) Then
...
#Region "Products"
    Private Async Function LoadProducts() As Task
        Dim exs As New List(Of Exception)
        Dim oProductChannels = Await FEB2.ProductChannels.All(exs, _DistributionChannel)
        If exs.Count = 0 Then
...
#Region "Dtos"
    Private Async Function LoadDtos() As Task
        Dim exs As New List(Of Exception)
        Dim oDtos = Await FEB2.CustomerTarifaDtos.All(exs, _DistributionChannel)
        If exs.Count = 0 Then
