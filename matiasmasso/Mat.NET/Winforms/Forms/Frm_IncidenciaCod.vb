...
Public Class Frm_IncidenciaCod
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.IncidenciaCod.Load(_IncidenciaCod, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.IncidenciaCod.Update(_IncidenciaCod, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.IncidenciaCod.Delete(_IncidenciaCod, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_IncidenciaCod))
                Me.Close()
            Else
        ...
        Select Case TabControl1.SelectedIndex
            Case Tabs.Incidencies
                If Not _Done Then
                    ...
                    End Select
                    oQuery = Await FEB2.Incidencias.Query(exs, oQuery)
                    If exs.Count = 0 Then
                        Xl_Incidencies1.Load(oQuery)
                        _Done = True
                    Else
                        UIHelper.WarnError(exs)
                    End If
