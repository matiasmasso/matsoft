...
Public Class Frm_Iva
    ...
    Private Async Sub Frm_Iva_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        _AllCtas = Await FEB2.PgcCtas.All(exs)
        If exs.Count = 0 Then
            Dim DefaultFch As Date = Today.AddMonths(-1)
    ...
    Private Async Function refresca() As Task
        ...
        Dim exs As New List(Of Exception)
        _IvaLiquidacio = Await FEB2.IvaLiquidacio.Factory(exs, oExercici, oYearMonth.Month)
    ...
    Private Sub LoadYears(defaultfch As Date)
        ...
        For i As Integer = Today.Year To 2012 Step -1
            iyears.Add(i)
        Next
    ...
    Private Sub ExcelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExcelToolStripMenuItem.Click
        Dim oExcel As MatHelperStd.ExcelHelper.Sheet = Xl_BaseQuotas1.ExcelSheet
