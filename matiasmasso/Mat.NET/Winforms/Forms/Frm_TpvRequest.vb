Public Class Frm_TpvRequest
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim oConfig = Await FEB2.SermepaConfig.ProductionEnvironment(exs, Current.Session.Emp)
        oTpv = Await FEB2.TpvRedSys.BookRequest(oTpv, oConfig, Current.Session.User, oTpv.Titular.Lang, DTOTpvRequest.Modes.Free, Nothing, Xl_Eur1.Amt, TextBoxConcept.Text, exs)
        UIHelper.ToggleProggressBar(Panel1, False)
        If exs.Count = 0 Then
            Dim sUrl = FEB2.TpvLog.CustomRequestUrl(oTpv)
