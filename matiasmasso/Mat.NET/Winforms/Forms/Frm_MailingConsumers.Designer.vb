...
Partial Class Frm_MailingConsumers
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_Areas1 = New Winforms.Xl_Areas()
        Me.Xl_LookupArea1 = New Winforms.Xl_LookupArea()
        Me.Xl_Rols1 = New Winforms.Xl_Rols()
    ...
    End Sub
    Friend WithEvents Xl_Users1 As Winforms.Xl_Users
    Friend WithEvents Xl_Rols1 As Winforms.Xl_Rols
    Friend WithEvents Xl_LookupArea1 As Winforms.Xl_LookupArea
    Friend WithEvents Xl_Areas1 As Winforms.Xl_Areas
