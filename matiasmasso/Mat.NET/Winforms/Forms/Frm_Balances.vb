Public Class Frm_Balances
    ...
    Private Async Function refresca() As Task
        ...
        Dim oTree = Await FEB2.Balance.Tree(Current.Session.Emp, CurrentFch)
    ...
    Private Async Sub Xl_DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles Xl_DateTimePicker1.ValueChanged
        If _Allowevents Then
            ...
            Dim sFch As String = Await FEB2.Default.EmpValue(Current.Session.Emp, DTODefault.Codis.LastBalanceQuadrat, exs)
            If exs.Count = 0 Then
    ...
    Private Sub SetCurrentFch()
        ...
        If IsNumeric(sFch) Then
            Try
                ...
                If DtFch > Today Then DtFch = Today
    ...
    Private Async Sub Do_Excel()
        Dim exs As New List(Of Exception)
        Dim DtFch As Date = CurrentFch()
        Dim oBook As MatHelperStd.ExcelHelper.Book = Await FEB2.Balance.Excel(Current.Session.Emp, DtFch)
    ...
    Private Async Sub TancarBalançToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles TancarBalançToolStripMenuItem.Click
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.Default.SetEmpValue(Current.Session.Emp, DTODefault.Codis.LastBalanceQuadrat, Xl_DateTimePicker1.Value.ToOADate, exs) Then
    ...
    Private Sub WebToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles WebToolStripMenuItem.Click
        Dim sUrl As String = FEB2.Balance.Url(Xl_DateTimePicker1.Value, True)
