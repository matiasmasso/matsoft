Public Class Frm_IncidenciesRatios
    ...
    Private Async Function refresca() As Task
        ...
        Dim values = Await FEB2.Incidencias.Ratios(exs, DateTimePicker1.Value, DateTimePicker2.Value)
        If exs.Count = 0 Then
    ...
    Private Sub syncFchs()
        Select Case ComboBox1.SelectedIndex
            Case Intervals.lastQ
                DateTimePicker1.Value = Today.AddMonths(-3)
                DateTimePicker2.Value = Today
            Case Intervals.lastY
                DateTimePicker1.Value = Today.AddMonths(-12)
                DateTimePicker2.Value = Today
            Case Intervals.YTD
                DateTimePicker1.Value = New Date(Today.Year, 1, 1)
                DateTimePicker2.Value = Today
