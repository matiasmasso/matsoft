Public Class Frm_Contacts
    ...
    Private Async Function refresca() As Task
        ...
        _Channels = Await FEB2.DistributionChannels.AllWithContacts(Current.Session.Emp, exs)
        If exs.Count = 0 Then
            ...
            If oClass IsNot Nothing Then
                ...
                Xl_Contacts1.Load(CurrentClass.Contacts)
            End If
    ...
    Private Sub Xl_ContactClasses1_ValueChanged(sender As Object, e As MatEventArgs) Handles Xl_ContactClasses1.ValueChanged
        Xl_Contacts1.Load(CurrentClass.Contacts)
    End Sub
    ...
    Private Sub Xl_TextboxSearch1_AfterUpdate(sender As Object, e As MatEventArgs) Handles Xl_TextboxSearch1.AfterUpdate
        Xl_Contacts1.Filter = e.Argument
    End Sub

    Private Sub Xl_DistributionChannels1_ValueChanged(sender As Object, e As MatEventArgs) Handles Xl_DistributionChannels1.ValueChanged
        Dim oChannel As DTODistributionChannel = CurrentChannel()
        Dim oClasses As List(Of DTOContactClass) = oChannel.ContactClasses
        Xl_ContactClasses1.Load(oClasses)
