Public Class Frm_InventoryDelta
    ...
    Private Async Function refresca() As Task
        ...
        _Stocks = Await FEB2.Mgz.Inventory(exs, oMgz, Current.Session.User, _CurrentFch)
    ...
    Private Async Function LoadHistoric() As Task
        ...
        _Values = Await FEB2.Mgz.DeliveryItems(oMgz, iYear, exs)
...
#Region "Historic"
    ...
    Private Async Function LoadMgzs(exs As List(Of Exception)) As Task(Of Boolean)
        Dim oMgzs = Await FEB2.Mgzs.Actius(Current.Session.Emp, Today, exs)
        If exs.Count = 0 Then
            With ComboBoxMgz
                .DataSource = oMgzs
    ...
    Private Sub LoadYears()
        ...
        For iYear As Integer = Today.Year To 1985 Step -1
            iYears.Add(iYear)
        Next
    ...
    Shared Async Function ActualitzarPreusMigDeCost(oMgz As DTOMgz) As Task(Of Boolean)
        ...
        Dim oSkus = Await FEB2.Mgz.Skus(oMgz, Today, exs)
        Dim idx As Integer
        For Each oSku In oSkus
            idx += 1
            oFrm.ShowProgress(1, oSkus.Count, idx, DTOProductSku.FullNom(oSku), BlCancel)
            If Not Await FEB2.Mgz.SetPrecioMedioCoste(oSku, oMgz, exs) Then
                UIHelper.WarnError(exs)
            End If
    ...
    Private Sub ExcelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExcelToolStripMenuItem.Click
        ...
        With oDlg
            ...
            If .ShowDialog = DialogResult.OK Then
                Dim oSheet As New MatHelperStd.ExcelHelper.Sheet(, .FileName)
                With oSheet
                    .addColumn("ref.M+O")
