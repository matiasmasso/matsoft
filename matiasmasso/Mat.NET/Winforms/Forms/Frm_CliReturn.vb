Public Class Frm_CliReturn
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.CliReturn.Load(_CliReturn, exs) Then
            With _CliReturn
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.CliReturn.Update(_CliReturn, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.CliReturn.Delete(_CliReturn, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_CliReturn))
                Me.Close()
            Else
    ...
    Private Async Sub Xl_LookupDelivery1_RequestToLookup(sender As Object, e As MatEventArgs) Handles Xl_LookupDelivery1.RequestToLookup
        ...
        Dim oDeliveries = Await FEB2.Deliveries.Headers(exs, Current.Session.Emp, contact:=_CliReturn.Customer)
        If exs.Count = 0 Then
