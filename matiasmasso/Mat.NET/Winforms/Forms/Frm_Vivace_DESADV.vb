...
Public Class Frm_Vivace_DESADV
    ...
    Private Async Function procesa(filename As String) As Task
        ...
        Dim oSkus = Await FEB2.ProductSkus.SearchFromSkuIds(exs, GlobalVariables.Emp, skuIds)
    ...
    Private Async Sub FtpToTradeInn_Click(sender As Object, e As EventArgs) Handles FtpToTradeInn.Click
        ...
        Else
            ...
            Dim msg = Await FEB2.Ftpserver.Send(exs, oCustomer, DTOFtpserver.Path.Cods.Desadv, oByteArray, filename)
            ProgressBar1.Visible = False
            If exs.Count = 0 Then
