Public Class Frm_StaffHoliday
    ...
    Private Sub Frm_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.StaffHoliday.Load(_StaffHoliday, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.StaffHoliday.Update(_StaffHoliday, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.StaffHoliday.Delete(_StaffHoliday, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_StaffHoliday))
                Me.Close()
            Else
