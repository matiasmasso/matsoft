Public Class Frm_SellOut
    ...
    Private Async Sub Frm_SellOut2_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If _value Is Nothing Then
            _value = Await FEB2.SellOut.Factory(exs, Current.Session.User)
        End If
        If exs.Count = 0 Then
            LoadConceptTypes()
    ...
    Private Async Function refresca() As Task
        ...
        LoadFilters()
        Dim oSellout = Await FEB2.SellOut.Load(exs, _value)
        If exs.Count = 0 Then
            _value = oSellout
    ...
    Private Async Function LoadYears() As Task(Of Boolean)
        Dim exs As New List(Of Exception)
        Dim iYears As List(Of Integer) = Await FEB2.SellOut.Years(exs, _value)
        If exs.Count = 0 Then
        ...
        If oFilter IsNot Nothing Then
            Select Case oFilter.Cod
                ...
                Case DTOSellOut.Filter.Cods.Channel
                    Dim oAllValues = Await FEB2.SellOut.Channels(exs, _value.Clone)
                    If exs.Count = 0 Then
                ...
                Case DTOSellOut.Filter.Cods.Provider
                    Dim oAllValues = Await FEB2.SellOut.Proveidors(exs, _value.Clone)
                    If exs.Count = 0 Then
                        Dim oSelectedValues = oFilter.Values
                        Dim oFrm As New Frm_BaseGuids_Checklist(oAllValues.ToArray, oSelectedValues.ToArray)
                ...
                Case DTOSellOut.Filter.Cods.Rep
                    Dim oAllValues = Await FEB2.SellOut.Reps(exs, _value.Clone)
                    If exs.Count = 0 Then
                        Dim oSelectedValues = oFilter.Values
                        Dim oFrm As New Frm_BaseGuids_Checklist(oAllValues.ToArray, oSelectedValues.ToArray)
    ...
    Private Sub ExcelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExcelToolStripMenuItem.Click
        Dim oSheet = DTOSellOut.Excel(_value)
        Dim exs As New List(Of Exception)
