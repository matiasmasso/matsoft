Public Class Frm_HighResImage
    Private _HighResImage As DTOHighResImage
    Private _DirtyThumbnail As Boolean

    Public Event AfterUpdate(sender As Object, e As MatEventArgs)

    Public Sub New(oValue As DTOHighResImage)
        MyBase.New()
        Me.InitializeComponent()
        _HighResImage = oValue
        BLL.BLLHighResImage.Load(_HighResImage)

        With _HighResImage
            TextBoxUrl.Text = .Url
            TextBoxFeatures.Text = BLL.BLLHighResImage.MultilineFeatures(_HighResImage)
            Xl_ImageCrop1.Load(.Thumbnail)
            Xl_Products1.Load(_HighResImage.Products)
    ...
    Private Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If BLL.BLLHighResImage.Update(_HighResImage, exs) Then
    ...
    Private Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        Dim exs As New List(Of exception)
        If BLL.BLLHighResImage.Delete(_HighResImage, exs) Then
    ...
    Private Sub Xl_ImageCrop1_RequestToRefresh(sender As Object, e As MatEventArgs) Handles Xl_ImageCrop1.RequestToRefresh
        ...
        Dim exs As New List(Of exception)
        Dim oImage As Image = BLL.ImageHelper.DownloadFromFtpsite(_HighResImage.Url, BLLApp.FtpClient)
