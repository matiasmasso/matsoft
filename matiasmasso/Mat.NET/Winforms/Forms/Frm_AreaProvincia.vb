Public Class Frm_AreaProvincia
    ...
    Private Async Function refrescaZonas() As Task
        ...
        Dim oZonas = Await FEB2.AreaProvincia.Zonas(_AreaProvincia, exs)
        If exs.Count = 0 Then
            Xl_Zonas1.Load(oZonas)
        Else
            UIHelper.WarnError("Error al carregar les zones:" & vbCrLf & exs.First.Message)
        End If
    End Function
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        End With
        Dim exs As New List(Of Exception)
        If Await FEB2.AreaProvincia.Update(_AreaProvincia, exs) Then
