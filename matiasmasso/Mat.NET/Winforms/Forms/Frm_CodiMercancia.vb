Public Class Frm_CodiMercancia
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If _CodiMercancia.id = "" Then
            _AllowEvents = True
        Else
            If FEB2.CodiMercancia.Load(_CodiMercancia, exs) Then
                With _CodiMercancia
                    TextBoxCodi.Text = .id
                    TextBoxDsc.Text = .dsc
                    Dim oProducts = Await FEB2.CodiMercancia.Products(_CodiMercancia, exs)
                    If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.CodiMercancia.Update(_CodiMercancia, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.CodiMercancia.Delete(_CodiMercancia, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_CodiMercancia))
                Me.Close()
            Else
