Public Class Frm_SegSocialGrup
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB2.SegSocialGrup.Load(_SegSocialGrup, exs) Then
            With _SegSocialGrup
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB2.SegSocialGrup.Update(_SegSocialGrup, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB2.SegSocialGrup.Delete(_SegSocialGrup, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_SegSocialGrup))
                Me.Close()
            Else
