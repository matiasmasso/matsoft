Public Class Menu_EDiversaException
    ...
    Private Async Function MenuItem_Platform_Select() As Task(Of ToolStripMenuItem)
        ...
        Else
            ...
            Dim oOrder = Await FEB2.EdiversaOrder.Find(_EDiversaException.Tag.Guid, exs)
            Dim oPlatforms As List(Of DTOCustomerPlatform) = Await FEB2.ElCorteIngles.Platforms(oOrder.Customer)
    ...
    Private Async Sub Do_ShowPdc(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Not TypeOf _EDiversaException.Tag Is DTOPurchaseOrder Then
            _EDiversaException.Tag = Await FEB2.PurchaseOrder.Find(_EDiversaException.Tag.Guid, exs)
        End If
    ...
    Private Async Sub Do_SkuNotFound_Email(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        Dim oOrderItem = Await FEB2.EdiversaOrderItem.Find(_EDiversaException.Tag.Guid, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub Do_PriceAmend(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If exs.Count = 0 Then
            ...
            Dim oPrice As DTOAmt = Await FEB2.ProductSku.Price(exs, oSku, oOrder.Customer)
            If exs.Count = 0 Then
    ...
    Private Async Sub Do_AmendDto(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If exs.Count = 0 Then
            ...
            If exs.Count = 0 Then
                Dim DcDto As Decimal = FEB2.PurchaseOrderItem.GetDiscount(oSku, oCustomer, oCliProductDtos)
        ...
        If exs.Count = 0 Then
            ...
            If exs.Count = 0 Then
                For Each item As DTOEdiversaOrderItem In oOrder.Items
                    item.Dto = FEB2.PurchaseOrderItem.GetDiscount(oSku, oCustomer, oCliProductDtos)
                Next
    ...
    Private Async Sub Do_ContactLookup(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim oGenrals = Await FEB2.EdiversaGenrals.Search(sSearchKey, exs)
    ...
    Private Sub Do_ContactRegister(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim oOrder As DTOEdiversaOrder = _EDiversaException.Tag
        Dim oEAN As DTOEan = oOrder.CompradorEAN
