Public Class Menu_SatRecall
    ...
    Private Async Sub Do_EmailCustomer()
        ...
        FEB2.SatRecall.Load(_SatRecall, exs)
        FEB2.Incidencia.Load(exs, _SatRecall.Incidencia)
        FEB2.Product.Load(_SatRecall.Incidencia.product, exs)

        LegacyHelper.SatRecallLegacyHelper.FillForm(_SatRecall, recallFormFilename, exs)
        If exs.Count = 0 Then

            Dim oMailMessage = Await FEB2.SatRecall.MailMessageToCustomer(_SatRecall, recallFormFilename, exs)
            If exs.Count = 0 Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.SatRecall.Delete(_SatRecalls.First, exs) Then
