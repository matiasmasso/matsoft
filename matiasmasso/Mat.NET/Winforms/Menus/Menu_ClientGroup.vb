...
Public Class Menu_ClientGroup
    ...
    Private Async Sub Do_SellOut(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If exs.Count = 0 Then
            ...
            If exs.Count = 0 Then
                FEB2.SellOut.AddFilterValues(oSellout, DTOSellOut.Filter.Cods.Customer, {oCcx})
    ...
    Private Async Sub Do_LastAlbs(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim oCcx = FEB2.Customer.CcxOrMe(exs, _Customer)
        If exs.Count = 0 Then
            Dim oDeliveries = Await FEB2.Deliveries.Headers(exs, Current.Session.Emp, contact:=oCcx, group:=True)
            If exs.Count = 0 Then
