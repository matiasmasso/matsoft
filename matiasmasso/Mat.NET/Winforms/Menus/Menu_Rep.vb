Public Class Menu_Rep
    ...
    Private Function MenuItem_Contact() As ToolStripMenuItem
        ...
        If mWithContact Then
            ...
            oMenuItem.DropDownItems.AddRange(New Menu_Contact(_Rep).Range)
        Else
    ...
    Private Async Sub Do_Extracte(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim oContact As DTOContact = FEB2.Rep.RaoSocialFacturacio(_Rep)
        Dim oCta = Await FEB2.PgcCta.FromCod(DTOPgcPlan.Ctas.ProveidorsEur, Current.Session.Emp, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub Do_MailAll()
        Dim exs As New List(Of Exception)
        Dim oRepEmails = Await FEB2.Reps.Emails(exs, GlobalVariables.Emp)
        If exs.Count = 0 Then
    ...
    Private Async Sub Do_MakeRetencions(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        Dim iYea As Integer
        Dim iQ As Integer
        TimeHelper.GetLastQuarter(iYea, iQ)
        Do
    ...
    Private Async Sub Do_Profile(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        Dim sUrl = Await FEB2.Rep.UrlProfile(exs, _Rep)
        Process.Start(sUrl)
    End Sub
    ...
    Private Sub Do_Excepcions()
        Dim exs As New List(Of Exception)
        If FEB2.Rep.Load(exs, _Rep) Then
