Public Class Menu_RaffleParticipant
    ...
    Private Async Sub Do_MailParticipationConfirmation()
        ...
        Dim oMailMessage = Await FEB2.RaffleParticipant.RaffleParticipationMailMessage(exs, GlobalVariables.Emp, _RaffleParticipants.First)
    ...
    Private Sub Do_CopyLinkToMailParticipationConfirmation()
        Dim sUrl As String = FEB2.Mailing.BodyUrl(DTODefault.MailingTemplates.RaffleParticipation, _RaffleParticipants.First.Guid.ToString())
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.RaffleParticipants.Delete(exs, _RaffleParticipants) Then
    ...
    Private Async Sub Do_SetAsWinner()
        Dim exs As New List(Of Exception)
        If Await FEB2.RaffleParticipant.SetAsWinner(_RaffleParticipants.First, exs) Then
