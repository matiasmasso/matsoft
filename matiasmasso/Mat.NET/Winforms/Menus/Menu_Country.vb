Public Class Menu_Country
    ...
    Private Async Sub Do_Sellout(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If exs.Count = 0 Then
            FEB2.SellOut.AddFilterValues(oSellout, DTOSellOut.Filter.Cods.Atlas, _Countries.ToArray)
    ...
    Private Async Sub Do_IbanStructure(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        Dim oIbanStructure = Await FEB2.IbanStructure.Find(_Country, exs)
        If exs.Count = 0 Then
            If oIbanStructure Is Nothing Then
                oIbanStructure = DTOIbanStructure.Factory(_Country)
