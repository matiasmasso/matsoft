Public Class Menu_ProductDownload
    ...
    Private Async Sub Do_Importar(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            If .ShowDialog = DialogResult.OK Then
                ...
                If exs.Count = 0 Then
                    ...
                    If rc = vbOK Then
                        ...
                        If Await FEB2.ProductDownload.Update(exs, _ProductDownload) Then
    ...
    Private Async Sub Do_Delete()
        ...
        If rc = vbOK Then
            Dim exs As New List(Of Exception)
            If Await FEB2.ProductDownload.Delete(exs, _ProductDownload) Then
