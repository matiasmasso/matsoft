Public Class Menu_EDiversaOrderItem
    ...
    Private Async Sub Do_SkuNotFound(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If IsNumeric(_EdiversaOrderItem.RefProveidor) Then
            oProduct = Await FEB2.ProductSku.FromId(exs, Current.Session.Emp, _EdiversaOrderItem.RefProveidor)
            If exs.Count <> 0 Then
        ...
        If oProduct Is Nothing And _EdiversaOrderItem.RefClient > "" Then
            ...
            Dim oCustomerProducts = Await FEB2.CustomerProducts.All(exs, oEdiversaOrder.Comprador,, _EdiversaOrderItem.RefClient)
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Dim exs As New List(Of Exception)
        If Await FEB2.EdiversaOrder.Update(_EdiversaOrderItem.Parent, exs) Then
