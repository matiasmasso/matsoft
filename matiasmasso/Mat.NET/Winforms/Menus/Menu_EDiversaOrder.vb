Public Class Menu_EDiversaOrder
    ...
    Public Shadows Event RequestToToggleProgressBar(sender As Object, e As MatEventArgs)
    ...
    Private Async Sub Do_Descarta(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Await FEB2.EdiversaOrders.Descarta(exs, _EdiversaOrders) Then
    ...
    Private Sub Do_Confirm(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        If FEB2.EdiversaOrder.Load(_EdiversaOrders(0), exs) Then
    ...
    Private Async Sub Do_Restore(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        For Each oOrder In _EdiversaOrders
            ...
            If FEB2.EdiversaFile.Load(oFile, exs) Then
                If Not Await FEB2.EdiversaFileSystem.SaveInboxFile(oFile, exs) Then
                    UIHelper.WarnError(exs)
                End If
            End If
        Next
        ...
        If Await FEB2.EdiversaOrders.Validate(_EdiversaOrders, exs) Then
    ...
    Private Async Sub Do_Procesa(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim exs As New List(Of Exception)
        If Await FEB2.EdiversaOrders.Procesa(Current.Session.User, _EdiversaOrders, exs) Then
            MyBase.RefreshRequest(Me, New MatEventArgs(_EdiversaOrders))
        Else
            UIHelper.WarnError(exs)
        End If
    ...
    Private Sub Do_Excel()
        Dim oCsv As DTOCsv = FEB2.EdiversaOrders.Csv(_EdiversaOrders)
