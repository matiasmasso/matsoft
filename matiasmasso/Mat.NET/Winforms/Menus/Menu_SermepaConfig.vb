Public Class Menu_SermepaConfig
    Inherits Menu_Base

    Private _SermepaConfig As DTOSermepaConfig


    Public Sub New(ByVal oSermepaConfig As DTOSermepaConfig)
        MyBase.New()
        _SermepaConfig = oSermepaConfig
        AddMenuItems()
    End Sub
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("Eliminem " & _SermepaConfig.Nom & "?", MsgBoxStyle.OkCancel)
