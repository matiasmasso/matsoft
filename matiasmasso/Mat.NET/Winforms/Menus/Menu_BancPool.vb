Public Class Menu_BancPool
    ...
    Public Sub New(ByVal oBancPool As DTOBancPool)
        MyBase.New()
        _BancPool = oBancPool
        AddMenuItems()
    End Sub
    ...
    Private Sub Do_Zoom(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim oFrm As New Frm_BancPool(_BancPool)
        AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
        oFrm.Show()
    End Sub

    Private Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("Eliminem " & _BancPool.Bank.RaoSocial & "?", MsgBoxStyle.OkCancel)
