Public Class Menu_VehicleModel
    ...
    Private _VehicleModels As List(Of DTOVehicleModel)
    Private _VehicleModel As DTOVehicleModel


    Public Sub New(ByVal oVehicleModels As List(Of DTOVehicleModel))
        MyBase.New()
    ...
    Public Sub New(ByVal oVehicleModel As DTOVehicleModel)
        MyBase.New()
        _VehicleModel = oVehicleModel
        _VehicleModels = New List(Of DTOVehicleModel)
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            ...
            If Await FEB2.VehicleModel.Delete(_VehicleModels.First, exs) Then
