Public Class Menu_PurchaseOrder
        ...
        If FEB2.PurchaseOrder.Load(exs, _PurchaseOrder) Then
            Select Case _PurchaseOrder.Cod
                Case DTOPurchaseOrder.Codis.Client
                    If Await FEB2.AlbBloqueig.BloqueigStart(Current.Session.User, _PurchaseOrder.Customer, DTOAlbBloqueig.Codis.PDC, exs) Then
                ...
                Case DTOPurchaseOrder.Codis.Proveidor
                    If Await FEB2.AlbBloqueig.BloqueigStart(Current.Session.User, _PurchaseOrder.Proveidor, DTOAlbBloqueig.Codis.PDC, exs) Then
    ...
    Private Async Sub Do_Delete()
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB2.PurchaseOrder.Delete(exs, _PurchaseOrders) Then
