Public Class Xl_NominasNew
    ...
    Public Shadows Sub Load(value As Nominas)
        _ControlItems = New ControlItems
        For Each oItem As Nomina In value
    ...
    Public WriteOnly Property Fch As Date
        Set(value As Date)
            For Each oItem As ControlItem In _ControlItems
                Dim oNomina As Nomina = oItem.Source
                oNomina.Fch = value
            Next
        End Set
    End Property

    Public ReadOnly Property SelectedValues As Nominas
        Get
            Dim retval As New Nominas
            For Each oItem As ControlItem In _ControlItems
    ...
    Private Sub LoadGrid()
        With DataGridView1
            ...
            .Columns.Add(New DataGridViewTextBoxColumn)
            With .Columns(Cols.Embargos)
                .DataPropertyName = "Embargos"
                .HeaderText = "embargos"
                .AutoSizeMode = DataGridViewAutoSizeColumnMode.None
                .Width = 70
                .DefaultCellStyle.Format = "#,##0.00 €;-#,##0.00 €;#"
    ...
    Private Function SelectedItems() As Nominas
        Dim retval As New Nominas
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            'Dim oMenu_RepComLiquidable As New Menu_Nomina(SelectedItems)
    ...
    Protected Class ControlItem
        Public Property Source As Nomina
        ...
        Public Sub New(oNomina As Nomina)
            ...
            With oNomina
                ...
                If .Embargos IsNot Nothing Then _Embargos = .Embargos.Eur
                If .Deutes IsNot Nothing Then _Deutes = .Deutes.Eur
                If .Liquid IsNot Nothing Then _Liquid = .Liquid.Eur

                If (_Devengat) <> (_SegSoc + _Irpf + _Embargos + _Deutes + _Liquid) Then
