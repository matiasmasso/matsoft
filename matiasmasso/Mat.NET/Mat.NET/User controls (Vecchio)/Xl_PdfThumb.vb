...
Public Class Xl_PdfThumb
    ...
    Private Sub Refresca()
        ...
        Else
            PictureBox1.Image = maxisrvr.GetThumbnail(mBigFile.BigFile.Img, PictureBox1.Width, PictureBox1.Height)
        ...
        With mBigFile.BigFile
            Select Case .MimeCod
                Case DTOEnums.MimeCods.Jpg, DTOEnums.MimeCods.Gif
                    ...
                    oImg = maxisrvr.GetThumbnail(oImg, maxisrvr.BigFileNew.THUMB_WIDTH, maxisrvr.BigFileNew.THUMB_HEIGHT)
