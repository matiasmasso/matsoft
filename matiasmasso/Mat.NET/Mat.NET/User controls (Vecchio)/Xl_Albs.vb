Public Class Xl_Albs
    ...
    Public Shadows Sub Load(value As Albs)
    ...
    Private Function SelectedItems() As Albs
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Alb As New Menu_Alb(SelectedItems)
    ...
    Protected Class ControlItem
        ...
        Public Property CashIco As Image
            ...
            With oAlb
                ...
                Select Case .CashCod
                    ...
                    Case DTO.DTOCustomer.CashCodes.Reembols
                        _CashIco = My.Resources.DollarBlue
                    Case DTO.DTOCustomer.CashCodes.TransferenciaPrevia
                        _CashIco = My.Resources.DollarOrange2
                    Case DTO.DTOCustomer.CashCodes.Visa
                        _CashIco = My.Resources.CreditCard
                End Select
                ...
                If .Transportista IsNot Nothing Then
                    _Transport = .Transportista.Nom_o_NomComercial
                End If
            End With
        End Sub
