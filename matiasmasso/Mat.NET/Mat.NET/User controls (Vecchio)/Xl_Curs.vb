Public Class Xl_Curs

    Private _DataSource As Curs
    ...
    Public Shadows Sub Load(oDataSource As Curs, Optional oDefaultItem As Cur = Nothing)
        _DataSource = oDataSource
        _DefaultItem = oDefaultItem
        LoadGrid()
    End Sub

    Public Function SelectedItem() As Cur
        Dim oControlItem As ControlItem = CurrentItem()
        Dim retval As Cur = Nothing
    ...
    Private Sub SetContextMenu()
        ...
        Dim oCur As Cur = CurrentItem.Source
    ...
    Private Sub LoadGrid()
        ...
        For Each oCur As Cur In _DataSource
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oControlItem As ControlItem = CurrentItem()
        Dim oCur As Cur = oControlItem.Source
