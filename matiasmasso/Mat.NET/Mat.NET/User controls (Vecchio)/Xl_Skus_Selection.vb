Public Class Xl_Skus_Selection
    ...
    Private _Mode As Modes 'TO DEPRECATE
    Private Enum Modes
        NewMode
        OldMode
    End Enum
    ...
    Public Shadows Sub Load(value As List(Of DTOProductSku))
        _Mode = Modes.NewMode 'TO DEPRECATE
    ...
    Public Shadows Sub Load(value As List(Of ProductSku)) 'TO DEPRECATE
        _Mode = Modes.OldMode
        _ControlItems = New ControlItems
        For Each oSku As ProductSku In value
            Dim oItem As New ControlItem(oSku)
            _ControlItems.Add(oItem)
        Next
    ...
    Public Function CurrentItemOld() As ProductSku 'TO DEPRECATE
        Dim retval As ProductSku = Nothing
        Dim oRow As DataGridViewRow = DataGridView1.CurrentRow
        If oRow IsNot Nothing Then
            Dim oItem As ControlItem = oRow.DataBoundItem
            retval = oItem.SourceOld
        End If
        Return retval
    End Function
    ...
    Private Sub Sortida()
        ...
        Select Case _Mode
            ...
            Case Modes.OldMode
                oEventArgs = New MatEventArgs(CurrentItemOld)
        End Select
    ...
    Private Sub DataGridView1_CellFormatting(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellFormattingEventArgs) Handles DataGridView1.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.Nom
                ...
                Select Case _Mode
                    Case Modes.NewMode
                        e.CellStyle.BackColor = BLL.BLLProductSku.BackColor(oItem.Source)
                    Case Modes.OldMode
                        e.CellStyle.BackColor = BLL_ProductSku.BackColor(oItem.SourceOld)
                End Select
        End Select
    End Sub
...
#Region "ControlItem"
    ...
    Protected Class ControlItem
        ...
        Public Property SourceOld As ProductSku  'TO DEPRECATE
        ...
        Public Sub New(oSku As ProductSku) 'TO DEPRECATE
            MyBase.New()
            _SourceOld = oSku
            With _SourceOld
                _Sku = .Sku
