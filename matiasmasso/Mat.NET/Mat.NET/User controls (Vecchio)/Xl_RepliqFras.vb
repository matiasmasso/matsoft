Public Class Xl_RepliqFras
    ...
    Public WriteOnly Property RepComsLiquidables As List(Of DTORepComLiquidable)
        Set(value As List(Of DTORepComLiquidable))
            _ControlItems = New ControlItems
            For Each oItem As DTORepComLiquidable In value
