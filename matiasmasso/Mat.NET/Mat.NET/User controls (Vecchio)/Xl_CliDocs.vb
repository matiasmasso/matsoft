Public Class Xl_CliDocs
    ...
    Public Shadows Sub Load(value As CliDocs)

        _ControlItems = New ControlItems
        For Each oItem As CliDoc In value
    ...
    Public ReadOnly Property Value As CliDoc
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As CliDoc = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As CliDocs
        Dim retval As New CliDocs
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_CliDoc As New Menu_CliDoc(SelectedItems.First)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oSelectedValue As CliDoc = CurrentControlItem.Source
        Dim oFrm As New Frm_CliDoc(oSelectedValue)
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles DataGridView1.RowPrePaint
        ...
        Dim oControlItem As ControlItem = oRow.DataBoundItem
        Dim oCliDoc As CliDoc = oControlItem.Source
    ...
    Protected Class ControlItem
        Public Property Source As CliDoc
        ...
        Public Sub New(oCliDoc As CliDoc)
            MyBase.New()
            _Source = oCliDoc
            With oCliDoc
