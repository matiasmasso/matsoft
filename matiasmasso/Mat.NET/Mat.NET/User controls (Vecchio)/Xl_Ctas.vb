Public Class Xl_Ctas
    ...
    Private _ControlItems As PgcCtas
    ...
    Public WriteOnly Property DataSource As PgcCtas
        Set(value As PgcCtas)
            _ControlItems = value
            LoadGrid()
        End Set
    End Property

    Public Property SelectedObject As PgcCta
        Get
            Dim retval As PgcCta = CurrentItem()
            Return retval
        End Get
        Set(value As PgcCta)
    ...
    Private Function CurrentItem() As PgcCta
    ...
    Private Sub SetContextMenu()
        ...
        Dim oControlItem As PgcCta = CurrentItem()
    ...
    Public Function WidthAdjustment() As Integer
        ...
        For Each oItem As PgcCta In _ControlItems
            Dim iWidth As Integer = DataGridViewCell.MeasureTextWidth(oGraphics, oItem.Cat, DataGridView1.Font, DataGridView1.RowTemplate.Height, TextFormatFlags.Left)
