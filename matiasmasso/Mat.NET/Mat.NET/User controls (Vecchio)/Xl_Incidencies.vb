Public Class Xl_Incidencies
    ...
    Private Sub LoadGrid()
        With DataGridView1
            ...
            With CType(.Columns(Cols.PdfIco), DataGridViewImageColumn)
            ...
            .Columns.Add(New DataGridViewImageColumn)
            With CType(.Columns(Cols.ImgIco), DataGridViewImageColumn)
    ...
    Private Sub Do_AddNew()
        Dim oIncidencia As DTOIncidencia = BLL_Incidencia.NewFromCustomer(Nothing, DTOIncidencia.Srcs.Producte)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oTemplate_Object As DTOIncidencia)
            MyBase.New()
            _Source = oTemplate_Object
            With oTemplate_Object
                _Id = .Id
                _Fch = .Fch
                ...
                If .Customer IsNot Nothing Then
                    _clx = .Customer.Nom
                End If
                _prodNom = BLL.BLLProduct.FullNom(.Product)
                _FchClose = .FchClose
