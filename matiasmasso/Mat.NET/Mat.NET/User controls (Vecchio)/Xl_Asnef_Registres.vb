...
Public Class Xl_Asnef_Registres
    ...
    Private Sub LoadGrid()
        ...
        oDs = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@EMP", mEmp.Id)
    ...
    Private Function CurrentItem() As Impagat
        Dim oRetVal As Impagat = Nothing
        Dim oRow As DataGridViewRow = DataGridView1.CurrentRow
        If oRow IsNot Nothing Then
            oRetVal = New Impagat(New System.Guid(oRow.Cells(Cols.Guid).Value.ToString))
        End If
        Return oRetVal
    End Function

    Private Sub Zoom(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim oItem As Impagat = CurrentItem()
