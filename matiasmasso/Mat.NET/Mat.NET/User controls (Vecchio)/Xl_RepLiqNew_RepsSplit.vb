Public Class Xl_RepLiqNew_RepsSplit
    ...
    Private Function GetControlItemByRep(oRep As DTORep) As ControlItem
        ...
        If retval Is Nothing Then
            retval = New ControlItem(oRep, New Amt, New Amt)
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Rep As New Menu_Rep(oControlItem.Source)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oRep As DTORep, oBase As Amt, oComisio As Amt)
            MyBase.New()
            _Source = oRep
            _Checked = True
