Public Class Xl_Emps
    ...
    Public Shadows Sub Load(values As List(Of DTOEmp), selectedvalue As DTOEmp, Optional SelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
    ...
    Private Sub DataGridView1_SelectionChanged(sender As Object, e As EventArgs) Handles DataGridView1.SelectionChanged
        If _AllowEvents Then
            If _SelectionMode = BLL.Defaults.SelectionModes.Browse Then
