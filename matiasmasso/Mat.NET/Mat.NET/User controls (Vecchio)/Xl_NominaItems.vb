Public Class Xl_NominaItems
    ...
    Public WriteOnly Property DataSource As NominaItems
        Set(value As NominaItems)
            _ControlItems = New ControlItems
            For Each oItem As NominaItem In value
    ...
    Private Function SelectedItems() As NominaItems
        Dim retval As New NominaItems
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Protected Class ControlItem
        Public Property Source As NominaItem
        ...
        Public Sub New(oNominaItem As NominaItem)
            MyBase.New()
            _Source = oNominaItem
            With oNominaItem
                _Cod = .Concepte.Id
