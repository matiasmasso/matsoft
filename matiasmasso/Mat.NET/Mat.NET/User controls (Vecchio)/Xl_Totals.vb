...
#End Region
    ...
    Private mCash As DTO.DTOCustomer.CashCodes
    Private mCredit As maxisrvr.Amt
    ...
    Public WriteOnly Property Credit() As maxisrvr.Amt
        Set(ByVal Value As maxisrvr.Amt)
            mCredit = Value
        End Set
    End Property

    Public Property Suma() As maxisrvr.Amt
        Get
    ...
    Public ReadOnly Property BaseImponible() As maxisrvr.Amt
        Get
    ...
    Public ReadOnly Property Total() As maxisrvr.Amt
        Get
            Return Xl_AmtTot.Amt
        End Get
    End Property

    Public Property Suplemento() As maxisrvr.Amt

        Get
            If CheckBoxSuplto.Checked Then
                If Xl_AmtSuplto.Amt Is Nothing Then
                    Dim oCur As maxisrvr.Cur = Xl_AmtSuma.Amt.Cur
                    Return New Amt(oCur)
                Else
    ...
    Public Function Liquid() As maxisrvr.Amt
    ...
    Public WriteOnly Property Cash() As DTO.DTOCustomer.CashCodes
        Set(ByVal Value As DTO.DTOCustomer.CashCodes)
            mCash = Value
            Select Case mCash
    ...
    Private Sub Calcula()
        ...
        Select Case mCash
            ...
            Case Else
                If CheckBoxSuplto.Checked Then
                    Dim oSuplto As maxisrvr.Amt = Xl_AmtSuplto.Amt
                    If oSuplto Is Nothing Then
                        oSuplto = New maxisrvr.Amt(0, oTot.Cur, 0)
    ...
    Private Sub CheckBoxIVA_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxIVA.CheckedChanged
        ...
        If CheckBoxIVA.Checked Then
            Xl_PercentIVA.Value = maxisrvr.Iva.Standard.Tipus
    ...
    Private Sub CheckBoxReq_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxReq.CheckedChanged
        Xl_PercentReq.Visible = CheckBoxReq.Checked
        If CheckBoxReq.Checked Then
            Dim oReq As MaxiSrvr.Iva = MaxiSrvr.Iva.Current(DTOTax.Codis.Recarrec_Equivalencia_Standard)
            Xl_PercentReq.Value = oReq.Tipus
        End If
        Calcula()
        SetDirty()
    End Sub
    ...
    Private Sub Xl_PercentDto_AfterUpdate(ByVal SngPercent As Object, ByVal e As System.EventArgs) Handles Xl_PercentDto.AfterUpdate
        Calcula()
        SetDirty()
    End Sub

    Private Sub Xl_PercentDpp_AfterUpdate(ByVal SngPercent As Object, ByVal e As System.EventArgs) Handles Xl_PercentDpp.AfterUpdate
        Calcula()
        SetDirty()
    End Sub
    ...
    Private Sub Xl_PercentReq_AfterUpdate(ByVal SngPercent As Object, ByVal e As System.EventArgs) Handles Xl_PercentReq.AfterUpdate
        Calcula()
        SetDirty()
    End Sub
