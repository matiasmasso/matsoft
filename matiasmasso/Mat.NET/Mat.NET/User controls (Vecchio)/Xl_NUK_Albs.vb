...
Public Class Xl_NUK_Albs
    ...
    Private Sub LoadGrid()
        ...
        & "ALBC.YEA AS YEAC, ALBC.alb AS CALB, CLX.clx, ALBC.CashCod, ALBC.eur + ALBC.Pt2 AS AMT " _
    ...
    Private Sub RedactaEntrada(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        For Each oItm As LineItmArc In oCliAlb.Itms
            ...
            Dim oTarifa As maxisrvr.Amt = oItm.Art.Cost
            Dim oPncLin As New LineItmPnc
            With oPncLin
                .Qty = oItm.Qty
                .Art = oArt
