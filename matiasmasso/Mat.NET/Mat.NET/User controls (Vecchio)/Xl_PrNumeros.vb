Public Class Xl_PrNumeros
    ...
    Public Shadows Sub Load(oPrNumeros As PrNumeros)
        ...
        LoadYear(Xl_Exercicis1.SelectedItem)
    End Sub
    ...
    Private Sub LoadYears(oPrNumeros As PrNumeros)
        Dim oExercicis As New Exercicis
        Dim oEmp as DTOEmp = BLL.BLLApp.Emp
        Dim oExercici As New Exercici(oEmp)
        For Each oPrNumero As PrNumero In oPrNumeros
            If oPrNumero.Yea <> oExercici.Yea Then
                oExercici = New Exercici(oEmp, oPrNumero.Yea)
    ...
    Private Sub LoadYear(value As Exercici)
        Dim oPrNumeros As List(Of PrNumero) = _PrNumeros.FindAll(Function(x) x.Yea = value.Yea)
    ...
    Protected Class ControlItem
        ...
        Private Function GetText(oPrNumero As PrNumero) As String
            ...
            sb.Append(Lang.CAT.MesAbr(oPrNumero.Mes) & " " & oPrNumero.Yea.ToString)
