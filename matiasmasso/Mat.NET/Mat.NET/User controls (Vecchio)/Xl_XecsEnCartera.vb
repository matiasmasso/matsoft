Public Class Xl_XecsEnCartera
    ...
    Public WriteOnly Property DataSource As Xecs
        Set(value As Xecs)
            _ControlItems = New ControlItems
            For Each oItem As Xec In value
    ...
    Public ReadOnly Property SelectedValues As Xecs
        Get
            Dim retval As New Xecs
    ...
    Private Function SelectedItems() As Xecs
        Dim retval As New Xecs
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oXec As Xec)
            ...
            With oXec
                ...
                _Amt = .Amt.Eur
                _XecNum = .XecNum
                _Banc = BLL.BLLIban.BankNom(.Iban)
                _Client = .Lliurador.Clx
            End With
        End Sub
