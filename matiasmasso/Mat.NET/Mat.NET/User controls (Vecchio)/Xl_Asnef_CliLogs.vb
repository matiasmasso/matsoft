...
Public Class Xl_Asnef_CliLogs
    ...
    Private Sub LoadGrid()
        ...
        oDs = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@EMP", mContact.Emp.Id, "@CLI", mContact.Id)
    ...
    Private Sub Zoom(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If TypeOf (oItem) Is AsnefConsulta Then
            ...
            oFrm.Show()
        ElseIf TypeOf (oItem) Is Impagat Then
            Dim oImpagat As Impagat = DirectCast(oItem, Impagat)
