Public Class Xl_RaffleParticipants
    ...
    Public Shadows Sub Load(values As List(Of DTORaffleParticipant), oMode As Modes)
        _values = values
    ...
    Private Sub LoadGrid()
        ...
        LabelCount.Text = _ControlItems.Count & " participants"
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_RaffleParticipant As New Menu_RaffleParticipant(SelectedItems.First)
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles DataGridView1.RowPrePaint
        ...
        Dim oControlItem As ControlItem = oRow.DataBoundItem
        If oControlItem.Source.User.FchCreated > oControlItem.Source.Raffle.FchFrom Then
            'nou lead
