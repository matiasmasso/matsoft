...
Public Class Xl_Pais
    ...
    Private Sub Refresca()
        ...
        Else
            ...
            If _Country.ISO = MaxiSrvr.Country.Default.ISO Then
                PictureBox1.Image = Nothing
            Else
                PictureBox1.Image = _Country.Flag
            End If
            sToolTipText = _Country.Nom(BLL.BLLSession.Current.User.Lang) & " (doble clic per canviar)"
        End If
    ...
    Private Sub Do_Change(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim oFrm As New Frm_Countries(_Country, BLL.Defaults.SelectionModes.Selection)
