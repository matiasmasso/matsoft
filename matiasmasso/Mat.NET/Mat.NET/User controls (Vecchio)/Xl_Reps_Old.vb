...
#End Region
    ...
    Public WriteOnly Property Reps() As Reps
        Set(ByVal Value As Reps)
    ...
    Private Sub SetReps()
        If mReps Is Nothing Then mReps = App.Current.emp.Reps(mHideObsoletos, mIncludeNoRep)
        Dim oRep As Rep
