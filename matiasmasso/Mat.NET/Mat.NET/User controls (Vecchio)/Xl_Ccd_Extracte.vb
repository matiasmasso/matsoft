...
Public Class Xl_Ccd_Extracte
    ...
    Private Sub LoadGrid()
        ...
        Dim EurId As String = MaxiSrvr.Cur.Eur.Id
        Dim CurId As String = ""
    ...
    Private Function FormatPnd(oPnd As Pnd) As String
        Dim retval As String = oPnd.Vto.ToShortDateString & " " & oPnd.Amt.CurFormat
        Return retval
    End Function
