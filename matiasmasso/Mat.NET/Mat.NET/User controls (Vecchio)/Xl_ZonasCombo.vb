Public Class Xl_ZonasCombo
    ...
    Public Shadows Sub Load(values As List(Of Zona), Optional oSelectedArea As area = Nothing)
        _ControlItems = New ControlItems
        _ControlItems.Add(ControlItem.AllZonas)
        For Each oZona As Zona In values
        ...
        If oSelectedArea IsNot Nothing Then
            For i As Integer = 1 To _ControlItems.Count - 1
                If _ControlItems(i).Source.Guid.Equals(oSelectedArea.Zona.Guid) Then
    ...
    Public ReadOnly Property Value As Zona
        Get
            Dim retval As Zona = Nothing
    ...
    Protected Class ControlItem
        Public Property Source As Zona

        Public Property Nom As String

        Public Sub New(Optional oZona As Zona = Nothing)
            MyBase.New()
