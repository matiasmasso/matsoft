Public Class Frm_PriceListSupplier_Import
    ...
    Private Sub ButtonFileBrowse_Click(sender As Object, e As EventArgs) Handles ButtonFileBrowse.Click
        ...
        With oDlg
            ...
            If .ShowDialog = Windows.Forms.DialogResult.OK Then
                ...
                Dim oSheets As List(Of String) = ExcelHelper.GetSheetNames(.FileName)
                ComboBoxSheets.DataSource = oSheets
                Dim sSelectedSheet As String = ComboBoxSheets.SelectedItem
                SetSourceColumns(.FileName, sSelectedSheet)
                SetDataSource()
            End If
        End With
    End Sub

    Private Sub SetSourceColumns(sFileName As String, sSheetName As String)
        Dim oSrcColumn As DataGridViewComboBoxColumn = DataGridView1.Columns(Cols.Source)
        Dim oDataSource = ExcelHelper.GetColumnNames(sFileName, sSheetName)
    ...
    Private Sub SetGrid()
        With DataGridView1
            ...
            With CType(.Columns(Cols.Source), DataGridViewComboBoxColumn)
                .HeaderText = "Columna"
