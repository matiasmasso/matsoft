    ...
    Private Sub refresca()
        ...
        For Each oItem As DTOFairGuest In _values
            ...
            If _filter = "" Then
                blProcede = True
            Else
                blProcede = (oItem.FirstName.ToUpper.Contains(_filter.ToUpper) Or _
                             oItem.LastName.ToUpper.Contains(_filter.ToUpper) Or _
                             oItem.RaoSocial.ToUpper.Contains(_filter.ToUpper) Or _
