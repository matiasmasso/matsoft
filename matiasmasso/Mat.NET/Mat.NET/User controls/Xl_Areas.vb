Public Class Xl_Areas
    ...
    Public Shadows Sub Load(values As List(Of DTOArea), Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
    ...
    Private Function FilteredValues() As List(Of DTOArea)
        ...
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) BLL.BLLArea.Nom(x).ToLower.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOArea)
            ...
            _Source = value
            With value
                _Nom = BLL.BLLArea.FullNomSegmentedReversed(value, BLL.BLLSession.Current.User.Lang)
            End With
        End Sub
