Public Class Xl_Gir_SelEfts2
    ...
    Public Shadows Sub Load(values As List(Of DTO.DTOCsb), oDescuadres As List(Of DTOCcd))
        _Descuadres = oDescuadres
        _ControlItems = New ControlItems
        For Each oItem As DTO.DTOCsb In values
    ...
    Public ReadOnly Property Values As List(Of DTO.DTOCsb)
        Get
            Dim retval As New List(Of DTO.DTOCsb)
    ...
    Public ReadOnly Property Value As DTO.DTOCsb
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTO.DTOCsb = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Public Sub SetAmt(oAmt As DTOAmt)
        ...
        If _ControlItems IsNot Nothing Then
            ...
            For Each oItem As ControlItem In _ControlItems
                Dim oContactGuid As Guid = CType(oItem.Source, DTO.DTOCsb).Contact.Guid
                Dim BlNegative As Boolean = oControlList.Exists(Function(x) CType(x.Source, DTO.DTOCsb).Contact.Guid.Equals(oContactGuid) And CType(x.Source, DTO.DTOCsb).Amt.Eur < 0)
                If BlNegative Then
                    oItem.Checked = False
                Else
    ...
    Private Sub LoadGrid()
        With DataGridView1
            ...
            With CType(.Columns(Cols.Chk), DataGridViewCheckBoxColumn)
            ...
            With CType(.Columns(Cols.Warn), DataGridViewImageColumn)
                .HeaderText = ""
                .AutoSizeMode = DataGridViewAutoSizeColumnMode.None
                .Width = 16
                .DefaultCellStyle.NullValue = Nothing
    ...
    Private Sub DataGridView1_RowPrePaint(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewRowPrePaintEventArgs) Handles DataGridView1.RowPrePaint
        ...
        Dim oControlItem As ControlItem = oRow.DataBoundItem
        Dim oContactGuid As Guid = CType(oControlItem.Source, DTO.DTOCsb).Contact.Guid
        Dim BlNegative As Boolean = _ControlItems.ToList.Exists(Function(x) CType(x.Source, DTO.DTOCsb).Contact.Guid.Equals(oContactGuid) And CType(x.Source, DTO.DTOCsb).Amt.Eur < 0)
        If BlNegative Then
    ...
    Private Function SelectedItems() As List(Of DTO.DTOCsb)
        Dim retval As New List(Of DTO.DTOCsb)
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oCsb As DTO.DTOCsb = oControlItem.Source
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oSelectedValue As DTO.DTOCsb = CurrentControlItem.Source
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oCsb As DTO.DTOCsb)
            MyBase.New()
            _Source = oCsb
            With oCsb
                _Checked = False
