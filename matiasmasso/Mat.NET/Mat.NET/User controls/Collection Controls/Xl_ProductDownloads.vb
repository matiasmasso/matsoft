Public Class Xl_ProductDownloads
    ...
    Public Shadows Sub Load(values As List(Of DTOProductDownload), Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
