Public Class Xl_Taxes
    ...
    Public Shadows Sub Load(values As List(Of DTOTax), Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
    ...
    Private Function FilteredValues() As List(Of DTOTax)
        ...
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) BLL.BLLTax.Nom(x.Codi).ToLower.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOTax)
            ...
            With value
                _Fch = .Fch
                _Tipus = .Tipus
                _Nom = BLL.BLLTax.Nom(.Codi, BLL.BLLSession.Current.User.Lang)
            End With
        End Sub
