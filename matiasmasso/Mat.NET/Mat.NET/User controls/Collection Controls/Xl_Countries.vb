Public Class Xl_Countries
    ...
    Public Shadows Sub Load(values As List(Of DTOCountry), Optional oDefaultValue As DTOCountry = Nothing, Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOCountry)
            ...
            _Source = value
            With value
                _Nom = BLL.BLLCountry.Nom(_Source, BLL.BLLSession.Current.User.Lang)
            End With
        End Sub
