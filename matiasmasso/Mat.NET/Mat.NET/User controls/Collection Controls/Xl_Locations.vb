Public Class Xl_Locations
    ...
    Public Shadows Sub Load(values As List(Of DTOLocation), Optional oDefaultValue As DTOLocation = Nothing, Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
