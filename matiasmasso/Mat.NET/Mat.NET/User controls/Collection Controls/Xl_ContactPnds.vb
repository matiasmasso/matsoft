Public Class Xl_ContactPnds
    ...
    Private _Impagats As List(Of DTO.DTOImpagat)
    ...
    Public Shadows Sub Load(oPnds As List(Of DTOPnd), oImpagats As List(Of DTO.DTOImpagat))
    ...
    Private Sub Refresca()
        ...
        For Each oItem As DTO.DTOImpagat In _Impagats
            Dim oControlItem As New ControlItem(oItem)
            _ControlItems.Add(oControlItem)
        Next
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        If oCurrentControlItem IsNot Nothing Then
            Select Case oCurrentControlItem.LinCod
                Case ControlItem.LinCods.Pnd
                    Dim oPnd As New Pnd
                    oPnd.Guid = oCurrentControlItem.Source.Guid
    ...
    Protected Class ControlItem
        ...
        Shared ReadOnly Property CtaImpagats As DTOPgcCta
            Get
                ...
                If retval Is Nothing Then
                    retval = BLL.BLLPgcCta.FromCod(DTOPgcPlan.Ctas.impagats)
                End If
                Return retval
            End Get
        End Property
        ...
        Public Sub New(value As DTOPnd)
            ...
            With value
                _Vto = .Vto
                _Amt = .Amt.Eur
                _Cta = BLL.BLLPgcCta.FullNom(.Cta, BLL.BLLApp.Lang)
                _Fra = .FraNum
                _Fch = .Fch
                _Obs = .Fpg
                _LinCod = LinCods.Pnd
        ...
        Public Sub New(value As DTO.DTOImpagat)
            MyBase.New()
            _Source = value
            With value
                _Vto = .Csb.Vto
                _Amt = .Csb.Amt.Eur
                _Cta = BLL.BLLPgcCta.FullNom(CtaImpagats, BLL.BLLApp.Lang)
                _Fra = .Csb.FraNum
                _Fch = .FchAFP
                _Obs = .Obs
