Public Class Xl_Zonas
    ...
    Public Shadows Sub Load(values As List(Of DTOZona), Optional oDefaultValue As DTOZona = Nothing, Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
