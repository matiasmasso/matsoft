Public Class Xl_Users
    ...
    Public Shadows Sub Load(values As List(Of DTOUser), Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
    ...
    Private Sub Refresca()
        ...
        For Each oItem As DTOUser In FilteredValues()
    ...
    Private Sub Do_Csv()
        ...
        For Each Item As DTOUser In _Values
            Dim oRow As DTOCsvRow = BLL.BLLCsv.AddRow(oCsv)
