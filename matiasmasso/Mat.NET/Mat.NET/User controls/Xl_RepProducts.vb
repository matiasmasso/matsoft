Public Class Xl_RepProducts
    ...
    Private Sub LoadControlItems()
        ...
        For Each oItem As DTORepProduct In _values
            If BLL.BLLRepProduct.IsActive(oItem) Or Not _ObsoletsHidden Then
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles DataGridView1.RowPrePaint
        ...
        If oRepProduct.FchTo <> Nothing And oRepProduct.FchTo < Today Then
            oRow.DefaultCellStyle.BackColor = Color.LightGray
        ElseIf oRepProduct.FchFrom > Today Then
