Public Class Xl_Reps
    ...
    Private _Mode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse
    ...
    Public Shadows Sub Load(values As List(Of DTORep), Optional oDefaultRep As DTORep = Nothing, Optional oMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
        _Mode = oMode
