Public Class Xl_PurchaseOrderDeliveryItems
    ...
    Public Shadows Sub Load(values As List(Of DTODeliveryItem), Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTODeliveryItem)
            ...
            With value
                ...
                End If
                _Sku = .PurchaseOrderItem.Sku.NomLlarg
                _Qty = .Qty
