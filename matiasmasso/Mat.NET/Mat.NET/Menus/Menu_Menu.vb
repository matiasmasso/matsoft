Public Class Menu_Menu
    ...
    Private Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("Eliminem " & BLL.BLLMenu.Nom(_Menu, BLL.BLLSession.Current.Lang) & "?", MsgBoxStyle.OkCancel)
        If rc = MsgBoxResult.Ok Then
            Dim exs as New List(Of exception)
            If BLL.BLLMenu.Delete(_Menu, exs) Then
                MsgBox(" " & BLL.BLLMenu.Nom(_Menu, BLL.BLLSession.Current.Lang) & " eliminat", MsgBoxStyle.Information, "M+O")
