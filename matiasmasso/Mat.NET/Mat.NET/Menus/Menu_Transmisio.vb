...
Public Class Menu_Transmisio
    ...
    Public Function Range() As ToolStripMenuItem()
        ...
        MenuItem_GetXML(), _
        MenuItem_GetAlbs(), _
        MenuItem_SendOutlook(), _
        MenuItem_SendExchange() _
        })
    End Function
    ...
    Private Sub Do_Zoom(ByVal sender As System.Object, ByVal e As System.EventArgs)
        TransmisioLoader.Load(mTransmisio)
        Dim oFrm As New Frm_Transmisio_New(mTransmisio)
    ...
    Private Sub Do_SendOutlook(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Dim exs as New List(Of exception)
        With mTransmisio
            If Not MatOutlook.NewMessage(.SendTo, "", , .SendSubject, , .SendUrlBody, .SendAttachments, exs) Then
