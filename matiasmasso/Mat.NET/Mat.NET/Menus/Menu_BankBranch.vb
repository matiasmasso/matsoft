Public Class Menu_BankBranch
    ...
    Private Sub Do_Del(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("eliminem aquesta oficina?" & vbCrLf & _BankBranch.ToString & "?", MsgBoxStyle.OkCancel, "MAT.NET")
        If rc = MsgBoxResult.Ok Then
            Dim exs as New List(Of exception)
            If BLL.BLLBankBranch.Delete(_BankBranch, exs) Then
