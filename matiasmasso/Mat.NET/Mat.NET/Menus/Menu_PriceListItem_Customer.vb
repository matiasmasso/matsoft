Public Class Menu_PricelistItemCustomer
    ...
    Private Function MenuItem_Art() As ToolStripMenuItem
        ...
        Dim oMenuArt As New Menu_Art(_Item.Sku)
    ...
    Private Sub Do_Historial(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim oFrm As New Frm_PricelistItemCustomer_Historial(_Item.Sku)
        'AddHandler oFrm.AfterUpdate, AddressOf RefreshRequest
        oFrm.Show()
    End Sub

    Private Sub Do_Del(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("Eliminem el preu de " & _Item.Sku.NomCurt & " ?", MsgBoxStyle.OkCancel, "M+O")
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If BLL.BLLPricelistItemCustomer.Delete(_Item, exs) Then
