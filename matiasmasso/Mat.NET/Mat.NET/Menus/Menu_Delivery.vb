...
Public Class Menu_Delivery
    ...
    Public Sub New(ByVal oDeliveries As List(Of DTODelivery))
        MyBase.New()
        _Deliveries = oDeliveries

        mAlbs = New Albs
        For Each item As DTODelivery In oDeliveries
            mAlbs.Add(New Alb(item.Guid))
        Next
    End Sub
    ...
    Public Sub New(ByVal oAlbs As Albs)
        ...
        For Each item As Alb In oAlbs
            _Deliveries.Add(New DTODelivery(item.Guid))
        Next
    End Sub
