...
Public Class Frm_Csb
    ...
    Private Sub Refresca()
        ...
        TextBoxEur.Text = mCsb.Amt.CurFormat
        TextBoxTxt.Text = mCsb.txt
        PictureBoxIBAN.Image = BLL.BLLIban.Img(mCsb.Iban.Digits)
    ...
    Private Sub ButtonCcaVto_Click(sender As Object, e As EventArgs) Handles ButtonCcaVto.Click
        ...
        Dim oCta As PgcCta = PgcPlan.FromYear(DtFch.Year).Cta(DTOPgcPlan.ctas.BancsEfectesDescomptats)
        Dim oFrm As New Frm_CliCtas(mCsb.Client, oCta, oExercici, bll.dEFAULTS.SelectionModes.Selection)
