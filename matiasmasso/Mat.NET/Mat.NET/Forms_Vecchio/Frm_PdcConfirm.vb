...
Public Class Frm_PdcConfirm
    ...
    Xl_BigFile1.AfterUpdate, _
    DateTimePickerFch.ValueChanged, _
    TextBoxRef.TextChanged, _
    Xl_Contact1.AfterUpdate, _
    DateTimePickerETD.ValueChanged, _
    DateTimePickerETA.ValueChanged, _
    ...
    Private Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        With mPdcConfirm
            If Xl_BigFile1.IsDirty Then
                .BigFile = New BigFileSrc(DTODocFile.Cods.PdcConfirm, .Guid, Xl_BigFile1.BigFile)
            End If
