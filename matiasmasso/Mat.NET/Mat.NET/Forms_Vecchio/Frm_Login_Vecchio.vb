Public Class Frm_Login_Vecchio
    Public Event OnSuccessLogging(sender As Object, e As EventArgs)
    ...
    Private Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Select Case oResult
            ...
            Case BLL_Usuari.ValidationResults.Success
                BLL.BLLSession.Current = BLL_Session.GetNewSession(, oUser)
                SaveSetting("MatSoft", "MAT.NET", DTOSession.CookieSessionName, BLL.BLLSession.Current.Guid.ToString)
                SaveSetting("MatSoft", "MAT.NET", DTOSession.CookiePersistName, IIf(CheckBoxPersist.Checked, "1", "0"))
                Me.Close()
        End Select
