...
Public Class Frm_RepComsDescuadres
    ...
    Private Sub LoadGridArcs()
        ...
        & "ARC ON PNC.PdcGuid = ARC.PdcGuid AND PNC.lin = ARC.ln2 LEFT OUTER JOIN " _
    ...
    Private Sub LoadGridArc2()
        ...
        & "FROM  PNC INNER JOIN " _
        & "ARC ON PNC.PdcGuid = ARC.PdcGuid AND PNC.lin = ARC.ln2 INNER JOIN " _
        ...
        Dim oDs As DataSet = MaxiSrvr.GetDataset(SQL, MaxiSrvr.Databases.Maxi, "@EMP", mEmp.Id, "@PNCREP", oPncRepGuid.ToString, "@PNCCOM", DcPncCom, "@ARCREP", iArcRep, "@ARCCOM", DcArcCom)
        Dim oTb As DataTable = oDs.Tables(0)
