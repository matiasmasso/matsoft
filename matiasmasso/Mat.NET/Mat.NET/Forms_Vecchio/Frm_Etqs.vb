...
Public Class Frm_Etqs
    ...
    Private Sub PrintToolStripButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles PrintToolStripButton.Click
        Dim oPdfEtq As New PdfEtq(mDs, NumericUpDown1.Value)
        root.ShowPdf(oPdfEtq.Stream)
    End Sub
    ...
    Private Sub ImportAdrsFromExcel(ByVal sFilename As String)
        ...
        Dim oWb As Excel.Workbook = Nothing '= oapp.Workbooks.Open(sFilename)
        ...
        Do
            ...
            oRow = oTb.NewRow
            oRow("ADR1") = oSheet.Cells(iRow, 1).value2
            oRow("ADR2") = oSheet.Cells(iRow, 2).value2
            oRow("ADR3") = oSheet.Cells(iRow, 3).value2
            oRow("ADR4") = oSheet.Cells(iRow, 4).value2
            Dim BlFits As Boolean = CheckRowFits(oRow("ADR4"), oRow("ADR4"), oRow("ADR4"), oRow("ADR4"))
            oRow("WARN") = IIf(BlFits, "", "1")
            oTb.Rows.Add(oRow)
        Loop
        oWb.Close()
    ...
    Private Sub TextBoxAdr1_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBoxAdr1.KeyDown
        If e.KeyCode = Keys.F1 Then
            Dim oContact As Contact = Finder.FindContact(BLL.BLLApp.Emp, TextBoxAdr1.Text)
            If Not oContact Is Nothing Then
                Dim oAdr As Adr = oContact.MailAdr
                ...
                If sNom <> sNomCom And sNomCom > "" Then
                    ...
                    TextBoxAdr3.Text = oAdr.Text
                    TextBoxAdr4.Text = oAdr.Zip.ZipyCityZon
                Else
                    TextBoxAdr2.Text = oAdr.Text
                    TextBoxAdr3.Text = oAdr.Zip.ZipyCit
                    TextBoxAdr4.Text = oAdr.Zip.ProvinciaoPais
                End If
            End If
        End If
    End Sub
