Public Class Frm_PricelistItemCustomer_Historial
    ...
    Private Sub LoadGrid()
        Dim SQL As String = "SELECT P1.Guid,P1.Fch,P1.Concepte,P2.Art,P2.TarifaA,P2.TarifaB,P2.Retail " _
        & "FROM            DTOPricelistItemCustomer P2 INNER JOIN " _
        & "PriceList_Customer P1 ON P2.PriceList=P1.Guid " _
        & "WHERE P2.Art=@Guid " _
        & "ORDER BY P1.Fch DESC"

        Dim oDs As DataSet = MaxiSrvr.GetDataset(SQL, MaxiSrvr.Databases.Maxi, "@Guid", _Sku.Guid.ToString)
