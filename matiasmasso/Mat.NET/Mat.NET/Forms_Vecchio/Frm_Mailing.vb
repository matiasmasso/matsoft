...
Public Class Frm_Mailing
    ...
    Private Sub ButtonTestCircular_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonTestCircular.Click
        Dim oContact As Contact = MaxiSrvr.Contact.FromNum(mEmp, 305)
        Dim exs as new list(Of Exception)
        If App.Current.emp.EMail_Circular(oContact, TextBoxUrl.Text, TextBoxSubject.Text, , exs) = EventLogEntryType.Information Then
            MsgBox("Circular enviada a luismiguel@bebedigital.com", MsgBoxStyle.Information, "MAT.NET")
        Else
            MsgBox("Circular enviada amb errors:" & vbCrLf & BLL.Defaults.ExsToMultiline(exs), MsgBoxStyle.Exclamation, "MAT.NET")
        End If
    End Sub
    ...
    Private Sub ButtonCircular_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonCircular.Click
        ...
        For Each oRow In mDs.Tables(0).Rows
            ...
            If BLSTART Then
                ...
                If App.Current.emp.EMail_Circular(oContact, TextBoxUrl.Text, TextBoxSubject.Text, sRecipient, exs) <> EventLogEntryType.Information Then
