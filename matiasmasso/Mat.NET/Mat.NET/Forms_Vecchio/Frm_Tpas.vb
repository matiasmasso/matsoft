...
Public Class Frm_Tpas
    ...
    Private Sub LoadGrid()
        Dim SQL As String = "SELECT Guid,DSC,LOGO FROM TPA WHERE EMP=@EMP ORDER BY ORD"
        Dim oDs As DataSet = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@EMP", mTpa.emp.Id)
