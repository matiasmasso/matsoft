Public Class Frm_FileAEAT303
    ...
    Private Sub Refresca()
        With mFile.Regs(0)
            ...
            Xl_DropdownList_BancsNostres1.Banc = App.Current.emp.DefaultBanc
        End With
    ...
    Private Sub Calcula()
        ...
        Dim DblEstat As Decimal = Math.Round(DblDif * SngEstatPct / 100, 2)
    ...
    Private Sub CheckPct(ByVal oTextBoxBase As TextBox, ByVal SngPct As Decimal, ByVal oTextBoxQuot As TextBox, ByVal oPictureboxWarning As PictureBox)
        ...
        Dim QuotFromBase As Decimal = Math.Round(DblBase * SngPct / 100, 2)
