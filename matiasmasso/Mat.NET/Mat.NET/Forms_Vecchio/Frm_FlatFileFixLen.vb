...
Public Class Frm_FlatFileFixLen
    ...
    Private Sub LoadRegs()
        ...
        For Each oReg As FlatFileFixLen_Reg In mFile.registres
            ...
            oRow(ColsReg.Ico) = maxisrvr.GetByteArrayFromImg(My.Resources.Ok)
    ...
    Private Sub LoadFields()
        ...
        If oReg IsNot Nothing Then
            ...
            For Each oField As FlatFileFixLen_Field In oReg.Fields
                ...
                oRow(ColsField.Ico) = maxisrvr.GetByteArrayFromImg(My.Resources.Ok)
        ...
        Select Case e.ColumnIndex
            Case ColsField.Value
                ...
                If iLen <> iEnteredValueLen Then
                    DataGridViewFields.Rows(e.RowIndex).Cells(ColsField.Ico).Value = maxisrvr.GetByteArrayFromImg(My.Resources.warn)
                Else
                    DataGridViewFields.Rows(e.RowIndex).Cells(ColsField.Ico).Value = maxisrvr.GetByteArrayFromImg(My.Resources.Ok)
