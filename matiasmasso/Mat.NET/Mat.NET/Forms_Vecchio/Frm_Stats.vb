...
Public Class Frm_Stats
    ...
    Private Sub refresca()
        ...
        With _Stat
            ...
            .Format = IIf(RadioButtonAmt.Checked, DTOStat.Formats.Amounts, DTOStat.Formats.Units)
    ...
    Private Sub LoadFormats()
        If _Stat.Format = DTOStat.Formats.Amounts Then
            RadioButtonAmt.Checked = True
        Else
            RadioButtonQty.Checked = True
        End If
    End Sub
    ...
    Private Sub RadioButtonResults_CheckedChanged(sender As Object, e As EventArgs) Handles _
        RadioButtonAmt.CheckedChanged
        If _AllowEvents Then
            refresca()
        End If
    End Sub

    Private Sub CheckBoxIncludeHidden_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxIncludeHidden.CheckedChanged
        If _AllowEvents Then
            refresca()
        End If
    End Sub
    ...
    Private Sub PictureBoxExcel_Click(sender As Object, e As EventArgs) Handles PictureBoxExcel.Click
        Dim oExcelSheet As DTOExcelSheet = BLL.BLLStat.ExcelSheet(_Stat)
        UIHelper.ShowExcel(oExcelSheet)
    End Sub

    Private Sub CheckBoxGroupByHolding_CheckedChanged(sender As Object, e As EventArgs) Handles CheckBoxGroupByHolding.CheckedChanged
        If _AllowEvents Then
            refresca()
        End If
    End Sub

    Private Sub Xl_ContactsComboProveidors_AfterUpdate(sender As Object, e As MatEventArgs)
        If _AllowEvents Then
            refresca()
        End If
    End Sub
    ...
    Private Sub Xl_GuidNoms_Proveidors_AfterUpdate(sender As Object, e As MatEventArgs) Handles Xl_GuidNoms_Proveidors.AfterUpdate
        If _AllowEvents Then
            refresca()
        End If
    End Sub
