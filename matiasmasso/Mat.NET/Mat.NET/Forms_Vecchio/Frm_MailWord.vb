...
#End Region
    ...
    Public WriteOnly Property Mail() As Mail
        Set(ByVal Value As Mail)
            mMail = Value
            LabelNom.Text = mMail.Contacts(0).Clx
    ...
    Private Sub WordFax()
        Dim oContact As Contact = mMail.Contacts(0)
        ...
        With oDoc
            ...
            SetBkm(oDoc, "ORG", App.Current.Emp.Org.Nom)
