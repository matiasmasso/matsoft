...
Public Class Frm_Insolvencia
    ...
    Private Function CurrentImpagat() As Impagat
        ...
        If oRow IsNot Nothing Then
            Dim oCsa As Csa = MaxiSrvr.Csa.FromNum(mInsolvencia.Contact.Emp, oRow.Cells(Cols.Yea).Value, oRow.Cells(Cols.Csa).Value)
            Dim oCsb As New Csb(oCsa, oRow.Cells(Cols.Csb).Value)
    ...
    Private Sub CalculaDeute()
        Dim oTmp As maxisrvr.Amt = Xl_AmtNominal.Amt.Clone
