...
Public Class Frm_Cca_Descuadres
    ...
    Private Sub LoadGrid()
        Dim SQL As String = "SELECT CCA.cca, CCA.FCH, " _
        ...
        & "WHERE CCA.EMP =" & App.Current.Emp.Id & " And CCA.YEA =" & mYea & " " _
    ...
    Private Function CurrentCcas() As Ccas
        ...
        If oRow IsNot Nothing Then
            Dim CcaId As Integer = oRow.Cells(Cols.Id).Value
            oCcas.Add(MaxiSrvr.Cca.FromNum(mEmp, mYea, CcaId))
        End If
        Return oCcas
    End Function
    ...
    Private Sub DataGridView1_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles DataGridView1.DoubleClick
        ...
        If oCcas.Count > 0 Then
            Dim oFrm As New Frm_Cca(oCcas(0))
