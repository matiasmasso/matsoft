Public Class Frm_RepComLiquidable
    ...
    Public Sub New(oRepComLiquidable As DTORepComLiquidable)
        ...
        With _RepComLiquidable
            ...
            TextBoxFra.Text = BLL.BLLInvoice.Caption(.Fra)
    ...
    Private Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        With _RepComLiquidable
            ...
            If BLL.BLLRepComLiquidable.Update(_RepComLiquidable, exs) Then
                RaiseEvent AfterUpdate(_RepComLiquidable, EventArgs.Empty)
            Else
                MsgBox("No s'ha pogut desar:" & vbCrLf & BLL.Defaults.ExsToMultiline(exs), MsgBoxStyle.Exclamation)
            End If
        End With
    End Sub
