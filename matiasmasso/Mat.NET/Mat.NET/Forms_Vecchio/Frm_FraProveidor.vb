...
Public Class Frm_FraProveidor
    ...
    Private Sub refresca()
        With mFra
            ...
            End If
            Xl_CtaCarrec.Cta = .Proveidor.DefaultCtaCarrec
            Xl_CtaAbonament.Cta = .Proveidor.DefaultCtaAbonament
            ComboBoxCfp.SelectedValue = .Cfp
            LoadAlbs()
    ...
    Private Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        If Xl_AmtIva.Amt.Eur > 0 Then
            Dim DtIvaFchUltimaDeclaracio As Date = Emp.FromDTOEmp(mFra.Proveidor.Emp).IvaFchUltimaDeclaracio
        ...
        With mFra
            ...
            .Iva = Xl_AmtIva.Amt
            .Liq = Xl_AmtLiq.Amt
            .CtaCarrec = Xl_CtaCarrec.Cta
            .CtaAbonament = Xl_CtaAbonament.Cta
            .Obs = TextBoxObs.Text
