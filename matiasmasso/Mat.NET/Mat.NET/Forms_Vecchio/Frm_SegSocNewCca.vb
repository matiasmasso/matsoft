Public Class Frm_SegSocNewCca
    ...
    Private Sub LoadDefaults()
        ...
        'get last
        Dim SQL As String = "SELECT TOP 1 CCB.FCH FROM CCB INNER JOIN CCA ON CCB.EMP=CCA.EMP AND CCB.YEA=CCA.YEA AND CCA.CCA=CCB.CCA " _
        & "WHERE CCB.EMP=" & mEmp.Id & " AND " _
        & "CCA.CCD=" & CInt(DTOCca.CcdEnum.SegSocTc1) & " " _
        ...
        Xl_DropdownList_BancsNostres1.Banc = New Banc(New Guid(BLL.BLLDefault.EmpValue(DTODefault.Codis.BancNominaTransfers)))
        SetFchDevengo()
        SetFchPagament()
        SetTxt()
        mAllowEvents = True
