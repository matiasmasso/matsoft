Public Class Frm_Menus
    ...
    Private Sub refresca()
        Dim oApp As DTOSession.AppTypes = ComboBox1.SelectedIndex
        Xl_Menus1.Load(oApp, BLL.BLLSession.Current.Lang)
    End Sub


    Private Sub LoadApps()
        UIHelper.LoadComboFromEnum(ComboBox1, GetType(DTOSession.AppTypes), , 1)
    End Sub
