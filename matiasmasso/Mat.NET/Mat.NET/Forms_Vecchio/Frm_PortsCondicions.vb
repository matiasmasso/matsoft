...
Public Class Frm_PortsCondicions
    ...
    Private mCur As maxisrvr.Cur = maxisrvr.DefaultCur
    ...
    Private Sub refresca()
        With mPortsConds
            ...
            Xl_AmtPdcMin.Amt = New maxisrvr.Amt(.PdcMinVal, mCur, .PdcMinVal)
            If .PdcMinVal > 0 Then
            ...
            Xl_AmtUnitsMinPreu.Amt = New maxisrvr.Amt(.UnitsMinPreu, mCur, .UnitsMinPreu)
            ...
            Xl_AmtForfait.Amt = New maxisrvr.Amt(.Fee, mCur, .Fee)
            If .Fee > 0 Then
    ...
    Private Sub LoadGrid()
        ...
        & "WHERE STP.EMP=" & App.Current.emp.Id & " AND " _
        & "STP.PORTS=1 AND " _
        & "TPA.OBSOLETO=0 AND " _
        & "STP.OBSOLETO=0 " _
        & "ORDER BY TPA.ORD, TPA.TPA,STP.ORD, STP.STP"
