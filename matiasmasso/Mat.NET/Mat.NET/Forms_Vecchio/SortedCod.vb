...
Public Class SortedCod
    ...
    Private Sub SetItm()
        ...
        Dim oDrd As SqlDataReader = maxisrvr.GetDataReader(SQL, maxisrvr.Databases.Maxi, "@GUID", mGuid.ToString)
        If oDrd.Read Then
    ...
    Public Sub Update()
        ...
        Try
            ...
            Dim oDA As SqlDataAdapter = maxisrvr.GetSQLDataAdapter(SQL, oConn, "@GUID", mGuid.ToString)
