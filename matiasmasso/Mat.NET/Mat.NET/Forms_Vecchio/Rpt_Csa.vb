...
#End Region
    ...
    Private mCsas As MaxiSrvr.Csas
    ...
    Public WriteOnly Property Csas() As MaxiSrvr.Csas
        Set(ByVal Value As MaxiSrvr.Csas)
            mCsas = Value
    ...
    Private Sub mScratch_PrintPageBodyStart(ByVal sender As Object, ByVal e As maxisrvr.ReportPageEventArgs) Handles mScratch.PrintPageBodyStart
        Do While mItmIdx < mCsas(mCsaIdx).csbs.Count
            Dim oCsb As MaxiSrvr.Csb = mCsas(mCsaIdx).csbs(mItmIdx)
    ...
    Private Sub mScratch_ReportBegin(ByVal sender As Object, ByVal e As maxisrvr.ReportPageEventArgs) Handles mScratch.ReportBegin
        ...
        e.WriteLine(mCsas(mCsaIdx).csbs.Count & " efectos por un total de " & mCsas(mCsaIdx).Amt.CurFormat)
        e.WriteLine("efecto medio: " & mCsas(mCsaIdx).Average.CurFormat & " a " & mCsas(mCsaIdx).Dias & " días")
        DrawId(e)
    End Sub
