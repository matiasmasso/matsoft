Public Class Frm_Edi
    ...
    Private Sub SetContextMenu2()
        ...
        If oFile IsNot Nothing Then
            ...
            Select Case oTag
                Case EdiFile.Tags.ORDERS_D_96A_UN_EAN008
                    oMenuItem = New ToolStripMenuItem("processa comanda", Nothing, AddressOf Do_Procesa)
                    oContextMenu.Items.Add(oMenuItem)
                ...
                Case EdiFile.Tags.REMADV_D_96A_UN_EAN003
                    oMenuItem = New ToolStripMenuItem("processa remesa", Nothing, AddressOf Do_Procesa)
                    oContextMenu.Items.Add(oMenuItem)
                    oMenuItem = New ToolStripMenuItem("processa totes les remeses validades", Nothing, AddressOf Do_ProcesaAll)
                    oContextMenu.Items.Add(oMenuItem)
