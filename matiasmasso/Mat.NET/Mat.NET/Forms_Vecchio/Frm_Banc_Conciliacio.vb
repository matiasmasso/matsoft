...
Public Class Frm_Banc_Conciliacio
    ...
    Private Sub Refresca()
        With mConciliacio
            Dim oNSdo As maxisrvr.Amt = .Ccd.GetSaldo(.Fch)
            Dim oAnteriors As maxisrvr.Amt = .SumaItemsAnteriors
            Dim oPosteriors As maxisrvr.Amt = .SumaItemsPosteriors
            ...
            Dim oResult As maxisrvr.Amt = oNSdo.Clone
