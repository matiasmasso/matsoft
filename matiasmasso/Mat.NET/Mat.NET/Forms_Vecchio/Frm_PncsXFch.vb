...
Public Class Frm_PncsXFch
    ...
    Private Sub LoadGrid()
        ...
        Dim oDs As DataSet = maxisrvr.GetDataset(SQL, maxisrvr.Databases.Maxi, "@EMP", App.Current.Emp.Id, "@COD", DTOPurchaseOrder.Codis.client)
    ...
    Private Function CurrentArt() As Art
        ...
        Dim oRow As DataGridViewRow = DataGridView1.CurrentRow
        If oRow IsNot Nothing Then
            retval = New Art(CType(oRow.Cells(Cols.ArtGuid).Value, Guid))
        End If
        Return retval
    End Function
    ...
    Private Sub SetContextMenu()
        ...
        If CurrentPdc() IsNot Nothing Then
            ...
            oContextMenu.Items.Add(oMenuItem)
            Dim oMenu_Art As New Menu_Art(CurrentArt)
