...
Partial Class Frm_RepLiq
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_RepliqFras1 = New Mat.NET.Xl_RepliqFras()
        Me.Xl_AmtTotalBaseFras = New Mat.Net.Xl_Amt()
        Me.Xl_AmtTotalComisions = New Mat.Net.Xl_Amt()
        ...
        Me.Xl_AmtIVA = New Mat.Net.Xl_Amt()
        Me.Xl_AmtIRPF = New Mat.NET.Xl_Amt()
        Me.Xl_PercentIRPF = New Mat.NET.Xl_Percent()
        Me.CheckBoxIRPF = New System.Windows.Forms.CheckBox()
        Me.Xl_AmtLiquid = New Mat.NET.Xl_Amt()
    ...
    Friend WithEvents Xl_RepliqFras1 As Mat.NET.Xl_RepliqFras
    Friend WithEvents Xl_AmtTotalBaseFras As Mat.NET.Xl_Amt
    Friend WithEvents Xl_AmtTotalComisions As Mat.NET.Xl_Amt
    ...
    Friend WithEvents Xl_PercentIVA As Mat.NET.Xl_Percent
    Friend WithEvents Xl_AmtIVA As Mat.NET.Xl_Amt
    Friend WithEvents Xl_AmtIRPF As Mat.NET.Xl_Amt
    Friend WithEvents Xl_PercentIRPF As Mat.NET.Xl_Percent
    Friend WithEvents CheckBoxIRPF As System.Windows.Forms.CheckBox
    Friend WithEvents Xl_AmtLiquid As Mat.NET.Xl_Amt
