Public Class Frm_CliCtas
    ...
    Private _Cta As PgcCta
    Private _Exercici As Exercici
    ...
    Public Sub New(oContact As Contact, Optional oCta As PgcCta = Nothing, Optional oExercici As Exercici = Nothing, Optional oSelectionMode As BLL.Defaults.SelectionModes = BLL.Defaults.SelectionModes.Browse)
        MyBase.New()
        ...
        If oExercici Is Nothing Then oExercici = MaxiSrvr.Exercici.Current
        _Exercici = oExercici
    ...
    Private Sub LoadCtas(Optional oDefaultExtracte As Extracte = Nothing)
        Dim oExercicis As Exercicis = Exercicis.FromContact(_Contact, _Exercici.Emp)
    ...
    Private Sub Xl_Exercicis1_onItemSelected(sender As Object, e As MatEventArgs) Handles Xl_Exercicis1.AfterSelect
        Dim oExercici As Exercici = e.Argument
        Dim oExtractes As Extractes = oExercici.Extractes
        Dim oDefaultExtracte As New Extracte(_Exercici, _Cta, _Contact)
        Xl_Extractes1.Load(oExtractes, oDefaultExtracte)
    ...
    Private Sub Xl_Extractes1_onItemSelected(sender As Object, e As MatEventArgs) Handles Xl_Extractes1.onItemSelected
