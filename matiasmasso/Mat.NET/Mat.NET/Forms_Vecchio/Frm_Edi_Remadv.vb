Public Class Frm_Edi_Remadv
    Private mEdiFile As EdiFile_REMADV_D_96A_UN_EAN003
    Private _Sender As Contact
    ...
    Public Sub New(oEdiFile As EdiFile_REMADV_D_96A_UN_EAN003)
        ...
        _Sender = Contact.FromGln(mEdiFile.Sender())
        For Each oLine As EdiLineItem In mEdiFile.LineItems
            ...
            If oTipo = EdiSegment_DOC.Tipos.Nota_de_Cargo Then
                DcImport = -DcImport
            End If
            Dim oGuid As Guid = PndLoader.FromFra(_Sender, oLine.DocumentNumber, DcImport).Guid
    ...
    Private Sub LoadHeader()
        Xl_Contact_Logo1.Contact = Contact.FromGln(mEdiFile.Sender)
    ...
    Private Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        For Each oLine As EdiLineItem In mEdiFile.LineItems
            ...
            Dim oPnd As Pnd = PndLoader.FindByGuid(oGuid)
            oPnds.Add(oPnd)
        Next
