...
Partial Class Frm_BriqSubject
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_BriqQuestionGroups1 = New Mat.NET.Xl_BriqQuestionGroups()
        Me.Xl_BriqQuestions1 = New Mat.NET.Xl_BriqQuestions()
    ...
    Friend WithEvents Xl_BriqQuestionGroups1 As Mat.NET.Xl_BriqQuestionGroups
    Friend WithEvents Xl_BriqQuestions1 As Mat.NET.Xl_BriqQuestions
End Class
