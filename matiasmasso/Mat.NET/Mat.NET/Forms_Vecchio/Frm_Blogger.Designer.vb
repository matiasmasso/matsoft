...
Partial Class Frm_Blogger
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_BloggerPosts1 = New Mat.NET.Xl_BloggerPosts()
        Me.Xl_LookupUser1 = New Mat.NET.Xl_LookupUser()
    ...
    Friend WithEvents Xl_BloggerPosts1 As Mat.NET.Xl_BloggerPosts
    Friend WithEvents Xl_LookupUser1 As Mat.NET.Xl_LookupUser
End Class
