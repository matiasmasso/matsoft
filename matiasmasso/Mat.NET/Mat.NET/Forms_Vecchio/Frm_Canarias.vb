...
& "Reg ON Provincia.Regio=Reg.Guid INNER JOIN " _
                         & "dbo.CLX ON dbo.PDC.Emp = dbo.CLX.Emp AND dbo.PDC.cli = dbo.CLX.cli " _
        ...
        Dim oDs As DataSet = MaxiSrvr.GetDataset(SQL, MaxiSrvr.Databases.Maxi, "@EMP", App.Current.Emp.Id, "@MgzGuid", oMgz.Guid.ToString)
