Public Class Xl_PurchaseOrders
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            ...
            AddHandler oMenu_Pdc.RequestToToggleProgressBar, AddressOf ToggleProgressBarRequest
    ...
    Private Sub Do_ExcelLinies()
        ...
        Dim oSheet = FEB.PurchaseOrders.ExcelLinies(exs, _values)
        If exs.Count = 0 Then
    ...
    Private Sub Do_ExcelPdcs()
        Dim oSheet = FEB.PurchaseOrders.ExcelPdcs(Me.SelectedItems)
        Dim exs As New List(Of Exception)
        If Not UIHelper.ShowExcel(oSheet, exs) Then
            UIHelper.WarnError(exs)
        End If
        ...
        If oCurrentControlItem IsNot Nothing Then
            ...
            Select Case _SelectionMode
                Case DTO.Defaults.SelectionModes.Browse
                    Dim exs As New List(Of Exception)
                    If Await FEB.AlbBloqueig.BloqueigStart(Current.Session.User, oSelectedValue.Contact, DTOAlbBloqueig.Codis.PDC, exs) Then
