Public Class Xl_ReadOnlyGridTemplate
    ...
    Public Shadows Sub Load(values As List(Of DTOTemplate), Optional oDefaultValue As DTOTemplate = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
        _Values = values
    ...
    Private Sub Refresca()
        ...
        For Each oItem As DTOTemplate In oFilteredValues
    ...
    Private Sub DataGridView1_RowPrePaint(sender As Object, e As DataGridViewRowPrePaintEventArgs) Handles MyBase.RowPrePaint
        ...
        Dim oControlItem As ControlItem = oRow.DataBoundItem
        Dim oTemplate As DTOTemplate = oControlItem.Source
