...
Public Class Xl_Cobrament
    ...
    Public Sub LoadPagare(sDocNum As String, DtVto As Date)
        ...
        If DtVto < DateTimePickerVto.MinDate Then
            DateTimePickerVto.Value = DTO.GlobalVariables.Today()
        Else
    ...
    Public ReadOnly Property Cta() As DTOPgcCta
        Get
            ...
            Select Case CodiFpg
                Case Fpgs.Cash
                    retval = FEB.PgcCta.FromCodSync(DTOPgcPlan.Ctas.caixa, Current.Session.Emp, exs)
                Case Fpgs.Transfer, Fpgs.Xec, Fpgs.Pagare
                    retval = FEB.PgcCta.FromCodSync(DTOPgcPlan.Ctas.bancs, Current.Session.Emp, exs)
            End Select
            Return retval
        End Get
    End Property
