Public Class Xl_Contacts_Insertable
    ...
    Private Async Function SetContextMenu() As Task
        ...
        If oControlItem IsNot Nothing Then
            Dim oContactMenu = Await FEB.ContactMenu.Find(exs, oControlItem)
            Dim oMenu As New Menu_Contact(oControlItem, oContactMenu)
                ...
                Case Cols.Nom
                    ...
                    Else
                        ...
                        If valueChanged Then
                            Dim exs As New List(Of Exception)
                            oContact = Finder.FindContact(exs, Current.Session.User, e.FormattedValue)
                            If exs.Count = 0 Then
