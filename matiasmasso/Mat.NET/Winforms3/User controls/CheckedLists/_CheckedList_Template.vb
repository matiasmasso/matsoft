Public Class _CheckedList_Template
    Inherits _Xl_ReadOnlyDatagridview

    Private _allValues As List(Of DTOTemplate)
    Private _selectedValues As List(Of DTOTemplate)
    ...
    Public Function CheckedValues() As List(Of DTOTemplate)
        Dim oCheckedControlItems = _ControlItems.ToList.Where(Function(x) x.Checked)
        Dim retval As List(Of DTOTemplate) = oCheckedControlItems.Select(Function(y) y.Source).ToList
        Return retval
    End Function

    Public Shadows Sub Load(allValues As List(Of DTOTemplate), selectedValues As List(Of DTOTemplate))
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            Dim oMenu_Template As New Menu_Template(SelectedItems)
