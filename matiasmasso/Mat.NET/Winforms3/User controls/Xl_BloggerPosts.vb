Public Class Xl_BloggerPosts
    ...
    Public Shadows Sub Load(values As List(Of DTOBloggerPost), Optional oBlogger As DTOBlogger = Nothing, Optional oMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
