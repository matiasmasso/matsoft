Public Class Xl_LangResources
    ...
    Private Sub Xl_FilterItems_CellValueChanged(sender As Object, e As DataGridViewCellEventArgs) Handles Me.CellValueChanged
        If e.RowIndex >= 0 Then
            ...
            Dim item As DTOLangText = oControlItem.Source
            Select Case e.ColumnIndex
                Case Cols.Esp
                    item.Outdated = item.Outdated Or DTOLangText.Outdateds.Cat Or DTOLangText.Outdateds.Eng Or DTOLangText.Outdateds.Por
                Case Cols.Cat
                    item.Outdated = item.Outdated And Not DTOLangText.Outdateds.Cat
                Case Cols.Eng
                    item.Outdated = item.Outdated And Not DTOLangText.Outdateds.Eng
                Case Cols.Por
                    item.Outdated = item.Outdated And Not DTOLangText.Outdateds.Por
            End Select
        End If
    End Sub
    ...
    Private Sub onUpdate(sender As Object, e As MatEventArgs)
        ...
        If oControlItem IsNot Nothing Then
            Dim original = _ControlItems(_ControlItems.IndexOf(oControlItem))
            Dim nou = New ControlItem(e.Argument)
            If original.Esp <> nou.Esp Then
                original.Source.Outdated = original.Source.Outdated Or DTOLangText.Outdateds.Cat Or DTOLangText.Outdateds.Eng Or DTOLangText.Outdateds.Por
            End If
            If original.Cat <> nou.Cat Then
                original.Source.Outdated = original.Source.Outdated And Not DTOLangText.Outdateds.Cat
            End If
            If original.Eng <> nou.Eng Then
                original.Source.Outdated = original.Source.Outdated And Not DTOLangText.Outdateds.Eng
            End If
            If original.Por <> nou.Por Then
                original.Source.Outdated = original.Source.Outdated And Not DTOLangText.Outdateds.Por
            End If
            _ControlItems(_ControlItems.IndexOf(oControlItem)) = nou
            Refresh()
        End If
    End Sub
    ...
    Private Sub DataGridView1_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles MyBase.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.Cat, Cols.Eng, Cols.Por
                If Not String.IsNullOrEmpty(e.Value) Then
                    ...
                    Dim item As DTOLangText = oControlItem.Source
                    'If item.Guid.Equals(New Guid("a23eb1c1-e35d-4c12-a5ba-532900f53a4f")) Then Stop
                    If (e.ColumnIndex = Cols.Cat And item.Outdated.HasFlag(DTOLangText.Outdateds.Cat)) Then
                        e.CellStyle.BackColor = Color.LightSalmon
                    End If
                    If (e.ColumnIndex = Cols.Eng And item.Outdated.HasFlag(DTOLangText.Outdateds.Eng)) Then
                        e.CellStyle.BackColor = Color.LightSalmon
                    End If
                    If (e.ColumnIndex = Cols.Por And item.Outdated.HasFlag(DTOLangText.Outdateds.Por)) Then
                        e.CellStyle.BackColor = Color.LightSalmon
                    End If
                End If
        End Select
