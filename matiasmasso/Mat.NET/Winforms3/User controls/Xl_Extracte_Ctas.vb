Public Class Xl_Extracte_Ctas
    ...
    Public Shadows Sub Load(values As List(Of DTOPgcCta), Optional defaultCta As DTOPgcCta = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOPgcCta)
            ...
            _Source = value
            With value
                _Cta = DTOPgcCta.FullNom(value, Current.Session.User.Lang)
            End With
        End Sub
