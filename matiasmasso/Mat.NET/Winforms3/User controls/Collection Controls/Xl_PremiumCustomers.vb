Public Class Xl_PremiumCustomers
    ...
    Private Sub Do_Excel()
        Dim oBook As New MatHelper.Excel.Book("Premium Line")
    ...
    Private Function ExcelSheet(oValues As List(Of DTOPremiumCustomer), sName As String) As MatHelper.Excel.Sheet
        Dim retval As New MatHelper.Excel.Sheet(sName)
        With retval
            .AddColumn("pais", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("zona", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("población", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("cliente", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("dirección", MatHelper.Excel.Cell.NumberFormats.W50)
        End With
