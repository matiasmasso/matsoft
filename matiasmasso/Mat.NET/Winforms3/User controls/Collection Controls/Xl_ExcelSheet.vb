Public Class Xl_ExcelSheet
    ...
    Private _Value As MatHelper.Excel.Sheet
    Private _ColumnHeaders As List(Of String)

    Public Shadows Sub Load(value As MatHelper.Excel.Sheet, Optional sColumnHeaders As List(Of String) = Nothing)
        _Value = value
    ...
    Private Sub Refresca()
        ...
        For Each oSrcRow As MatHelper.Excel.Row In _Value.Rows
            Dim oCellValuesList As New List(Of String)
            For Each oSrcCell As MatHelper.Excel.Cell In oSrcRow.Cells
                Try
