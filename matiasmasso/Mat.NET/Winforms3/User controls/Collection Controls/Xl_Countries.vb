Public Class Xl_Countries
    Inherits _Xl_ReadOnlyDatagridview

    Private _Values As IEnumerable(Of DTOCountry)
    Private _DefaultValue As DTOCountry
    ...
    Public Event ShowAllCountries(sender As Object, e As MatEventArgs)
    ...
    Public Shadows Sub Load(values As IEnumerable(Of DTOCountry), Optional oDefaultValue As DTOCountry = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.Browse)
    ...
    Private Sub Refresca()
        ...
        For Each oItem As DTOCountry In FilteredValues()
    ...
    Public Sub Clear()
        _Values = New List(Of DTOCountry)
        Refresca()
    End Sub

    Private Function FilteredValues() As List(Of DTOCountry)
        Dim retval As List(Of DTOCountry)
        If String.IsNullOrEmpty(_Filter) Then
            retval = _Values
        Else
            retval = _Values.ToList().FindAll(Function(x) x.LangNom.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
    ...
    Public ReadOnly Property Values As List(Of DTOCountry)
        Get
            Return _Values
        End Get
    End Property
    ...
    Public ReadOnly Property Value As DTOCountry
        Get
            ...
            Dim retval As DTOCountry = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As List(Of DTOCountry)
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            ...
            AddHandler oMenu_Country.AfterDelete, AddressOf DeleteRequest
        ...
        oContextMenu.Items.Add("mostrar tots els països", Nothing, AddressOf Do_ShowAllCountries)
        oContextMenu.Items.Add("afegir", Nothing, AddressOf Do_AddNew)

        MyBase.ContextMenuStrip = oContextMenu
    End Sub

    Private Sub Do_ShowAllCountries()
        RaiseEvent ShowAllCountries(Me, New MatEventArgs)
    End Sub
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        Dim oSelectedValue As DTOCountry = CurrentControlItem.Source
    ...
    Private Sub Xl_Countries_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles Me.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.export
                ...
                Dim oControlItem As ControlItem = oRow.DataBoundItem
                Dim oCountry As DTOCountry = oControlItem.Source
    ...
    Private Sub Xl_Countriess_CellToolTipTextNeeded(sender As Object, e As DataGridViewCellToolTipTextNeededEventArgs) Handles Me.CellToolTipTextNeeded
        Select Case e.ColumnIndex
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOCountry)
            ...
            _Source = value
            With value
                _Nom = DTOCountry.NomTraduit(_Source, Current.Session.User.Lang)
                _ISO = .ISO
