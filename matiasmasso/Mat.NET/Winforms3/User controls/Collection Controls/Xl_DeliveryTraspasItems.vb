Public Class Xl_DeliveryTraspasItems
    ...
    Public Shadows Sub Load(values As List(Of DTODeliveryItem))
        _Values = values.Where(Function(x) x.Cod < 50)
    ...
    Private Function FilteredValues() As List(Of DTODeliveryItem)
        ...
        If _Filter = "" Then
            retval = _Values
        Else
            retval = _Values.FindAll(Function(x) x.Sku.NomProveidor.ToLower.Contains(_Filter.ToLower))
        End If
        Return retval
    End Function
