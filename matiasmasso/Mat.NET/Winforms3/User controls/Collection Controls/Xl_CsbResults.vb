    ...
    Protected Class ControlItem
        ...
        Public Sub New(yearMonth As DTOYearMonth)
            ...
            Else
                ...
                _expanded = isCurrent()
                _visible = (_yearMonth.Year = DTO.GlobalVariables.Today().Year)
            End If
        End Sub
        ...
        Function isCurrent() As Boolean
            ...
            Select Case _linCod
                Case linCods.year
                    retval = (_yearMonth.Year = DTO.GlobalVariables.Today().Year)
                Case linCods.month
                    retval = (_yearMonth.Year = DTO.GlobalVariables.Today().Year And _yearMonth.Month = DTO.GlobalVariables.Today().Month)
                Case linCods.vto
                    retval = (_vto.Year = DTO.GlobalVariables.Today().Year And _vto.Month = DTO.GlobalVariables.Today().Month)
            End Select
            Return retval
        End Function
