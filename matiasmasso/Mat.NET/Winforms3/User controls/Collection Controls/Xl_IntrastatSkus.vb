Public Class Xl_IntrastatSkus
    ...
    Private Sub Refresca()
        ...
        If _FilterWarnings Then oFilteredValues.RemoveAll(Function(x) Not DTOIntrastat.Partida.Warn(_Intrastat.Flujo, DTOIntrastat.SkuKg(x), x.CodiMercancia, x.MadeIn))
    ...
    Private Function FilteredValues() As List(Of DTOProductSku)
        ...
        If _FilterWarnings Then
            retval = retval.Where(Function(x) DTOIntrastat.Partida.Warn(_Intrastat.Flujo, DTOIntrastat.SkuKg(x), x.CodiMercancia, x.MadeIn))
        End If
    ...
    Private Sub SetContextMenu()
        ...
        If oControlItem IsNot Nothing Then
            ...
            Dim oSkuMenu As ToolStripMenuItem = oContextMenu.Items.Add("Producte")
            oSkuMenu.DropDownItems.AddRange(oMenu_ProductSku.Range)
            Dim oCopyRefMenu = oContextMenu.Items.Add("Copiar ref.proveidor", My.Resources.Copy, AddressOf Do_CopyRef)
            oCopyRefMenu.Enabled = SelectedItems.First.RefProveidor > ""
        End If

        MyBase.ContextMenuStrip = oContextMenu
    End Sub

    Private Sub Do_CopyRef()
        Dim oSku = SelectedItems.First
        UIHelper.CopyLink(oSku.RefProveidor)
    End Sub
