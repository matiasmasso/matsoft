...
#Region "DragDrop"
    ...
    Private Sub Xl_ProductDownloads_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles Me.CellFormatting
        Select Case e.ColumnIndex
            Case Cols.esp
                Dim oRow As DataGridViewRow = Rows(e.RowIndex)
                Dim oControlItem As ControlItem = oRow.DataBoundItem
                Dim oItem As DTOProductDownload = oControlItem.Source
