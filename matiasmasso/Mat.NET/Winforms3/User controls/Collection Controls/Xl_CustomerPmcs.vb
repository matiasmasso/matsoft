Public Class Xl_CustomerPmcs
    ...
    Private _Values As List(Of DTOPmc)
    ...
    Public Shadows Sub Load(values As List(Of DTOPmc))
    ...
    Private Sub Refresca()
        _AllowEvents = False
        Dim oFilteredValues As List(Of DTOPmc) = _Values
        ...
        For Each oItem As DTOPmc In oFilteredValues
    ...
    Public ReadOnly Property Value As DTOPmc
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTOPmc = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As List(Of DTOPmc)
        Dim retval As New List(Of DTOPmc)
        For Each oRow As DataGridViewRow In MyBase.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Private Async Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles MyBase.DoubleClick
        ...
        If oCurrentControlItem IsNot Nothing Then
            Dim oSelectedValue As DTOPmc = CurrentControlItem.Source
            Dim oDelivery As DTODelivery = Nothing '= oSelectedValue.Delivery
            Dim oCustomer As DTOCustomer = Nothing '= oDelivery.Contact
    ...
    Private Sub Do_Excel()
        Dim oSheet As New MatHelper.Excel.Sheet("Customer PMC")
    ...
    Protected Class ControlItem
        ...
        Public Sub New(value As DTOPmc)
            MyBase.New()
            _Source = value
            ...
            Dim DcNet As Decimal = Math.Round(iQty * DcEur * (100 - DcDto) / 100, 2)
        ...
        Public Sub AddToTotal(value As DTOPmc)
            Dim iQty As Integer = value.Qty
            Dim DcEur As Decimal = value.Eur
            Dim DcDto As Decimal = value.Dto
            Dim DcNet As Decimal = Math.Round(iQty * DcEur * (100 - DcDto) / 100, 2)
