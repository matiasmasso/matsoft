Public Class Xl_Contacts
    ...
    Public Shadows Async Function Load(values As IEnumerable(Of DTOContact), Optional oDefaultValue As DTOContact = Nothing, Optional oSelectionMode As DTO.Defaults.SelectionModes = DTO.Defaults.SelectionModes.browse) As Task
    ...
    Private Async Function SetContextMenu() As Task
        ...
        If oControlItem IsNot Nothing AndAlso SelectedItems.Count > 0 Then
            Dim oSelectedItem As DTOContact = SelectedItems.First()
            Dim oContactMenu = Await FEB.ContactMenu.Find(exs, oSelectedItem)
            Dim oMenu_Contact As New Menu_Contact(oSelectedItem, oContactMenu)
...
#Region "Sizes"
    ...
    Private Sub Xl_Contacts_UserDeletingRow(sender As Object, e As DataGridViewRowCancelEventArgs) Handles Me.UserDeletingRow
        'Dim oControlItem As ControlItem = e.Row.DataBoundItem
        'Dim idx = _ControlItems.IndexOf(oControlItem)
