...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents CheckBoxTeletrabajo As CheckBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Xl_LookupStaffCategory1 = New Mat.Net.Xl_LookupStaffCategory()
        Me.Xl_Image1 = New Mat.Net.Xl_Image()
        Me.Xl_LookupStaffPos1 = New Mat.Net.Xl_LookupStaffPos()
        Me.Xl_Sex1 = New Mat.Net.Xl_Sex()
        Me.Xl_NumSS1 = New Mat.Net.Xl_NumSS()
        Me.CheckBoxTeletrabajo = New System.Windows.Forms.CheckBox()
        ...
        'CheckBoxTeletrabajo
        '
        Me.CheckBoxTeletrabajo.AutoSize = True
        Me.CheckBoxTeletrabajo.Location = New System.Drawing.Point(15, 223)
        Me.CheckBoxTeletrabajo.Name = "CheckBoxTeletrabajo"
        Me.CheckBoxTeletrabajo.Size = New System.Drawing.Size(77, 17)
        Me.CheckBoxTeletrabajo.TabIndex = 23
        Me.CheckBoxTeletrabajo.Text = "teletreballa"
        '
        'Xl_Contact_Staff
        '
        Me.Controls.Add(Me.CheckBoxTeletrabajo)
...
#End Region
    ...
    Public Shadows Async Function Load(value As DTOStaff) As Task
        ...
        With _Staff
            ...
            CheckBoxTeletrabajo.Checked = .Teletrabajo

            If FEB.Iban.Load(.Iban, exs) Then
        ...
        Get
            With _Staff
                ...
                Else
                    .Baixa = Nothing
                End If
                .Teletrabajo = CheckBoxTeletrabajo.Checked
                .Iban = Xl_Iban1.Value
            End With
            Return _Staff
        End Get
    ...
    Private Async Function refrescaVisas() As Task
        Dim exs As New List(Of Exception)
        Dim oVisas = Await FEB.VisaCards.All(exs, Current.Session.Emp, _Staff)
        If exs.Count = 0 Then
    ...
    Private Sub CheckBoxBaixa_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles CheckBoxBaixa.CheckedChanged
        ...
        If CheckBoxBaixa.Checked Then
            If DateTimePickerBaixa.Value = DateTimePicker.MinimumDateTime Then
                DateTimePickerBaixa.Value = DTO.GlobalVariables.Today()
            End If
        End If
    ...
    Private Sub ControlChanged() Handles _
        ...
        Xl_LookupStaffPos1.AfterUpdate,
         Xl_Image1.AfterUpdate,
          Xl_Sex1.AfterUpdate,
           CheckBoxTeletrabajo.CheckedChanged
