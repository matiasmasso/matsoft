Public Class Xl_CliProducts
    ...
    Public Shadows Sub Load(values As List(Of DTOCliProduct))
        _ControlItems = New ControlItems
        For Each oItem As DTOCliProduct In values
    ...
    Public ReadOnly Property Value As DTOCliProduct
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTOCliProduct = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Function SelectedItems() As List(Of DTOCliProduct)
        Dim retval As New List(Of DTOCliProduct)
        For Each oRow As DataGridViewRow In DataGridView1.SelectedRows
            Dim oControlItem As ControlItem = oRow.DataBoundItem
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oSelectedValue As DTOCliProduct = CurrentControlItem.Source
    ...
    Protected Class ControlItem
        Property Source As DTOCliProduct

        Property Cli As String
        Property Product As String

        Public Sub New(oDTOCliProduct As DTOCliProduct)
            MyBase.New()
