Public Class Xl_ProductStocks
    Private _Values As List(Of DTOStock)
    ...
    Public Shadows Sub Load(values As List(Of DTOStock))
        _Values = values
    ...
    Public ReadOnly Property Value As DTOStock
        Get
            Dim oControlItem As ControlItem = CurrentControlItem()
            Dim retval As DTOStock = oControlItem.Source
            Return retval
        End Get
    End Property
    ...
    Private Sub LoadControlItems()
        ...
        For Each oItem As DTOStock In _Values
    ...
    Private Sub DataGridView1_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles DataGridView1.CellFormatting
        ...
        Select Case e.ColumnIndex
            Case Cols.Pn1
                ...
                Dim oStock As DTOStock = oControlItem.Source
    ...
    Private Function SelectedItems() As List(Of DTOStock)
    ...
    Private Sub DataGridView1_DoubleClick(sender As Object, e As EventArgs) Handles DataGridView1.DoubleClick
        Dim oSelectedValue As DTOStock = CurrentControlItem.Source
    ...
    Protected Class ControlItem
        ...
        Public Sub New(oStock As DTOStock)
            MyBase.New()
            _Source = oStock
            With oStock
                _Id = .Sku.id
                _Nom = .Sku.nom.Tradueix(Current.Session.Lang)
