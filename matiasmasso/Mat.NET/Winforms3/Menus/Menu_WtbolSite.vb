...
Public Class Menu_WtbolSite
        ...
        With oDlg
            ...
            If .ShowDialog = DialogResult.OK Then
                ...
                If exs.Count = 0 Then
                    ...
                    If Await FEB.WtbolLandingPages.Upload(_WtbolSite, oSheet, exs) Then
    ...
    Private Async Sub Do_ImportStocks()
        ...
        With oDlg
            ...
            If .ShowDialog = DialogResult.OK Then
                ...
                If exs.Count = 0 Then
                    Dim oSheet = oBook.Sheets.FirstOrDefault()
                    If Await FEB.WtbolStocks.Upload(_WtbolSite, oSheet, exs) Then
    ...
    Private Sub Do_TestUploadLandingPages()
        Dim exs As New List(Of Exception)
        If FEB.WtbolSite.Load(_WtbolSite, exs) Then
            ...
            Dim UrlProduction As String = "https://api.matiasmasso.es/"
            'Dim urlDeveloper As String = "http://localhost:55836/"
            Dim urlDeveloper As String = "https://localhost:55836/"
            ...
            If FEB.Api.SendRequest(sUrl, sJsonString, "application/json", "POST", jsonOutputString, exs) Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.WtbolSite.Delete(_WtbolSites.First, exs) Then
    ...
    Private Sub Do_CopyLinkExcel()
        Dim url = FEB.UrlHelper.Factory(True, "wtbol", "excel", _WtbolSite.Guid.ToString())
