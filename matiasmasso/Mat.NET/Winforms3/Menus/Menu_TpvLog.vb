Public Class Menu_TpvLog
    ...
    Private Function MenuItem_Titular() As ToolStripMenuItem
        ...
        If oMenuItem.Enabled Then
            Dim oContactMenu = FEB.ContactMenu.FindSync(exs, _TpvLog.Titular)
            Dim oMenu_Contact As New Menu_Contact(_TpvLog.Titular, oContactMenu)
    ...
    Private Sub Do_CopyLink(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim sUrl = FEB.TpvLog.CustomRequestUrl(_TpvLog)
    ...
    Private Async Sub Do_Alb()
        ...
        If _TpvLog.Request IsNot Nothing Then
            Dim oDelivery = Await FEB.Delivery.Find(_TpvLog.Request.Guid, exs)
            If exs.Count = 0 Then
    ...
    Private Async Sub Do_LogResponse()
        ...
        If Await FEB.TpvRedSys.LogResponse(Current.Session.Emp, _TpvLog, exs) Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.TpvLog.Delete(_TpvLogs.First, exs) Then
