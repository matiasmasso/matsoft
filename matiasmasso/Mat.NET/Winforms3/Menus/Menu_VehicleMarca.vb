Public Class Menu_VehicleMarca
    ...
    Private _VehicleMarca As DTOVehicle.Marca


    Public Sub New(ByVal oVehicleMarcas As List(Of DTOVehicle.Marca))
        MyBase.New()
    ...
    Public Sub New(ByVal oVehicleMarca As DTOVehicle.Marca)
        MyBase.New()
        _VehicleMarca = oVehicleMarca
        _VehicleMarcas = New List(Of DTOVehicle.Marca)
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            ...
            If Await FEB.VehicleMarca.Delete(_VehicleMarcas.First, exs) Then
