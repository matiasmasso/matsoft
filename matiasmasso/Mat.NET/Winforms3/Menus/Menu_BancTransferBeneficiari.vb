Public Class Menu_BancTransferBeneficiari
    ...
    Private Function MenuItem_Error() As ToolStripMenuItem
        ...
        If FEB.Iban.ValidateBankBranch(_BancTransferBeneficiari.BankBranch, exs) Then
    ...
    Private Async Sub Do_SelectBankBranch()
        ...
        Dim oBankBranch = Await FEB.BankBranch.FromIban(exs, _BancTransferBeneficiari.Account)
        If exs.Count = 0 Then
