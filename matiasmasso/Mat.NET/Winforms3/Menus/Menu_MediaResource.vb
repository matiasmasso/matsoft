...
Public Class Menu_MediaResource
    ...
    Private Function MenuItem_CopyLink() As ToolStripMenuItem
        ...
        oMenuItem.DropDownItems.Add("identificador", Nothing, AddressOf Do_CopyHash)
        Return oMenuItem
    End Function
    ...
    Private Sub Do_CopyHash(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Async Sub Do_Download(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        With oDlg
            ...
            If .ShowDialog Then
                ...
                Dim oImageBytes = Await FEB.Api.FetchBinary(exs, url)
                If exs.Count = 0 Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.MediaResources.Delete(exs, _MediaResources) Then
