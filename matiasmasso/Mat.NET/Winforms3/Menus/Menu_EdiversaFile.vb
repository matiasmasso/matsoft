Public Class Menu_EdiversaFile
    ...
    Private Sub Do_Savefile()
        ...
        With oDlg
            ...
            If .ShowDialog = DialogResult.OK Then
                If FEB.EdiversaFile.Load(_EdiversaFile, exs) Then
    ...
    Private Async Sub Do_Restore(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If Await FEB.EdiversaFiles.Restore(exs, Current.Session.Emp, _EdiversaFiles) Then
            For Each oFile In _EdiversaFiles
                Await FEB.EdiversaFile.Update(exs, oFile)
            Next
    ...
    Private Async Sub Do_Process()
        ...
        If Await FEB.EdiversaFileSystem.SaveInboxFiles(_EdiversaFiles, exs) Then
    ...
    Private Async Sub Do_ReturnToProcess()
        ...
        For Each oFile In _EdiversaFiles
            If FEB.EdiversaFile.Load(oFile, exs) Then
                ...
                If Not Await FEB.EdiversaFile.Update(exs, oFile) Then
                    UIHelper.WarnError(exs)
                End If
            Else
                UIHelper.WarnError(exs)
    ...
    Private Async Sub Do_Descarta(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.EdiversaFiles.Descarta(exs, _EdiversaFiles) Then
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.EdiversaFiles.Delete(_EdiversaFiles, exs) Then
                MyBase.RefreshRequest(Me, MatEventArgs.Empty)
            Else
