Public Class Menu_PurchaseOrderItem
    ...
    Private Function MenuItem_Order() As ToolStripMenuItem
        ...
        If _PurchaseOrderItems.First Is Nothing OrElse _PurchaseOrderItems.First.PurchaseOrder Is Nothing Then
    ...
    Private Sub CustomerDropdown(sender As Object, e As EventArgs)
        ...
        If oMenuItem.DropDownItems.Count = 0 Then
            Dim oContactMenu = FEB.ContactMenu.FindSync(exs, _PurchaseOrderItems.First.PurchaseOrder.contact)
            Dim oMenu As New Menu_Contact(_PurchaseOrderItems.First.PurchaseOrder.contact, oContactMenu)
            oMenuItem.DropDownItems.AddRange(oMenu.Range)
        End If
    End Sub
