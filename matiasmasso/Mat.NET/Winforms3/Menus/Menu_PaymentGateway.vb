Public Class Menu_PaymentGateway
    Inherits Menu_Base

    Private _PaymentGateway As DTOPaymentGateway


    Public Sub New(ByVal oPaymentGateway As DTOPaymentGateway)
        MyBase.New()
        _PaymentGateway = oPaymentGateway
        AddMenuItems()
    End Sub
    ...
    Private Async Sub Do_Delete(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim rc As MsgBoxResult = MsgBox("Eliminem " & _PaymentGateway.Nom & "?", MsgBoxStyle.OkCancel)
