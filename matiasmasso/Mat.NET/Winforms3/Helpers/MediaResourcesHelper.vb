...
Public Class MediaResourcesHelper
    ...
    Shared Function Factory(oUser As DTOUser, sFullPath As String, exs As List(Of Exception)) As DTOMediaResource
        ...
        If sFilename.Length <= DTOMediaResource.MAXNOMLENGTH Then
            If FileSystemHelper.GetStreamFromFile(sFullPath, oByteArray, exs) Then
                retval = New DTOMediaResource(oUser, oByteArray)
                With retval
                    .Nom = sFilename
    ...
    Shared Function LoadFromStream(oUser As DTOUser, oByteArray As Byte(), ByRef oMediaResource As DTOMediaResource, exs As List(Of Exception), Optional sFilename As String = "") As Boolean
        ...
        oMediaResource = New DTOMediaResource(oUser, oByteArray)
        With oMediaResource
            If sFilename = "" Then
    ...
    Shared Function LoadMimeDetails(oMediaResource As DTOMediaResource, exs As List(Of Exception)) As Boolean
        ...
        With oMediaResource
            Select Case .Mime
                ...
                Case MimeCods.Ai
                    .Thumbnail = My.Resources.ai_140.Bytes()
                Case MimeCods.Rtf
                    .Thumbnail = My.Resources.word.Bytes ' pasar a 140x140
                Case MimeCods.Zip
                    ...
                    End If
                    If .Thumbnail Is Nothing Then .Thumbnail = My.Resources.zip_140.Bytes
                Case MimeCods.Jpg, MimeCods.Gif, MimeCods.Png, MimeCods.Bmp, MimeCods.Tif, MimeCods.Tiff
                    Dim oImg = ImageHelper.GetImgFromByteArray(.Stream)
                    .Width = oImg.Width
                    .Height = oImg.Height
                    .VRes = oImg.VerticalResolution
                    .HRes = oImg.HorizontalResolution
                    .Thumbnail = LegacyHelper.ImageHelper.GetThumbnailToFill(oImg, DTOMediaResource.THUMBWIDTH, DTOMediaResource.THUMBHEIGHT).Bytes
                Case MimeCods.Ppt, MimeCods.Pptx
                Case MimeCods.Docx
                Case MimeCods.Mpg, MimeCods.Mp4
                    .Thumbnail = My.Resources.NoImg140.Bytes
            End Select
        End With
        Return retval
    End Function
