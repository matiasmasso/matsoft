Module UIHelper
    ...
    Public Function SaveExcelDialog(oSheet As MatHelper.Excel.Sheet, Optional ShowProgress As ProgressBarHandler = Nothing, Optional sTitle As String = "") As Boolean
        Dim retval As Boolean
        Dim oDlg As New SaveFileDialog
        With oDlg
    ...
    Public Function SaveExcelDialog(oBook As MatHelper.Excel.Book, Optional ShowProgress As ProgressBarHandler = Nothing, Optional sTitle As String = "") As Boolean
        Dim retval As Boolean
        Dim oDlg As New SaveFileDialog
        With oDlg
    ...
    Public Async Function ShowStreamAsync(exs As List(Of Exception), oDocFile As DTODocFile, Optional sSuggestedFileName As String = "", Optional BlDownloadFromWeb As Boolean = True) As Task(Of Boolean)
        ...
        Else
            ...
            If exs.Count = 0 Then
                ...
                Else
                    Try
                        Process.Start("https://api.matiasmasso.es/doc/" + oDocFile.Hash)
