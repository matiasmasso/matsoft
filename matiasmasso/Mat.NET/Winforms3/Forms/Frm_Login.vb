Public Class Frm_Login
    ...
    Public Property RequestToFbLogin As Boolean
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Else
            ...
            _User = Await FEB.User.Validate(_Emp, sEmail, sPassword, exs)
    ...
    Private Async Sub LinkLabelRemindPassword_Click(sender As Object, e As EventArgs) Handles LinkLabelRemindPassword.Click
        ...
        Else
            Dim exs As New List(Of Exception)
            If Await FEB.User.EmailPwd(_Emp, sEmail, exs) Then
                WarnUser(Icons.Info, "password enviat a " & sEmail)
            Else
    ...
    Private Sub ButtonFbLogin_Click(sender As Object, e As EventArgs) Handles ButtonFbLogin.Click
        RequestToFbLogin = True
        Me.Close()
    End Sub
