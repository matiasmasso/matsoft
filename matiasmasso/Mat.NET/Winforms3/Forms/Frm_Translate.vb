Public Class Frm_Translate
    ...
    Private Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        ' If FEB.WebMenuGroup.Load(exs, oWebMenuGroup) Then
        ' oWebMenuGroup.LangText = _LangText
        ' If Await FEB.WebMenuGroup.Update(exs, oWebMenuGroup) Then
        ...
        ' If FEB.WebMenuItem.Load(exs, oWebMenuItem) Then
        ' oWebMenuItem.LangText = _LangText
        ' If Await FEB.WebMenuItem.Update(exs, oWebMenuItem) Then
        ...
        ' If FEB.WinmenuItem.Load(oWinMenuItem, exs) Then
        ' oWinMenuItem.LangText = _LangText
        ' If Await FEB.WinmenuItem.Update(oWinMenuItem, exs) Then
