Public Class Frm_Invoice
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.Invoice.Load(_Invoice, exs) Then
            If Not _Invoice.customer.IsConsumer Then
                ...
                FEB.Customer.Load(_Invoice.customer, exs)
            End If
            ...
            With _Invoice
                ...
                SetAmounts()
                Dim oContactMenu = Await FEB.ContactMenu.Find(exs, _Invoice.Customer.Guid)
                Dim oMenuContact = New Menu_Contact(_Invoice.Customer, oContactMenu)
    ...
    Private Async Function SetNumYSerie(exs As List(Of Exception)) As Task
        With _Invoice
            If .IsNew Then
                Dim iNums = Await FEB.Invoices.AvailableNums(Current.Session.Emp, .Fch.Year, .Serie, exs)
    ...
    Private Function ExentoDeIva() As Boolean
        Dim retval As Boolean = False
        Select Case _Invoice.ExportCod
            Case DTOInvoice.ExportCods.nacional
                retval = False
            Case DTOInvoice.ExportCods.intracomunitari
                retval = Not _Invoice.IsConsumer
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        With _Invoice
            ...
            If RadioButtonSubjecta.Checked Then
                .SiiL9 = ""
            Else
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.Invoice.Delete(_Invoice, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Invoice))
                Me.Close()
            Else
                UIHelper.ToggleProggressBar(PanelButtons, False)
    ...
    Private Async Sub DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles DateTimePicker1.ValueChanged
        ...
        If _Invoice.IsNew AndAlso _Invoice.Fch.Year <> iYear Then
            Dim exs As New List(Of Exception)
            Dim iNums = Await FEB.Invoices.AvailableNums(Current.Session.Emp, iYear, _Invoice.Serie, exs)
            If iNums.Count = 1 Then
