Public Class Frm_Email
    ...
    Private Async Function CheckEmail(src) As Task
        ...
        Else
            Dim oUser = Await FEB.User.FromEmail(exs, Current.Session.Emp, src)
            If exs.Count = 0 Then
    ...
    Private Sub Xl_EmailAddress1_Validated(sender As Object, e As EventArgs) Handles Xl_EmailAddress1.Validated
        If String.IsNullOrEmpty(TextBoxNickname.Text) AndAlso Xl_EmailAddress1.Nickname.Trim() > "" Then
            TextBoxNickname.Text = Xl_EmailAddress1.Nickname.Trim
            Xl_EmailAddress1.Load(Xl_EmailAddress1.EmailAddress)
        End If
    End Sub
End Class