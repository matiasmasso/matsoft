...
Partial Class Frm_Noticia
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_Keywords1 = New Xl_Keywords()
        Me.Xl_Image265x150 = New Xl_Image()
        Me.Xl_LookupProduct1 = New Xl_LookupProduct()
        Me.Xl_CategoriasDeNoticia1 = New Xl_CategoriasDeNoticia()
    ...
    Friend WithEvents Xl_Image265x150 As Xl_Image
    Friend WithEvents CheckBoxProfessional As System.Windows.Forms.CheckBox
    Friend WithEvents Xl_CategoriasDeNoticia1 As Xl_CategoriasDeNoticia
    Friend WithEvents Xl_LookupProduct1 As Xl_LookupProduct
    Friend WithEvents Xl_Keywords1 As Xl_Keywords
