Public Class Frm_Ccx
    ...
    Private Async Sub Frm_Ccx_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        FEB.Contact.Load(_Ccx, exs)
        _Ccx = FEB.Customer.CcxOrMe(exs, _Ccx)
    ...
    Private Async Sub RefrescaControl(sender As Object, e As EventArgs)
        ...
        If TypeOf sender Is Xl_CustomerCentres Then
            Dim oCentres = Await FEB.Customer.Children(exs, _Ccx)
            If exs.Count = 0 Then
        ...
        ElseIf TypeOf _Control Is Xl_CcxPncs Then
            Dim oPncs = Await FEB.PurchaseOrderItems.Pending(exs, _Ccx, DTOPurchaseOrder.Codis.client, GlobalVariables.Emp.Mgz, DTOCustomer.GroupLevels.Chain)
            If exs.Count = 0 Then
        ...
        ElseIf TypeOf sender Is Xl_SellOut Then
            Dim oSellOut = Await FEB.SellOut.Factory(exs, Current.Session.User)
            If exs.Count = 0 Then
                FEB.SellOut.SetCcx(oSellOut, _Ccx)
