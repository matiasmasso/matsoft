Public Class Frm_DeliveryTraspas
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.DeliveryTraspas.Load(_DeliveryTraspas, exs) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs)
        ...
        Dim exs As New List(Of Exception)
        If Await FEB.DeliveryTraspas.Update(_DeliveryTraspas, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.DeliveryTraspas.Delete(_DeliveryTraspas, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_DeliveryTraspas))
                Me.Close()
            Else
