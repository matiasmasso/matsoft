Public Class Frm_Location
    ...
    Private Async Sub Frm_Location_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If _Location.IsNew Then
            FEB.Zona.Load(_Location.Zona, exs)
        Else
            If Not FEB.Location.Load(_Location, exs) Then
        ...
        With _Location
            ...
            If .Zona.SplitByComarcas Then
                ...
                Dim oComarcas = Await FEB.Comarcas.All(.Zona, exs)
                If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        ...
        Else
            ...
            If Await FEB.Location.Update(_Location, exs) Then
        ...
        Select Case TabControl1.SelectedIndex
            Case Tabs.Contacts
                If Not _BlDoneContacts Then
                    ...
                    Dim oContacts = Await FEB.Contacts.All(exs, GlobalVariables.Emp, _Location)
                    If exs.Count = 0 Then
            ...
            Case Tabs.Albarans
                If Not _BlDoneAlbarans Then
                    ...
                    Dim oDeliveries = Await FEB.Deliveries.All(exs, GlobalVariables.Emp, _Location)
                    If exs.Count = 0 Then
            ...
            Case Tabs.BankBranches
                If Not _BlDoneBankBranches Then
                    ...
                    Dim oBankBranches = Await FEB.BankBranches.All(_Location, exs)
                    If exs.Count = 0 Then
