Public Class Frm_Facturacio
    ...
    Private Async Sub Frm_Facturacio_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If _Transmisions Is Nothing Then
            ...
            _PendingDeliveries = Await FEB.Deliveries.PendentsDeFacturar(exs, Current.Session.Emp)
            If exs.Count = 0 Then
    ...
    Private Async Function Procesa() As Task
        ...
        _LastInvoicesEachSerie = Await FEB.Invoices.LastEachSerie(exs, oExercici)
        ...
        _Deliveries = Await FEB.Deliveries.PendentsDeFacturar(exs, Current.Session.Emp)
        If exs.Count = 0 Then
            ...
            Else
                ...
                _Invoices = Await FEB.Invoice.Factory(exs, Current.Session.Emp, _DeliveriesToInvoice, _MinTransmisioFch, oLastInvoicesEachSerie, AddressOf Xl_ProgressBar2.ShowProgress)
            End If
    ...
    Private Async Function refresca() As Task
        Await Xl_Facturacio2.Load(_Invoices, _LastInvoicesEachSerie, _MinTransmisioFch)
    ...
    Private Async Sub Xl_Facturacio2_RequestToRefresh(sender As Object, e As MatEventArgs) Handles Xl_Facturacio2.RequestToRefresh
        Await refresca()
    End Sub
    ...
    Private Async Sub Xl_Deliveries2_RequestToInvoice(sender As Object, e As MatEventArgs) Handles Xl_Deliveries2.RequestToInvoice
        ...
        If oSortedDeliveries.Count > 0 Then
            oInvoices = Await FEB.Invoice.Factory(exs, Current.Session.Emp, oSortedDeliveries, _MinTransmisioFch, _LastInvoicesEachSerie, AddressOf Xl_ProgressBar2.ShowProgress)
        End If
        Await Xl_Facturacio2.Load(oInvoices, _LastInvoicesEachSerie, _MinTransmisioFch)
