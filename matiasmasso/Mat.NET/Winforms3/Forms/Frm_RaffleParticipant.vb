Public Class Frm_RaffleParticipant
    ...
    Private Sub Frm_RaffleParticipant_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.RaffleParticipant.Load(exs, _RaffleParticipant) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.RaffleParticipant.Delete(exs, _RaffleParticipant) Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.RaffleParticipant.Update(exs, _RaffleParticipant) Then
