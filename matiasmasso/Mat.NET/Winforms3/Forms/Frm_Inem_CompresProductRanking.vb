Public Class Frm_Inem_CompresProductRanking
    ...
    Private Async Sub Frm_Inem_CompresProductRanking_Load(sender As Object, e As EventArgs) Handles Me.Load
        Dim oYearMonth = DTOYearMonth.FromFch(DTO.GlobalVariables.Today().AddMonths(-1))
    ...
    Private Async Function refresca() As Task
        ...
        Dim items = Await FEB.InemCompresProductRanking.All(exs, GlobalVariables.Emp, oYearMonth)
        If exs.Count = 0 Then
