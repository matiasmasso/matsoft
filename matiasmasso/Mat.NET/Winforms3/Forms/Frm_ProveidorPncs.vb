Public Class Frm_ProveidorPncs
    ...
    Private Async Function refresca() As Task
        ...
        If _Values Is Nothing Then
            ...
            _Values = Await FEB.PurchaseOrderItems.Pending(exs, _Proveidor, DTOPurchaseOrder.Codis.proveidor, GlobalVariables.Emp.Mgz)
    ...
    Private Sub Do_Excel()
        ...
        Dim oSheet = FEB.PurchaseOrderItems.Excel(_Values, sTitle, sFilename)
        Dim exs As New List(Of Exception)
