Public Class Frm_ContactPurchaseOrderItems
    ...
    Private Async Sub Frm_ContactPurchaseOrderItems_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If FEB.Contact.Load(_Contact, exs) Then
            ...
            _Items = Await FEB.PurchaseOrderItems.All(exs, _Contact)
            ...
            Xl_LookupProduct1.Load(New List(Of DTOProduct), DTOProduct.SelectionModes.SelectAny, CustomLookup:=True)
        Else
            UIHelper.WarnError(exs)
        End If
    End Sub
