...
Partial Class Frm_BookFra
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_SiiLog1 = New Xl_SiiLog()
        Me.Xl_BaseQuotaIva2 = New Xl_BaseQuota()
        Me.Xl_BaseQuotaIrpf = New Xl_BaseQuota()
        Me.Xl_BaseQuotaIva = New Xl_BaseQuota()
        Me.Xl_AmtTot = New Xl_Amount()
        Me.Xl_AmtDevengat = New Xl_Amount()
        Me.Xl_AmtCurBaseExento = New Xl_AmountCur()
        Me.Xl_DocFile1 = New Xl_DocFile_Old()
        Me.Xl_Cta1 = New Xl_Cta()
        Me.Xl_Contact1 = New Xl_Contact2()
        Me.Xl_BaseQuotaIva1 = New Xl_BaseQuota()
