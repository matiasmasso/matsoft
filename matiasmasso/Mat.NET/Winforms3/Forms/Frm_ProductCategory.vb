Public Class Frm_ProductCategory
    ...
    Public Sub New(value As DTOProductCategory) 'Ojo, es carrega les url i les descripcions
        MyBase.New()
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        With _ProductCategory
            ...
            If .Brand IsNot Nothing Then oProducts.Add(.Brand)
            Xl_LookupProductBrand.Load(oProducts, DTOProduct.SelectionModes.Selectbrand)
    ...
    Private Sub Control_Changed(sender As Object, e As EventArgs) Handles _
         TextBoxNom.TextChanged,
          Xl_LookupProductBrand.AfterUpdate,
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.ProductCategory.Update(_ProductCategory, exs) Then
        ...
        Select Case DirectCast(TabControl1.SelectedIndex, Tabs)
            Case Tabs.Skus
                If Not _SkusLoaded Then
                    _SkusLoaded = True
                    Dim oSkus = Await FEB.ProductSkus.All(exs, _ProductCategory, Current.Session.Lang, GlobalVariables.Emp.Mgz, True)
                    If exs.Count = 0 Then
            ...
            Case Tabs.Filters
                If Not _FiltersLoaded Then
                    ...
                    If exs.Count = 0 Then
                        Dim oCheckedItems = Await FEB.FilterTargets.All(exs, _ProductCategory)
                        If exs.Count = 0 Then
