                        ...
                        If FEB.ProductSku.Load(oSku, exs) Then
                            ...
                            If Not oResults.Any(Function(x) x.Row = lin) Then
                                If Await FEB.ProductSku.Update(oSku, exs) Then
                                    oResults.Add(MatHelper.Excel.ValidationResult.Factory(lin, MatHelper.Excel.ValidationResult.Cods.Success, oSku.RefYNomLlarg.Tradueix(Current.Session.Lang)))
                                Else
