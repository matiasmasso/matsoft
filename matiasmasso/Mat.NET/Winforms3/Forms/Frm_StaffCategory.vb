Public Class Frm_StaffCategory
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.StaffCategory.Load(exs, _StaffCategory) Then
            With _StaffCategory
                TextBox1.Text = .Nom
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.StaffCategory.Update(exs, _StaffCategory) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.StaffCategory.Delete(exs, _StaffCategory) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_StaffCategory))
                Me.Close()
            Else
