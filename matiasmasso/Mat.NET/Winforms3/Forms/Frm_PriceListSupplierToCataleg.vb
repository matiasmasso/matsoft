Public Class Frm_PriceListSupplierToCataleg
    ...
    Private Async Function Refresca(Optional oLastPriceListCustomer As DTOPricelistCustomer = Nothing, Optional oLastCategory As DTOProductCategory = Nothing) As Task
        ...
        With _Item
            ...
            If oLastCategory IsNot Nothing Then oProducts.Add(oLastCategory)
            Xl_LookupProduct1.Load(oProducts, DTOProduct.SelectionModes.SelectCategory)

            Dim oSku = Await FEB.ProductSku.FromProveidor(exs, _Item.Parent.Proveidor, _Item.Ref)
            If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If exs.Count = 0 Then
            If oSku Is Nothing Then
                ...
                Dim oExistingSku = Await FEB.ProductSku.FromNom(exs, oCategory, sNomCurt)
                If exs.Count = 0 Then
                    ...
                    With oSku
                        ...
                        If CheckBoxHideUntil.Checked Then
                            If DTO.GlobalVariables.Today() < Xl_PriceList_Customer1.PriceList_Customer.Fch Then
                    ...
                    If Await FEB.ProductSku.Update(oSku, exs) Then
                        ...
                        If Await FEB.PriceListItemCustomer.Update(exs, oDTOPricelistItemCustomer) Then
                            Me.Close()
