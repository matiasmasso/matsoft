Public Class Frm_MediaResources
    ...
    Private Async Function refrescaTree() As Task
        ...
        Dim oTree = Await FEB.ProductCatalog.CompactTree(exs, Current.Session.Emp, includeObsoletos)
    ...
    Private Async Function refresca(oProduct As DTOProduct) As Task
        Dim exs As New List(Of Exception)
        ProgressBar1.Visible = True
        Dim items = Await FEB.MediaResources.ProductSpecificWithThumbnails(exs, oProduct)
        ProgressBar1.Visible = False
        If exs.Count = 0 Then
