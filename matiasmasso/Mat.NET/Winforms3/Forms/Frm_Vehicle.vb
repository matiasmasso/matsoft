Public Class Frm_Vehicle
    ...
    Private _Model As DTOVehicle.ModelClass
    ...
    Private Async Sub Refresca()
        ...
        If FEB.Vehicle.Load(_Vehicle, exs) Then
            With _Vehicle
                _Model = .Model
                ...
                Dim oDownloads = Await FEB.ProductDownloads.All(_Vehicle, exs)
                If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        With _Vehicle
            ...
            If Await FEB.Vehicle.Upload(_Vehicle, exs) Then
...
#Region "Multes"
    ...
    Private Async Sub refrescaMultes()
        Dim exs As New List(Of Exception)
        Dim oMultes = Await FEB.Multes.All(_Vehicle, exs)
        If exs.Count = 0 Then
    ...
    Private Sub Xl_Multas1_RequestToAddNew(sender As Object, e As MatEventArgs) Handles Xl_Multas1.RequestToAddNew
        ...
        With oMulta
            .Subjecte = _Vehicle
            .Subjecte.Nom = _Vehicle.MarcaModelYMatricula
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            Dim exs As New List(Of Exception)
            If Await FEB.Vehicle.Delete(_Vehicle, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Vehicle))
                Me.Close()
            Else
                UIHelper.WarnError(exs)
