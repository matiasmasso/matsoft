Public Class Frm_WebMenuItem
    ...
    Private Async Sub Frm_WebMenuItem_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.WebMenuItem.Load(exs, _WebMenuItem) Then
            ...
            If exs.Count = 0 Then
                With _WebMenuItem
                    ...
                    End If
                    If .LangUrl IsNot Nothing Then
                        TextBoxUrlEsp.Text = .LangText.Text(DTOLang.ESP)
                        TextBoxUrlCat.Text = .LangText.Text(DTOLang.CAT)
                        TextBoxUrlEng.Text = .LangText.Text(DTOLang.ENG)
                        TextBoxUrlPor.Text = .LangText.Text(DTOLang.POR)
                    End If
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        With _WebMenuItem
            ...
            .LangUrl = New DTOLangText(TextBoxUrlEsp.Text, TextBoxUrlCat.Text, TextBoxUrlEng.Text, TextBoxUrlPor.Text)
        ...
        If Await FEB.WebMenuItem.Update(exs, _WebMenuItem) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.WebMenuItem.Delete(exs, _WebMenuItem) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_WebMenuItem))
                Me.Close()
            Else
