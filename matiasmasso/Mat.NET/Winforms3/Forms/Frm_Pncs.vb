Public Class Frm_Pncs
    ...
    Private Async Function refresca() As Task
        ...
        Dim oPurchaseOrderItems = Await FEB.PurchaseOrderItems.Pending(exs, oUser, DTOPurchaseOrder.Codis.Client, GlobalVariables.Emp.Mgz)
        If exs.Count = 0 Then
    ...
    Private Sub ExcelToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ExcelToolStripMenuItem.Click
        Dim exs As New List(Of Exception)
        Dim oSheet As MatHelper.Excel.Sheet = FEB.PurchaseOrderItems.Excel(_Items)
