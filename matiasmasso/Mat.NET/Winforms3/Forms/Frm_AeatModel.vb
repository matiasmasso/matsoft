Public Class Frm_AeatModel
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.AeatModel.Load(_AeatModel, exs) Then
            With _AeatModel
                TextBoxNom.Text = .Nom
                TextBoxDsc.Text = .Dsc
    ...
    Private Async Sub refrescaDocs()
        Dim exs As New List(Of Exception)
        Dim oDocs = Await FEB.AeatDocs.All(Current.Session.Emp, _AeatModel, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        Dim exs As New List(Of Exception)
        If Await FEB.AeatModel.Update(_AeatModel, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.AeatModel.Delete(_AeatModel, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_AeatModel))
                Me.Close()
            Else
    ...
    Private Async Sub Xl_AeatDocs1_RequestToAddNew(sender As Object, e As MatEventArgs) Handles Xl_AeatDocs1.RequestToAddNew
        Dim exs As New List(Of Exception)
        Dim oAeatDoc = Await FEB.AeatDoc.CreateNext(Current.Session.Emp, _AeatModel, exs)
        If exs.Count = 0 Then
            Dim oFrm_Aeatdoc As New Frm_AeatDoc(oAeatDoc)
            oAeatDoc.Fch = DTO.GlobalVariables.Today()
