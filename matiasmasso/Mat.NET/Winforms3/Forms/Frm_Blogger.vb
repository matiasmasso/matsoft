Public Class Frm_Blogger
    ...
    Private Async Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.Blogger.Load(_Blogger, exs) Then
            With _Blogger
                TextBoxTitle.Text = .Title
                TextBoxUrl.Text = .Url
                Xl_LookupUser1.Load(.Author)
                If _Blogger.IsNew Then
                    ButtonOk.Enabled = True
                Else
                    ButtonDel.Enabled = True
                    Xl_Image1.Bitmap = LegacyHelper.ImageHelper.Converter(Await FEB.Blogger.Logo(.Guid, exs))
                    If exs.Count > 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.Blogger.Update(_Blogger, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        ...
        If rc = MsgBoxResult.Ok Then
            If Await FEB.Blogger.Delete(_Blogger, exs) Then
                RaiseEvent AfterUpdate(Me, New MatEventArgs(_Blogger))
                Me.Close()
            Else
