Public Class Frm_LastCcas
    ...
    Private Async Sub refresca()
        ...
        Dim oCcas = Await FEB.Ccas.Headers(oExercici, exs)
        If exs.Count = 0 Then
    ...
    Private Sub LoadYears()
        ...
        For i = 1985 To DTO.GlobalVariables.Today().Year
            years.Insert(0, i)
        Next
        Xl_Years1.Load(years, DTO.GlobalVariables.Today().Year)
    End Sub
    ...
    Private Async Sub LlibreMajorToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles LlibreMajorToolStripMenuItem.Click
        Dim exs As New List(Of Exception)
        Dim oSheet = Await FEB.LlibreMajor.Excel(exs, CurrentExercici)
