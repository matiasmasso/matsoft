Public Class Frm_Zona
    ...
    Private Sub Frm_Properties_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If FEB.Zona.Load(_Zona, exs) Then
            With _Zona
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.Zona.Update(_Zona, exs) Then
    ...
    Private Async Sub refrescaLocations()
        Dim exs As New List(Of Exception)
        Dim oLocations = Await FEB.Locations.FromZona(_Zona, exs)
        If exs.Count = 0 Then
    ...
    Private Async Function refrescaReps() As Task
        Dim exs As New List(Of Exception)
        Dim oRepProducts = Await FEB.RepProducts.All(exs, _Zona)
        If exs.Count = 0 Then
