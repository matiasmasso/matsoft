Public Class Frm_PriceLists_Customers
    ...
    Private Sub Do_CopyLink()
        Dim sUrl As String = FEB.UrlHelper.Factory(True, "tarifas")
        'If DtFch <> DTO.GlobalVariables.Today() Then
        'sUrl = FEB.UrlHelper.Factory(True, "tarifa", DtFch.ToFileTime)
        'End If
    ...
    Private Async Function refresca() As Task
        ...
        Dim items = Await FEB.PriceListItemsCustomer.Vigent(exs)
        If exs.Count = 0 Then
            Xl_PriceList_Customers_Vigent1.Load(items) 'Today)
            Dim values = Await FEB.PriceListsCustomer.All(exs)
