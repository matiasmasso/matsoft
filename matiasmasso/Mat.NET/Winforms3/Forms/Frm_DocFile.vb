Public Class Frm_DocFile
    ...
    Private Async Sub Frm_DocFile_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Dim oLogs = Await FEB.DocFile.Logs(_DocFile, exs)
        If exs.Count = 0 Then
        ...
        Dim oSrcs = Await FEB.DocFile.Srcs(_DocFile, exs)
        If exs.Count = 0 Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.DocFile.Upload(Xl_DocFile1.Value, exs) Then
    ...
    Private Async Sub ButtonDel_Click(sender As Object, e As EventArgs) Handles ButtonDel.Click
        Dim exs As New List(Of Exception)
        If Await FEB.DocFile.Delete(_DocFile, exs) Then
