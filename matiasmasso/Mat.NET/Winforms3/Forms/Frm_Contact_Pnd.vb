...
Public Class Frm_Contact_Pnd
                ...
                If .Csb IsNot Nothing Then
                    ...
                    If FEB.Csb.Load(.Csb, exs) Then
                        ...
                        If oCsa IsNot Nothing Then
                            ...
                            PictureBoxCsbIban.Image = LegacyHelper.ImageHelper.Converter(Await FEB.Iban.Img(exs, .Csb.Iban, Current.Session.Lang))
                        End If
                    Else
                        UIHelper.WarnError(exs)
                    End If
    ...
    Private Async Sub ButtonOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonOk.Click
        Try
            LoadPndFromForm()
            Dim exs As New List(Of Exception)
            If Await FEB.Pnd.Update(_Pnd, exs) Then
