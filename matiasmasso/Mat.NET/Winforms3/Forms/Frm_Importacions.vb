...
Public Class Frm_Importacions
    ...
    Private Sub LoadYears()
        ...
        For i = DTO.GlobalVariables.Today().Year + 1 To 2007 Step -1
            iYears.Add(i)
        Next
    ...
    Private Async Function refresca() As Task
        ...
        _Importacions = Await FEB.Importacions.All(exs, Current.Session.Emp, Xl_Years1.Value, _Proveidor)
    ...
    Private Async Sub TabControl1_SelectedIndexChanged(sender As Object, e As EventArgs) Handles TabControl1.SelectedIndexChanged
        ...
        If Not _IsLoaded(oTab) Then
            Select Case oTab
                Case Tabs.Weeks
                    Dim oImportacions = Await FEB.Importacions.Weeks(exs, Current.Session.Emp)
    ...
    Private Async Function LoadTransits() As Task
        Dim exs As New List(Of Exception)
        Dim oTransits = Await FEB.Importacions.Transits(exs, Current.Session.Emp)
        If exs.Count = 0 Then
    ...
    Private Sub AddNew()
        Dim exs As New List(Of Exception)
        If _Proveidor IsNot Nothing Then FEB.Proveidor.Load(_Proveidor, exs)
    ...
    Private Sub Xl_Importacions1_RequestToToggleProgressBar(sender As Object, e As MatEventArgs) Handles Xl_Importacions1.RequestToToggleProgressBar
