...
Partial Class Frm_PriceListSupplierToCataleg
    ...
    Private Sub InitializeComponent()
        ...
        Me.Xl_PercentCostDto = New Xl_Percent()
        Me.Xl_PercentRetail = New Xl_Percent()
        Me.Xl_AmtCurRetail = New Xl_AmountCur()
        Me.Xl_AmtCurCost = New Xl_AmountCur()
        ...
        Me.Xl_PriceList_Customer1 = New Xl_PriceList_Customer()
    ...
    Friend WithEvents Xl_PercentCostDto As Xl_Percent
    Friend WithEvents Xl_PercentRetail As Xl_Percent
    ...
    Friend WithEvents Xl_PriceList_Customer1 As Xl_PriceList_Customer
