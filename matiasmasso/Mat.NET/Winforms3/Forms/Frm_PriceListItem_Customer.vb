Public Class Frm_PricelistItemCustomer
    ...
    Private Async Sub LoadArt(oSku As DTOProductSku)
        ...
        If oSku IsNot Nothing Then
            ...
            PictureBox1.Image = LegacyHelper.ImageHelper.Converter(Await FEB.ProductSku.Image(exs, oSku))
            If exs.Count = 0 Then
            ...
            If FEB.ProductSku.Load(oSku, exs) Then
                ...
                Dim DcCostNet As Decimal
                Dim oPriceListItem_Supplier = Await FEB.PriceListItemSupplier.FromSku(exs, oSku)
                If exs.Count = 0 Then
    ...
    Private Async Function CostNet(exs As List(Of Exception), oSku As DTOProductSku) As Task(Of Decimal)
        ...
        If exs.Count = 0 Then
            If oSku IsNot Nothing Then
                'oSku = _Cache.FindSku(oSku.Guid)
                'If oSku.RefProveidor = "" Then FEB.ProductSku.Load(oSku, exs)
                Dim oPriceListItem_Supplier = Await FEB.PriceListItemSupplier.GetPreusDeCost(exs, oSku) ' oArt.GetPreusDeCost
                If oPriceListItem_Supplier IsNot Nothing Then
    ...
    Private Async Sub ButtonOk_Click(sender As Object, e As System.EventArgs) Handles ButtonOk.Click
        ...
        If Await FEB.PriceListItemCustomer.Update(exs, _Item) Then
