...
Public Class Frm_Raffles
    ...
    Private Async Function refresca() As Task
        ...
        Dim oRaffles = Await FEB.Raffles.Headers(exs, oLang:=Xl_Langs1.Value, year:=Xl_Years1.Value)
        If exs.Count = 0 Then
    ...
    Private Sub ToolStripButtonExcel_Click(sender As Object, e As EventArgs) Handles ToolStripButtonExcel.Click
        Dim oSheet As MatHelper.Excel.Sheet = FEB.Raffles.Excel(Xl_Raffles1.Values)
        Dim exs As New List(Of Exception)
