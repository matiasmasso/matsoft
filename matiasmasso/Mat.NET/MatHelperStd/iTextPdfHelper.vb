...
Public Class iTextPdfHelper
            ...
            Try
                ...
                For Each oObject In oObjectsToAdd
                    If TypeOf oObject Is MatPdfText Then
                        ...
                        Document.Add(p)
                    ElseIf TypeOf oObject Is MatPdfText Then
    ...
    Public Class MatPdfObject
        Property rectangle As SixLabors.ImageSharp.Rectangle
    ...
    Public Class MatPdfText
        ...
        Shared Function Factory(text As String, rectangle As SixLabors.ImageSharp.Rectangle, Optional font As Fonts = Fonts.Helvetica) As MatPdfText
    ...
    Public Class MatPdfImage
        ...
        Shared Function Factory(oImage As Image, rectangle As SixLabors.ImageSharp.Rectangle) As MatPdfImage
        ...
        Shared Function Factory(exs As List(Of Exception), oImageUri As Uri, rectangle As SixLabors.ImageSharp.Rectangle) As MatPdfImage
            Dim retval As New MatPdfImage
            With retval
                .Image = ImageHelper.DownloadFromWebsite(exs, oImageUri.AbsoluteUri)
                .rectangle = rectangle
            End With
            Return retval
        End Function
