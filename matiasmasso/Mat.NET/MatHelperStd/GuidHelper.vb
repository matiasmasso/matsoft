Public Class GuidHelper
    ...
    Shared Function GetGuid(ByVal oGuidCandidate As Object) As Guid
        ...
        If oGuidCandidate IsNot Nothing Then
            If Not Convert.IsDBNull(oGuidCandidate) Then
    ...
    Shared Function GetGuidFromBase64(sBase64 As String) As Guid
        ...
        Try
            ...
            Dim sBase64WithSufix As String = If(TextHelper.VbRight(sCleanBase64, 2) = "==", sCleanBase64, sCleanBase64 & "==")
    ...
    Shared Function RegexPattern() As String
        Return "?(?<Guid>\s?[a-zA-Z0-9]{8}\s?[-]?\s?(?:[a-zA-Z0-9]{4}\s?[-]?\s?){3}\s?[a-zA-Z0-9]{12}\s?)"
    End Function
End Class