...
Public Class ExcelEPPlusHelper
    ...
    Shared Function Read(exs As List(Of Exception), ByVal FilePath As String, Optional Title As String = "") As ExcelHelper.Sheet
        Dim retval As New ExcelHelper.Sheet(Title)
        Try
            Dim existingFile As New System.IO.FileInfo(FilePath)
            ...
            Using package As ExcelPackage = New ExcelPackage(existingFile)
                ...
                For row As Integer = 1 To rowCount
                    ...
                    For col As Integer = 1 To colCount
                        oRow.AddCell(worksheet.Cells(row, col).Value.ToString().Trim())
                    Next
                Next
            End Using
    ...
    Shared Function Read(exs As List(Of Exception), oByteArray As Byte(), Optional Filename As String = "", Optional Title As String = "") As ExcelHelper.Sheet
