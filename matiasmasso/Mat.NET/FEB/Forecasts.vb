Public Class Forecasts
    ...
    Shared Async Function Excel(oUser As DTOUser, oMgz As DTOMgz, exs As List(Of Exception)) As Task(Of MatHelper.Excel.Sheet)
        Return Await Api.Fetch(Of MatHelper.Excel.Sheet)(exs, "forecast/Excel", oUser.Guid.ToString, oMgz.Guid.ToString())
    End Function
