Public Class NominaEscuraHelper
    ...
    Shared Function CheckFile(exs As List(Of Exception), filename As String, oUser As DTOUser, ByRef fch As Date) As Boolean
        ...
        If sNif <> oUser.emp.Org.nif Then
            Dim nifOwner = Contact.SearchSync(exs, oUser, sNif, DTOContact.SearchBy.nif)
        ...
        For Each filename In filenames
            If firstFile Then
                ...
                If empNif = oUser.emp.Org.nif Then
                    ...
                    oStaffs = Await Staffs.All(exs, oExercici)
                    oCtas = Await PgcCtas.All(exs, oExercici.year)
                    firstFile = False
                Else
        ...
        If exs.Count = 0 Then
            ...
            If exs.Count = 0 Then
                ...
                With retval
                    ...
                    .cca = Nomina.Cca(retval, dtFch, oCtas, oUser, exs)
                    ...
                    .cca.docFile = DocFile.Factory(signedFilename, exs)
                End With
            End If
        End If
        Return retval
