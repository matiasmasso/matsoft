Public Class IbanStructure
    ...
    Shared Async Function GetBank(sIbanDigits As String, exs As List(Of Exception)) As Task(Of DTOBank)
        ...
        If src.Length >= 2 And Not TextHelper.VbIsNumeric(src) Then
            ...
            Dim oStructure = IbanStructure.FindSync(sPaisDigits, exs)
            If oStructure IsNot Nothing Then
                ...
                If Not String.IsNullOrEmpty(sBankDigits) Then
                    retval = Await Bank.FromCodi(oStructure.Country, sBankDigits, exs)
                End If
            End If
        End If
        Return retval
    ...
    Shared Async Function GetBank(oIban As DTOIban, exs As List(Of Exception)) As Task(Of DTOBank)
        ...
        If Iban.Load(oIban, exs) Then
            ...
            If oStructure IsNot Nothing Then
                ...
                retval = Await Bank.FromCodi(oStructure.Country, BankId, exs)
            End If
        End If
        Return retval
    End Function
    ...
    Shared Async Function GetBankBranch(oIban As DTOIban, exs As List(Of Exception)) As Task(Of DTOBankBranch)
        ...
        If Iban.Load(oIban, exs) Then
            ...
            If oStructure IsNot Nothing Then
                ...
                retval = Await BankBranch.Find(oStructure.Country, BankId, BranchId, exs)
            End If
        End If
        Return retval
    End Function
        ...
        If sIbanDigits > "" Then
            ...
            If src.Length >= 2 And Not TextHelper.VbIsNumeric(src) Then
                ...
                If oStructure IsNot Nothing Then
                    ...
                    retval = Await BankBranch.Find(oStructure.Country, sBankDigits, sBranchDigits, exs)
                End If
            End If
        End If
        Return retval
    ...
    Shared Async Function GetBankBranchId(sIbanDigits As String) As Task(Of String)
        ...
        If src.Length >= 2 And Not TextHelper.VbIsNumeric(src) Then
            Dim sPaisDigits As String = src.Substring(0, 2)
            Dim oStructure As DTOIban.Structure = Await IbanStructure.Find(sPaisDigits, exs)
            If oStructure IsNot Nothing Then
            ...
            If src.Length > 2 Then
                ...
                Select Case sISO
                    Case "ES"
                        ...
                        End If
                    Case Else
                        Dim oIbanStructure = Await IbanStructure.Find(sISO, exs)
                        If oIbanStructure Is Nothing Then
                            retval = True
                        Else
