...
Public Class Contracts
    ...
    Shared Function Excel(oContracts As List(Of DTOContract)) As MatHelper.Excel.Sheet
        Dim retval As New MatHelper.Excel.Sheet("contractes", "M+O contractes")
        With retval
            .AddColumn("tipus", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("numero", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("data", MatHelper.Excel.Cell.NumberFormats.DDMMYY)
            .AddColumn("caducitat", MatHelper.Excel.Cell.NumberFormats.DDMMYY)
            .AddColumn("concepte", MatHelper.Excel.Cell.NumberFormats.W50)
            .AddColumn("contractant", MatHelper.Excel.Cell.NumberFormats.W50)
        End With
        ...
        For Each oContract In oContracts
            ...
            With oContract
                ...
                oRow.AddCell(.fchTo)
                oRow.AddCell(.Nom, DocFile.DownloadUrl(.DocFile, True))
