Public Class RepComsFollowUp
    ...
    Shared Async Function Excel(oRep As DTORep, exs As List(Of Exception)) As Task(Of MatHelper.Excel.Sheet)
        Dim retval As New MatHelper.Excel.Sheet(oRep.NickName, String.Format("M+O Seguimiento comisiones {0}", oRep.NickName))
        With retval
            .AddColumn("Ejercicio")
            .AddColumn("Mes")
            .AddColumn("Dia")
            .AddColumn("Pedido", MatHelper.Excel.Cell.NumberFormats.Euro)
            .AddColumn("Servido", MatHelper.Excel.Cell.NumberFormats.Euro)
            .AddColumn("Facturado", MatHelper.Excel.Cell.NumberFormats.Euro)
            .AddColumn("Liquidado", MatHelper.Excel.Cell.NumberFormats.Euro)
            .AddColumn("Num.Registro")
            .AddColumn("Cliente")
            .AddColumn("Concepto")
        End With
        Dim oOrders = Await Rep.Archive(oRep, exs)
        For Each oOrder In oOrders
            ...
            oRow.AddCell(oOrder.FormattedId, PurchaseOrder.Url(oOrder, True))
