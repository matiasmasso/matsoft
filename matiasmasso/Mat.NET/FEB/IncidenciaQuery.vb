...
Public Class IncidenciaQuery
    ...
    Shared Function ExcelSheet(oModel As Models.IncidenciesModel, oCulture As CultureInfo, oLang As DTOLang) As MatHelper.Excel.Sheet
        ...
        Else
            ...
            For Each item In oModel.Items
                Dim oRow As MatHelper.Excel.Row = retval.AddRow()
                oRow.AddCell(item.Num.ToString, UrlHelper.Factory(True, "incidencia", item.Guid.ToString))
