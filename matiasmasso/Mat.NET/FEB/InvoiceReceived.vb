...
Public Class InvoicesReceived
    ...
    Shared Async Function ClearImportacio(exs As List(Of Exception), oInvoicesReceived As List(Of DTOInvoiceReceived)) As Threading.Tasks.Task(Of Boolean)
        Return Await Api.Execute(Of List(Of DTOInvoiceReceived), Boolean)(oInvoicesReceived, exs, "InvoicesReceived/ClearImportacio")
    End Function
End Class
