...
Public Class Correspondencias
    ...
    Shared Function Excel(items As List(Of DTOCorrespondencia)) As MatHelper.Excel.Sheet
        Dim retval As New MatHelper.Excel.Sheet("Correspoondencia")
        With retval
            .AddColumn("Id")
        ...
        For Each item In items
            ...
            oRow.AddCell(item.Subject, DocFile.DownloadUrl(item.DocFile, True))
        Next
        Return retval
    End Function
End Class
