Public Class WebAtlas
    ...
    Shared Async Function Excel(oProveidor As DTOProveidor, exs As List(Of Exception)) As Task(Of MatHelper.Excel.Sheet)
        Dim retval As MatHelper.Excel.Sheet = Nothing
        Dim items = Await WebAtlas.Distributors(oProveidor, exs)
        If exs.Count = 0 Then
            ...
            retval = New MatHelper.Excel.Sheet(sTitle, sFilename)
            With retval
