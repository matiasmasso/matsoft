Public Class Ediversa_INVOIC_D_93A_UN_EAN007
    ...
    Shared Async Function EdiMessage(oEmp As DTOEmp, oInvoice As DTOInvoice, exs As List(Of DTOEdiversaException)) As Task(Of String)
        ...
        If oClient.isElCorteIngles Then
            Dim oEdiversaOrderFile = Await EdiversaFile.FromResultGuid(ex2, oFirstOrder.Guid)
            ...
            Else
                oNadBy = Await EdiversaFile.GetInterlocutor(oEdiversaOrderFile, DTOEdiversaContact.Cods.NADBY, exs)
                oNadDp = Await EdiversaFile.GetInterlocutor(oEdiversaOrderFile, DTOEdiversaContact.Cods.NADDP, exs)
                oNadIv = Await EdiversaFile.GetInterlocutor(oEdiversaOrderFile, DTOEdiversaContact.Cods.NADIV, exs)
            End If
                ...
                Try
                    ...
                    If isFirstDelivery Then
                        ...
                        If oInvoice.Customer.Equals(DTOCustomer.Wellknown(DTOCustomer.Wellknowns.carrefour)) Then
                            ...
                            With oComprador
                                sb.AppendLine(String.Format("NADBY|{0}|{1}|{2}|{3}|{4}|{5}", oNadBy.GLN.Value, .Nom.Truncate(70).RemoveDiacritics(), TextHelper.ToSingleLine(.Address.Text, 70).RemoveDiacritics(), .Address.Zip.Location.Nom.Truncate(35).RemoveDiacritics(), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                                'sb.AppendLine(String.Format("NADBY|{0}|{1}|{2}|{3}|{4}|{5}|{6}", "8480015009007", Left(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), Left(.Address.Zip.Location.Nom, 35), Left(.Address.Zip.ZipCod, 5), Left(.Nif, 11), Left(sDept, 3)))
                            End With
                            With oClient
                                sb.AppendLine(String.Format("NADIV|{0}|{1}|{2}|{3}|{4}|{5}", oNadIv.GLN.Value, .Nom.Truncate(70).RemoveDiacritics(), TextHelper.ToSingleLine(.Address.Text, 70).RemoveDiacritics(), .Address.Zip.Location.Nom.Truncate(35).RemoveDiacritics(), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                                'sb.AppendLine(String.Format("NADIV|{0}|{1}|{2}|{3}|{4}|{5}", "8480015222222", Left(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), Left(.Address.Zip.Location.Nom, 35), Left(.Address.Zip.ZipCod, 5), Left(.Nif, 11)))
                                sb.AppendLine(String.Format("NADBCO|{0}|{1}|{2}|{3}|{4}|{5}", oNadIv.GLN.Value, TextHelper.VbLeft(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                                'sb.AppendLine(String.Format("NADPR|{0}|{1}|{2}|{3}|{4}|{5}", "8480015222222", Left(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), Left(.Address.Zip.Location.Nom, 35), Left(.Address.Zip.ZipCod, 5), Left(.Nif, 11)))
                            End With
                            With oProveidor
                                ...
                                sb.AppendLine(String.Format("NADII|{0}|{1}|{2}|{3}|{4}|{5}", .GLN.Value, TextHelper.VbLeft(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                            End With
                            sb.AppendLine("NADDP|" & oNadDp.GLN.Value) 'Datos receptor mercancia (plataforma)
                        Else
                            With oComprador
                                sb.AppendLine(String.Format("NADBY|{0}|{1}|{2}|{3}|{4}|{5}|{6}", .GLN.Value, TextHelper.VbLeft(.Nom, 70).RemoveDiacritics(), TextHelper.ToSingleLine(.Address.Text, 70).RemoveDiacritics(), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35).RemoveDiacritics(), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11), TextHelper.VbLeft(sDept, 3)))
                            End With
                            With oClient
                                sb.AppendLine(String.Format("NADIV|{0}|{1}|{2}|{3}|{4}|{5}", .GLN.Value, TextHelper.VbLeft(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                                sb.AppendLine(String.Format("NADBCO|{0}|{1}|{2}|{3}|{4}|{5}", .GLN.Value, TextHelper.VbLeft(.Nom, 70), TextHelper.ToSingleLine(.Address.Text, 70), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                            End With
                            With oProveidor
                                sb.AppendLine(String.Format("NADSU|{0}|{1}|{2}|{3}|{4}|{5}|{6}", .GLN.Value, TextHelper.VbLeft(.Nom, 70), TextHelper.VbLeft(sRegistroMercantil, 70), TextHelper.ToSingleLine(.Address.Text, 70), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
                                sb.AppendLine(String.Format("NADSCO|{0}|{1}|{2}|{3}|{4}|{5}|{6}", .GLN.Value, TextHelper.VbLeft(.Nom, 70), TextHelper.VbLeft(sRegistroMercantil, 70), TextHelper.ToSingleLine(.Address.Text, 70), TextHelper.VbLeft(.Address.Zip.Location.Nom, 35), TextHelper.VbLeft(.Address.Zip.ZipCod, 5), TextHelper.VbLeft(.PrimaryNifValue(), 11)))
