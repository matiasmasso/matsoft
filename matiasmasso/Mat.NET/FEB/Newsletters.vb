    ...
    Shared Function ItemUrl(item As DTONewsletterSource, Optional ByVal AbsoluteUrl As Boolean = False) As String
        ...
        Select Case item.Cod
            Case DTONewsletterSource.Cods.News, DTONewsletterSource.Cods.Events
                retval = UrlHelper.Factory(False, "news", item.Url)
                ...
                '    oNoticia = item.Tag
                'End If
                'retval = Noticia.UrlFriendly(oNoticia, AbsoluteUrl)
            Case DTONewsletterSource.Cods.Blog
                retval = UrlHelper.Factory(False, "blog", item.Url)
            ...
            Case DTONewsletterSource.Cods.Promo
                retval = UrlHelper.Factory(False, "promo", item.Url)
                ...
                '    oIncentiu = item.Tag
                'End If
                'retval = Incentiu.Url(oIncentiu, True)
        End Select
        Return retval
    End Function
