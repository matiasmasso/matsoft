Public Class Ean13
    ...
    Shared Function FromDigits(src As String) As DTOEan
        Dim sCleanSrc As String = CleanDigits(src)
        Dim retval =DTOEan.Factory(sCleanSrc)
        Return retval
    End Function
    ...
    Shared Function StringValue(oEan As DTOEan) As String
        ...
        Else
            Select Case Len(oEan.Value)
                ...
                Case 13
                    ...
                    Dim iCheckDigit As Integer = CheckDigit(oEan)
    ...
    Shared Function IsEmpty(oEan As DTOEan) As Boolean
        Dim retval As Boolean = False
        If oEan.Value = "0000000000000" Then retval = True
        Return retval
    End Function
...
#Region "Drawing"
    ...
    Shared Function Bitmap(oEan As DTOEan, Optional ByVal BlDrawDigits As Boolean = True, Optional iHeight As Integer = 40, Optional oBgGolor As Color = Nothing) As Bitmap
        ...
        SetAreaDefinition()
        If isValid(oEan) Then
            Dim sPadding As String = "00000000"
            Dim sCleanDigits As String = CleanDigits(oEan.Value)
