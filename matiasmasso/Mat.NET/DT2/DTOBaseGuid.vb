Public Class DTOBaseGuid
    ...
    Shared Function Opcional(Of T As DTOBaseGuid)(oGuid As Guid) As T
    ...
    Public Shadows Function UnEquals(oCandidate As DTOBaseGuid) As Boolean
        Dim retval As Boolean = Not Equals(oCandidate)
        Return retval
    End Function

    Public Shadows Function Equals(oCandidate As DTOBaseGuid) As Boolean
    ...
    Public Function NotEquals(oCandidate As DTOBaseGuid) As Boolean
        Dim retval As Boolean = Not Equals(oCandidate)
        Return retval
    End Function
    ...
    Public Function Trimmed() As DTOBaseGuid
    ...
    Shared Function Trim(Of T)(oSource As T, exs As List(Of Exception)) As T
        ...
        Try
            ...
            For Each oProperty In oProperties
                If GetType(DTOBaseGuid).IsAssignableFrom(oProperty.PropertyType) Then
                    Try
                        Dim oBaseGuid As DTOBaseGuid = oProperty.GetValue(oSource)
                        If oBaseGuid IsNot Nothing Then
                            Dim oTrimmedPropertyValue = Activator.CreateInstance(oProperty.PropertyType, oBaseGuid.Guid)
                            oProperty.SetValue(retval, oTrimmedPropertyValue)
                        End If
                ...
                Else
                    ...
                    If oRawValue IsNot Nothing Then
                        Dim oTrimmedValue = DTOBaseGuid.Trim(oRawValue, exs)
