Public Class EdiversaInvRpt
    ...
    Shared Async Function Excel(exs As List(Of Exception), oEmp As DTOEmp, oCustomer As DTOCustomer) As Task(Of ExcelHelper.Sheet)
        Return Await Api.Fetch(Of ExcelHelper.Sheet)(exs, "EdiversaInvRpt/Excel", oEmp.Id, oCustomer.Guid.ToString())
    End Function
