...
Public Class CliProductsBlocked
    ...
    Shared Function ExcelRankingLastPdc(values As List(Of DTOCliProductBlocked)) As ExcelHelper.Sheet
        Dim retval As New ExcelHelper.Sheet("ranking de remolones")
        retval.AddColumn("ranking", ExcelHelper.Sheet.NumberFormats.PlainText)
        retval.AddColumn("ultima comanda", ExcelHelper.Sheet.NumberFormats.DDMMYY)
        retval.AddColumn("client", ExcelHelper.Sheet.NumberFormats.PlainText)
        retval.AddColumn("producte", ExcelHelper.Sheet.NumberFormats.PlainText)
        retval.AddColumn("modalitat", ExcelHelper.Sheet.NumberFormats.PlainText)
        retval.AddColumn("observacions", ExcelHelper.Sheet.NumberFormats.PlainText)
        For Each item As DTOCliProductBlocked In values
            ...
            With item
                ...
                oRow.addCell(CType(item.product, DTOProduct).Nom)
