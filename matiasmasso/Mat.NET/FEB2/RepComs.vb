        ...
        Else
            ...
            Else
                If oRepProducts Is Nothing Then
                    oRepProducts = Await FEB2.RepProducts.All(exs, oChannel, oCustomer.Address.Zip, oProduct, DtFch)
                Else
                ...
                If oRepProducts.Count > 0 Then
                    ...
                    Dim oRepCliCom As DTORepCliCom = Await FEB2.RepCliCom.Match(exs, oEmp, oRepProduct.Rep, oCustomer, DtFch, oRepCliComs)
