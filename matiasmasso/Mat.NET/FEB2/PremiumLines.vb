Public Class PremiumLine
    ...
    Shared Async Function ExcelEmailRecipients(exs As List(Of Exception), oPremiumLine As DTOPremiumLine, Optional oCustomersToFilter As List(Of DTOGuidNom) = Nothing) As Task(Of ExcelHelper.Sheet)
        Dim retval As ExcelHelper.Sheet = Nothing
        If FEB2.PremiumLine.Load(oPremiumLine, exs) Then
            retval = New ExcelHelper.Sheet(oPremiumLine.Nom)

            With retval
                .AddColumn("Guid", ExcelHelper.Sheet.NumberFormats.W50)
                .AddColumn("Llengua", ExcelHelper.Sheet.NumberFormats.W50)
                .AddColumn("Email", ExcelHelper.Sheet.NumberFormats.W50)
                .AddColumn("Pais", ExcelHelper.Sheet.NumberFormats.W50)
                .AddColumn("Zona", ExcelHelper.Sheet.NumberFormats.W50)
                .AddColumn("Població", ExcelHelper.Sheet.NumberFormats.W50)
                .AddColumn("Client", ExcelHelper.Sheet.NumberFormats.W50)
            End With

            Dim items As List(Of DTOUser) = Await FEB2.PremiumLine.EmailRecipients(exs, oPremiumLine)
            If exs.Count = 0 Then
    ...
    Shared Function ExcelEmailRecipients(oRecipients As List(Of DTOUser)) As ExcelHelper.Sheet
        Dim retval As New ExcelHelper.Sheet("Destinataris circular Premium Line")
        ...
        With retval
            ...
            .AddColumn("Població", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Client", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Classificacio", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("Canal", ExcelHelper.Sheet.NumberFormats.W50)
        End With
