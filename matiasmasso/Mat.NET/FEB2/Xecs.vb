Public Class Xec
    ...
    Shared Async Function Cobrament(exs As List(Of Exception), oUser As DTOUser, oXec As DTOXec) As Task(Of Boolean)
        ...
        End If
        Dim oCtaXecsEnCartera = Await FEB2.PgcCta.FromCod(DTOPgcPlan.Ctas.ClientsXecsEnCartera, oUser.Emp, exs)
        If exs.Count = 0 Then
            ...
            If oXec.Impagats.Count > 0 Then
                Dim oCtaImpagats = Await FEB2.PgcCta.FromCod(DTOPgcPlan.Ctas.impagats, oUser.Emp, exs)
                Dim oCtaRecuperacioGastos As DTOPgcCta = Await FEB2.PgcCta.FromCod(DTOPgcPlan.Ctas.ImpagosRecuperacioDespeses, oUser.Emp, exs)
