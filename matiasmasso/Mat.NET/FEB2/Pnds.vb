Public Class Pnd
    ...
    Shared Async Function Rebut(exs As List(Of Exception), oPnd As DTOPnd) As Task(Of DTORebut)
        ...
        If FEB2.Pnd.Load(oPnd, exs) Then
            If FEB2.Contact.Load(oPnd.Contact, exs) Then
                ...
                With retval
                    ...
                    If oPnd.Cod = DTOPnd.Codis.Deutor Then
                        Dim oIban = Await FEB2.Iban.FromContact(exs, oPnd.Contact, oPnd.Cod)
...
Public Class Pnds
    ...
    Shared Async Function CarteraDeDeutorsYCreditors(exs As List(Of Exception), oEmp As DTOEmp, oAD As DTOPnd.Codis, DtFch As Date) As Task(Of ExcelHelper.Sheet)
        ...
        Dim retval As New ExcelHelper.Sheet(sNom)
        With retval
