Public Class YouTubeMovie
    ...
    Shared Async Function Update(oYouTubeMovie As DTOYouTubeMovie, exs As List(Of Exception)) As Task(Of Boolean)
...
Public Class YouTubeMovies
    ...
    Shared Async Function All(exs As List(Of Exception), oUser As DTOUser, Optional oProduct As DTOProduct = Nothing, Optional oLang As DTOLang = Nothing) As Task(Of List(Of DTOYouTubeMovie))
        If oLang Is Nothing Then
            Return Await Api.Fetch(Of List(Of DTOYouTubeMovie))(exs, "YouTubeMovies", OpcionalGuid(oProduct), OpcionalGuid(oUser))
        Else
            Return Await Api.Fetch(Of List(Of DTOYouTubeMovie))(exs, "YouTubeMovies", OpcionalGuid(oProduct), OpcionalGuid(oUser), oLang.Tag)
        End If
    End Function
