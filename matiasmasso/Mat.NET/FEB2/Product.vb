...
Public Class Product
    ...
    Shared Function Load(ByRef src As DTOProduct, exs As List(Of Exception)) As Boolean
        ...
        ElseIf src.sourceCod = DTOProduct.SourceCods.Dept Then
            src = FEB2.Dept.FindSync(exs, src.Guid)
        End If
        Return exs.Count = 0
    End Function
    ...
    Shared Function Excerpt(oProduct As DTOProduct, oLang As DTOLang) As String
        ...
        If retval = "" Then
            ...
            If sContent.Length > 0 Then
                retval = TextHelper.Excerpt(sContent, 250)
            End If
        End If
        Return retval
    End Function
    ...
    Shared Function UrlThumbnail(oProduct As DTOProduct, Optional AbsoluteUrl As Boolean = False) As String
        ...
        If TypeOf oProduct Is DTOProductBrand Then
            retval = FEB2.ProductBrand.LogoUrl(oProduct, AbsoluteUrl)
        ElseIf TypeOf oProduct Is DTOProductCategory Then
            retval = FEB2.ProductCategory.ThumbnailUrl(oProduct, AbsoluteUrl)
    ...
    Shared Function ShowAtlas(src As DTOProduct) As Boolean
        ...
        Dim oBrand As DTOProductBrand = FEB2.Product.Brand(exs, src)
    ...
    Shared Function Content(oProduct As DTOProduct, oLang As DTOLang, Optional AllowInheritance As Boolean = True) As String
        ...
        ElseIf TypeOf oProduct Is DTOProductSku Then
            ...
            If AllowInheritance And oSku.Hereda Then
                ...
                FEB2.ProductCategory.Load(oProductCategory, exs)
    ...
    Shared Function Excerpt(oProduct As DTOProduct, ByVal oLang As DTOLang, Optional ByVal MaxLen As Integer = 0, Optional BlAppendEllipsis As Boolean = True) As String
        ...
        End Select
        If retval = "" Then
            Dim content = FEB2.Product.Content(oProduct, oLang, True)
            retval = TextHelper.Excerpt(content, MaxLen, BlAppendEllipsis)
        End If
        Return retval
    End Function
    ...
    Shared Function Html(oProduct As DTOProduct, oLang As DTOLang) As String
        Dim retval As String = FEB2.Product.Content(oProduct, oLang)
        If retval > "" Then
    ...
    Shared Function Pills(oProduct As DTOProduct, oLang As DTOLang, oActiveTab As DTOProduct.Tabs) As DTONavbar
        ...
        Select Case oProduct.sourceCod
            Case DTOProduct.SourceCods.Brand
                oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.general, oActiveTab, oLang, "productos", "productes", "products", "produtos"))
                If FEB2.Product.Brand(exs, oProduct).ShowAtlas Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.distribuidores, oActiveTab, oLang, "puntos de venta", "punts de venda", "sale points", "pontos de venda"))
                End If
                If FEB2.MediaResources.ExistsFromProductOrChildrenSync(exs, oProduct) Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.galeria, oActiveTab, oLang, "galería", "galeria", "gallery", "galeria"))
                End If
                If FEB2.ProductDownloads.ExistsFromProductOrParentSync(oProduct, False, True) Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.descargas, oActiveTab, oLang, "descargas", "descarregues", "downloads", "descargas"))
                End If
                If FEB2.YouTubeMovies.ExistFromProductSync(exs, oProduct.Guid, oLang) Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.videos, oActiveTab, oLang, "Vídeos", "Vídeos", "Vídeos", "vídeos"))
                End If
            Case DTOProduct.SourceCods.Dept
                oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.general, oActiveTab, oLang, "características", "característiques", "features", "características"))
                'oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.coleccion, oActiveTab, oLang, "colección", "colecció", "collection", "coleção"))
                'If ProductAccessoriesLoader.Exist(oProduct) Then
                'oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.accesorios, oActiveTab, oLang, "accesorios", "accessoris", "accessories", "accessórios"))
                'End If
                'If Brand(oProduct).ShowAtlas Then
                oNavbar.Items.Add(FEB2.Product.PillNavbarItem(DirectCast(oProduct, DTODept).Brand, DTOProduct.Tabs.distribuidores, oActiveTab, oLang, "puntos de venta", "punts de venda", "sale points", "pontos de venda"))
                'End If
                'If FEB2.MediaResources.ExistsFromProductOrChildrenSync(exs,oProduct) Then
                'oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.galeria, oActiveTab, oLang, "galería", "galeria", "gallery", "galeria"))
                'End If
            ...
            Case DTOProduct.SourceCods.Category
                oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.general, oActiveTab, oLang, "características", "característiques", "features", "características"))
                oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.coleccion, oActiveTab, oLang, "colección", "colecció", "collection", "coleção"))
                If FEB2.Product.RelatedsExistSync(exs, DTOProduct.Relateds.Accessories, oProduct) Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.accesorios, oActiveTab, oLang, "accesorios", "accessoris", "accessories", "accessórios"))
                End If
                If FEB2.Product.Brand(exs, oProduct).ShowAtlas Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.distribuidores, oActiveTab, oLang, "puntos de venta", "punts de venda", "sale points", "pontos de venda"))
                ...
                If FEB2.MediaResources.ExistsFromProductOrChildrenSync(exs, oProduct) Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.galeria, oActiveTab, oLang, "galería", "galeria", "gallery", "galeria"))
                End If
                If FEB2.Downloads.FromProductOrParentSync(exs, oProduct, False, True, oLang).Count > 0 Then
                    'If FEB2.ProductDownloads.ExistsFromProductOrParentSync(oProduct, False, True) Then
                    oNavbar.Items.Add(FEB2.Product.PillNavbarItem(oProduct, DTOProduct.Tabs.descargas, oActiveTab, oLang, "descargas", "descarregues", "downloads", "descargas"))
                End If
                If FEB2.YouTubeMovies.ExistFromProductSync(exs, oProduct.Guid, oLang) Then
