Public Class Noticia
    ...
    Shared Function Load(exs As List(Of Exception), ByRef oNoticia As DTONoticia, Optional IncludeImages As Boolean = False) As Boolean
        ...
        If Not oNoticia.IsLoaded And Not oNoticia.IsNew Then
            ...
            End If
            If exs.Count = 0 Then
                oNoticia.Image265x150 = FEB2.Noticia.Image265x150Sync(exs, oNoticia.Guid)
            End If
        End If
                ...
                Select Case oUser.Rol.id
                    ...
                    Case Else
                        ...
                        If oProduct Is Nothing Then
                            retval = True
                        Else
                            Dim oUserBrands = FEB2.ProductBrands.AllSync(exs, oUser)
                            Dim oProductBrand = FEB2.Product.Brand(exs, oProduct)
