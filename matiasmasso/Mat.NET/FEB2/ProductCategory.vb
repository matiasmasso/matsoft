...
Public Class ProductCategory
    ...
    Shared Function Url(oCategory As DTOProductCategory, Optional oTab As DTOProduct.Tabs = DTOProduct.Tabs.general, Optional AbsoluteUrl As Boolean = False) As String
        Dim retval As String = ""
        Dim oBrand As DTOProductBrand = oCategory.Brand
        If oBrand IsNot Nothing Then
            retval = MmoUrl.Factory(AbsoluteUrl, oCategory.UrlFullSegment(oTab))
        End If
        Return retval
    End Function

    Shared Function ThumbnailUrl(oCategory As DTOProductCategory, Optional BlAbsoluteUrl As Boolean = False) As String
        Return FEB2.ApiUrl("ProductCategory/thumbnail", oCategory.Guid.ToString())
    End Function
