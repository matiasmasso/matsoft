Public Class EdiversaSalesReportItems
    ...
    Shared Async Function Excel(exs As List(Of Exception), iYear As Integer, oUser As DTOUser, oHolding As DTOHolding, units As DTOStat2.Units, brand As Guid, category As Guid, sku As Guid) As Task(Of ExcelHelper.Sheet)
        Return Await Api.Fetch(Of ExcelHelper.Sheet)(exs, "EdiversaSalesReportItems/Excel", iYear, oUser.Guid.ToString, oHolding.Guid.ToString, units, brand.ToString(), category.ToString(), sku.ToString())
    End Function
