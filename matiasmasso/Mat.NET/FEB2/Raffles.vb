Public Class Raffle
    Shared Async Function Find(oGuid As Guid, exs As List(Of Exception)) As Task(Of DTORaffle)
        ...
        If retval IsNot Nothing AndAlso retval.Product IsNot Nothing Then
            FEB2.Product.Load(retval.Product, exs)
        End If
        Return retval
    End Function
    ...
    Shared Function PlayOrZoomUrl(oRaffle As DTORaffle, Optional AbsoluteUrl As Boolean = False) As String
        ...
        If DateTime.Today > oRaffle.FchTo Then
            retval = FEB2.Raffle.ZoomUrl(oRaffle, AbsoluteUrl)
        Else
            retval = FEB2.Raffle.PlayUrl(oRaffle, AbsoluteUrl)
        End If
        Return retval
    End Function
    ...
    Shared Function FacebookPage(oRaffle As DTORaffle, oLang As DTOLang) As String
        ...
        Dim retval As String = ""
        Dim oBrand = FEB2.Product.Brand(exs, oRaffle.Product)
...
Public Class Raffles
    ...
    Shared Function DaysToNextRaffle(exs As List(Of Exception), oLang As DTOLang) As Integer
        Dim retval As Integer = NextFchFrom(exs, oLang).Subtract(DateTime.Today).TotalDays
        Return retval
    End Function
    ...
    Shared Function Excel(oRaffles As List(Of DTORaffle)) As ExcelHelper.Sheet

        Dim retval As New ExcelHelper.Sheet
        With retval
            .AddColumn("des de", ExcelHelper.Sheet.NumberFormats.DDMMYY)
            .AddColumn("fins", ExcelHelper.Sheet.NumberFormats.DDMMYY)
            .AddColumn("pais")
            .AddColumn("titol")
            .AddColumn("participants")
            .AddColumn("nous")
            .AddColumn("premi", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("publicitat", ExcelHelper.Sheet.NumberFormats.Euro)
        End With
        ...
        For Each item As DTORaffle In oRaffles
            ...
            With item
                ...
                oRow.AddCell(.Title, FEB2.Raffle.ZoomUrl(item, True))
