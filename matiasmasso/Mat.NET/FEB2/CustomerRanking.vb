Public Class CustomerRanking
    ...
    Shared Function CsvUrl(value As DTOCustomerRanking) As String
        ...
        Dim productGuid As Guid = Nothing
        If value.Product IsNot Nothing Then productGuid = value.Product.Guid
        Dim retval = FEB2.Api.ApiUrl("CustomerRanking/Csv", value.User.Guid.ToString, productGuid.ToString, areaGuid.ToString, value.FchFrom.ToString("yyyy-MM-dd"), value.FchTo.ToString("yyyy-MM-dd"))
        Return retval
    End Function
