Public Class PostComment
    ...
    Shared Function Url(oPostComment As DTOPostComment, Optional BlAbsoluteUrl As Boolean = False) As String
        ...
        Dim oNoticia As DTONoticia = FEB2.Noticia.FindSync(exs, oPostComment.Parent)
        Dim retval = FEB2.Noticia.UrlFriendly(oNoticia, BlAbsoluteUrl) & "#" & oPostComment.Guid.ToString
        Return retval
    End Function
