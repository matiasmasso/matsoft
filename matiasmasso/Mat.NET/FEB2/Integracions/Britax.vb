Public Class Britax
    ...
    Shared Function ExcelTarget(year As Integer, bookFras As List(Of DTOBookFra),
                            ...
                            PendingOrders As List(Of DTOPurchaseOrder)) As ExcelHelper.Sheet

        Dim oLang As DTOLang = DTOLang.ENG

        Dim retval As New ExcelHelper.Sheet(year, "monthly targets")
        With retval
            .AddColumn("month", ExcelHelper.Sheet.NumberFormats.W50)
            .AddColumn("orders", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("invoices", ExcelHelper.Sheet.NumberFormats.Euro)
            .AddColumn("order book", ExcelHelper.Sheet.NumberFormats.Euro)
            .DisplayTotals = True
        End With
