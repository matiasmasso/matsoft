Public Class LangText
    ...
    Shared Async Function Update(exs As List(Of Exception), oLangText As DTOLangText) As Task(Of Boolean)
        Return Await Api.Update(Of DTOLangText, Boolean)(oLangText, exs, "LangText")
    End Function
End Class
