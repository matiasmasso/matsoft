Public Class AeatMod347Controller
    ...
    Async Function Index() As Threading.Tasks.Task(Of ActionResult)
        ...
        If oUser IsNot Nothing AndAlso oUser.Rol.IsAuthenticated Then
            ...
            Dim oRaonsSocials = Await FEB.Contacts.RaonsSocials(exs, oUser)
            If exs.Count = 0 AndAlso oRaonsSocials.Count > 0 Then
                Dim oExercici As DTOExercici = DTOExercici.Past(Website.GlobalVariables.Emp)
                Dim oMod347 = Await FEB.AeatMod347.Factory(exs, oExercici)
                If exs.Count = 0 Then
