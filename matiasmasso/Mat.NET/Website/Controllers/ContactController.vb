    ...
    Async Function Index(guid As Guid) As Threading.Tasks.Task(Of ActionResult)
        ...
        Select Case MyBase.Authorize({DTORol.Ids.SuperUser,
            ...
            Case AuthResults.success
                ...
                Dim Model As DTOContact = Await FEB.Contact.Find(guid, exs)
                ...
                If pass Then
                    ...
                    Select Case Model.Rol.id
                        Case DTORol.Ids.cliFull, DTORol.Ids.cliLite
                            sTitle = ContextHelper.Tradueix("Cliente", "Client", "Customer")
                        Case DTORol.Ids.comercial
                            sTitle = ContextHelper.Tradueix("Comercial", "Comercial", "Salesman")
                        Case DTORol.Ids.rep
                            sTitle = ContextHelper.Tradueix("Representante", "Representant", "Rep")
                        Case Else
                            sTitle = ContextHelper.Tradueix("Contacto", "Contacte", "Contact")
                    End Select
