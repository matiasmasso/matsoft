Public Class DiariController
    ...
    Async Function Diari() As Threading.Tasks.Task(Of ActionResult)
        Dim retval As ActionResult = Await BaseDiari(Nothing, DTO.GlobalVariables.Today().Year, DTO.GlobalVariables.Today().Month, DTO.GlobalVariables.Today().Day, DtoDiariItem.Levels.Yea)
        Return retval
    End Function

    Async Function ContactDiari(contact As Guid) As Threading.Tasks.Task(Of ActionResult)
        Dim retval As ActionResult = Await BaseDiari(contact, DTO.GlobalVariables.Today().Year, DTO.GlobalVariables.Today().Month, DTO.GlobalVariables.Today().Day, DtoDiariItem.Levels.Yea)
        Return retval
    End Function
    ...
    Async Function BaseDiari(contact As Guid, year As Integer, month As Integer, day As Integer, level As DTODiariItem.Levels) As Threading.Tasks.Task(Of ActionResult)
        ...
        With Model
            ...
            .emp = Website.GlobalVariables.Emp
        ...
        Model = Await FEB.Diari.LoadBrands(Model, exs)
        If exs.Count > 0 Then
