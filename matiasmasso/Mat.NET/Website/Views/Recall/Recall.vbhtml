...
@Code
    ...
    Dim sTitle As String = ContextHelper.Tradueix("Retirada de producto", "Retirada de Producte", "Product Recall")
...
<div class="pagewrapper">
    ...
    <div>
        ...
        <div class="inputbox"><input type="text" id="ContactTel" value="@FEB.Contact.TelSync(exs, Model.Customer)" maxlength="50" /></div>
