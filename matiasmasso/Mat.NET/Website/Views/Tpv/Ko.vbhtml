...
@Code
    ...
    Dim bancGuid As String = FEB.Default.EmpValueSync(Website.GlobalVariables.Emp, DTODefault.Codis.BancToReceiveTransfers, exs)
    Dim oBanc As DTOBanc = FEB.Banc.FindSync(New Guid(bancGuid), exs)
End Code
...
<fieldset>
    ...
    <img src="@FEB.Iban.ImgUrl(oBanc.Iban.Digits)"/>
