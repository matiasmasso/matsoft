...
@Code
    ...
    Dim oContacts As List(Of DTOContact) = FEB.Contacts.RaonsSocialsSync(exs, oUser)
End Code
    ...
    @If Model Is Nothing Then
        ...
        @<div>
            <h1>@ContextHelper.Tradueix("Modelo", "Model", "Form") 347</h1>
            <p>
    ...
    Else
        ...
        @<div>
            <h1 class="PageTitle">@ContextHelper.Tradueix("Modelo", "Model", "Form") 347: @ContextHelper.Tradueix("ejercicio", "exercici", "exercise") @item.Parent.Exercici.Year</h1>
    ...
    <div class="Row">
        <div class="Label">
            @ContextHelper.Tradueix("Razón Social", "Rao Social", "Legal Name")
        </div>
    ...
    <div class="Row">
        <div class="Label">
            @ContextHelper.Tradueix("NIF", "NIF", "VAT Number")
        </div>
        <div class="CellText">
