...
Else
    @<div>
        <div class="Row">
            <div class="Label">
                @ContextHelper.Tradueix("Código pais", "Codi pais", "Country code")
            </div>
            <div class="CellText">
                @Model(0).CodPais
            </div>
        ...
        <div class="Row">
            <div class="Label">
                @ContextHelper.Tradueix("Código Provincia", "Codi Provincia", "Province code")
            </div>
            <div class="CellText">
            ...
            @<div>
                <p class="Epigraf">
                    @If item.ClauOp = DTOAeatMod347Item.ClauOps.Vendes Then
                        @ContextHelper.Tradueix("Ventas", "Vendes", "Sales")
                    ElseIf item.ClauOp = DTOAeatMod347Item.ClauOps.Compres Then
                        @ContextHelper.Tradueix("Compras", "Compres", "Purchases")
                    End If
                </p>

                <div class="Row">
                    <div class="Label">
                        @ContextHelper.Tradueix("Trimestre 1", "Trimestre 1", "Quarter 1")
                    </div>
                    <div class="CellAmt">
                ...
                <div class="Row">
                    <div class="Label">
                        @ContextHelper.Tradueix("Trimestre 2", "Trimestre 2", "Quarter 2")
                    </div>
                    <div class="CellAmt">
                ...
                <div class="Row">
                    <div class="Label">
                        @ContextHelper.Tradueix("Trimestre 3", "Trimestre 3", "Quarter 3")
                    </div>
                    <div class="CellAmt">
                ...
                <div class="Row">
                    <div class="Label">
                        @ContextHelper.Tradueix("Trimestre 4", "Trimestre 4", "Quarter 4")
                    </div>
                    <div class="CellAmt">
