...
<div class="PageWrapperVertical">
    ...
    <p>
        @Html.Raw(ContextHelper.Tradueix("Confirmamos que ya estás registrado en este blog y deberias recibir las actualizaciones a: ",
    ...
    <a href="@Model.ReturnUrl" class="Submit">@ContextHelper.Tradueix("Volver al blog", "Tornar al blog", "Take me back", "de volta ao blog")</a>
