...
@Code
    ...
    Dim oCountries As List(Of DTOCountry) = FEB.Countries.AllSync(oUser, exs)
    Dim sTitle As String = ContextHelper.Tradueix("Ranking clientes", "Ranking clients", "Customers ranking")
End Code
    ...
    <section class="title">
        ...
        @*<a id="Csv" href='@FEB.CustomerRanking.CsvUrl(Model)' title='@(ContextHelper.Tradueix("Descargar fichero Excel", "Descarregar fitxer Excel", "Download Excel file")) '>
    ...
    <div class="filters">
        <div>
            @ContextHelper.Tradueix("Desde", "Des de", "From")
            <input id="FchFrom" type="date" value="@sFchFrom" />
        </div>
        <div>
            @ContextHelper.Tradueix("Hasta", "Fins", "To")
        ...
        <div @IIf(oCountries.Count = 1, "hidden='hidden'", "")>
            <select id="Country">
                ...
                Else
                    @<option value="@Guid.Empty.ToString">@ContextHelper.Tradueix("Seleccionar país", "Sel·leccionar país", "Select country")</option>
        ...
        <div hidden='hidden' class="Zona">
            <select id="Zona">
                <option value="@Guid.Empty.ToString">@ContextHelper.Tradueix("Seleccionar zona", "Sel·leccionar zona", "Select area")</option>
            </select>
        </div>

        <input type="button" id="Submit" value="@ContextHelper.Tradueix("Actualizar", "Actualitzar", "Update")">
    </div>
