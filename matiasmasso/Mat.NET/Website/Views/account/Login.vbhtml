...
<h1>@ContextHelper.Tradueix("Inicia sesión", "Inicia sessió", "Sign in", "Iniciar sessão")</h1>
...
<div class="orDivider">
    <hr />
    &nbsp;@ContextHelper.Tradueix("o", "o", "or", "o")&nbsp;
    <hr />
</div>
...
<div class="IforgotInstructions" hidden="hidden">
    @Html.Raw(oLang.Tradueix("Para recuperar su contraseña:<br/>1) entra tu email en la primera casilla<br/> 2) deja la contraseña en blanco<br/> 3) pulsa en Enviar.<br/> Recibirás un correo con instrucciones",
                                                                                                          ...
                                                                                                          "Para recuperar a sua contrassenha::<br/>1) introduza o seu email no primeiro espaço<br/> 2) deixe o espaço da contrassenha em branco<br/> 3) clique em Enviar.<br/>Receberá uma mensagem com instruções."))
</div>
