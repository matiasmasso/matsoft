...
@Using (Html.BeginForm()) ' "Edit", "State", FormMethod.Post,  Nothing))
    ...
    @<fieldset class="mat_form" id="mat_form">
        ...
        <div class="row">
            <div class="label">
                <label for='TextboxNom'>@ContextHelper.Tradueix("Nombre", "Nom", "First Name", "Nome")</label>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="label">
                <label for='TextboxCognoms'>@ContextHelper.Tradueix("Apellidos", "Cognoms", "Surname", "Apelidos")</label>
            </div>
            <div class="control">
        ...
        <div class="row">
            <div class="label">
                <label>@Html.RadioButtonFor(Function(Model) Model.sex, DTOUser.Sexs.Male)@ContextHelper.Tradueix("hombre", "home", "male", "homem")</label>
                <label>@Html.RadioButtonFor(Function(Model) Model.sex, DTOUser.Sexs.Female)@ContextHelper.Tradueix("mujer", "dona", "female", "mulher")</label>
            </div>
        </div>
