...
@Code
    ...
    Dim items As List(Of DTOMediaResource) = FEB.MediaResources.AllSync(exs, oProduct).
Where(Function(x) x.Obsolet = False And x.Product.Obsoleto = False And (x.Lang Is Nothing OrElse x.Lang.Equals(ContextHelper.Lang()))).
ToList
...
<div>
    ...
    @If Not TypeOf oProduct Is DTOProductBrand Then
     @<a href = "@FEB.MediaResources.DownloadAllUrl(oProduct)" >@FEB.MediaResources.DownloadAllText(items, ContextHelper.lang())</a>
    End If
        -->
</div>
