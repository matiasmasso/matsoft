...
<section class="Compte">
    ...
    <a href="@FEB.SumasYSaldos.UrlSubComptes(Model.Exercici, Model.Cta)">
        @DTOPgcCta.FullNom(Model.Cta, ContextHelper.lang())
    </a>
</section>

@If Model.Contact IsNot Nothing Then
    @<section class="SubCompte">
        @ContextHelper.Tradueix("Subcuenta", "Subcompte", "Subaccount"):
...
<section class="Grid">
    <div class="RowHdr">
        <div class="CellNum CellDesktop">@ContextHelper.Tradueix("Num", "Num", "Num")</div>
        <div class="CellIco"></div>
        <div class="CellFch CellDesktop">@ContextHelper.Tradueix("Fecha", "Data", "Date")</div>
        <div class="CellFch CellMobile">@ContextHelper.Tradueix("Fecha", "Data", "Date")</div>
        ...
        <div class="CellAmt CellMobile">@ContextHelper.Tradueix("Importe", "Import", "Amount")</div>
        <div class="CellAmt CellDesktop">@ContextHelper.Tradueix("Saldo", "Saldo", "Balance")</div>
    </div>
        ...
        @<div class="Row">
            ...
            <div class="CellIco">
                @If item.Cca.DocFile IsNot Nothing Then
                    @<a href="@FEB.DocFile.DownloadUrl(item.Cca.DocFile, False)">
