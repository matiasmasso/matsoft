...
@Code
    ...
    Dim BlShow = FEB.PurchaseOrders.ExistsSync(exs, Model.User, DTO.GlobalVariables.Today().AddYears(-2), DTO.GlobalVariables.Today())
End Code
