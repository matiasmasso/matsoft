...
<section class="LangSelection">
    <div>
        <a href="@FEB.SepaMandato.UrlForNewMandatoManual(DTOLang.ESP)" target="_blank">
            @lang.Tradueix("Español", "Espanyol", "Spanish", "Espanhol")
        </a>
    </div>
    <div>
        <a href="@FEB.SepaMandato.UrlForNewMandatoManual(DTOLang.CAT)" target="_blank">
            @lang.Tradueix("Catalán", "Català", "Catalan", "Catalão")
        </a>
    </div>
    <div>
        <a href="@FEB.SepaMandato.UrlForNewMandatoManual(DTOLang.ENG)" target="_blank">
            @lang.Tradueix("Inglés", "Anglés", "English", "Inglês")
        </a>
    </div>
    <div>
        <a href="@FEB.SepaMandato.UrlForNewMandatoManual(DTOLang.POR)" target="_blank">
