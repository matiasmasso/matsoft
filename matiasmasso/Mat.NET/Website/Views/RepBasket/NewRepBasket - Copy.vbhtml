...
@Code
    ...
    Dim sTitle As String = ContextHelper.Tradueix("Pedido de Representante", "Comanda de Representant", "Sales Order")
    ...
    <div class="DataCollection">
        ...
        <section class="CustomerProductSelection" >
            ...
            <table class="AdvancedOptions" hidden="hidden">
                ...
                <tr>
                    ...
                    @ContextHelper.Tradueix("Servir todo junto", "Servir tot junt", "Ship all together")</td>
                </tr>
                <tr>
                    <td colspan="2">
                    <table width="100">
        ...
        <section class="SubmitButtons">
            <span id="CheckBoxMail" hidden="hidden">
                <input type="checkbox" />
                @ContextHelper.Tradueix("Enviar email de confirmación", "Enviar email de confirmació", "Send confirmation email")
            </span>
            <input type="button" id="ButtonCancel" value='@ContextHelper.Tradueix("Cancelar", "Cancel·lar", "Cancel")' />
            <input type="button" id="ButtonSubmit" value='@ContextHelper.Tradueix("Enviar", "Enviar", "Submit", "Aceitar")' disabled="disabled" />
        </section>
    </div>
