...
<div class="DataCollection">
    ...
    <section Class="CustomerProductSelection">
        ...
        <section Class="CustomerSelection" hidden="hidden">
            <div>
                <select id="Country" disabled='disabled'>
                    <option value="">@ContextHelper.Tradueix("Seleccionar país", "Sel·leccionar país", "Select country")</option>
                </select>
            </div>
            <div>
                <select id="Zona" disabled='disabled'>
                    <option value="">@ContextHelper.Tradueix("Seleccionar zona", "Sel·leccionar zona", "Select area")</option>
                </select>
            </div>
            <div>
                <select id="Location" disabled='disabled'>
                    <option value="">@ContextHelper.Tradueix("Seleccionar población", "Sel·leccionar població", "Select location")</option>
                </select>
            </div>
            <div>
                <select id="Customer" disabled='disabled'>
                    <option value="">@ContextHelper.Tradueix("Seleccionar cliente", "Sel·leccionar client", "Select customer")</option>
                </select>
            </div>
        </section>
        ...
        <a href="#" Class="AdvancedOptions" hidden="hidden">@ContextHelper.Tradueix("Opciones Avanzadas", "Opcions Avançades", "Advanced Options")</a>
                    ...
                    <table width="100%">
                        <tr>
                            <td align="left" wrap="nowrap">
                                ...
                                @ContextHelper.Tradueix("Fecha Servicio", "Data Servei", "Shipping Date")
                            </td>
    ...
    <section class="SubmitButtons" hidden="hidden">
        <span id="CheckBoxMail">
            <input type="checkbox" />
            @ContextHelper.Tradueix("Enviarme email de confirmación", "Enviar-me email de confirmació", "Send me an email confirmation")
        </span>
        <input type="button" id="ButtonCancel" value='@ContextHelper.Tradueix("Cancelar", "Cancel·lar", "Cancel")' />
        &nbsp;
        <input type="button" id="ButtonSubmit" value='@ContextHelper.Tradueix("Enviar", "Enviar", "Submit", "Aceitar")' />
    </section>
</div>
