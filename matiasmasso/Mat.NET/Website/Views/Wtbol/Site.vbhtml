...
@Code
    ...
    Dim oCultureInfo = ContextHelper.GetCultureInfo()
End Code
...
<div id="DetailsForm" hidden="hidden">
    ...
    <div id="DetailsFormWrapper">
        <div>
            <div>@ContextHelper.Tradueix("Marca comercial", "Marca comercial", "Brand")</div>
            <select id="BrandSelector"></select>
        </div>
        <div>
            <div>@ContextHelper.Tradueix("Categoria", "Categorya", "Product category")</div>
