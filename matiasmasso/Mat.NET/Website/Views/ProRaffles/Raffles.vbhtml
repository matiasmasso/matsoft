...
End Code
        ...
        <div class="Raffles">
            <div class="Year">
                @ContextHelper.Tradueix("Año", "Any", "Year", "Ano")
                <select>
                    <option selected value="@DTO.GlobalVariables.Today().Year">@DTO.GlobalVariables.Today().Year</option>
                    @for year As Integer = DTO.GlobalVariables.Today().Year - 1 To 2012 Step -1
