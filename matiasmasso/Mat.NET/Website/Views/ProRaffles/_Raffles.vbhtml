...
<div class="Row">
    <div class="CenterAlign">@ContextHelper.Tradueix("Inicio", "Inici", "Start", "")</div>
    <div class="CenterAlign">@ContextHelper.Tradueix("Final", "Final", "End", "")</div>
    <div class="CenterAlign">@ContextHelper.Tradueix("Idioma", "Idioma", "", "")</div>
    <div>@ContextHelper.Tradueix("Título", "Titol", "", "")</div>
    <div class="RightAlign">@ContextHelper.Tradueix("Leads", "Leads", "", "")</div>
    <div class="RightAlign">@ContextHelper.Tradueix("Nuevos", "Nous", "", "")</div>
    <div class="RightAlign">@ContextHelper.Tradueix("Nuevos", "Nous", "", "")</div>
    <div class="RightAlign">@ContextHelper.Tradueix("Premio", "Premi", "", "")</div>
    <div class="RightAlign">@ContextHelper.Tradueix("Publi", "Publi", "", "")</div>
    <div class="RightAlign">@ContextHelper.Tradueix("Cpl", "Cpl", "", "")</div>
    <div>&nbsp;</div>
</div>
