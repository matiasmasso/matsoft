@Code
    ...
    If oExercicis.Count > 0 Then
        oCcas = FEB.LlibreDiari.HeadersSync(exs, oExercicis(0))
    End If
    Dim sTitle As String = ContextHelper.Tradueix("Libro Diario", "Llibre Diari", "Journal of Accounting")
...
<div class="pagewrapper">
    <section class="PageTitle">
        ...
        @If oExercicis.Count > 0 Then
            @<a href='@FEB.LlibreDiari.ExcelUrl(oExercicis(0))' title='@(ContextHelper.Tradueix("Descargar fichero Excel", "Descarregar fitxer Excel", "Download Excel file")) '>
