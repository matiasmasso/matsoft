...
@ContextHelper.Tradueix("Por favor entre su correo electrónico y pulse el botón 'verificar'",
...
<div class="SISU_EmailVerificationRequest">
    ...
    <input type="button" onclick="verifyEmail()" value="@ContextHelper.Tradueix("verificar","verificar","verify")" />
...
<div class="SISU_UserData" hidden>
    <div class="SISU_FirstName">
        <div>
            <label>@ContextHelper.Tradueix("Nombre", "Nom", "First name", "Nome")</label>
        </div>
        <input type="text" />
    </div>
    <div class="SISU_Surname">
        <div>
            <label>@ContextHelper.Tradueix("Apellidos", "Conoms", "Surname", "Apelidos")</label>
        </div>
        <input type="text" />
    </div>
    <div class="SISU_UserDataSubmit">
        <input type="button" value='@ContextHelper.Tradueix("Enviar", "Enviar", "Submit", "Aceitar")' />
    </div>
</div>
