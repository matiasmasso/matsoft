...
@Code
    ...
    Dim oFacebookWidget = FEB.SocialMediaWidget.WidgetSync(exs, Model, DTOSocialMediaWidget.Platforms.Facebook, oProduct)
End Code
...
<script>
    (function (d, s, id) {
        ...
        js.src = "//connect.facebook.net/@Html.Raw(DTOLang.Locale(ContextHelper.lang()))/sdk.js#xfbml=1&appId=@oFacebookWidget.widgetId&version=v3.0";
