    ...
    <div class="body-content">
            ...
            <div class="headerTopRow">
                ...
                <div class="Hello">
                    @if Session("User") IsNot Nothing Then
                        @<a href="#" title="@CType(Session("User"), DTOUser).emailAddress">@Html.Raw(String.Format("{0} {1}", ContextHelper.Tradueix("Hola", "Hola", "Hi", "Olá"), CType(Session("User"), DTOUser).NicknameOrElse))</a>
                    End If
                </div>
                ...
                <div class="searchBox">
                    ...
                    @If ContextHelper.GetUser() Is Nothing Then
                        @<a href="/pro" Class="avatar" title='@ContextHelper.Lang.Tradueix("iniciar sesión", "iniciar sessió", "log in")'>
        ...
        <footer>
            ...
            <div class="topFooter hideOnMobile">
                <!--about-->
                <div>
                    <h3>@ContextHelper.Tradueix("Acerca de", "Qui som", "About", "Sobre nós").ToUpper()</h3>
                    <div>
                        @ContextHelper.Tradueix("MATIAS MASSO, S.A. importa marcas líderes en puericultura para su distribución en los mercados Español, Portugués y de Andorra.",
          ...
          "MATIAS MASSO, S.A. importa marcas líderes em puericultura para a sua distribuição nos mercados de Espanha, Portugal e de Andorra")
                        <a href="/about">
                            @ContextHelper.Tradueix("Leer más...", "Continuar llegint...", "ReadMore...", "Lêr mais...")
                        </a>
                    </div>
                </div>
                ...
                <!--help-->
                <div>
                    <h3>@ContextHelper.Tradueix("Ayuda", "Ajuda", "Help").ToUpper()</h3>
                    <div>
                        <a href="/distribuidores">
                            @ContextHelper.Tradueix("¿Dónde comprar?", "On comprar?", "Where to buy?", "Onde comprar")
                        </a>
                    </div>
                    <div>
                        <a href="/instrucciones">
                            @ContextHelper.Tradueix("Manuales de usuario", "Manuals d'usuari", "User manuals", "Manuais de usuário")
                        </a>
                    </div>
                    <div>
                        <a href="/videos">
                    ...
                    <div>
                        <a href="/compatibilidad">
                            @ContextHelper.Tradueix("Listas de compatibilidad", "Llistes de compatibilitat", "Compatibility lists", "Listas de compatibilidade")
                        </a>
                    </div>
                    <div>
                        <a href="/blog/consultas">
                            @ContextHelper.Tradueix("Consultas", "Consultes", "Any questions?")
                        </a>
                    </div>
                </div>
                ...
                <!--contact-->
                <div>
                    <h3>@ContextHelper.Tradueix("Contacto", "Contacte", "Contact")</h3>
                    <div>
                        <a href='tel:@ContextHelper.Tradueix("+34932541522", "+34932541522", "+34932541522", "+351308806304")'>
                            <img src="~/Media/Img/Ico/phone.png" class="contact" />
                            @ContextHelper.Tradueix("932541522", "932541522", "(+34) 932541522", "(+351) 308.806.304")
                        </a>
                    </div>
                    <div>
                        <a href='mailto:@ContextHelper.Tradueix("info@matiasmasso.es", "info@matiasmasso.es", "info@matiasmasso.es", "info@matiasmasso.pt")'>
                            <img src="~/Media/Img/Ico/email.png" class="contact" />
                            @ContextHelper.Tradueix("info@matiasmasso.es", "info@matiasmasso.es", "info@matiasmasso.es", "info@matiasmasso.pt")
                        </a>
                    </div>
                    <h3>@ContextHelper.Tradueix("Síguenos en: ", "Segueix-nos a:", "Follow us on:", "Segue-nos em:").ToUpper()</h3>
            ...
            <div class="socialMediaMobile showOnMobile">
                @ContextHelper.Tradueix("Síguenos en:", "Segueix-nos a:", "Follow us on:", "Segue-nos em:")
            </div>
            <div class="socialMediaMobile showOnMobile">
                @Html.Partial("_SocialMedia")
            </div>
