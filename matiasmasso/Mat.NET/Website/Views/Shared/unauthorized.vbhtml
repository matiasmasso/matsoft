...
<div class="PageWrapperVertical">
    <h1>@ViewBag.Title</h1>
    <p>
    @ContextHelper.Tradueix("Sus credenciales no le autorizan a acceder a la página solicitada.",
    ...
    @ContextHelper.Tradueix("Verifique que la sesión se haya abierto con su perfil.", _
                                             "Verifiqui que la sesió s'hagi obert amb el seu perfil.", _
                                             "Check current session has been logged in with your profile.")
</p><p>
    @ContextHelper.Tradueix("Si cree que debería tener acceso por favor contacte con nuestras oficinas", _
