...
<meta name="dcterms.rightsHolder" content="MATIAS MASSO, S.A. @DTO.GlobalVariables.Now().Year" />
...
@If ViewBag.Canonical IsNot Nothing Then
    If TypeOf ViewBag.Canonical Is DTOUrl Then
        ...
        If oUrl.CanonicalUrl(DTOLang.ESP()) > "" Then
            @If oUrl.CanonicalUrl(ViewBag.Lang).Contains("/4moms/") Then
                @<link rel='canonical' href="@DTO.Helpers.UrlHelper.Product4momsOrElseCanonicalUrl(oUrl.CanonicalUrl(ViewBag.Lang))" />
            Else
