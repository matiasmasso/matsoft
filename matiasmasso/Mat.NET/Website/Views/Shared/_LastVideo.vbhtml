...
@Code
    ...
    Dim oVideo As DTOYouTubeMovie = FEB.YouTubeMovies.LastSync(oProduct, Model, ContextHelper.lang(), exs)
End Code
...
<a class="video-front" href="/videos">
    ...
    <div class="MatBoxFooter">
        @ContextHelper.Tradueix("ver todos los videos disponibles", "veure tots els videos disponibles", "see all videos available", "Ver todos os vídeos disponíveis")
    </div>
</a>