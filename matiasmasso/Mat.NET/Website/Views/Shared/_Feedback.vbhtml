...
<div id="Feedback" data-cod="@CInt(Model.Source.Cod)" 
    ...
    <div class="Request">
        @ContextHelper.Tradueix("¿Te ha resultado útil esta información?", "Ha estat d'ultilitat aquesta informació?", "Did this information help you?")
    </div>
    ...
    <div class="Comment" hidden="hidden">
        <p>@ContextHelper.Tradueix("Gracias por registrar su opinión.")</p>
        <p>@ContextHelper.Tradueix("Si desea añadir algun comentario que nos permita mejorar puede hacerlo a continuación:")</p>
        <textarea></textarea>
        <div class="SubmitDiv">
            <input type="button" value=@ContextHelper.Tradueix("enviar") />
        </div>
    </div>
</div>
