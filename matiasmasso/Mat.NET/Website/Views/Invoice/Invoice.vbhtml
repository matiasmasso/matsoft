...
@Code
    ...
    ViewBag.Title = ContextHelper.Tradueix("factura", "factura", "invoice")
    ...
    If oUser.Rol.id = DTORol.Ids.Rep Then
        ...
        oRepLiq = FEB.Repliq.HeaderSync(exs, oUser.Emp, Model, oRep)
    End If
End Code
...
<div class="pagewrapper">
    ...
    <section class="PageTitle">
        <a href='@FEB.Invoice.PdfUrl(Model)' title='@(ContextHelper.Tradueix("Descargar fichero Pdf", "Descarregar fitxer Pdf", "Download Pdf file")) '>
            <img class="Download" src="~/Media/Img/48x48/Pdf48.png" />
        </a>
        
        <p>
            @DTOInvoice.Caption(Model, ContextHelper.lang())
            <br/>
            <a href="@FEB.Contact.Url(Model.Customer)">@Model.Customer.Nom</a>
            <br />
        ...
        @For Each oDelivery As DTODelivery In Model.Deliveries
            ...
            @<div class="Row Delivery">
                <div class="CellEpigraf">
                    <a href="@FEB.Delivery.Url(oDelivery)">
                        @DTODelivery.Caption(oDelivery, ContextHelper.lang())
                    </a>
                </div>
            ...
            @<div class="Row Item">
                ...
                <div class="CellTxt">
                    <a href="@item.purchaseOrderItem.sku.GetUrl(ContextHelper.Lang)">
        ...
        @If oUser.Rol.Id = DTORol.Ids.Rep Then
            ...
            Else
                @<span>
                    ...
                    <a href="@FEB.DocFile.DownloadUrl(oRepLiq.Cca.DocFile, False)" target="_blank">
