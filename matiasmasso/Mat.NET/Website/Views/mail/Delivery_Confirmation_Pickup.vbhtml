...
@Code
    ...
    Dim DtPickUpFrom As Date = FEB.Delivery.PickUpFchFrom(Model).ToLocalTime.Date
            ...
            <table style="font-family:Arial,helvetica,sans-serif;font-size:1em;line-height:1.2em;width:100%">
                ...
                @For i As Integer = 0 To Model.Items.Count - 1
                    ...
                    @<tr>
                        ...
                        <td style="padding-left:10px;"><a href="@Item.PurchaseOrderItem.Sku.GetUrl(oLang,, True)">@Item.PurchaseOrderItem.Sku.RefYNomLlarg.Tradueix(oLang)</a></td>
                    </tr>
                Next
            </table>
