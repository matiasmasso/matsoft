...
<p>
    Podeu descarregar els albarans en Pdf de <a href="@FEB.Transmisio.UrlPdfDeliveries(Model)">aquest enllaç</a>
</p>
        ...
        <table>
            ...
            @For Each item As DTODelivery In Model.Deliveries.FindAll(Function(x) x.EtiquetesTransport IsNot Nothing)
                @<tr>
                    ...
                    <td>
                        <a href=" @FEB.DocFile.DownloadUrl(item.EtiquetesTransport, False)" target="_Blank">
                            descarregar
                        </a>
                    </td>
                </tr>
