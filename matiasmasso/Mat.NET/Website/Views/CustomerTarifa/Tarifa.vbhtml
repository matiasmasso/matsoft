...
End Code
    ...
    <section class="PageTitle">
        ...
        <a href='@FEB.CustomerTarifa.ExcelUrl(Model)' title='@(ContextHelper.Tradueix("Descargar fichero Excel", "Descarregar fitxer Excel", "Download Excel file")) '>
    ...
    <div class="@GridClass">
        <div class="Row">
            <div class="CellSku">@ContextHelper.Tradueix("Concepto", "Concepte", "Concept")</div>
            @If Model.CostEnabled Then
                @<div class="CellCost">@ContextHelper.Tradueix("Coste", "Cost", "Cost")</div>

                @If DtoVisible Then
                    @<div class="CellDto">@ContextHelper.Tradueix("Dto", "Dte", "Dct")</div>
                End If
            End If
            <div class="CellPvp">@ContextHelper.Tradueix("PVP", "PVP", "RRPP")</div>
        </div>

        @For Each oBrand As DTOProductBrand In Model.Brands
            @<div class="Row">
                <div class="CellBrand"><a id="@oBrand.Guid.ToString">@oBrand.Nom.Tradueix(ContextHelper.Lang)</a></div>
            </div>
            @For Each oCategory As DTOProductCategory In oBrand.Categories
                @<div class="Row">
                    <div class="CellCategory">@oCategory.Nom.Tradueix(ContextHelper.Lang)</div>
                </div>
    ...
    @If Model.CostEnabled Then
            @<p>@ContextHelper.Tradueix("Los precios de coste no incluyen el IVA", "Els preus de cost no inclouen l'IVA", "Cost prices are VAT excluded")</p>
            @<p>@ContextHelper.Tradueix("Los precios recomendados de venta al público son IVA incluido", "Els preus recomenats de venda al public son IVA inclos", "Retail prices are VAT included")</p>
        End If
