...
@Code
    ...
    Dim sTitle As String = ContextHelper.Tradueix("Seguimiento de Comisiones", "Seguiment de Comisions", "Commission Follow up")
    ViewBag.Title = "M+O | " & sTitle

    Dim oOrders As List(Of DTOPurchaseOrder) = FEB.Rep.ArchiveSync(exs, Model)
    Dim oMonths As List(Of DTORepComFollowUp) = DTORepComFollowUp.Months(oOrders, ContextHelper.lang())
End Code
    ...
    <div class="DrillDownGridTitles">
        <div class="RightAlignedTotals">
            <div class="CellResult">@ContextHelper.Tradueix("Pedido", "Demanat", "Ordered")</div>
            <div class="CellResult">@ContextHelper.Tradueix("Servido", "Servit", "Delivered")</div>
            <div class="CellResult">@ContextHelper.Tradueix("Facturado", "Facturat", "Invoiced")</div>
            <div class="CellResult">@ContextHelper.Tradueix("Liquidado", "Liquidat", "Liquidated")</div>
        </div>
    </div>
    ...
    <div class="DrillDownGrid">
            ...
            @For Each oMonth As DTORepComFollowUp In oMonths
                @<div class='Collapsed truncate FollowUpRow'>
                    ...
                    @For Each oDay As DTORepComFollowUp In DTORepComFollowUp.Days(oOrders, oMonth, ContextHelper.lang())
                        @<div class='Collapsed truncate FollowUpRow'>
                            <a href="#" class="PlusMinus">&nbsp;</a>
                                ...
                                @<div class='Collapsed truncate FollowUpRow'>
                                    <div class="Period">
                                        <div class="CellOrder truncate">
                                            <a href="@FEB.PurchaseOrder.Url(oOrder.Source)" target="_blank">
                                                @oOrder.Period
                                            </a>
                                        </div>
                                        <div class="RightAlignedTotals">
