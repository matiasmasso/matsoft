...
@Code
    ...
    ViewBag.Title = ContextHelper.Tradueix("Incidencia", "Incidencia", "Support incidence")
...
End Code
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Incidencia num.", "Incidencia num.", "Incident #")
        </div>
        <div class="DivData">
            @Model.AsinOrNum()
        </div>
    ...
    <div class="DivRow">
        ...
        <div class="DivData">
            @Html.Raw(FEB.Contact.HtmlNameAndAddress(Model.Customer))
        </div>
    </div>
    <div class="DivRow">
        <div class="DivLabel">
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Teléfono", "Telefon", "Phone")
        </div>
        <div class="DivData">
            @Model.Tel
        </div>
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Numero de serie", "Numero de serie", "Serial number")
        </div>
        <div class="DivData">
            @Model.serialNumber
        </div>
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Fecha fabricación", "Data fabricació", "Manufacturing date")
        </div>
        <div class="DivData">
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Descripción", "Descripció", "Description")
        </div>
        <div class="DivData">
            @Model.description
        </div>
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Imágenes", "Imatges", "Images")
        </div>
        <div class="DivData">
            @If (Model.DocFileImages.Count > 0) Then
                For Each oDocFile As DTODocFile In Model.DocFileImages
                    @<div class="DocFile">
                        <a href="@FEB.DocFile.DownloadUrl(oDocFile, False)" target="_blank">
                            <img src="@FEB.DocFile.ThumbnailUrl(oDocFile)" width='150px' height='auto' />
                        </a>
                    </div>
                Next
            Else
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Ticket de compra", "Ticket de compra", "Purchase ticket")
        </div>
        <div class="DivData">
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Fecha de cierre", "Data de tancament", "Closure date")
        </div>
        <div class="DivData">
    ...
    <div class="DivRow">
        <div class="DivLabel">
            @ContextHelper.Tradueix("Solución", "Solució", "Solution")
        </div>
        <div class="DivData">
            @DTOIncidencia.CodiNom(Model.Tancament, ContextHelper.lang())
        </div>
    </div>
