@Code
    ...
    Dim oBoxItems = FEB.BoxItems.FromEBooksSync(Website.GlobalVariables.Emp, exs)
    Dim sTitle As String = ContextHelper.Tradueix("Descarga de Catálogos en Libro Electrónico", "Descarrega de catalegs en llibre electronic", "Download e-book catalogues")
...
<div class="pagewrapper">
    ...
    <p>
        @Html.Raw(ContextHelper.Tradueix("Los siguientes ficheros le permitirán trabajar con toda la documentación en un iPad, desde donde podrá mostrar al consumidor las distintas imágenes de producto, características y precios.<br />Puede ir actualizando sus catálogos desde esta misma página.",
    ...
    @If Not FEB.Session.is_IOS_Browser(System.Web.HttpContext.Current) Then
        @<p class="warning">
            ...
            @<p class="warning">
                @Html.Raw(ContextHelper.Tradueix("Para utilizar catálogos en formato electrónico deberá tener la aplicación iBooks instalada.<br />Si no la tiene, puede descargarsela gratuitamente de la ",
    ...
    <p>
        @Html.Raw(ContextHelper.Tradueix("Seleccione una de las marcas comerciales siguientes para descargar su catálogo.<br />Cuando le pregunte cómo quiere abrir el fichero seleccione la aplicación iBooks.",
