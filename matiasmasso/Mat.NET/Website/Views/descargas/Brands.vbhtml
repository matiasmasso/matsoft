        ...
        <div>
            @Select Case Model.Src
                Case DTOProductDownload.Srcs.compatibilidad
                    @ContextHelper.Tradueix("¿De qué producto buscas las compatibilidades?", "De quin producte vols les compatibilitats?", "What product do you want the compatibility list for?", "De que produto procuras confirmar a compatibilidade de instalação com o teu veículo?")
                Case Else
                    @ContextHelper.Tradueix("¿De qué producto buscas las instrucciones?", "De quin producte vols les instruccions?", "What product do you want the user manual for?", "De que produto procuras as instruções?")
            End Select
        </div>
        ...
        <div class="ProductSelection">
            <select id="Brands">
                <option selected value="">
                    @ContextHelper.Tradueix("(Selecciona una marca comercial)", "(Selecciona una marca comercial)", "(Pick a brand name)", "(Seleciona uma marca)")
                </option>
            ...
            <select id="Categories">
                <option selected value="">
                    @ContextHelper.Tradueix("(Selecciona una categoría)", "(selecciona una categoría)", "(Pick a product category)", "(Seleciona uma categoria)")
                </option>
                                    </select>
            <select id="Skus">
                <option selected value="">
                    @ContextHelper.Tradueix("(Selecciona un producto)", "(Selecciona un producte)", "(Pick a product)", "(Seleciona um produto)")
                </option>
                                    </select>
        </div>
                    ...
                    <a href="@item.DownloadUrl()">
                        ...
                        <div class="Features">
                            <div>
                                @item.Features
                                <br />
                                @(ContextHelper.Tradueix("Descargas: ") & item.LogCount)
                            </div>
