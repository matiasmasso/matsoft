...
<div class="Home">
    ...
    <div class="CenterColumn">
        ...
        <p>
            MATIAS MASSO, S.A. cesó su actividad por jubilación en fecha 15/12/2023
        </p>
        <p>
            La extranet de profesionales continua funcionando para consultas de documentación fiscal y contable.
        </p>
        <p>
            Para otros temas, puede dirigirse a los siguientes contactos:
        </p>
        <p>
            Britax Römer: customerservice.esp@britax.com<br />
            Tommee Tippee: info@infobebe.com<br />
            4moms: francesco.campolo@elevenbaby.it
        </p>
        @*<div class="BannerRotator">
            ...
            <a class="prev" title='@ContextHelper.Tradueix("ir al banner anterior", "anar al banner anterior", "go to previous banner")'>&#10094;</a>
            <a class="next" title='@ContextHelper.Tradueix("ir al siguiente banner", "anar al següent banner", "go to next banner")'>&#10095;</a>
        ...
        @*<div Class="BrandsV">
            <div Class="BrandV1">
                <a href="@Model.PortadaImgNavigateTo(PortadaImgModel.Ids.V1)" title="@Model.PortadaImgTitle(PortadaImgModel.Ids.V1)">
                    <img src="@Model.PortadaImgSrc(PortadaImgModel.Ids.V1)" alt="@Model.PortadaImgTitle(PortadaImgModel.Ids.V1)" width="@MvcHomeModel.BRANDSVWIDTH" height="@MvcHomeModel.BRANDSVHEIGHT" />
                </a>
            </div>
            <div class="BrandV2">
                <a href="@Model.PortadaImgNavigateTo(PortadaImgModel.Ids.V2)" title="@Model.PortadaImgTitle(PortadaImgModel.Ids.V2)">
                    <img src="@Model.PortadaImgSrc(PortadaImgModel.Ids.V2)" alt="@Model.PortadaImgTitle(PortadaImgModel.Ids.V2)" width="@MvcHomeModel.BRANDSVWIDTH" height="@MvcHomeModel.BRANDSVHEIGHT" />
                </a>
            </div>
            <div class="BrandV3">
                <a href="@Model.PortadaImgNavigateTo(PortadaImgModel.Ids.V3)" title="@Model.PortadaImgTitle(PortadaImgModel.Ids.V3)">
                    <img src="@Model.PortadaImgSrc(PortadaImgModel.Ids.V3)" alt="@Model.PortadaImgTitle(PortadaImgModel.Ids.V3)" width="@MvcHomeModel.BRANDSVWIDTH" height="@MvcHomeModel.BRANDSVHEIGHT" />
                </a>
            </div>
        </div>*@
        ...
        @*<div class="BrandsH">
            <div Class="BrandH1">
                <a href="@Model.PortadaImgNavigateTo(PortadaImgModel.Ids.H1)" title="@Model.PortadaImgTitle(PortadaImgModel.Ids.H1)">
                    <img src="@Model.PortadaImgSrc(PortadaImgModel.Ids.H1)" alt="@Model.PortadaImgTitle(PortadaImgModel.Ids.H1)" width="@MvcHomeModel.BRANDSVWIDTH" height="@MvcHomeModel.BRANDSVHEIGHT" />
                </a>
            </div>
            <div class="BrandH2">
                <a href="@Model.PortadaImgNavigateTo(PortadaImgModel.Ids.H2)" title="@Model.PortadaImgTitle(PortadaImgModel.Ids.H2)">
                    <img src="@Model.PortadaImgSrc(PortadaImgModel.Ids.H2)" alt="@Model.PortadaImgTitle(PortadaImgModel.Ids.H2)" width="@MvcHomeModel.BRANDSVWIDTH" height="@MvcHomeModel.BRANDSVHEIGHT" />
                </a>
            </div>
            <div class="BrandH3">
                <a href="@Model.PortadaImgNavigateTo(PortadaImgModel.Ids.H3)" title="@Model.PortadaImgTitle(PortadaImgModel.Ids.H3)">
                    <img src="@Model.PortadaImgSrc(PortadaImgModel.Ids.H3)" alt="@Model.PortadaImgTitle(PortadaImgModel.Ids.H3)" width="@MvcHomeModel.BRANDSVWIDTH" height="@MvcHomeModel.BRANDSVHEIGHT" />
                </a>
            </div>*@
        ...
        @*@If Model.ActiveRaffle IsNot Nothing Then
        @<div Class="Raffle">
        ...
        @*@If Not ContextHelper.IsIOS Then
