...
@Code
    ...
    Dim sTitle As String = ContextHelper.Tradueix("Informes de visitas comerciales", "Raports de visites comercials", "Sales visits reports")
...
<div class="pagewrapper">
    ...
    @If Model.Count = 0 Then
        @<div>
            @ContextHelper.Tradueix("No nos constan visitas registrados", "No ens consten visites registrades", "No visits have been logged")
        </div>
    Else
        @<div id="Items">
