...
<div class="OtherYears">
    <a href="@FEB.Ccd.Url(Model.Cta, Model.Contact, MatHelperStd.TimeHelper.LastDayOfYear(Model.Fch).AddYears(-1))">
        @ContextHelper.Tradueix("Ejercicio anterior", "Exercici anterior", "Previous year")
    </a>
</div>
...
<div class="Grid">
    <div class="RowHdr">
        ...
        <div class="CellAmt">
            @ContextHelper.Tradueix("Debe", "Deure", "Debit")
        </div>
        <div class="CellAmt">
            @ContextHelper.Tradueix("Haber", "Haver", "Credit")
        </div>
        <div class="CellAmt">
            @ContextHelper.Tradueix("Saldo", "Saldo", "Balance")
        </div>
    </div>
...
<div class="OtherYears">
    <a href="@FEB.Ccd.Url(Model.Cta, Model.Contact, MatHelperStd.TimeHelper.LastDayOfYear(Model.Fch).AddYears(1))">
        @ContextHelper.Tradueix("Siguiente Ejercicio", "Següent Exercici", "Next year")
    </a>
</div>
