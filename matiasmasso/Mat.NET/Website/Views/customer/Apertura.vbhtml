...
<fieldset class="mat_form" id="mat_form">
    <legend>@ContextHelper.Tradueix("Solicitud Apertura Punto de Venta", "Sol.licitut Apertura Punt de Venda", "New Sale Point Request")</legend>
    ...
    <ul>
        ...
        <li>
            <button class="submit" type="submit">@ContextHelper.Tradueix("Aceptar", "Acceptar", "Submit")</button>
        </li>
    </ul>
