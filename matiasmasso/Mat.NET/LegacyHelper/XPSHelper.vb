...
Public Class XPSHelper
    ...
    Public Function GenerateThumbnail(Optional iWidth As Integer = 0, Optional iHeight As Integer = 0) As Byte()
        ...
        Dim oImage = Image.FromStream(oStream)
        Dim oThumbnail = ImageHelper.GetThumbnailToFit(oImage, iWidth, iHeight)
