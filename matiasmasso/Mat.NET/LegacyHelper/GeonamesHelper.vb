Public Class GeonamesHelper
    ...
    Public Class request
        Public Property postalCodes As List(Of Google.postalCode)
    End Class
...
#Region "ExcelImport"
    ...
    Shared Function ReadFromExcel(oSheet As  MatHelperStd.ExcelHelper.Sheet) As List(Of GeonamesHelper.Zip)
    ...
    Public Class Zip
        ...
        Public Sub AddArea(oRow As  MatHelperStd.ExcelHelper.Row, NomCellIdx As Integer, CodCellIdx As Integer)
