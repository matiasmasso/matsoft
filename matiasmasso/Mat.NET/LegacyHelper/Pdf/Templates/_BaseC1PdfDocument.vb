...
Public Class _BaseC1PdfDocument
    ...
    Public Function DocFile() As DTODocFile
        Dim exs As New List(Of Exception)
        Dim oByteArray = MyBase.Stream(exs)
    ...
    Protected Sub DrawDestination(oContact As DTOContact)
        ...
        X = _LeftMargin
        Y = Y + _Font.Height
        DrawString(DTOAddress.ZipyCit(oContact.Address), iWidth)
    End Sub
    ...
    Protected Sub DrawCell(oColumn As PdfColumn, oValue As Object)
        If oValue IsNot Nothing Then
            ...
            If TypeOf oValue Is DTOAmt Then
                src = DTOAmt.CurFormatted(DirectCast(oValue, DTOAmt))
            ElseIf oColumn.Type = PdfColumn.Types.Fch Then
