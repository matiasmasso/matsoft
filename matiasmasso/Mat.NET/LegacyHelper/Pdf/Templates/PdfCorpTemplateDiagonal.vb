Public Class PdfCorpTemplateDiagonal
    ...
    Protected mTemplate As Templates
    Protected _EmpId As Integer
    ...
    Public Sub New(ByVal oTemplate As Templates, Optional EmpId As Integer = 1)
    ...
    Protected Sub DrawAddress()
        ...
        Select Case _EmpId
            Case 1
                sTxt = "MATIAS MASSO, S.A. - Diagonal 403 - 08008 Barcelona - tel.: 932.541.522 - www.matiasmasso.es"
            Case 7
                sTxt = "TATITA 84, S.L. - Diagonal 403 - 08008 Barcelona - tel.: 932.541.522"
        End Select
    ...
    Protected Sub DrawDadesRegistrals()
        ...
        Select Case _EmpId
            Case 1
                s = "Reg.Mercantil de Barcelona, Tomo 6403, Libro 5689, Sección 2ª, Folio 167, Hoja 76326, Inscripción 1ª, NIF ES-A58007857"
            Case 7
                s = "TATITA 84, S.L. - Reg.Mercantil de Barcelona, Tomo 46497, Folio 16, Hoja B521947, Inscripción 1ª, NIF ES-B67246132"
        End Select
    ...
    Protected Sub DrawLogo(ByVal iOverAllX As Integer, ByVal iOverAllY As Integer, ByVal iOverAllWidth As Integer, ByVal iOverAllHeight As Integer, Optional ByVal BlDrawRaoSocial As Boolean = False)
        Select Case _EmpId
            Case 1
                DrawLogoMMO(iOverAllX, iOverAllY, iOverAllWidth, iOverAllHeight, BlDrawRaoSocial)
            Case 7
                DrawLogoTatita(iOverAllX, iOverAllY, iOverAllWidth, iOverAllHeight, BlDrawRaoSocial)
        End Select
    End Sub

    Protected Sub DrawLogoTatita(ByVal iOverAllX As Integer, ByVal iOverAllY As Integer, ByVal iOverAllWidth As Integer, ByVal iOverAllHeight As Integer, Optional ByVal BlDrawRaoSocial As Boolean = False)
        Dim iPageWidth As Integer = MyBase.PageRectangle.Width
        Dim oFont As New Font("Arial Rounded MT Bold", 40, FontStyle.Bold)
        Dim s As String = "TATITA 84"
        Dim iLogoWidth = MyBase.MeasureString(s, oFont).Width
        Dim rc As New Rectangle((iPageWidth - iLogoWidth) / 2, iOverAllY, iLogoWidth, oFont.Height)
        Dim sF As New StringFormat()
        sF.Alignment = StringAlignment.Near
        s = "TATITA"
        MyBase.DrawString(s, oFont, Brushes.Black, rc, sF)
        sF.Alignment = StringAlignment.Far
        s = "84"
        MyBase.DrawString(s, oFont, Brushes.Red, rc, sF)

    End Sub


    Protected Sub DrawLogoMMO(ByVal iOverAllX As Integer, ByVal iOverAllY As Integer, ByVal iOverAllWidth As Integer, ByVal iOverAllHeight As Integer, Optional ByVal BlDrawRaoSocial As Boolean = False)
