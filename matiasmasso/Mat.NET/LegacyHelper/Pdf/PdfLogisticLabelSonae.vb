...
Public Class PdfLogisticLabelSonae
    Inherits _PdfBase
    Private _Delivery As DTODelivery

    Public Sub New(oDelivery As DTODelivery, oCountries As List(Of DTOCountry))
        MyBase.New(landscape:=True)
        _Delivery = oDelivery
        DTODelivery.loadMadeIns(_Delivery, oCountries, MyBase.exs)
    ...
    Private Sub DrawPage(item As DTODeliveryItem, iBulto As Integer)
        ...
        MyBase.X = 20
        MyBase.Y = 210
        MyBase.DrawString("Cód. Form / Supplier Code")

        MyBase.Y += 46
        MyBase.DrawString("N° Nota Encomenda / Order number")
        ...
        MyBase.X = 20
        MyBase.Y = 318
        MyBase.DrawString("EAN14")

        MyBase.Y += 46
        MyBase.DrawString("Sku")

        MyBase.X = MyBase.MarginsRectangle.Width - 360 - 20
        MyBase.DrawString("Quantidade")

        MyBase.X = 20
        MyBase.Y += 46
        MyBase.DrawString("Descrição do produto / Product description")
        ...
        MyBase.Y = 183
        MyBase.DrawString(item.Delivery.Customer.SuProveedorNum)
