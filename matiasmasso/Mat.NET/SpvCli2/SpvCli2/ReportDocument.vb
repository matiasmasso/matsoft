...
#Region " DataSource/DataMember "
    ...
    Private Sub SetSource()
        ...
        If TypeOf InnerSource Is IBindingList Then
            mBindingList = DirectCast(InnerSource, IBindingList)
    ...
    Private Function InnerDataSource() As IList
        ...
        If TypeOf mDataSource Is DataSet Then
            If Len(mDataMember) > 0 Then
                Return DirectCast(DirectCast(mDataSource, DataSet).Tables(mDataMember), IListSource).GetList

            Else
                Return DirectCast(DirectCast(mDataSource, DataSet).Tables(0), IListSource).GetList
            End If

        ElseIf TypeOf mDataSource Is IListSource Then
            Return DirectCast(mDataSource, IListSource).GetList

        Else
            Return DirectCast(mDataSource, IList)
        End If
...
#Region " AutoDiscover "
    ...
    Private Sub DoAutoDiscover()
        ...
        If TypeOf InnerSource Is DataView Then
            DoAutoDiscover(DirectCast(InnerSource, DataView))
...
#Region " GetField "
    ...
    Private Function GetField(ByVal obj As Object, ByVal FieldName As String) As String
        If TypeOf obj Is DataRowView Then
            ...
            Return DirectCast(obj, DataRowView).Item(FieldName).ToString
