...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(rpt_SPV))
        ...
        Me.PrintPreviewDialog1.Location = New System.Drawing.Point(144, 9)
    ...
    Private Sub PrintItm(ByVal itm As DTOSpv, ByVal sender As Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs)
        ...
        With e.Graphics
            ...
            If itm.Incidencia IsNot Nothing Then
                e.Graphics.DrawString("Incidencia nº " & itm.Incidencia.Num, FontEpg, Brushes.Black, hTabMid + StringOffset, (row * rowHeight))
            End If
            ...
            e.Graphics.DrawString(itm.Product.Nom, FontStd, Brushes.Black, hTabData, (row * rowHeight))
            row = row + 1
