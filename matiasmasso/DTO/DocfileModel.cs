...
namespace DTO
{
    public class DocfileModel:IModel
    {
        ...
        public string? MD5 { get; set; } // for backward compatibility
        ...
        public DocfileModel() { }
        public DocfileModel(string asin)
        {
            this.Hash = asin;
        }

        public string? ThumbnailUrl() => string.IsNullOrEmpty(Hash) ? null : Globals.ApiUrl("Doc/thumbnail", Hash!);

        public string? DownloadUrl() => string.IsNullOrEmpty(Hash) ? null : $"https://api.matiasmasso.es/doc/{Hash!}"; // Globals.ApiUrl("Doc", Hash!);
