...
namespace DTO
{
    public class PgcCtaModel:BaseGuid, IModel, IComparable
    {
        ...
        public bool IsExplotacio()=> Id?.CompareTo("6") > 0 && Id?.CompareTo("8") < 0;
        ...
        public static Cods[] VATCtaCods() => new []{
            Cods.IvaRepercutitNacional,
            Cods.IvaReduit,
            Cods.IvaSuperReduit,
            Cods.IvaSoportatNacional
            };

        public static Cods[] IrpfCtaCods() => new[]{
            Cods.IrpfTreballadors,
            Cods.IrpfLloguers,
            Cods.IrpfProfessionals
            };
