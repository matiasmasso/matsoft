...
namespace DTO.Excel
{
    public class Row
    {
        ...
        public Cell AddCell(DateOnly? fch, string? url, Cell.NumberFormats numberFormat = Cell.NumberFormats.NotSet)
        {
            var retval = new Cell();
            if (fch != null)
            {
        ...
        public Cell AddFch(DateOnly? content, string? url = "")
        {
            var retval = new Cell();
            if (content != null)
            {
                retval.Content = string.Format("{0:dd/MM/yyyy}", content);
                if (!string.IsNullOrEmpty(url))
                    retval.Url = url;
                retval.NumberFormat = Cell.NumberFormats.DDMMYY;
            }
        ...
        public Cell AddFch(DateTime? content, string? url = "")
        {
            var retval = new Cell();
            if (content != null)
            {
        ...
        public Cell AddEur(decimal? content, string? url = "")
        {
            var retval = new Cell();
            if (content != null)
            {
                ...
                if (!string.IsNullOrEmpty(url))
                    retval.Url = url;
                retval.NumberFormat = Cell.NumberFormats.Euro;
            }
            Cells.Add(retval);
            return retval;
        }
        public Cell AddInt(int? content, string? url = "")
        {
            var retval = new Cell();
            if (content != null)
            {
                ...
                if (!string.IsNullOrEmpty(url))
                    retval.Url = url;
                retval.NumberFormat = Cell.NumberFormats.Integer;
            }
            Cells.Add(retval);
            return retval;
        }
