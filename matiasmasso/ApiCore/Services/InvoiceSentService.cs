...
namespace Api.Services
{
    public class InvoiceSentService
    {
        ...
        //InvoiceSentModel FactoryMagasalfa(int year, int month)
        //{

        //}

        //public static bool Update(MaxiContext db, InvoiceSentModel value)
        //{
        ...
        //        if (entity == null) throw new System.Exception("Invoice not found");
        //    }

        //    entity.Fch = value.Fch;
        //    entity.Fra1 = value.Id;
        //    entity.Yea = (short)value.Fch.Year;
        //    entity.Cur =  "EUR";
        //    entity.CliGuid= (Guid)value.Contact!;
    ...
    public class InvoicesSentService
    {
        ...
        public static int LastInvoice(int emp, int year)
        {
            using (var db = new Entities.MaxiContext())
            {
                return db.Fras
