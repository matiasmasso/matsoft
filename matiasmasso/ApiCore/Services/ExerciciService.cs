...
namespace Api.Services
{
    public class ExerciciService
    {
        ...
        public static void Renumera(EmpModel.EmpIds emp, int year)
        {
            using (var db = new Entities.MaxiContext())
            {
                Renumera(db, emp, year);
        ...
        private static void Renumera(Entities.MaxiContext db, EmpModel.EmpIds emp, int year)
        {
