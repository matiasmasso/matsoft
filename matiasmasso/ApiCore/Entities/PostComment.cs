...
public partial class PostComment
{
    ...
    public virtual ICollection<PostComment> InverseAnswerRootNavigation { get; set; } = new List<PostComment>();

    public virtual ICollection<PostComment> InverseAnsweringNavigation { get; set; } = new List<PostComment>();
