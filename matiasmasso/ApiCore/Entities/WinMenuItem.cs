...
public partial class WinMenuItem
{
    ...
    public virtual ICollection<WinMenuItem> InverseParentNavigation { get; set; } = new List<WinMenuItem>();

    public virtual WinMenuItem? ParentNavigation { get; set; }

    public virtual ICollection<WinMenuItemRol> WinMenuItemRols { get; set; } = new List<WinMenuItemRol>();
}
