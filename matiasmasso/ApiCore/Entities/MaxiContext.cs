...
public partial class MaxiContext : DbContext
{
    ...
    public virtual DbSet<Aeat> Aeats { get; set; }

    public virtual DbSet<AeatMod> AeatMods { get; set; }

    public virtual DbSet<Alb> Albs { get; set; }

    public virtual DbSet<AlbBloqueig> AlbBloqueigs { get; set; }

    public virtual DbSet<App> Apps { get; set; }

    public virtual DbSet<AppUsrLog> AppUsrLogs { get; set; }

    public virtual DbSet<Arc> Arcs { get; set; }

    public virtual DbSet<Art> Arts { get; set; }

    public virtual DbSet<ArtCustRef> ArtCustRefs { get; set; }

    public virtual DbSet<ArtSpare> ArtSpares { get; set; }
    ...
    public virtual DbSet<AuditStock> AuditStocks { get; set; }

    public virtual DbSet<BancSdo> BancSdos { get; set; }

    public virtual DbSet<BancTerm> BancTerms { get; set; }

    public virtual DbSet<BancTransferBeneficiari> BancTransferBeneficiaris { get; set; }

    public virtual DbSet<BancTransferPool> BancTransferPools { get; set; }
    ...
    public virtual DbSet<Bloggerpost> Bloggerposts { get; set; }

    public virtual DbSet<BloggerpostProduct> BloggerpostProducts { get; set; }

    public virtual DbSet<Bn1> Bn1s { get; set; }

    public virtual DbSet<Bn2> Bn2s { get; set; }

    public virtual DbSet<BookFra> BookFras { get; set; }

    public virtual DbSet<BrandArea> BrandAreas { get; set; }

    public virtual DbSet<CategoriaDeNoticium> CategoriaDeNoticia { get; set; }

    public virtual DbSet<Cca> Ccas { get; set; }

    public virtual DbSet<CcaSched> CcaScheds { get; set; }

    public virtual DbSet<CcaSchedItem> CcaSchedItems { get; set; }

    public virtual DbSet<Ccb> Ccbs { get; set; }

    public virtual DbSet<CertificatIrpf> CertificatIrpfs { get; set; }

    public virtual DbSet<ChannelDto> ChannelDtos { get; set; }

    public virtual DbSet<Claim> Claims { get; set; }

    public virtual DbSet<CliAdr> CliAdrs { get; set; }

    public virtual DbSet<CliApertura> CliAperturas { get; set; }

    public virtual DbSet<CliBnc> CliBncs { get; set; }

    public virtual DbSet<CliCert> CliCerts { get; set; }

    public virtual DbSet<CliClient> CliClients { get; set; }

    public virtual DbSet<CliContact> CliContacts { get; set; }

    public virtual DbSet<CliCreditLog> CliCreditLogs { get; set; }

    public virtual DbSet<CliDoc> CliDocs { get; set; }

    public virtual DbSet<CliDto> CliDtos { get; set; }

    public virtual DbSet<CliGral> CliGrals { get; set; }

    public virtual DbSet<CliPrv> CliPrvs { get; set; }

    public virtual DbSet<CliRep> CliReps { get; set; }

    public virtual DbSet<CliReturn> CliReturns { get; set; }

    public virtual DbSet<CliStaff> CliStaffs { get; set; }

    public virtual DbSet<CliTel> CliTels { get; set; }

    public virtual DbSet<CliTpa> CliTpas { get; set; }

    public virtual DbSet<Cll> Clls { get; set; }

    public virtual DbSet<Clx> Clxes { get; set; }

    public virtual DbSet<Cnap> Cnaps { get; set; }

    public virtual DbSet<Cod> Cods { get; set; }

    public virtual DbSet<CodisMercancium> CodisMercancia { get; set; }

    public virtual DbSet<Comarca> Comarcas { get; set; }

    public virtual DbSet<Computer> Computers { get; set; }

    public virtual DbSet<Cond> Conds { get; set; }

    public virtual DbSet<CondCapitol> CondCapitols { get; set; }

    public virtual DbSet<ConsumerTicket> ConsumerTickets { get; set; }

    public virtual DbSet<ContactClass> ContactClasses { get; set; }

    public virtual DbSet<ContactGlnDeprecated> ContactGlnDeprecateds { get; set; }
    ...
    public virtual DbSet<ContractCodi> ContractCodis { get; set; }

    public virtual DbSet<Country> Countries { get; set; }

    public virtual DbSet<Credencial> Credencials { get; set; }

    public virtual DbSet<Crr> Crrs { get; set; }

    public virtual DbSet<Csa> Csas { get; set; }

    public virtual DbSet<Csb> Csbs { get; set; }

    public virtual DbSet<Cur> Curs { get; set; }

    public virtual DbSet<CurExchangeRate> CurExchangeRates { get; set; }

    public virtual DbSet<CustomerCluster> CustomerClusters { get; set; }

    public virtual DbSet<CustomerDept> CustomerDepts { get; set; }

    public virtual DbSet<CustomerDeptItem> CustomerDeptItems { get; set; }

    public virtual DbSet<CustomerDto> CustomerDtos { get; set; }

    public virtual DbSet<CustomerInvoiceTemplate> CustomerInvoiceTemplates { get; set; }

    public virtual DbSet<CustomerInvoiceTemplateItem> CustomerInvoiceTemplateItems { get; set; }

    public virtual DbSet<CustomerPlatform> CustomerPlatforms { get; set; }

    public virtual DbSet<CustomerPlatformDestination> CustomerPlatformDestinations { get; set; }

    public virtual DbSet<Default> Defaults { get; set; }

    public virtual DbSet<DefaultImage> DefaultImages { get; set; }

    public virtual DbSet<DeliveryShipment> DeliveryShipments { get; set; }
    ...
    public virtual DbSet<DocFileLog> DocFileLogs { get; set; }

    public virtual DbSet<DocFileSrc> DocFileSrcs { get; set; }

    public virtual DbSet<DownloadTarget> DownloadTargets { get; set; }

    public virtual DbSet<E11Customer> E11Customers { get; set; }

    public virtual DbSet<E11cli> E11clis { get; set; }

    public virtual DbSet<E11dto> E11dtos { get; set; }

    public virtual DbSet<E11sale> E11sales { get; set; }

    public virtual DbSet<Eci> Ecis { get; set; }

    public virtual DbSet<Ecidept> Ecidepts { get; set; }

    public virtual DbSet<EciplantillaModLog> EciplantillaModLogs { get; set; }

    public virtual DbSet<EcitransmCentre> EcitransmCentres { get; set; }

    public virtual DbSet<EcitransmGroup> EcitransmGroups { get; set; }

    public virtual DbSet<Edi> Edis { get; set; }

    public virtual DbSet<EdiInvrptHeader> EdiInvrptHeaders { get; set; }

    public virtual DbSet<EdiInvrptItem> EdiInvrptItems { get; set; }

    public virtual DbSet<EdiRemadvHeader> EdiRemadvHeaders { get; set; }

    public virtual DbSet<EdiRemadvItem> EdiRemadvItems { get; set; }

    public virtual DbSet<EdiversaDesadvHeader> EdiversaDesadvHeaders { get; set; }

    public virtual DbSet<EdiversaDesadvItem> EdiversaDesadvItems { get; set; }

    public virtual DbSet<EdiversaException> EdiversaExceptions { get; set; }

    public virtual DbSet<EdiversaInterlocutor> EdiversaInterlocutors { get; set; }

    public virtual DbSet<EdiversaOrderHeader> EdiversaOrderHeaders { get; set; }

    public virtual DbSet<EdiversaOrderItem> EdiversaOrderItems { get; set; }

    public virtual DbSet<EdiversaOrdrspHeader> EdiversaOrdrspHeaders { get; set; }

    public virtual DbSet<EdiversaOrdrspItem> EdiversaOrdrspItems { get; set; }

    public virtual DbSet<EdiversaRecadvHdr> EdiversaRecadvHdrs { get; set; }

    public virtual DbSet<EdiversaRecadvItm> EdiversaRecadvItms { get; set; }

    public virtual DbSet<EdiversaSalesReportHeader> EdiversaSalesReportHeaders { get; set; }

    public virtual DbSet<EdiversaSalesReportItem> EdiversaSalesReportItems { get; set; }

    public virtual DbSet<ElCorteInglesAlineamientoStock> ElCorteInglesAlineamientoStocks { get; set; }

    public virtual DbSet<Email> Emails { get; set; }

    public virtual DbSet<EmailCli> EmailClis { get; set; }

    public virtual DbSet<Emp> Emps { get; set; }

    public virtual DbSet<Escriptura> Escripturas { get; set; }
    ...
    public virtual DbSet<FraItem> FraItems { get; set; }

    public virtual DbSet<FtpPath> FtpPaths { get; set; }
    ...
    public virtual DbSet<HourInOut> HourInOuts { get; set; }

    public virtual DbSet<HpLastPurchase> HpLastPurchases { get; set; }

    public virtual DbSet<Iban> Ibans { get; set; }

    public virtual DbSet<IbanStructure> IbanStructures { get; set; }

    public virtual DbSet<Immoble> Immobles { get; set; }

    public virtual DbSet<Impagat> Impagats { get; set; }

    public virtual DbSet<ImportDtl> ImportDtls { get; set; }

    public virtual DbSet<ImportHdr> ImportHdrs { get; set; }

    public virtual DbSet<ImportPrevisio> ImportPrevisios { get; set; }

    public virtual DbSet<Incentiu> Incentius { get; set; }

    public virtual DbSet<IncentiuProduct> IncentiuProducts { get; set; }

    public virtual DbSet<IncentiuQtyDto> IncentiuQtyDtos { get; set; }

    public virtual DbSet<IncidenciaDocFile> IncidenciaDocFiles { get; set; }

    public virtual DbSet<IncidenciesCod> IncidenciesCods { get; set; }

    public virtual DbSet<Incidency> Incidencies { get; set; }

    public virtual DbSet<Incoterm> Incoterms { get; set; }

    public virtual DbSet<Insolvencia> Insolvencias { get; set; }

    public virtual DbSet<Intrastat> Intrastats { get; set; }

    public virtual DbSet<IntrastatPartidum> IntrastatPartida { get; set; }

    public virtual DbSet<InventariItem> InventariItems { get; set; }

    public virtual DbSet<InvoiceReceivedHeader> InvoiceReceivedHeaders { get; set; }

    public virtual DbSet<InvoiceReceivedItem> InvoiceReceivedItems { get; set; }

    public virtual DbSet<JornadaLaboral> JornadaLaborals { get; set; }

    public virtual DbSet<JsonLog> JsonLogs { get; set; }

    public virtual DbSet<JsonSchema> JsonSchemas { get; set; }

    public virtual DbSet<Keyword> Keywords { get; set; }

    public virtual DbSet<LangText> LangTexts { get; set; }

    public virtual DbSet<LiniaTelefon> LiniaTelefons { get; set; }

    public virtual DbSet<Lloguer> Lloguers { get; set; }

    public virtual DbSet<Location> Locations { get; set; }

    public virtual DbSet<MailingLog> MailingLogs { get; set; }

    public virtual DbSet<MarketPlace> MarketPlaces { get; set; }

    public virtual DbSet<MarketplaceSku> MarketplaceSkus { get; set; }

    public virtual DbSet<MediaResource> MediaResources { get; set; }

    public virtual DbSet<MediaResourceTarget> MediaResourceTargets { get; set; }

    public virtual DbSet<Mem> Mems { get; set; }

    public virtual DbSet<Mgz> Mgzs { get; set; }

    public virtual DbSet<Miravia2> Miravia2s { get; set; }

    public virtual DbSet<Miravium> Miravia { get; set; }

    public virtual DbSet<Mr2> Mr2s { get; set; }

    public virtual DbSet<Mrt> Mrts { get; set; }

    public virtual DbSet<MrtTipu> MrtTipus { get; set; }

    public virtual DbSet<Msg> Msgs { get; set; }

    public virtual DbSet<Multum> Multa { get; set; }

    public virtual DbSet<N43cca> N43ccas { get; set; }

    public virtual DbSet<N43hdr> N43hdrs { get; set; }

    public virtual DbSet<N43itm> N43itms { get; set; }

    public virtual DbSet<N43template> N43templates { get; set; }

    public virtual DbSet<Nav> Navs { get; set; }

    public virtual DbSet<NavRol> NavRols { get; set; }

    public virtual DbSet<Newsletter> Newsletters { get; set; }

    public virtual DbSet<NewsletterSource> NewsletterSources { get; set; }

    public virtual DbSet<Nomina> Nominas { get; set; }

    public virtual DbSet<NominaConcepte> NominaConceptes { get; set; }

    public virtual DbSet<NominaItem> NominaItems { get; set; }

    public virtual DbSet<Noticium> Noticia { get; set; }

    public virtual DbSet<Offer> Offers { get; set; }

    public virtual DbSet<Otto> Ottos { get; set; }

    public virtual DbSet<PaymentGateway> PaymentGateways { get; set; }

    public virtual DbSet<Pdc> Pdcs { get; set; }

    public virtual DbSet<Pdd> Pdds { get; set; }

    public virtual DbSet<PgcClass> PgcClasses { get; set; }

    public virtual DbSet<PgcCtum> PgcCta { get; set; }

    public virtual DbSet<PgcPlan> PgcPlans { get; set; }

    public virtual DbSet<Plantilla> Plantillas { get; set; }

    public virtual DbSet<Pnc> Pncs { get; set; }

    public virtual DbSet<Pnd> Pnds { get; set; }

    public virtual DbSet<PortadaImg> PortadaImgs { get; set; }

    public virtual DbSet<PortsCondicion> PortsCondicions { get; set; }

    public virtual DbSet<PostComment> PostComments { get; set; }

    public virtual DbSet<PremiumCustomer> PremiumCustomers { get; set; }

    public virtual DbSet<PremiumLine> PremiumLines { get; set; }

    public virtual DbSet<PremiumProduct> PremiumProducts { get; set; }

    public virtual DbSet<PriceListCustomer> PriceListCustomers { get; set; }

    public virtual DbSet<PriceListItemCustomer> PriceListItemCustomers { get; set; }

    public virtual DbSet<PriceListItemSupplier> PriceListItemSuppliers { get; set; }

    public virtual DbSet<PriceListSupplier> PriceListSuppliers { get; set; }

    public virtual DbSet<ProductChannel> ProductChannels { get; set; }

    public virtual DbSet<ProductDownload> ProductDownloads { get; set; }

    public virtual DbSet<ProductPlugin> ProductPlugins { get; set; }

    public virtual DbSet<ProductPluginItem> ProductPluginItems { get; set; }

    public virtual DbSet<Projecte> Projectes { get; set; }

    public virtual DbSet<PromofarmaFeed> PromofarmaFeeds { get; set; }

    public virtual DbSet<Provincium> Provincia { get; set; }

    public virtual DbSet<PrvCliNum> PrvCliNums { get; set; }

    public virtual DbSet<PwaMenuItem> PwaMenuItems { get; set; }

    public virtual DbSet<Recall> Recalls { get; set; }

    public virtual DbSet<RecallCli> RecallClis { get; set; }

    public virtual DbSet<RecallProduct> RecallProducts { get; set; }

    public virtual DbSet<RedsysErr> RedsysErrs { get; set; }

    public virtual DbSet<Ref> Refs { get; set; }

    public virtual DbSet<Regio> Regios { get; set; }

    public virtual DbSet<RepCliCom> RepCliComs { get; set; }

    public virtual DbSet<RepLiq> RepLiqs { get; set; }

    public virtual DbSet<RepProduct> RepProducts { get; set; }

    public virtual DbSet<Rp> Rps { get; set; }

    public virtual DbSet<SalesManager> SalesManagers { get; set; }

    public virtual DbSet<SatRecall> SatRecalls { get; set; }

    public virtual DbSet<SearchRequest> SearchRequests { get; set; }

    public virtual DbSet<SearchResult> SearchResults { get; set; }

    public virtual DbSet<SegSocialGrup> SegSocialGrups { get; set; }

    public virtual DbSet<SepaMe> SepaMes { get; set; }

    public virtual DbSet<SepaText> SepaTexts { get; set; }
    ...
    public virtual DbSet<SkuBundle> SkuBundles { get; set; }

    public virtual DbSet<SkuMoqLock> SkuMoqLocks { get; set; }

    public virtual DbSet<SkuWith> SkuWiths { get; set; }

    public virtual DbSet<SocialMediaWidget> SocialMediaWidgets { get; set; }

    public virtual DbSet<SonaeTt> SonaeTts { get; set; }

    public virtual DbSet<Sorteo> Sorteos { get; set; }

    public virtual DbSet<SorteoLead> SorteoLeads { get; set; }

    public virtual DbSet<Spv> Spvs { get; set; }

    public virtual DbSet<SpvIn> SpvIns { get; set; }

    public virtual DbSet<Ssc> Sscs { get; set; }

    public virtual DbSet<SscEmail> SscEmails { get; set; }

    public virtual DbSet<SscLog> SscLogs { get; set; }

    public virtual DbSet<SscRol> SscRols { get; set; }

    public virtual DbSet<StaffCategory> StaffCategories { get; set; }

    public virtual DbSet<StaffHoliday> StaffHolidays { get; set; }

    public virtual DbSet<StaffPo> StaffPos { get; set; }

    public virtual DbSet<StaffSched> StaffScheds { get; set; }

    public virtual DbSet<StaffSchedItem> StaffSchedItems { get; set; }

    public virtual DbSet<Stp> Stps { get; set; }

    public virtual DbSet<StringLocalizer> StringLocalizers { get; set; }

    public virtual DbSet<Tamariu> Tamarius { get; set; }
    ...
    public virtual DbSet<Tmp3> Tmp3s { get; set; }

    public virtual DbSet<TmpChild> TmpChildren { get; set; }

    public virtual DbSet<TmpParent> TmpParents { get; set; }

    public virtual DbSet<TmpParent2> TmpParent2s { get; set; }

    public virtual DbSet<Tpa> Tpas { get; set; }

    public virtual DbSet<Tpv> Tpvs { get; set; }

    public virtual DbSet<TpvLog> TpvLogs { get; set; }

    public virtual DbSet<Tracking> Trackings { get; set; }

    public virtual DbSet<Transm> Transms { get; set; }

    public virtual DbSet<Trp> Trps { get; set; }

    public virtual DbSet<Tutorial> Tutorials { get; set; }

    public virtual DbSet<TutorialRol> TutorialRols { get; set; }

    public virtual DbSet<TutorialSubject> TutorialSubjects { get; set; }

    public virtual DbSet<Txt> Txts { get; set; }

    public virtual DbSet<UrlSegment> UrlSegments { get; set; }

    public virtual DbSet<UserClaim> UserClaims { get; set; }

    public virtual DbSet<UserDefault> UserDefaults { get; set; }

    public virtual DbSet<UsrRol> UsrRols { get; set; }

    public virtual DbSet<UsrSession> UsrSessions { get; set; }

    public virtual DbSet<VehicleFlotum> VehicleFlota { get; set; }

    public virtual DbSet<VehicleMarca> VehicleMarcas { get; set; }

    public virtual DbSet<VehicleModel> VehicleModels { get; set; }

    public virtual DbSet<VisaCard> VisaCards { get; set; }

    public virtual DbSet<VisaEmisor> VisaEmisors { get; set; }

    public virtual DbSet<Vw2023sale> Vw2023sales { get; set; }

    public virtual DbSet<Vw4momsCategory> Vw4momsCategories { get; set; }

    public virtual DbSet<Vw4momsProductRoute> Vw4momsProductRoutes { get; set; }

    public virtual DbSet<Vw4momsSku> Vw4momsSkus { get; set; }

    public virtual DbSet<Vw4momsSkuRetail> Vw4momsSkuRetails { get; set; }

    public virtual DbSet<Vw4momsSkuStock> Vw4momsSkuStocks { get; set; }

    public virtual DbSet<VwAddress> VwAddresses { get; set; }

    public virtual DbSet<VwAddressBase> VwAddressBases { get; set; }

    public virtual DbSet<VwAppUsr> VwAppUsrs { get; set; }

    public virtual DbSet<VwAppUsrLog> VwAppUsrLogs { get; set; }

    public virtual DbSet<VwArea> VwAreas { get; set; }

    public virtual DbSet<VwAreaNom> VwAreaNoms { get; set; }

    public virtual DbSet<VwAreaParent> VwAreaParents { get; set; }

    public virtual DbSet<VwAtla> VwAtlas { get; set; }

    public virtual DbSet<VwAtlasRep> VwAtlasReps { get; set; }

    public virtual DbSet<VwAtlasSalesManager> VwAtlasSalesManagers { get; set; }

    public virtual DbSet<VwBalance> VwBalances { get; set; }

    public virtual DbSet<VwBanc> VwBancs { get; set; }

    public virtual DbSet<VwBancsSdo> VwBancsSdos { get; set; }

    public virtual DbSet<VwBank> VwBanks { get; set; }

    public virtual DbSet<VwBrand> VwBrands { get; set; }

    public virtual DbSet<VwBrandCategory> VwBrandCategories { get; set; }

    public virtual DbSet<VwBrandVideo> VwBrandVideos { get; set; }

    public virtual DbSet<VwBundleRetail> VwBundleRetails { get; set; }

    public virtual DbSet<VwBundleStock> VwBundleStocks { get; set; }

    public virtual DbSet<VwCategoriesOld> VwCategoriesOlds { get; set; }

    public virtual DbSet<VwCategory> VwCategories { get; set; }

    public virtual DbSet<VwCategoryNom> VwCategoryNoms { get; set; }

    public virtual DbSet<VwCca> VwCcas { get; set; }

    public virtual DbSet<VwCca1> VwCcas1 { get; set; }

    public virtual DbSet<VwCcasList> VwCcasLists { get; set; }

    public virtual DbSet<VwCcxOrMe> VwCcxOrMes { get; set; }

    public virtual DbSet<VwChannelDto> VwChannelDtos { get; set; }

    public virtual DbSet<VwChannelOpenSku> VwChannelOpenSkus { get; set; }

    public virtual DbSet<VwChannelSkusExcluded> VwChannelSkusExcludeds { get; set; }

    public virtual DbSet<VwClaim> VwClaims { get; set; }

    public virtual DbSet<VwCliTpaExcludedCustomer> VwCliTpaExcludedCustomers { get; set; }

    public virtual DbSet<VwCnap> VwCnaps { get; set; }

    public virtual DbSet<VwCnapParent> VwCnapParents { get; set; }

    public virtual DbSet<VwCondicion> VwCondicions { get; set; }

    public virtual DbSet<VwContact> VwContacts { get; set; }

    public virtual DbSet<VwContactChannel> VwContactChannels { get; set; }

    public virtual DbSet<VwContactMenu> VwContactMenus { get; set; }

    public virtual DbSet<VwContent> VwContents { get; set; }

    public virtual DbSet<VwContentUrl> VwContentUrls { get; set; }

    public virtual DbSet<VwCrr> VwCrrs { get; set; }

    public virtual DbSet<VwCrrCli> VwCrrClis { get; set; }

    public virtual DbSet<VwCtaMe> VwCtaMes { get; set; }

    public virtual DbSet<VwCurExchange> VwCurExchanges { get; set; }

    public virtual DbSet<VwCustomerChannelOpenSku> VwCustomerChannelOpenSkus { get; set; }

    public virtual DbSet<VwCustomerChannelSkusExcluded> VwCustomerChannelSkusExcludeds { get; set; }

    public virtual DbSet<VwCustomerCredit> VwCustomerCredits { get; set; }

    public virtual DbSet<VwCustomerDeptSku> VwCustomerDeptSkus { get; set; }

    public virtual DbSet<VwCustomerDto> VwCustomerDtos { get; set; }

    public virtual DbSet<VwCustomerIban> VwCustomerIbans { get; set; }

    public virtual DbSet<VwCustomerProductGuidsIncluded> VwCustomerProductGuidsIncludeds { get; set; }

    public virtual DbSet<VwCustomerSku> VwCustomerSkus { get; set; }

    public virtual DbSet<VwCustomerSkusExcluded> VwCustomerSkusExcludeds { get; set; }

    public virtual DbSet<VwCustomerSkusIncluded> VwCustomerSkusIncludeds { get; set; }

    public virtual DbSet<VwCustomerSkusLite> VwCustomerSkusLites { get; set; }

    public virtual DbSet<VwDelivery> VwDeliveries { get; set; }

    public virtual DbSet<VwDeliveryShipment> VwDeliveryShipments { get; set; }

    public virtual DbSet<VwDeliveryTracking> VwDeliveryTrackings { get; set; }

    public virtual DbSet<VwDeliveryTrackingTrp> VwDeliveryTrackingTrps { get; set; }

    public virtual DbSet<VwDept> VwDepts { get; set; }

    public virtual DbSet<VwDeptCategory> VwDeptCategories { get; set; }

    public virtual DbSet<VwDocfile> VwDocfiles { get; set; }

    public virtual DbSet<VwDocfileThumbnail> VwDocfileThumbnails { get; set; }

    public virtual DbSet<VwDownloadTarget> VwDownloadTargets { get; set; }

    public virtual DbSet<VwEciPlantillaModLog> VwEciPlantillaModLogs { get; set; }

    public virtual DbSet<VwEciSalesReport> VwEciSalesReports { get; set; }

    public virtual DbSet<VwEdiInvRpt> VwEdiInvRpts { get; set; }

    public virtual DbSet<VwEdiInvrptHeader> VwEdiInvrptHeaders { get; set; }

    public virtual DbSet<VwEdiSalesReport> VwEdiSalesReports { get; set; }

    public virtual DbSet<VwEmailDefault> VwEmailDefaults { get; set; }

    public virtual DbSet<VwFeedback> VwFeedbacks { get; set; }

    public virtual DbSet<VwFeedbackSum> VwFeedbackSums { get; set; }

    public virtual DbSet<VwFilter> VwFilters { get; set; }

    public virtual DbSet<VwFilterTarget> VwFilterTargets { get; set; }

    public virtual DbSet<VwForecast> VwForecasts { get; set; }

    public virtual DbSet<VwHoldingCustomRef> VwHoldingCustomRefs { get; set; }

    public virtual DbSet<VwIban> VwIbans { get; set; }

    public virtual DbSet<VwImpagat> VwImpagats { get; set; }

    public virtual DbSet<VwImpagatsOinsolvent> VwImpagatsOinsolvents { get; set; }

    public virtual DbSet<VwInsolvent> VwInsolvents { get; set; }

    public virtual DbSet<VwInvRpt> VwInvRpts { get; set; }

    public virtual DbSet<VwInvRptException> VwInvRptExceptions { get; set; }

    public virtual DbSet<VwInvoicesSent> VwInvoicesSents { get; set; }

    public virtual DbSet<VwLangText> VwLangTexts { get; set; }

    public virtual DbSet<VwLastRetailPrice> VwLastRetailPrices { get; set; }

    public virtual DbSet<VwLocation> VwLocations { get; set; }

    public virtual DbSet<VwMediaResource> VwMediaResources { get; set; }

    public virtual DbSet<VwMediaResourceTarget> VwMediaResourceTargets { get; set; }

    public virtual DbSet<VwMgzInventoryCost> VwMgzInventoryCosts { get; set; }

    public virtual DbSet<VwMgzInventoryIo> VwMgzInventoryIos { get; set; }

    public virtual DbSet<VwMgzInventoryMovement> VwMgzInventoryMovements { get; set; }

    public virtual DbSet<VwNav> VwNavs { get; set; }

    public virtual DbSet<VwNoticia> VwNoticias { get; set; }

    public virtual DbSet<VwPdc> VwPdcs { get; set; }

    public virtual DbSet<VwPgcCtaSdo> VwPgcCtaSdos { get; set; }

    public virtual DbSet<VwPgcCtum> VwPgcCta { get; set; }

    public virtual DbSet<VwPncSku> VwPncSkus { get; set; }

    public virtual DbSet<VwPostalAddress> VwPostalAddresses { get; set; }

    public virtual DbSet<VwPremiumLineExcludedCustomer> VwPremiumLineExcludedCustomers { get; set; }

    public virtual DbSet<VwPremiumLineExclusiveCustomer> VwPremiumLineExclusiveCustomers { get; set; }

    public virtual DbSet<VwProductBreadcrumb> VwProductBreadcrumbs { get; set; }

    public virtual DbSet<VwProductCanonicalUrl> VwProductCanonicalUrls { get; set; }

    public virtual DbSet<VwProductCnap> VwProductCnaps { get; set; }

    public virtual DbSet<VwProductDefaultUrl> VwProductDefaultUrls { get; set; }

    public virtual DbSet<VwProductGuid> VwProductGuids { get; set; }

    public virtual DbSet<VwProductLandingPage> VwProductLandingPages { get; set; }

    public virtual DbSet<VwProductLangText> VwProductLangTexts { get; set; }

    public virtual DbSet<VwProductNom> VwProductNoms { get; set; }

    public virtual DbSet<VwProductParent> VwProductParents { get; set; }

    public virtual DbSet<VwProductText> VwProductTexts { get; set; }

    public virtual DbSet<VwProductUrl> VwProductUrls { get; set; }

    public virtual DbSet<VwProductUrlCanonical> VwProductUrlCanonicals { get; set; }

    public virtual DbSet<VwRepCustomer> VwRepCustomers { get; set; }

    public virtual DbSet<VwRepPncsLiqPending> VwRepPncsLiqPendings { get; set; }

    public virtual DbSet<VwRepProduct> VwRepProducts { get; set; }

    public virtual DbSet<VwRepSku> VwRepSkus { get; set; }

    public virtual DbSet<VwRetail> VwRetails { get; set; }

    public virtual DbSet<VwRetailPrice> VwRetailPrices { get; set; }

    public virtual DbSet<VwSalesManagerCustomer> VwSalesManagerCustomers { get; set; }

    public virtual DbSet<VwSalesManagerSku> VwSalesManagerSkus { get; set; }

    public virtual DbSet<VwSellout> VwSellouts { get; set; }

    public virtual DbSet<VwSellout2> VwSellout2s { get; set; }

    public virtual DbSet<VwSelloutCli> VwSelloutClis { get; set; }

    public virtual DbSet<VwSelloutProveidor> VwSelloutProveidors { get; set; }

    public virtual DbSet<VwSelloutRep> VwSelloutReps { get; set; }

    public virtual DbSet<VwShopProductText> VwShopProductTexts { get; set; }

    public virtual DbSet<VwSku> VwSkus { get; set; }

    public virtual DbSet<VwSkuAndBundlePnc> VwSkuAndBundlePncs { get; set; }

    public virtual DbSet<VwSkuAndBundleStock> VwSkuAndBundleStocks { get; set; }

    public virtual DbSet<VwSkuBundleRetail> VwSkuBundleRetails { get; set; }

    public virtual DbSet<VwSkuCost> VwSkuCosts { get; set; }

    public virtual DbSet<VwSkuLastCost> VwSkuLastCosts { get; set; }

    public virtual DbSet<VwSkuNom> VwSkuNoms { get; set; }

    public virtual DbSet<VwSkuPnc> VwSkuPncs { get; set; }

    public virtual DbSet<VwSkuRetail> VwSkuRetails { get; set; }

    public virtual DbSet<VwSkuStock> VwSkuStocks { get; set; }

    public virtual DbSet<VwStaff> VwStaffs { get; set; }

    public virtual DbSet<VwStaffIban> VwStaffIbans { get; set; }

    public virtual DbSet<VwStat> VwStats { get; set; }

    public virtual DbSet<VwStoreLocator> VwStoreLocators { get; set; }

    public virtual DbSet<VwStoreLocatorRaw> VwStoreLocatorRaws { get; set; }

    public virtual DbSet<VwTaskLastLog> VwTaskLastLogs { get; set; }

    public virtual DbSet<VwTel> VwTels { get; set; }

    public virtual DbSet<VwTelDefault> VwTelDefaults { get; set; }

    public virtual DbSet<VwTelsyEmail> VwTelsyEmails { get; set; }

    public virtual DbSet<VwTmpParent> VwTmpParents { get; set; }

    public virtual DbSet<VwTransm> VwTransms { get; set; }

    public virtual DbSet<VwTrp> VwTrps { get; set; }

    public virtual DbSet<VwUsrArtCustRef> VwUsrArtCustRefs { get; set; }

    public virtual DbSet<VwUsrLog> VwUsrLogs { get; set; }

    public virtual DbSet<VwUsrNickname> VwUsrNicknames { get; set; }

    public virtual DbSet<VwVehicle> VwVehicles { get; set; }

    public virtual DbSet<VwWebAtla> VwWebAtlas { get; set; }

    public virtual DbSet<VwWtbolBasket> VwWtbolBaskets { get; set; }

    public virtual DbSet<VwWtbolDisplay> VwWtbolDisplays { get; set; }

    public virtual DbSet<VwWtbolInventory> VwWtbolInventories { get; set; }

    public virtual DbSet<VwWtbolLandingPage> VwWtbolLandingPages { get; set; }

    public virtual DbSet<VwWtbolStock> VwWtbolStocks { get; set; }

    public virtual DbSet<VwYouTube> VwYouTubes { get; set; }

    public virtual DbSet<VwZip> VwZips { get; set; }

    public virtual DbSet<VwZona> VwZonas { get; set; }

    public virtual DbSet<Web> Webs { get; set; }

    public virtual DbSet<WebErr> WebErrs { get; set; }

    public virtual DbSet<WebLogBrowse> WebLogBrowses { get; set; }

    public virtual DbSet<WebMenuGroup> WebMenuGroups { get; set; }

    public virtual DbSet<WebMenuItem> WebMenuItems { get; set; }

    public virtual DbSet<WebPageAlias> WebPageAliases { get; set; }

    public virtual DbSet<WinBug> WinBugs { get; set; }

    public virtual DbSet<WinMenuItem> WinMenuItems { get; set; }

    public virtual DbSet<WinMenuItemRol> WinMenuItemRols { get; set; }

    public virtual DbSet<Worten> Wortens { get; set; }

    public virtual DbSet<WortenEan> WortenEans { get; set; }

    public virtual DbSet<WtbolBasket> WtbolBaskets { get; set; }

    public virtual DbSet<WtbolBasketItem> WtbolBasketItems { get; set; }

    public virtual DbSet<WtbolCtr> WtbolCtrs { get; set; }

    public virtual DbSet<WtbolLandingPage> WtbolLandingPages { get; set; }

    public virtual DbSet<WtbolLog> WtbolLogs { get; set; }

    public virtual DbSet<WtbolSerp> WtbolSerps { get; set; }

    public virtual DbSet<WtbolSerpItem> WtbolSerpItems { get; set; }

    public virtual DbSet<WtbolSite> WtbolSites { get; set; }

    public virtual DbSet<WtbolStock> WtbolStocks { get; set; }

    public virtual DbSet<Xec> Xecs { get; set; }

    public virtual DbSet<XecDetail> XecDetails { get; set; }

    public virtual DbSet<Yea> Yeas { get; set; }

    public virtual DbSet<YouTube> YouTubes { get; set; }

    public virtual DbSet<YouTubeProduct> YouTubeProducts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=10.74.52.10;TrustServerCertificate=true;Initial Catalog=Maxi;Persist Security Info=True;User ID=sa_cXJSQYte;Password=CC1SURJQXHyfem27Bc", x => x.UseNetTopologySuite());

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Aeat>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_AEAT");

            entity.ToTable("Aeat", tb => tb.HasComment("Tax declaration documents"));
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_AEAT_fch");
            entity.Property(e => e.FchCreated)
                .HasDefaultValueSql("(getdate())", "DF_Aeat_FchCreated")
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_AEAT_MOD_1");

            entity.ToTable("Aeat_Mod", tb => tb.HasComment("Spanish Tax Agency form models (AEAT=Agencia Estatal de Administración Tributaria)"));

            entity.HasIndex(e => e.Mod, "IX_AeatMod_Mod").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_AEAT_MOD_GUID");
            ...
            entity.Property(e => e.Pyme)
                ...
                .HasDefaultValue(true, "DF_AEAT_MOD_PYME");
            entity.Property(e => e.SoloInfo)
                .HasComment("If true, no economic transaction applicable, just informative declaration")
                .HasDefaultValue(false, "DF_AEAT_MOD_SOLOINFO");
            entity.Property(e => e.Tperiod)
                .HasComment("Enumerable DTOAeatModel.PeriodTypes (mensual, trimestral, anual...)")
                .HasDefaultValue(0, "DF_AEAT_MOD_TPERIOD")
                .HasColumnName("TPeriod");
            entity.Property(e => e.VisibleBancs)
                .HasComment("Our extranet publishes some tax declarations depending on the users rol.\r\nThis field controls which models are accessible to bank employees.")
                .HasDefaultValue(false, "DF_Aeat_Mod_VisibleBancs");
        });

        modelBuilder.Entity<Alb>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_ALB");

            entity.ToTable("Alb", tb => tb.HasComment("Delivery note parent table for shipped goods, either received or sent"));

            entity.HasIndex(e => e.CliGuid, "IX_ALB_CliGuid");

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Alb1 }, "IX_ALB_EmpYeaAlb").IsUnique();
            ...
            entity.Property(e => e.CashCod)
                ...
                .HasDefaultValue(9, "DF_ALB_CashCod");
            ...
            entity.Property(e => e.Cur)
                ...
                .HasDefaultValue("ESP", "DF_ALB_Cur");
            ...
            entity.Property(e => e.Facturable)
                ...
                .HasDefaultValue(true, "DF_ALB_facturable");
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ALB_fch")
                .HasColumnType("datetime");
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time the delivery note was issued")
                .HasDefaultValueSql("(getdate())", "DF_Alb_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.FchLastEdited)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Alb_FchLastEdited")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Nom)
                ...
                .HasDefaultValue("", "DF_ALB_nom");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasDefaultValue("", "DF_ALB_Obs")
                .HasColumnType("text");
            ...
            entity.Property(e => e.Valorado)
                ...
                .HasDefaultValue(true, "DF_ALB_valorado");
            ...
            entity.HasOne(d => d.Cli).WithMany(p => p.AlbClis)
                .HasForeignKey(d => d.CliGuid)
                .HasConstraintName("FK_ALB_CliGral");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Albs)
                .HasForeignKey(d => d.Emp)
                .HasConstraintName("FK_ALB_Emp");

            entity.HasOne(d => d.EtiquetesTransportNavigation).WithMany(p => p.Albs)
                .HasForeignKey(d => d.EtiquetesTransport)
                .HasConstraintName("FK_Alb_DocFile");

            entity.HasOne(d => d.FacturarANavigation).WithMany(p => p.AlbFacturarANavigations)
                .HasForeignKey(d => d.FacturarA)
                .HasConstraintName("FK_ALB_FacturarA");

            entity.HasOne(d => d.Fra).WithMany(p => p.Albs)
                .HasForeignKey(d => d.FraGuid)
                .HasConstraintName("FK_ALB_FRA");

            entity.HasOne(d => d.Mgz).WithMany(p => p.AlbMgzs)
                .HasForeignKey(d => d.MgzGuid)
                .HasConstraintName("FK_ALB_Mgz");

            entity.HasOne(d => d.Platform).WithMany(p => p.AlbPlatforms)
                .HasForeignKey(d => d.PlatformGuid)
                .HasConstraintName("FK_ALB_Platform");

            entity.HasOne(d => d.Transm).WithMany(p => p.AlbsNavigation)
                .HasForeignKey(d => d.TransmGuid)
                .HasConstraintName("FK_ALB_Transm");

            entity.HasOne(d => d.Trp).WithMany(p => p.AlbTrps)
                .HasForeignKey(d => d.TrpGuid)
                .HasConstraintName("FK_ALB_Trp");

            entity.HasOne(d => d.UsrCreated).WithMany(p => p.AlbUsrCreateds)
                .HasForeignKey(d => d.UsrCreatedGuid)
                .HasConstraintName("FK_ALB_UsrCreated");

            entity.HasOne(d => d.UsrLastEdited).WithMany(p => p.AlbUsrLastEditeds)
                .HasForeignKey(d => d.UsrLastEditedGuid)
                .HasConstraintName("FK_ALB_UsrLastEdited");

            entity.HasOne(d => d.ZipNavigation).WithMany(p => p.Albs)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_ALB_BLOQUEIG");

            entity.ToTable("Alb_Bloqueig", tb => tb.HasComment("Prevents user from concurrently registering orders or delivery notes for same customer"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_ALB_BLOQUEIG_RowGuid");
            entity.Property(e => e.Cod)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasComment("PDC for purchase order, ALB for delivery notes")
                .HasDefaultValue("ALB", "DF_ALB_BLOQUEIG_cod");
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ALB_BLOQUEIG_fch")
                .HasColumnType("datetime");
            entity.Property(e => e.UserGuid).HasComment("User requesting lock. Foreign key to Email table");

            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.AlbBloqueigs)
                .HasForeignKey(d => d.Contact)
                .HasConstraintName("FK_Alb_Bloqueig_CliGral");

            entity.HasOne(d => d.User).WithMany(p => p.AlbBloqueigs)
        ...
        {
            entity.ToTable("App", tb => tb.HasComment("Corporate Apps from Matsoft"));
        ...
        modelBuilder.Entity<AppUsrLog>(entity =>
        {
            ...
            entity.ToTable("AppUsrLog", tb => tb.HasComment("Log of apps launched by users"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_AppUsrLog_Guid");
            ...
            entity.Property(e => e.Fch)
                .HasComment("Log date")
                .HasDefaultValueSql("(getdate())", "DF_AppUsrLog_Fch")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.AppNavigation).WithMany(p => p.AppUsrLogs)
                .HasForeignKey(d => d.App)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_AppUsrLog_App");

            entity.HasOne(d => d.UsrNavigation).WithMany(p => p.AppUsrLogs)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_ARC");

            entity.ToTable("Arc", tb => tb.HasComment("Delivery note items table for shipped goods, either received or sent"));

            entity.HasIndex(e => e.ArtGuid, "Arc_ArtGuid");

            entity.HasIndex(e => e.RepComLiquidable, "IX_ARC_ComRepLiquidable");

            entity.HasIndex(e => new { e.AlbGuid, e.Lin }, "IX_Arc_AlbGuidLin").IsUnique();
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_ARC_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency in ISO 4217")
                .HasDefaultValue("EUR", "DF_ARC_Cur");
            ...
            entity.HasOne(d => d.Alb).WithMany(p => p.Arcs)
                .HasForeignKey(d => d.AlbGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Arc_Alb");

            entity.HasOne(d => d.Art).WithMany(p => p.Arcs)
                .HasForeignKey(d => d.ArtGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Arc_Art");

            entity.HasOne(d => d.BundleNavigation).WithMany(p => p.InverseBundleNavigation)
                .HasForeignKey(d => d.Bundle)
                .HasConstraintName("FK_Arc_Bundle");

            entity.HasOne(d => d.Pdc).WithMany(p => p.Arcs)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_ART_1");

            entity.ToTable("Art", tb => tb.HasComment("Product sku properties"));

            entity.HasIndex(e => e.Cbar, "IX_Art_CBarNotNull")
                .IsUnique()
                .HasFilter("([CBar] IS NOT NULL)");

            entity.HasIndex(e => e.FchObsoleto, "IX_Art_FchObsoleto").IsDescending();
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_ART_Guid");
            entity.Property(e => e.Art1)
                .HasComment("Unique product number within the Company")
                .HasColumnName("Art");
            entity.Property(e => e.Availability).HasComment("Expected availability date, if it is not currently available");
            ...
            entity.Property(e => e.CodiMercancia)
                ...
                .HasDefaultValue("00000000", "DF_ART_CodiMercancia");
            ...
            entity.Property(e => e.EnvasesPlasticoReciclado).HasComment("(units. miligrams)");
            entity.Property(e => e.EnvasesPlasticoTotal).HasComment("(units. miligrams)");
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time the product was registered")
                .HasDefaultValueSql("(getdate())", "DF_ART_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Last time the product was edited")
                .HasDefaultValueSql("(getdate())", "DF_ART_FchLastEdited")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Hereda)
                ...
                .HasDefaultValue((byte)1, "DF_ART_Hereda");
            entity.Property(e => e.HeredaDimensions).HasComment("If true, the product inherits logistic data from its category");
            entity.Property(e => e.HideUntil).HasComment("The product won't be displayed until this date if not null");
            ...
            entity.Property(e => e.ImgFch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ART_FchImgUpdated")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.IvaCod)
                ...
                .HasDefaultValue((byte)1, "DF_Art_IvaCod");
            ...
            entity.Property(e => e.NoEcom).HasComment("Prevents it from being listed on ecommerce platforms or market places");
            ...
            entity.HasOne(d => d.CategoryNavigation).WithMany(p => p.Arts)
                .HasForeignKey(d => d.Category)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ART_STP");

            entity.HasOne(d => d.Cnap).WithMany(p => p.Arts)
                .HasForeignKey(d => d.CnapGuid)
                .HasConstraintName("FK_ART_Cnap");

            entity.HasOne(d => d.CodiMercanciaNavigation).WithMany(p => p.Arts)
                .HasForeignKey(d => d.CodiMercancia)
                .HasConstraintName("FK_Art_CodisMercancia");

            entity.HasOne(d => d.MadeInNavigation).WithMany(p => p.Arts)
                .HasForeignKey(d => d.MadeIn)
                .HasConstraintName("FK_Art_Country");

            entity.HasOne(d => d.SubstituteNavigation).WithMany(p => p.InverseSubstituteNavigation)
        ...
        modelBuilder.Entity<ArtCustRef>(entity =>
        {
            ...
            entity.ToTable("ArtCustRef", tb => tb.HasComment("Customer product code equivalences"));

            entity.HasIndex(e => new { e.CliGuid, e.Ref }, "IX_ArtCustRef_CliGuid_Ref");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_ArtCustRef_Guid");
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ArtCustRef_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchDescatalogado).HasColumnType("datetime");
            ...
            entity.HasOne(d => d.Art).WithMany(p => p.ArtCustRefs)
                .HasForeignKey(d => d.ArtGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Cod, e.TargetGuid, e.ProductGuid }).HasName("PK_ARTSPARE_1");

            entity.ToTable("ArtSpare", tb => tb.HasComment("Accessories and spares for each product"));
            ...
            entity.HasOne(d => d.Product).WithMany(p => p.ArtSpares)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_AUDITSTK");

            entity.ToTable("AuditStock", tb => tb.HasComment("Stocks reported by logistic center in order to match our records"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_AUDITSTK_Guid");
            ...
            entity.Property(e => e.Fch).HasComment("Report date");
        ...
        modelBuilder.Entity<BancSdo>(entity =>
        {
            ...
            entity.ToTable("BancSdo", tb => tb.HasComment("Bank balance. Every day we log the balance as appears on the bank website as a base for account conciliation"));

            entity.HasIndex(e => new { e.Fch, e.Banc }, "IX_BancSdo_FchBanc").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_BancSdo_Guid");
            entity.Property(e => e.Banc).HasComment("Bank account, foreign key for CliGral");
            entity.Property(e => e.Fch)
                .HasComment("Date")
                .HasDefaultValueSql("(getdate())", "DF_BANCSDO_fch")
                .HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_BancTerms");

            entity.ToTable("BancTerm", tb => tb.HasComment("Bank conditions for remittance advances"));

            entity.HasIndex(e => new { e.Banc, e.Fch }, "BancTerm_BancFch");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_BancTerms_Guid");
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_BancTerms_fch");
            ...
            entity.HasOne(d => d.BancNavigation).WithMany(p => p.BancTerms)
        ...
        modelBuilder.Entity<BancTransferBeneficiari>(entity =>
        {
            ...
            entity.ToTable("BancTransferBeneficiari", tb => tb.HasComment("Transfer beneficiaries and amounts"));
            ...
            entity.Property(e => e.Account)
                ...
                .HasDefaultValue("", "DF_BancTransferBeneficiari_Account");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_BancTransferBeneficiari_Cur");
            entity.Property(e => e.Eur)
            ...
            entity.HasOne(d => d.BankBranchNavigation).WithMany(p => p.BancTransferBeneficiaris)
                .HasForeignKey(d => d.BankBranch)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BancTransferBeneficiari_BN2");

            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.BancTransferBeneficiaris)
                .HasForeignKey(d => d.Contact)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BancTransferBeneficiari_CliGral");

            entity.HasOne(d => d.PoolNavigation).WithMany(p => p.BancTransferBeneficiaris)
        ...
        modelBuilder.Entity<BancTransferPool>(entity =>
        {
            ...
            entity.ToTable("BancTransferPool", tb => tb.HasComment("Sets of bank transfers"));

            entity.HasIndex(e => e.Cca, "IX_BancTransferPool_Cca").IsUnique();
            ...
            entity.HasOne(d => d.BancEmissorNavigation).WithMany(p => p.BancTransferPools)
                .HasForeignKey(d => d.BancEmissor)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_BancTransferPool_CliBnc");

            entity.HasOne(d => d.CcaNavigation).WithOne(p => p.BancTransferPool)
        ...
        modelBuilder.Entity<Banner>(entity =>
        {
            ...
            entity.ToTable("Banner", tb => tb.HasComment("Website home page banners"));
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Banner_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchFrom)
                .HasComment("Date to be published from")
                .HasDefaultValueSql("(getdate())", "DF_Banner_FchFrom")
                .HasColumnType("datetime");
            entity.Property(e => e.FchTo)
        ...
        modelBuilder.Entity<BlogPost>(entity =>
        {
            ...
            entity.ToTable("BlogPost", tb => tb.HasComment("Blog posts"));
            ...
            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.BlogPostUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_BlogPost_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.BlogPostUsrLastEditedNavigations)
        ...
        modelBuilder.Entity<Blogger>(entity =>
        {
            ...
            entity.ToTable("Blogger", tb => tb.HasComment("External blog authors"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Blogger_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.AuthorNavigation).WithMany(p => p.Bloggers)
        ...
        modelBuilder.Entity<Bloggerpost>(entity =>
        {
            ...
            entity.ToTable("Bloggerpost", tb => tb.HasComment("Posts of interest from external bloggers"));

            entity.HasIndex(e => new { e.Blogger, e.Fch }, "IX_Bloggerpost_Blogger_fch").IsDescending(false, true);

            entity.Property(e => e.Guid)
                .ValueGeneratedNever()
                .HasComment("Primary key");
            entity.Property(e => e.Blogger).HasComment("Foreign key to parent table Blogger");
            entity.Property(e => e.Fch).HasComment("Post date");
            entity.Property(e => e.HighlightFrom).HasComment("Date to start publishing on our website");
            entity.Property(e => e.HighlightTo).HasComment("Date to terminate publication on our website");
            entity.Property(e => e.Lang)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasComment("ISO 639-2 language code (3 digits)")
                .HasDefaultValue("ESP", "DF_Bloggerpost_Lang");
            entity.Property(e => e.Title)
                .HasMaxLength(200)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.BloggerNavigation).WithMany(p => p.Bloggerposts)
        ...
        modelBuilder.Entity<BloggerpostProduct>(entity =>
        {
            ...
            entity.ToTable("BloggerpostProduct", tb => tb.HasComment("Product promoted on a blogger post"));
            ...
            entity.HasOne(d => d.PostNavigation).WithMany(p => p.BloggerpostProducts)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_BN1_1");

            entity.ToTable("Bn1", tb => tb.HasComment("Bank entities"));

            entity.HasIndex(e => new { e.Country, e.Bn11 }, "IX_BN1_Country_Id");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_BN1_GUID");
            entity.Property(e => e.Abr)
                .HasMaxLength(20)
                .HasComment("Bank friendly name")
                .HasDefaultValue("", "DF_BN1_ABR");
            ...
            entity.Property(e => e.Svg).IsUnicode(false);
            entity.Property(e => e.Swift)
                .HasMaxLength(11)
                .IsUnicode(false)
                .HasComment("Swift (BIC) code")
                .HasDefaultValue("", "DF_BN1_SWIFT");
            entity.Property(e => e.Tel)
                .HasMaxLength(20)
                .HasComment("Default bank phone number")
                .HasDefaultValue("", "DF_BN1_TEL");
            entity.Property(e => e.Web)
                .HasMaxLength(60)
                .IsUnicode(false)
                .HasComment("Website")
                .HasDefaultValue("", "DF_BN1_WEB");
        });

        modelBuilder.Entity<Bn2>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_BN2");

            entity.ToTable("Bn2", tb => tb.HasComment("Bank branches"));

            entity.HasIndex(e => new { e.Bank, e.Agc }, "IX_BN2_Bank_Id").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_BN2_Guid");
            entity.Property(e => e.Adr)
                .HasMaxLength(50)
                .HasComment("Address (street and number). Free text")
                .HasDefaultValue("", "DF_BN2_adr");
            ...
            entity.Property(e => e.Tel)
                ...
                .HasDefaultValue("", "DF_BN2_tel");

            entity.HasOne(d => d.BankNavigation).WithMany(p => p.Bn2s)
                .HasForeignKey(d => d.Bank)
                .HasConstraintName("FK_BN2_BN1");

            entity.HasOne(d => d.LocationNavigation).WithMany(p => p.Bn2s)
        ...
        {
            entity.HasKey(e => e.CcaGuid).HasName("PK_BookFras2");

            entity.ToTable(tb => tb.HasComment("Received invoices book, including SII (Suministro inmediato de información) data"));
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_BookFras_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FraNum)
                .HasMaxLength(18)
                .IsUnicode(false)
                .HasComment("Invoice number")
                .HasDefaultValue("", "DF_BookFras_FraNum");
            ...
            entity.Property(e => e.TipoFra)
                ...
                .HasDefaultValue("F1", "DF_BookFras_TipoFra");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_BrandArea_1");

            entity.ToTable("BrandArea", tb => tb.HasComment("Geographical distribution areas agreed with the manufacturer for each product brand"));

            entity.HasIndex(e => new { e.Brand, e.Area, e.FchFrom }, "IX_BrandArea_Brand_Area_Fch").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_BrandArea_Guid");
            ...
            entity.Property(e => e.FchFrom).HasComment("Date of the agreement");
            entity.Property(e => e.FchTo).HasComment("Date of termination");

            entity.HasOne(d => d.BrandNavigation).WithMany(p => p.BrandAreas)
        ...
        modelBuilder.Entity<CategoriaDeNoticium>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("News categories"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CCA");

            entity.ToTable("Cca", tb => tb.HasComment("Account entries"));

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Cca1 }, "IX_CCA_EmpYeaCca").IsUnique();
            ...
            entity.Property(e => e.Docfile)
                ...
                .IsFixedLength();
            entity.Property(e => e.Emp).HasComment("Company; foreign key for Emp table");
            entity.Property(e => e.Fch).HasComment("Entry date");
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time the entry was registered")
                .HasDefaultValueSql("(getdate())", "DF_CCA_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date and time the entry was last updated")
                .HasDefaultValueSql("(getdate())", "DF_CCA_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Ccas)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Cca_Emp");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.Ccas)
                .HasForeignKey(d => d.Hash)
                .HasConstraintName("FK_Cca_DocFile");

            entity.HasOne(d => d.ProjecteNavigation).WithMany(p => p.Ccas)
                .HasForeignKey(d => d.Projecte)
                .HasConstraintName("FK_Cca_Projecte");

            entity.HasOne(d => d.UsrCreated).WithMany(p => p.CcaUsrCreateds)
                .HasForeignKey(d => d.UsrCreatedGuid)
                .HasConstraintName("FK_Cca_UsrCreated");

            entity.HasOne(d => d.UsrLastEdited).WithMany(p => p.CcaUsrLastEditeds)
                .HasForeignKey(d => d.UsrLastEditedGuid)
                .HasConstraintName("FK_Cca_UsrLastEdited");
        });

        modelBuilder.Entity<CcaSched>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("CcaSched");

            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_CcaSched_Guid");
            entity.Property(e => e.Concept)
                .HasMaxLength(62)
                .IsUnicode(false);
            entity.Property(e => e.Emp).HasDefaultValue(1, "DF_CcaSched_Emp");
            entity.Property(e => e.FreqDue).HasComment("Frequency due (day of month, day of week...)");
            entity.Property(e => e.FreqMod).HasComment("Frequency mode (monthly, weekly, daily...)");
            entity.Property(e => e.LastTime).HasColumnType("datetime");
        });

        modelBuilder.Entity<CcaSchedItem>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("CcaSchedItem");

            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_CcaSchedItem_Guid");
            entity.Property(e => e.Dh).HasDefaultValue(1, "DF_CcaSchedItem_Dh");
            entity.Property(e => e.Eur).HasColumnType("decimal(9, 2)");

            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.CcaSchedItems)
                .HasForeignKey(d => d.Contact)
                .HasConstraintName("FK_CcaSchedItem_CliGral");

            entity.HasOne(d => d.CtaNavigation).WithMany(p => p.CcaSchedItems)
                .HasForeignKey(d => d.Cta)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CcaSchedItem_PgcCta");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.CcaSchedItems)
                .HasForeignKey(d => d.Parent)
                .HasConstraintName("FK_CcaSchedItem_CcaSched");
        });

        modelBuilder.Entity<Ccb>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_CCB");

            entity.ToTable("Ccb", tb => tb.HasComment("Account entry items"));

            entity.HasIndex(e => e.ContactGuid, "IX_CCB_ContactGuid");

            entity.HasIndex(e => e.CcaGuid, "IX_Ccb_CcaGuid");

            entity.HasIndex(e => new { e.CcaGuid, e.Lin }, "IX_Ccb_CcaLin").IsUnique();

            entity.HasIndex(e => new { e.CtaGuid, e.ContactGuid }, "IX_Ccb_CtaContact");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CCB_Guid_1");
            ...
            entity.HasOne(d => d.Cca).WithMany(p => p.Ccbs)
                .HasForeignKey(d => d.CcaGuid)
                .HasConstraintName("FK_CCB_CCA");

            entity.HasOne(d => d.Contact).WithMany(p => p.Ccbs)
                .HasForeignKey(d => d.ContactGuid)
                .HasConstraintName("FK_CCB_CliGral");

            entity.HasOne(d => d.Cta).WithMany(p => p.Ccbs)
                .HasForeignKey(d => d.CtaGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CertificatIrpf>(entity =>
        {
            ...
            entity.ToTable("CertificatIrpf", tb => tb.HasComment("Irpf tax withholdings certificates"));
            ...
            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.CertificatIrpfs)
                .HasForeignKey(d => d.Contact)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CertificatIrpf_CliGral");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.CertificatIrpfs)
                .HasForeignKey(d => d.Hash)
        ...
        modelBuilder.Entity<ChannelDto>(entity =>
        {
            ...
            entity.ToTable("ChannelDto", tb => tb.HasComment("Default discount over retail price for new customers from each distributioon channel. Used to generate price list"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_ChannelDto_Guid");
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ChannelDto_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");
            ...
            entity.HasOne(d => d.ChannelNavigation).WithMany(p => p.ChannelDtos)
        ...
        {
            entity.HasKey(e => new { e.SrcGuid, e.Cod }).HasName("PK_CliAdr_1");

            entity.ToTable("CliAdr", tb => tb.HasComment("Contact addresses"));
            ...
            entity.Property(e => e.GeoFont)
                ...
                .HasDefaultValue(0, "DF_CliAdr_GeoFont");
            ...
            entity.HasOne(d => d.ZipNavigation).WithMany(p => p.CliAdrs)
                .HasForeignKey(d => d.Zip)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CLI_APERTURAS");

            entity.ToTable("Cli_Aperturas", tb => tb.HasComment("Potential new customer application form"));
            ...
            entity.Property(e => e.Adr)
                ...
                .HasDefaultValue("", "DF_CLI_APERTURAS_Adr");
            ...
            entity.Property(e => e.Cit)
                ...
                .IsUnicode(false)
                .HasComment("Location")
                .HasDefaultValue("", "DF_CLI_APERTURAS_Cit");
            ...
            entity.Property(e => e.Email)
                ...
                .HasDefaultValue("", "DF_CLI_APERTURAS_email");
            entity.Property(e => e.FchApertura).HasComment("Launch date");
            entity.Property(e => e.FchCreated)
                .HasComment("Inquiry date")
                .HasDefaultValueSql("(getdate())", "DF_CLI_APERTURAS_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.IsoPais)
                ...
                .HasDefaultValue("ES", "DF_CLI_APERTURAS_IsoPais");
            entity.Property(e => e.Nif)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasComment("VAT number")
                .HasDefaultValue("", "DF_CLI_APERTURAS_Nif");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Contact person")
                .HasDefaultValue("", "DF_CLI_APERTURAS_Nom");
            entity.Property(e => e.NomComercial)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Commercial name")
                .HasDefaultValue("", "DF_CLI_APERTURAS_NomComercial");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");
            ...
            entity.Property(e => e.RaoSocial)
                ...
                .HasDefaultValue("", "DF_CLI_APERTURAS_RaoSocial");
            ...
            entity.Property(e => e.Tel)
                ...
                .HasDefaultValue("", "DF_CLI_APERTURAS_tel");
            entity.Property(e => e.Web)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Website url")
                .HasDefaultValue("", "DF_CLI_APERTURAS_web");
            entity.Property(e => e.Zip)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasComment("Zip code")
                .HasDefaultValue("", "DF_CLI_APERTURAS_Zip");
            entity.Property(e => e.ZonaGuid).HasComment("Country zone; foreign key for Zona table");

            entity.HasOne(d => d.ContactClassNavigation).WithMany(p => p.CliAperturas)
                .HasForeignKey(d => d.ContactClass)
                .HasConstraintName("FK_Cli_Aperturas_ContactClass");

            entity.HasOne(d => d.Zona).WithMany(p => p.CliAperturas)
                .HasForeignKey(d => d.ZonaGuid)
                .HasConstraintName("FK_Cli_Aperturas_Zona");

            entity.HasMany(d => d.Brands).WithMany(p => p.Aperturas)
                .UsingEntity<Dictionary<string, object>>(
                    "CliAperturasBrand",
                    r => r.HasOne<Tpa>().WithMany()
                        .HasForeignKey("Brand")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_Cli_Aperturas_Brands_TPA"),
                    l => l.HasOne<CliApertura>().WithMany()
                        .HasForeignKey("Apertura")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_Cli_Aperturas_Brands_Cli_Aperturas"),
                    j =>
                    {
                        j.HasKey("Apertura", "Brand");
                        j.ToTable("Cli_Aperturas_Brands", tb => tb.HasComment("Commercial brands potential new customers request to distribute"));
        ...
        modelBuilder.Entity<CliBnc>(entity =>
        {
            ...
            entity.ToTable("CliBnc", tb => tb.HasComment("Our banks"));
            ...
            entity.Property(e => e.ConditionsUnpayments)
                ...
                .HasDefaultValue("", "DF_CliBnc_CondsImpag")
                .HasColumnType("text");
            entity.Property(e => e.NormaRmecedent)
                .HasMaxLength(15)
                .IsUnicode(false)
                .HasComment("Id for remittances to Andorra")
                .HasDefaultValue("", "DF_CliBnc_NormaRMEcedent")
            ...
            entity.Property(e => e.TransferReceiptPreferencia)
                ...
                .HasDefaultValue(9, "DF_CliBnc_TransferReceiptPreferencia");

            entity.HasOne(d => d.Gu).WithOne(p => p.CliBnc)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CliCert_1");

            entity.ToTable("CliCert", tb => tb.HasComment("Digital Certificates"));
            ...
            entity.Property(e => e.Caduca)
                ...
                .HasDefaultValue(new DateTime(1900, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "DF_CliCert_CADUCA")
                .HasColumnType("datetime");
            entity.Property(e => e.DataMime).HasDefaultValue(33, "DF_CliCert_Mime");
            entity.Property(e => e.Ext)
                .HasMaxLength(4)
                .IsUnicode(false)
                .HasComment("File extension")
                .HasDefaultValue("", "DF_CliCert_EXT");
            entity.Property(e => e.Image)
                .HasComment("Signature image")
                .HasColumnType("image");
            entity.Property(e => e.ImageMime).HasDefaultValue(1, "DF_CliCert_ImageMime");
            ...
            entity.HasOne(d => d.Gu).WithOne(p => p.CliCert)
        ...
        modelBuilder.Entity<CliClient>(entity =>
        {
            ...
            entity.ToTable("CliClient", tb => tb.HasComment("Customers properties"));
            ...
            entity.Property(e => e.ExportCod)
                ...
                .HasDefaultValue(1, "DF_CliClient_ExportCod");
            ...
            entity.Property(e => e.SuProveedorNum)
                ...
                .HasDefaultValue("", "DF_CliClient_SuProveedorNum");
            ...
            entity.HasOne(d => d.Ccx).WithMany(p => p.InverseCcx)
                .HasForeignKey(d => d.CcxGuid)
                .HasConstraintName("FK_CliClient_Ccx");

            entity.HasOne(d => d.Gu).WithOne(p => p.CliClient)
                .HasForeignKey<CliClient>(d => d.Guid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliClient_CliGral");

            entity.HasOne(d => d.HoldingNavigation).WithMany(p => p.CliClients)
                .HasForeignKey(d => d.Holding)
                .HasConstraintName("FK_CliClient_Holding");

            entity.HasOne(d => d.IncotermNavigation).WithMany(p => p.CliClients)
        ...
        modelBuilder.Entity<CliContact>(entity =>
        {
            ...
            entity.ToTable("CliContact", tb => tb.HasComment("Those contacts who are Companies may need to list individual contact person names with their positions. This table is the place to store them"));
            ...
            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.CliContacts)
                .HasForeignKey(d => d.ContactGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CliCreditLog>(entity =>
        {
            ...
            entity.ToTable("CliCreditLog", tb => tb.HasComment("Customer credit updates"));

            entity.HasIndex(e => new { e.CliGuid, e.FchCreated }, "IX_CliCreditLog_CliGuid_FchCreated");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CliCreditLog_Guid");
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_CliCreditLog_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_CliCreditLog_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
            ...
            entity.HasOne(d => d.Cli).WithMany(p => p.CliCreditLogs)
                .HasForeignKey(d => d.CliGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliCreditLog_CliGral");

            entity.HasOne(d => d.UserCreatedNavigation).WithMany(p => p.CliCreditLogUserCreatedNavigations)
                .HasForeignKey(d => d.UserCreated)
                .HasConstraintName("FK_CliCreditLog_UsrCreated");

            entity.HasOne(d => d.UserLastEditedNavigation).WithMany(p => p.CliCreditLogUserLastEditedNavigations)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CLIDOCS");

            entity.ToTable("CliDoc", tb => tb.HasComment("Contact documentation"));
            ...
            entity.Property(e => e.Docfile)
                ...
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Fch).HasComment("Document date");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength()
            ...
            entity.Property(e => e.Ref)
                ...
                .HasDefaultValue("", "DF_CLIDOCS_ref");
            entity.Property(e => e.Type).HasComment("Enumerable DTOContactDoc.Types (1.Nif, 2.Deed...)");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.CliDocs)
                .HasForeignKey(d => d.Hash)
        ...
        {
            entity.HasKey(e => new { e.Customer, e.Brand }).HasName("PK_CLIDTO");

            entity.ToTable("CliDto", tb => tb.HasComment("Fix discount some customers may have granted in certain product ranges"));
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.CliDtos)
        ...
        modelBuilder.Entity<CliGral>(entity =>
        {
            ...
            entity.ToTable("CliGral", tb => tb.HasComment("Contacts"));

            entity.HasIndex(e => new { e.Emp, e.Cli }, "IX_CLIGRAL_EmpCli").IsUnique();
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CliGral_Guid");
            entity.Property(e => e.Alias)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Friendly name")
                .HasDefaultValue("", "DF_CliGral_Alias");
            ...
            entity.Property(e => e.LangId)
                ...
                .HasDefaultValue("ESP", "DF_CliGral_LangId");
            entity.Property(e => e.Nif)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasComment("Primary tax id number (usually VAT number)")
                .HasDefaultValue("", "DF_CliGral_NIF")
                .HasColumnName("NIF");
            ...
            entity.Property(e => e.RaoSocial)
                ...
                .HasDefaultValue("", "DF_CliGral_RaoSocial");
            entity.Property(e => e.Rol)
                .HasComment("Default rol for this contact users. Enumerable DTORol.Ids")
                .HasDefaultValue((short)20, "DF_CliGral_Rol");
            entity.Property(e => e.Web)
                .HasComment("Website address")
                .HasDefaultValue("", "DF_CliGral_Web")
                .HasColumnType("text");

            entity.HasOne(d => d.ContactClassNavigation).WithMany(p => p.CliGrals)
                .HasForeignKey(d => d.ContactClass)
                .HasConstraintName("FK_CliGral_ContactClass");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.CliGrals)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliGral_Emp");

            entity.HasOne(d => d.NomAnterior).WithMany(p => p.InverseNomAnterior)
                .HasForeignKey(d => d.NomAnteriorGuid)
                .HasConstraintName("FK_CliGral_NomAnterior");

            entity.HasOne(d => d.NomNou).WithMany(p => p.InverseNomNou)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CliPrv_1");

            entity.ToTable("CliPrv", tb => tb.HasComment("Suppliers"));
            ...
            entity.Property(e => e.Cur)
                ...
                .HasDefaultValue("EUR", "DF_CliPrv_cur");
            ...
            entity.Property(e => e.Incoterm)
                ...
                .HasDefaultValue("FOB", "DF_CliPrv_Incoterm");
            ...
            entity.HasOne(d => d.CtaCarrecNavigation).WithMany(p => p.CliPrvCtaCarrecNavigations)
                .HasForeignKey(d => d.CtaCarrec)
                .HasConstraintName("FK_CliPrv_PgcCta");

            entity.HasOne(d => d.CtaCreditoraNavigation).WithMany(p => p.CliPrvCtaCreditoraNavigations)
                .HasForeignKey(d => d.CtaCreditora)
                .HasConstraintName("FK_CliPrv_PgcCtaCreditora");

            entity.HasOne(d => d.Gu).WithOne(p => p.CliPrv)
        ...
        modelBuilder.Entity<CliRep>(entity =>
        {
            ...
            entity.ToTable("CliRep", tb => tb.HasComment("Commercial agents (Reps) details"));
            ...
            entity.Property(e => e.Iva)
                ...
                .HasDefaultValue((byte)1, "DF_CliRep_IVA")
                .HasColumnName("IVA");
            entity.Property(e => e.Obsoleto).HasComment("Outdated account, no longer active");

            entity.HasOne(d => d.Ccx).WithMany(p => p.CliRepCcxes)
                .HasForeignKey(d => d.CcxGuid)
                .HasConstraintName("FK_CliRep_Ccx");

            entity.HasOne(d => d.Gu).WithOne(p => p.CliRepGu)
        ...
        modelBuilder.Entity<CliReturn>(entity =>
        {
            ...
            entity.ToTable("CliReturn", tb => tb.HasComment("Warehouse reception of customer returns"));

            entity.HasIndex(e => e.FchCreated, "IX_CliReturns_FchCreated").IsDescending();
            ...
            entity.Property(e => e.Bultos)
                ...
                .HasDefaultValue(1, "DF_CliReturn_Bultos");
            ...
            entity.Property(e => e.Fch).HasComment("Reception date");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_CliReturn_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited last time")
                .HasDefaultValueSql("(getdate())", "DF_CliReturn_FchLastEdited")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.CliNavigation).WithMany(p => p.CliReturnCliNavigations)
                .HasForeignKey(d => d.Cli)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliReturn_Cli");

            entity.HasOne(d => d.EntradaNavigation).WithMany(p => p.CliReturns)
                .HasForeignKey(d => d.Entrada)
                .HasConstraintName("FK_CliReturn_Alb");

            entity.HasOne(d => d.MgzNavigation).WithMany(p => p.CliReturnMgzNavigations)
                .HasForeignKey(d => d.Mgz)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliReturn_Mgz");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.CliReturnUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliReturn_EmailUsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.CliReturnUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<CliStaff>(entity =>
        {
            ...
            entity.ToTable("CliStaff", tb => tb.HasComment("Employees"));
            ...
            entity.Property(e => e.Abr)
                ...
                .IsUnicode(false)
                .HasComment("Friendly name")
                .HasDefaultValue("", "DF_CliStaff_Abr");
            ...
            entity.Property(e => e.NumSs)
                ...
                .HasDefaultValue("", "DF_CliStaff_NumSS")
                .HasColumnName("NumSS");
            ...
            entity.HasOne(d => d.CategoriaNavigation).WithMany(p => p.CliStaffs)
                .HasForeignKey(d => d.Categoria)
                .HasConstraintName("FK_CliStaff_StaffCategory");

            entity.HasOne(d => d.Gu).WithOne(p => p.CliStaff)
                .HasForeignKey<CliStaff>(d => d.Guid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliStaff_CliGral");

            entity.HasOne(d => d.StaffPosNavigation).WithMany(p => p.CliStaffs)
        ...
        modelBuilder.Entity<CliTel>(entity =>
        {
            ...
            entity.ToTable("CliTel", tb => tb.HasComment("Contact phone numbers"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CliTel_Guid");
            ...
            entity.Property(e => e.Num)
                ...
                .IsUnicode(false)
                .HasComment("Phone number")
                .HasDefaultValue("", "DF_CliTel_num");
            entity.Property(e => e.Obs)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Comments; usually the owner person")
                .HasDefaultValue("", "DF_CliTel_obs");
            entity.Property(e => e.Ord)
                .HasComment("Sort order")
                .HasDefaultValue((short)99, "DF_CliTel_Ord");
            ...
            entity.HasOne(d => d.Cli).WithMany(p => p.CliTels)
                .HasForeignKey(d => d.CliGuid)
                .HasConstraintName("FK_CliTel_CliGral");

            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.CliTels)
        ...
        {
            entity.HasKey(e => new { e.CliGuid, e.ProductGuid }).HasName("PK_CLITPA");

            entity.ToTable("CliTpa", tb => tb.HasComment("Customer product ranges"));
            ...
            entity.Property(e => e.Obs)
                ...
                .HasDefaultValue("", "DF_CLITPA_Obs")
                .HasColumnType("text");
            entity.Property(e => e.Zip)
                .HasMaxLength(5)
                .IsUnicode(false)
                .HasComment("Postal code in case it takes area exclusivity")
                .HasDefaultValue("", "DF_CLITPA_Zip");

            entity.HasOne(d => d.Cli).WithMany(p => p.CliTpas)
                .HasForeignKey(d => d.CliGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Cll1, e.ContactGuid, e.Cod }).HasName("PK_CLL");

            entity.ToTable("Cll", tb => tb.HasComment("Contact search keys"));
            ...
            entity.Property(e => e.Cll1)
                ...
                .HasColumnName("Cll");
            entity.Property(e => e.ContactGuid).HasComment("Foreign key for CliGral table");
            entity.Property(e => e.Cod).HasComment("Enumerable DTOContact.ContactKeys (0.Name, 3.Location, 4.Commercial name, 26.Custom search key)");

            entity.HasOne(d => d.Contact).WithMany(p => p.Clls)
                .HasForeignKey(d => d.ContactGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CLX");

            entity.ToTable("Clx", tb => tb.HasComment("Contact logos"));
            ...
            entity.HasOne(d => d.Gu).WithOne(p => p.Clx)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CNAP");

            entity.ToTable("Cnap", tb => tb.HasComment("Product classification by function. Clasificacion Normalizada de Artículos de Puericultura"));

            entity.HasIndex(e => e.Id, "IX_CNAP_Deprecated_Id").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CNAP_Guid");
        ...
        modelBuilder.Entity<Cod>(entity =>
        {
            ...
            entity.ToTable("Cod", tb => tb.HasComment("Multi purpose codes"));

            entity.HasIndex(e => new { e.Parent, e.Id }, "Idx_Cod_ParentOrd");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Cod_Guid");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Cod_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.Cods)
                .HasForeignKey(d => d.UsrCreated)
        ...
        {
            entity.ToTable(tb => tb.HasComment("Customs codes for products"));
        ...
        modelBuilder.Entity<Comarca>(entity =>
        {
            ...
            entity.ToTable("Comarca", tb => tb.HasComment("County details. A County is an optional area inside a Zona"));

            entity.Property(e => e.Guid)
                .HasComment("Primary Key")
                .HasDefaultValueSql("(newid())", "DF_Comarca_Guid");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.ZonaNavigation).WithMany(p => p.Comarcas)
        ...
        modelBuilder.Entity<Computer>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_Computer_Guid");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<Cond>(entity =>
        {
            ...
            entity.ToTable("Cond", tb => tb.HasComment("Commercial terms and conditions"));
        ...
        modelBuilder.Entity<CondCapitol>(entity =>
        {
            ...
            entity.ToTable("CondCapitol", tb => tb.HasComment("Terms and conditions chapters"));
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_CondCapitol_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date and time this chapter was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_CondCapitol_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Ord)
                .HasComment("Chapter order")
                .HasDefaultValue(999, "DF_CondCapitol_Ord");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.CondCapitols)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CondCapitol_Cond");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.CondCapitolUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_CondCapitol_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.CondCapitolUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_MarketPlace");

            entity.ToTable("ConsumerTicket", tb => tb.HasComment("Sale operation to consumer"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_MarketPlace_Guid");
            ...
            entity.Property(e => e.Emp).HasComment("Company; foreign key for Emp table");
            entity.Property(e => e.Fch).HasComment("Ticket date");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_MarketPlace_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Lang)
                ...
                .IsFixedLength()
                .HasComment("ISO 639-2 language code")
                .HasDefaultValue("ESP", "DF_ConsumerTicket_Lang");
            ...
            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.ConsumerTickets)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ConsumerTicket_Email");
        });
        ...
        modelBuilder.Entity<ContactClass>(entity =>
        {
            ...
            entity.ToTable("ContactClass", tb => tb.HasComment("Contact activity classification"));
            ...
            entity.Property(e => e.Ord)
                .HasComment("Sort order")
                .HasDefaultValue(999, "DF_ContactClass_Ord");
            ...
            entity.HasOne(d => d.DistributionChannelNavigation).WithMany(p => p.ContactClasses)
        ...
        {
            entity.HasKey(e => e.Gln).HasName("PK_ContactGln");

            entity.ToTable("ContactGln_Deprecated");

            entity.HasIndex(e => e.Contact, "ContactGln_Contact").HasFilter("([Contact] IS NOT NULL)");
            ...
            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.ContactGlnDeprecateds)
                .HasForeignKey(d => d.Contact)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_ContactMessge");

            entity.ToTable("ContactMessage", tb => tb.HasComment("Web visitor contact messages"));
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ContactMessge_FchCreated")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<Content>(entity =>
        {
            ...
            entity.ToTable("Content", tb => tb.HasComment("Brand content for websites, Html formatted. Text stored in LangText table"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Content_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Visible)
                .HasComment("Visible if true")
                .HasDefaultValue(true, "DF_Content_vISIBLE");
        });

        modelBuilder.Entity<ContentUrl>(entity =>
        {
            entity.HasKey(e => new { e.Target, e.Lang }).HasName("PK_ContentUrl_1");

            entity.ToTable("ContentUrl");

            entity.HasIndex(e => e.UrlSegment, "IX_ContentUrl_Segment");

            entity.Property(e => e.Target).HasDefaultValueSql("(newid())", "DF_ContentUrl_Target");
            entity.Property(e => e.Lang)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("ESP", "DF_ContentUrl_Lang");
            entity.Property(e => e.UrlSegment)
                .HasMaxLength(150)
                .IsUnicode(false)
                .HasDefaultValue("", "DF_ContentUrl_UrlSegment");
        });

        modelBuilder.Entity<Contract>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_CONTRACT");

            entity.ToTable("Contract", tb => tb.HasComment("Contracts"));
            ...
            entity.Property(e => e.Docfile)
                ...
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Emp).HasDefaultValue(1, "DF_Contract_Emp");
            entity.Property(e => e.FchFrom).HasComment("Contract effective date");
            entity.Property(e => e.FchTo).HasComment("Contract expiry date");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength()
            ...
            entity.Property(e => e.Nom)
                ...
                .IsUnicode(false)
                .HasComment("Friendly name")
                .HasDefaultValue("", "DF_CONTRACT_Nom");
            entity.Property(e => e.Num)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Contract number")
                .HasDefaultValue("", "DF_CONTRACT_Num");

            entity.HasOne(d => d.Codi).WithMany(p => p.Contracts)
                .HasForeignKey(d => d.CodiGuid)
                .HasConstraintName("FK_Contract_Contract_Codis");

            entity.HasOne(d => d.Contact).WithMany(p => p.Contracts)
                .HasForeignKey(d => d.ContactGuid)
                .HasConstraintName("FK_Contract_CliGral");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.Contracts)
                .HasForeignKey(d => d.Hash)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_Contract_Codis_1");

            entity.ToTable("Contract_Codis", tb => tb.HasComment("Contract purposes"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Contract_Codis_Guid");
        ...
        modelBuilder.Entity<Country>(entity =>
        {
            ...
            entity.ToTable("Country", tb => tb.HasComment("Countries"));

            entity.HasIndex(e => e.Iso, "IX_COUNTRY_ISO").IsUnique();
            ...
            entity.Property(e => e.LangIso)
                ...
                .HasDefaultValue("ENG", "DF_Country_LangISO")
            ...
            entity.Property(e => e.NomPor)
                ...
                .HasDefaultValue("", "DF_Country_Nom_Por")
        ...
        modelBuilder.Entity<Credencial>(entity =>
        {
            ...
            entity.ToTable("Credencial", tb => tb.HasComment("User credentials to sign in partners systems"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Credencial_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_Credencial_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");
            ...
            entity.Property(e => e.Referencia)
                ...
                .HasDefaultValue("", "DF_Credencial_Referencia");
            entity.Property(e => e.Url)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasComment("Landing page")
                .HasDefaultValue("", "DF_Credencial_Url");
            entity.Property(e => e.UsrCreated).HasComment("User who created this entry");
            entity.Property(e => e.UsrLastEdited).HasComment("User who edited this entry for last time");
            ...
            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.Credencials)
                .HasForeignKey(d => d.Contact)
                .HasConstraintName("FK_Credencial_CliGral");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.CredencialUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Credencial_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.CredencialUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Credencial_Email");

            entity.HasMany(d => d.Owners).WithMany(p => p.Credencials)
                .UsingEntity<Dictionary<string, object>>(
                    "CredencialOwner",
                    r => r.HasOne<Email>().WithMany()
                        .HasForeignKey("Owner")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_CredencialOwner_Email"),
                    l => l.HasOne<Credencial>().WithMany()
                        .HasForeignKey("Credencial")
                        .HasConstraintName("FK_CredencialOwner_Credencial"),
                    j =>
                    {
                        j.HasKey("Credencial", "Owner");
                        j.ToTable("CredencialOwner", tb => tb.HasComment("Users with read, write and delete permissions to credentials"));
            ...
            entity.HasMany(d => d.Rols).WithMany(p => p.Credencials)
                .UsingEntity<Dictionary<string, object>>(
                    "CredencialRol",
                    r => r.HasOne<UsrRol>().WithMany()
                        .HasForeignKey("Rol")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_CredencialRol_UsrRols"),
                    l => l.HasOne<Credencial>().WithMany()
                        .HasForeignKey("Credencial")
                        .HasConstraintName("FK_CredencialRol_Credencial"),
                    j =>
                    {
                        j.HasKey("Credencial", "Rol");
                        j.ToTable("CredencialRol", tb => tb.HasComment("Rols with readonly permissions to credentials"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CRR");

            entity.ToTable("Crr", tb => tb.HasComment("Correspondence documents"));

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Crr1 }, "IX_CRR");

            entity.HasIndex(e => new { e.Emp, e.Fch }, "IX_CRR_Fch").IsDescending(false, true);

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CRR_Guid");
            entity.Property(e => e.Atn)
                .HasMaxLength(30)
                .HasComment("Destination person")
                .HasDefaultValue("", "DF_CRR_atn");
            ...
            entity.Property(e => e.Dsc)
                .HasMaxLength(255)
                .HasComment("Subject")
                .HasDefaultValue("", "DF_CRR_dsc");
            entity.Property(e => e.Emp)
                .HasComment("Company; foreign key for Emp table")
                .HasDefaultValue(1, "DF_Crr_Emp");
            entity.Property(e => e.Fch).HasComment("Date of issue/reception");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Crr_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_Crr_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Crrs)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Crr_Emp");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.Crrs)
                .HasForeignKey(d => d.Hash)
                .HasConstraintName("FK_Crr_DocFile");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.CrrUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_Crr_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.CrrUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
                .HasConstraintName("FK_Crr_UsrLastEdited");

            entity.HasMany(d => d.Clis).WithMany(p => p.Mail)
                .UsingEntity<Dictionary<string, object>>(
                    "CrrCli",
                    r => r.HasOne<CliGral>().WithMany()
                        .HasForeignKey("CliGuid")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_CrrCli_CliGral"),
                    l => l.HasOne<Crr>().WithMany()
                        .HasForeignKey("MailGuid")
                        .HasConstraintName("FK_CrrCli_CRR"),
                    j =>
                    {
                        j.HasKey("MailGuid", "CliGuid");
                        j.ToTable("CrrCli", tb => tb.HasComment("Contacts receiving or sending correspondence"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CSA");

            entity.ToTable("Csa", tb => tb.HasComment("Bank remittances (remesas de efectos bancarios al cobro o al descuento)"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CSA_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_CSA_Cur");
            ...
            entity.HasOne(d => d.Banc).WithMany(p => p.Csas)
                .HasForeignKey(d => d.BancGuid)
                .HasConstraintName("FK_CSA_CliBnc");

            entity.HasOne(d => d.Cca).WithMany(p => p.Csas)
                .HasForeignKey(d => d.CcaGuid)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CSB");

            entity.ToTable("Csb", tb => tb.HasComment("Bank remittance items (efectos de las remesas bancarias)"));

            entity.HasIndex(e => new { e.CsaGuid, e.Doc }, "IX_CSB_CsaDoc");

            entity.HasIndex(e => e.SepaMandato, "IX_CSB_Mandato");

            entity.HasIndex(e => e.Vto, "IX_CSB_Vto").IsDescending();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CSB_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_CSB_cur");
            ...
            entity.HasOne(d => d.Cli).WithMany(p => p.Csbs)
                .HasForeignKey(d => d.CliGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Csb_CliGral");

            entity.HasOne(d => d.Csa).WithMany(p => p.Csbs)
                .HasForeignKey(d => d.CsaGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CSB_CSA");

            entity.HasOne(d => d.SepaMandatoNavigation).WithMany(p => p.Csbs)
        ...
        {
            entity.HasKey(e => e.Tag).HasName("PK_CURRENCY");

            entity.ToTable("Cur", tb => tb.HasComment("Currency"));
        ...
        modelBuilder.Entity<CurExchangeRate>(entity =>
        {
            ...
            entity.ToTable("CurExchangeRate", tb => tb.HasComment("Currency Exchange rates"));

            entity.HasIndex(e => new { e.Iso, e.Fch }, "CurExchangeRate_IDX_ISO_Fch").IsUnique();
        ...
        modelBuilder.Entity<CustomerCluster>(entity =>
        {
            ...
            entity.ToTable("CustomerCluster", tb => tb.HasComment("Cluster definitions for a certain holding"));
            ...
            entity.HasOne(d => d.HoldingNavigation).WithMany(p => p.CustomerClusters)
                .HasForeignKey(d => d.Holding)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerCluster_Holding");
        });

        modelBuilder.Entity<CustomerDept>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("CustomerDept");

            entity.HasIndex(e => new { e.Customer, e.Cod }, "IX_CustomerCod").IsUnique();
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.CustomerDepts)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerDept_CliGral");
        });

        modelBuilder.Entity<CustomerDeptItem>(entity =>
        {
            entity.HasKey(e => new { e.Parent, e.Product });

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.CustomerDeptItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerDeptItems_CustomerDept");
        });
        ...
        modelBuilder.Entity<CustomerDto>(entity =>
        {
            ...
            entity.ToTable("CustomerDto", tb => tb.HasComment("Discount from Retail Price list VAT included a customer gets for a product range in order to generate his cost price list VAT excluded. Newer entries always override older entries for each customer and product range"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CustomerDto_Guid");
            entity.Property(e => e.Customer).HasComment("Foreign key for CliGral table");
            entity.Property(e => e.Dto)
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.CustomerDtos)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerDto_CliGral");
        });

        modelBuilder.Entity<CustomerInvoiceTemplate>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("CustomerInvoiceTemplate");

            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_CustomerInvoiceTemplate_Guid");
            entity.Property(e => e.Cur)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("EUR", "DF_CustomerInvoiceTemplate_Cur");
            entity.Property(e => e.IrpfPct).HasColumnType("decimal(4, 2)");
            entity.Property(e => e.IvaPct).HasColumnType("decimal(4, 2)");
            entity.Property(e => e.Lang)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("CAT", "DF_CustomerInvoiceTemplate_Lang");
            entity.Property(e => e.Tag)
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.VfConcept)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.VfTaxException)
                .HasMaxLength(2)
                .IsUnicode(false);
            entity.Property(e => e.VfTaxScheme)
                .HasMaxLength(2)
                .IsUnicode(false);
            entity.Property(e => e.VfTaxType)
                .HasMaxLength(2)
                .IsUnicode(false);
        });

        modelBuilder.Entity<CustomerInvoiceTemplateItem>(entity =>
        {
            entity.HasKey(e => new { e.Template, e.Cod, e.Lin }).HasName("PK_CustomerInvoiceTemplateItem_1");

            entity.ToTable("CustomerInvoiceTemplateItem");
            ...
            entity.HasOne(d => d.TemplateNavigation).WithMany(p => p.CustomerInvoiceTemplateItems)
                .HasForeignKey(d => d.Template)
                .HasConstraintName("FK_CustomerInvoiceTemplateItem_CustomerInvoiceTemplate1");
        });
        ...
        modelBuilder.Entity<CustomerPlatform>(entity =>
        {
            ...
            entity.ToTable("CustomerPlatform", tb => tb.HasComment("Delivery platforms available per customer"));
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.CustomerPlatformCustomerNavigations)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerPlatform_Customer");

            entity.HasOne(d => d.Gu).WithOne(p => p.CustomerPlatformGu)
        ...
        modelBuilder.Entity<CustomerPlatformDestination>(entity =>
        {
            ...
            entity.ToTable("CustomerPlatformDestination", tb => tb.HasComment("Destination centers covered by each delivery platform"));
            ...
            entity.HasOne(d => d.PlatformNavigation).WithMany(p => p.CustomerPlatformDestinations)
                .HasForeignKey(d => d.Platform)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CustomerPlatformDestination_Destination");

            entity.HasOne(d => d.Platform1).WithMany(p => p.CustomerPlatformDestinations)
                .HasForeignKey(d => d.Platform)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Default>(entity =>
        {
            ...
            entity.ToTable("Default", tb => tb.HasComment("Stores system default values"));
        ...
        {
            entity.ToTable("DefaultImage", tb => tb.HasComment("Default images for certain occasions"));
        ...
        modelBuilder.Entity<DeliveryShipment>(entity =>
        {
            ...
            entity.ToTable("DeliveryShipment", tb => tb.HasComment("Log provided by our logistic center reporting delivery packages contents"));
            ...
            entity.HasOne(d => d.LogNavigation).WithMany(p => p.DeliveryShipments)
        ...
        modelBuilder.Entity<DeliveryTracking>(entity =>
        {
            ...
            entity.ToTable("DeliveryTracking", tb => tb.HasComment("Log provided by our logistic center reporting package transport tracking and costs"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_DeliveryTracking_Guid");
            entity.Property(e => e.Cost)
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.DeliveryTrackings)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DeliveryTracking_Emp");

            entity.HasOne(d => d.LogNavigation).WithMany(p => p.DeliveryTrackings)
                .HasForeignKey(d => d.Log)
        ...
        modelBuilder.Entity<Dept>(entity =>
        {
            ...
            entity.ToTable("Dept", tb => tb.HasComment("Product departments, to group brand categories into functional groups more intuitive for consumers"));
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Dept_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this record was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_Dept_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Obsoleto).HasComment("Outdated if true");
            entity.Property(e => e.Ord)
                .HasComment("Department sort order")
                .HasDefaultValue(99, "DF_Dept_Ord");

            entity.HasOne(d => d.BrandNavigation).WithMany(p => p.Depts)
                .HasForeignKey(d => d.Brand)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Dept_TPA");

            entity.HasMany(d => d.Cnaps).WithMany(p => p.Depts)
                .UsingEntity<Dictionary<string, object>>(
                    "DeptCnap",
                    r => r.HasOne<Cnap>().WithMany()
                        .HasForeignKey("Cnap")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_DeptCnap_Cnap"),
                    l => l.HasOne<Dept>().WithMany()
                        .HasForeignKey("Dept")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_DeptCnap_Dept"),
                    j =>
                    {
                        j.HasKey("Dept", "Cnap");
                        j.ToTable("DeptCnap", tb => tb.HasComment("Relates Product departments with product functionalities as per classification Cnap"));
        ...
        modelBuilder.Entity<DistributionChannel>(entity =>
        {
            ...
            entity.ToTable("DistributionChannel", tb => tb.HasComment("Distribution channels"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_DistributionChannel_Guid");
            entity.Property(e => e.ConsumerPriority)
                .HasComment("Priority when displayed to consumer")
                .HasDefaultValue(999, "DF_DistributionChannel_PuntDeVenda");
            entity.Property(e => e.NomCat)
                .HasMaxLength(50)
                .IsUnicode(false)
            ...
            entity.Property(e => e.Ord)
                .HasComment("Sort order")
                .HasDefaultValue(999, "DF_DistributionChannel_Ord");
        });
        ...
        modelBuilder.Entity<DocFile>(entity =>
        {
            ...
            entity.ToTable("DocFile", tb => tb.HasComment("Documents"));

            entity.HasIndex(e => e.Sha256, "IX_Docfile_Sha256");
            ...
            entity.Property(e => e.Hash)
                ...
                .HasDefaultValue("123456789012345678901234", "DF_DocFile_Hash2");
            entity.Property(e => e.Cat).HasColumnType("text");
            entity.Property(e => e.Doc).HasComment("Stream as byte array");
            entity.Property(e => e.Eng).HasColumnType("text");
            entity.Property(e => e.Esp).HasColumnType("text");
            entity.Property(e => e.Fch)
                .HasComment("Date")
                .HasDefaultValueSql("(getdate())", "DF_DocFile_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.FchCreated)
            ...
            entity.Property(e => e.Por).HasColumnType("text");
            ...
            entity.Property(e => e.Thumbnail)
                ...
                .HasColumnType("image");
            entity.Property(e => e.ThumbnailMime).HasDefaultValue(1, "DF_DocFile_ThumbnailMime");
        ...
        modelBuilder.Entity<DocFileLog>(entity =>
        {
            ...
            entity.ToTable("DocFileLog", tb => tb.HasComment("Log of users who have browsed the documents"));

            entity.HasIndex(e => new { e.Hash, e.Fch }, "IX_DocFileLog_HashFch").IsDescending(false, true);

            entity.Property(e => e.Pk).HasDefaultValueSql("(newid())", "DF_DocFileLog_Pk");
            entity.Property(e => e.Docfile)
                .HasMaxLength(24)
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_DocFileLog_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.DocFileLogs)
                .HasForeignKey(d => d.Hash)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_DocFileLog_DocFile");

            entity.HasOne(d => d.UserNavigation).WithMany(p => p.DocFileLogs)
        ...
        {
            entity.HasKey(e => new { e.SrcGuid, e.SrcOrd, e.Hash, e.SrcCod }).HasName("PK_DocFileSrc_1");

            entity.ToTable("DocFileSrc", tb => tb.HasComment("Links objects with documents"));
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.DocFileSrcs)
                .HasForeignKey(d => d.Hash)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.Download, e.Target }).HasName("PK_ProductDownloadTarget");

            entity.ToTable("DownloadTarget", tb => tb.HasComment("Used to specify different targets for a single document"));
            ...
            entity.HasOne(d => d.DownloadNavigation).WithMany(p => p.DownloadTargets)
                .HasForeignKey(d => d.Download)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ProductDownloadTarget_ProductDownload");
        });

        modelBuilder.Entity<E11Customer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("E11_Customers");
        ...
        modelBuilder.Entity<E11cli>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("E11Cli");
        ...
        modelBuilder.Entity<E11dto>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("E11Dto");
        ...
        modelBuilder.Entity<E11sale>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("E11Sales");
        ...
        modelBuilder.Entity<Eci>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Eci");

            entity.Property(e => e.Albarán).HasMaxLength(255);
            entity.Property(e => e.CódigoCargoAbono)
                .HasMaxLength(255)
                .HasColumnName("Código Cargo/Abono");
            entity.Property(e => e.DenominaciónBanco)
                .HasMaxLength(255)
                .HasColumnName("Denominación Banco");
            entity.Property(e => e.Descripcion).HasMaxLength(255);
            entity.Property(e => e.Divisa).HasMaxLength(255);
            entity.Property(e => e.Divisa1).HasMaxLength(255);
            entity.Property(e => e.DocumentoCompensación).HasColumnName("Documento Compensación");
            entity.Property(e => e.DocumentoPago).HasColumnName("Documento Pago");
            entity.Property(e => e.DptoCompraUneco).HasColumnName("Dpto# Compra/UNECO");
            entity.Property(e => e.FechaContable)
                .HasMaxLength(255)
                .HasColumnName("Fecha Contable");
            entity.Property(e => e.FechaDocumento)
                .HasMaxLength(255)
                .HasColumnName("Fecha Documento");
            entity.Property(e => e.FechaPrevistaPago)
                .HasMaxLength(255)
                .HasColumnName("Fecha Prevista Pago");
            entity.Property(e => e.FechaVencimiento)
                .HasMaxLength(255)
                .HasColumnName("Fecha Vencimiento");
            entity.Property(e => e.Importe).HasMaxLength(255);
            entity.Property(e => e.Observaciones).HasMaxLength(255);
            entity.Property(e => e.ReceptorPago)
                .HasMaxLength(255)
                .HasColumnName("Receptor Pago");
            ...
            entity.Property(e => e.VíaPago)
                .HasMaxLength(255)
                .HasColumnName("Vía Pago");
        });
        ...
        modelBuilder.Entity<Ecidept>(entity =>
        {
            ...
            entity.Property(e => e.Guid).ValueGeneratedNever();
            entity.Property(e => e.FchCreated)
                .HasDefaultValueSql("(getdate())", "DF_ECIDept_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Id)
                .HasMaxLength(5)
                .IsUnicode(false);
        ...
        {
            entity.HasKey(e => new { e.Dept, e.Fch, e.Sku }).HasName("PK_ECIDeptModLog");
        ...
        modelBuilder.Entity<EcitransmCentre>(entity =>
        {
            ...
            entity.ToTable("ECITransmCentre", tb => tb.HasComment("El Corte Ingles centers and the shipment groups they belong to share a common delivery platform"));
            ...
            entity.HasOne(d => d.CentreNavigation).WithMany(p => p.EcitransmCentres)
                .HasForeignKey(d => d.Centre)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ECITransmCentre_CliGral");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.EcitransmCentres)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<EcitransmGroup>(entity =>
        {
            ...
            entity.ToTable("ECITransmGroup", tb => tb.HasComment("Shipments to El Corte Ingles customer are grouped by destinations which share a common delivery platform. This table stores the group name and the delivery platform, and its children on EciTransmCentre table store the final destination centers for the shipments"));
            ...
            entity.HasOne(d => d.PlatformNavigation).WithMany(p => p.EcitransmGroups)
                .HasForeignKey(d => d.Platform)
        ...
        modelBuilder.Entity<Edi>(entity =>
        {
            ...
            entity.ToTable("Edi", tb => tb.HasComment("Edi messages log (sent and received)"));

            entity.HasIndex(e => e.Fch, "IX_Edi_Fch").IsDescending();

            entity.HasIndex(e => new { e.Tag, e.FchCreated }, "IX_Edi_TagFchCreated").IsDescending(false, true);
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Edi_FchCreated")
                .HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_EdiInvrpt");
            ...
            entity.Property(e => e.Fch).HasColumnType("datetime");
            entity.Property(e => e.FchCreated)
                .HasDefaultValueSql("(getdate())", "DF_EdiInvrptHeader_FchCreated")
                .HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => new { e.Parent, e.Lin }).HasName("PK_EdiInvrptItem_1");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.EdiInvrptItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<EdiRemadvHeader>(entity =>
        {
            ...
            entity.ToTable("EdiRemadvHeader", tb => tb.HasComment("Remittance advice messages"));
            ...
            entity.Property(e => e.Amt)
                ...
                .HasDefaultValue(0m, "DF_EdiRemadvHeader_Amt")
                .HasColumnType("decimal(9, 2)");
            entity.Property(e => e.Cur)
                .HasMaxLength(3)
                .IsUnicode(false)
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_EdiRemadvHeader_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchDoc).HasComment("Document date");
            entity.Property(e => e.FchVto).HasComment("Due date");
            ...
            entity.HasOne(d => d.EmisorPagoNavigation).WithMany(p => p.EdiRemadvHeaderEmisorPagoNavigations)
                .HasForeignKey(d => d.EmisorPago)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiRemadvHeader_Emisor");

            entity.HasOne(d => d.Gu).WithOne(p => p.EdiRemadvHeader)
                .HasForeignKey<EdiRemadvHeader>(d => d.Guid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiRemadvHeader_Edi");

            entity.HasOne(d => d.ReceptorPagoNavigation).WithMany(p => p.EdiRemadvHeaderReceptorPagoNavigations)
                .HasForeignKey(d => d.ReceptorPago)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiRemadvHeader_Receptor");

            entity.HasOne(d => d.ResultNavigation).WithMany(p => p.EdiRemadvHeaders)
        ...
        modelBuilder.Entity<EdiRemadvItem>(entity =>
        {
            ...
            entity.ToTable("EdiRemadvItem", tb => tb.HasComment("Documents included on each remittance advice"));
            ...
            entity.Property(e => e.ItemCur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_EdiRemadvItem_Cur");
            entity.Property(e => e.ItemFch).HasComment("Daocument date");
            entity.Property(e => e.ItemNom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Document concept")
                .HasDefaultValue("", "DF_EdiRemadvItem_DocNom");
            entity.Property(e => e.ItemNum)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasComment("Document number")
                .HasDefaultValue("", "DF_EdiRemadvItem_DocNum");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.EdiRemadvItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<EdiversaDesadvHeader>(entity =>
        {
            ...
            entity.ToTable("EdiversaDesadvHeader", tb => tb.HasComment("Delivery notes sent/received by Edi"));
            ...
            entity.Property(e => e.FchDoc).HasComment("Document date");
            entity.Property(e => e.FchShip).HasComment("Shipping date");
            ...
            entity.HasOne(d => d.EntregaNavigation).WithMany(p => p.EdiversaDesadvHeaderEntregaNavigations)
                .HasForeignKey(d => d.Entrega)
                .HasConstraintName("FK_EdiversaDesadvHeader_Entrega");

            entity.HasOne(d => d.Gu).WithOne(p => p.EdiversaDesadvHeader)
                .HasForeignKey<EdiversaDesadvHeader>(d => d.Guid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiversaDesadvHeader_Edi");

            entity.HasOne(d => d.ProveidorNavigation).WithMany(p => p.EdiversaDesadvHeaderProveidorNavigations)
                .HasForeignKey(d => d.Proveidor)
                .HasConstraintName("FK_EdiversaDesadvHeader_Proveidor");

            entity.HasOne(d => d.PurchaseOrderNavigation).WithMany(p => p.EdiversaDesadvHeaders)
        ...
        modelBuilder.Entity<EdiversaDesadvItem>(entity =>
        {
            ...
            entity.ToTable("EdiversaDesadvItem", tb => tb.HasComment("Delivery note items"));
            ...
            entity.HasOne(d => d.DesadvNavigation).WithMany(p => p.EdiversaDesadvItems)
                .HasForeignKey(d => d.Desadv)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiversaDesadvItem_EdiversaDesadvHeader");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.EdiversaDesadvItems)
                .HasForeignKey(d => d.Sku)
        ...
        modelBuilder.Entity<EdiversaException>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Exceptions thrown when validating Edi files"));

            entity.HasIndex(e => e.Parent, "IX_EdiversaExceptions_Parent");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_EdiversaExceptions_Guid");
            ...
            entity.Property(e => e.TagCod)
                ...
                .HasDefaultValue(0, "DF_EdiversaExceptions_TagCod");
        ...
        modelBuilder.Entity<EdiversaInterlocutor>(entity =>
        {
            ...
            entity.ToTable("EdiversaInterlocutor", tb => tb.HasComment("GLN EAN 13 Codes of the entities whom we have agreed to exchange Edi documents"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_EdiOrderHeader");

            entity.ToTable("EdiversaOrderHeader", tb => tb.HasComment("Orders received through Edi messages"));
            ...
            entity.Property(e => e.CompradorEan)
                ...
                .HasDefaultValue("", "DF_EdiversaOrderHeader_CompradorEAN")
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_EdiOrderHeader_Cur");
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_EdiversaOrderHeader_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchDelivery).HasComment("Delivery date");
            entity.Property(e => e.FchDoc).HasComment("Order date");
            entity.Property(e => e.FchLast).HasComment("Delivery deadline");
            ...
            entity.Property(e => e.ReceptorMercanciaEan)
                ...
                .HasDefaultValue("", "DF_EdiversaOrderHeader_ReceptorMercanciaEAN")
            ...
            entity.HasOne(d => d.CompradorNavigation).WithMany(p => p.EdiversaOrderHeaderCompradorNavigations)
                .HasForeignKey(d => d.Comprador)
                .HasConstraintName("FK_EdiversaOrderHeader_Comprador");

            entity.HasOne(d => d.FacturarANavigation).WithMany(p => p.EdiversaOrderHeaderFacturarANavigations)
                .HasForeignKey(d => d.FacturarA)
                .HasConstraintName("FK_EdiversaOrderHeader_FacturarA");

            entity.HasOne(d => d.ProveedorNavigation).WithMany(p => p.EdiversaOrderHeaderProveedorNavigations)
                .HasForeignKey(d => d.Proveedor)
                .HasConstraintName("FK_EdiversaOrderHeader_Proveidor");

            entity.HasOne(d => d.ReceptorMercanciaNavigation).WithMany(p => p.EdiversaOrderHeaderReceptorMercanciaNavigations)
                .HasForeignKey(d => d.ReceptorMercancia)
                .HasConstraintName("FK_EdiversaOrderHeader_ReceptorMercancia");

            entity.HasOne(d => d.ResultNavigation).WithMany(p => p.EdiversaOrderHeaders)
                .HasForeignKey(d => d.Result)
        ...
        modelBuilder.Entity<EdiversaOrderItem>(entity =>
        {
            ...
            entity.ToTable("EdiversaOrderItem", tb => tb.HasComment("Line items from orders received through Edi messages"));

            entity.HasIndex(e => new { e.Parent, e.Lin }, "IX_EdiversaOrderItem_ParentLin").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_EdiversaOrderItem_Guid");
            entity.Property(e => e.Dsc)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Product name");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.EdiversaOrderItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiversaOrderItem_EdiversaOrderHeader");

            entity.HasOne(d => d.SkipDtoValidationUserNavigation).WithMany(p => p.EdiversaOrderItemSkipDtoValidationUserNavigations)
                .HasForeignKey(d => d.SkipDtoValidationUser)
                .HasConstraintName("FK_EdiversaOrderItem_SkipDtoValidationUser");

            entity.HasOne(d => d.SkipItemUserNavigation).WithMany(p => p.EdiversaOrderItemSkipItemUserNavigations)
                .HasForeignKey(d => d.SkipItemUser)
                .HasConstraintName("FK_EdiversaOrderItem_SkipItemUser");

            entity.HasOne(d => d.SkipPreuValidationUserNavigation).WithMany(p => p.EdiversaOrderItemSkipPreuValidationUserNavigations)
                .HasForeignKey(d => d.SkipPreuValidationUser)
                .HasConstraintName("FK_EdiversaOrderItem_SkipPreuValidationUser");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.EdiversaOrderItems)
                .HasForeignKey(d => d.Sku)
        ...
        modelBuilder.Entity<EdiversaOrdrspHeader>(entity =>
        {
            ...
            entity.ToTable("EdiversaOrdrspHeader", tb => tb.HasComment("Order confirmations sent or received through Edi"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_EdiversaOrdrspHeader_FchCreated")
                .HasColumnType("datetime");

            entity.HasOne(d => d.EdiversaOrderNavigation).WithMany(p => p.EdiversaOrdrspHeaderEdiversaOrderNavigations)
                .HasForeignKey(d => d.EdiversaOrder)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiversaOrdrspHeader_Edi1");

            entity.HasOne(d => d.Gu).WithOne(p => p.EdiversaOrdrspHeaderGu)
        ...
        {
            entity.HasKey(e => e.OrderItem).HasName("PK_EdiversaOrdrspItem_1");

            entity.ToTable("EdiversaOrdrspItem", tb => tb.HasComment("Order confirmation lines"));
            ...
            entity.HasOne(d => d.OrderItemNavigation).WithOne(p => p.EdiversaOrdrspItem)
                .HasForeignKey<EdiversaOrdrspItem>(d => d.OrderItem)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiversaOrdrspItem_EdiversaOrderItem");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.EdiversaOrdrspItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_EdiversaSalesReportHeader2");

            entity.ToTable("EdiversaSalesReportHeader", tb => tb.HasComment("Customer sales reports received through Edi"));
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_EdiversaSalesReportHeader2_Dtm");
            entity.Property(e => e.Id)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Document num")
                .HasDefaultValue("", "DF_EdiversaSalesReportHeader2_Bgm");

            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.EdiversaSalesReportHeaders)
                .HasForeignKey(d => d.Customer)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_EdiversaSalesReport");

            entity.ToTable("EdiversaSalesReportItem", tb => tb.HasComment("Customer sales report items"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_EdiversaSalesReportItem_Guid");
            entity.Property(e => e.Centro)
                .HasMaxLength(5)
                .IsUnicode(false)
            ...
            entity.Property(e => e.Eur)
                ...
                .HasColumnType("decimal(9, 2)");
            entity.Property(e => e.Fch).HasComment("Sales date");
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.EdiversaSalesReportItems)
                .HasForeignKey(d => d.Customer)
                .HasConstraintName("FK_EdiversaSalesReportItem_CliGral");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.EdiversaSalesReportItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EdiversaSalesReportItem_EdiversaSalesReportHeader");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.EdiversaSalesReportItems)
                .HasForeignKey(d => d.Sku)
        ...
        modelBuilder.Entity<ElCorteInglesAlineamientoStock>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_ElCorteInglesAlineamientoStocks_Guid");
            entity.Property(e => e.Fch).HasColumnType("datetime");
            entity.Property(e => e.Text).HasColumnType("text");
        });
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_EMAIL");

            entity.ToTable("Email", tb => tb.HasComment("Users"));

            entity.HasIndex(e => new { e.Emp, e.Adr }, "IX_EMAIL_ID_ADR").IsUnique();

            entity.HasIndex(e => e.Guid, "IX_EMAIL_ID_GUID").IsUnique();
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_EMAIL_ID_guid");
            entity.Property(e => e.Address)
                .HasMaxLength(60)
                .IsUnicode(false)
            ...
            entity.Property(e => e.Birthday).HasComment("User birthday");
            ...
            entity.Property(e => e.Lang)
                ...
                .IsFixedLength()
                .HasComment("ISO 639-2 language code")
                .HasDefaultValue("ESP", "DF_EMAIL_Lang");
            entity.Property(e => e.LastChildBirthday).HasComment("Birthday of youngest children");
            ...
            entity.HasOne(d => d.BadMail).WithMany(p => p.Emails)
                .HasForeignKey(d => d.BadMailGuid)
                .HasConstraintName("FK_Email_Cod");

            entity.HasOne(d => d.DefaultContact).WithMany(p => p.Emails)
                .HasForeignKey(d => d.DefaultContactGuid)
                .HasConstraintName("FK_Email_CliGral");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Emails)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Email_Emp");

            entity.HasOne(d => d.LocationNavigation).WithMany(p => p.Emails)
                .HasForeignKey(d => d.Location)
                .HasConstraintName("FK_Email_Location");

            entity.HasOne(d => d.ResidenceNavigation).WithMany(p => p.Emails)
        ...
        {
            entity.HasKey(e => new { e.EmailGuid, e.ContactGuid }).HasName("PK_EMAIL_CLIS_1");

            entity.ToTable("Email_Clis", tb => tb.HasComment("Users per contact"));
            ...
            entity.HasOne(d => d.Contact).WithMany(p => p.EmailClis)
                .HasForeignKey(d => d.ContactGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_EMAIL_CLIS_CliGral");

            entity.HasOne(d => d.Email).WithMany(p => p.EmailClis)
        ...
        {
            entity.HasKey(e => e.Emp1).HasName("PK_Emp_1");

            entity.ToTable("Emp", tb => tb.HasComment("Company"));
            ...
            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_Emp_Guid");
            entity.Property(e => e.Ip)
                .HasMaxLength(15)
                .IsUnicode(false);
            entity.Property(e => e.MailboxPort)
                .HasComment("Mailbox Smtp port")
                .HasDefaultValue(25, "DF_EMP_MailboxPort");
            ...
            entity.Property(e => e.MailboxSmtp)
                ...
                .HasDefaultValue("", "DF_EMP_MailboxSmtp");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_Escriptures");

            entity.ToTable("Escriptura", tb => tb.HasComment("Notarial deeds"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Escriptures_Guid");
            entity.Property(e => e.Codi).HasComment("Purpose. Enumerable DTOEscriptura.Codis");
            entity.Property(e => e.Docfile)
                .HasMaxLength(24)
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Emp).HasDefaultValue(1, "DF_Escriptura_Emp");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Escriptura_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchFrom)
                .HasComment("Effective date")
                .HasDefaultValueSql("(getdate())", "DF_Escriptures_FchFrom");
            entity.Property(e => e.FchTo).HasComment("Expiry date");
            ...
            entity.Property(e => e.Nom)
                ...
                .IsUnicode(false)
                .HasComment("Friendly name")
                .HasDefaultValue("", "DF_Escriptures_Nom");
            entity.Property(e => e.Notari).HasComment("Notary; foreign key for CliGral table");
            entity.Property(e => e.NumProtocol)
                .HasComment("Document number")
                .HasDefaultValue(0, "DF_Escriptures_NumProtocol");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.Escripturas)
                .HasForeignKey(d => d.Hash)
                .HasConstraintName("FK_Escriptura_Escriptura");

            entity.HasOne(d => d.NotariNavigation).WithMany(p => p.EscripturaNotariNavigations)
                .HasForeignKey(d => d.Notari)
                .HasConstraintName("FK_Escriptura_Notari");

            entity.HasOne(d => d.RegistreMercantilNavigation).WithMany(p => p.EscripturaRegistreMercantilNavigations)
        ...
        modelBuilder.Entity<Exception>(entity =>
        {
            ...
            entity.ToTable("Exception", tb => tb.HasComment("Exceptions from different operations that need to be recorded. For example, validation exceptions detected when importing invoices received from Edi console"));
        ...
        modelBuilder.Entity<Feedback>(entity =>
        {
            ...
            entity.ToTable("Feedback", tb => tb.HasComment("Users feedback events log"));
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Feedback_Fch")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<Filter>(entity =>
        {
            ...
            entity.ToTable("Filter", tb => tb.HasComment("Product features filters"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_FilterItems");

            entity.ToTable("FilterItem", tb => tb.HasComment("Options for product filters"));
            ...
            entity.HasOne(d => d.FilterNavigation).WithMany(p => p.FilterItems)
        ...
        modelBuilder.Entity<FilterTarget>(entity =>
        {
            ...
            entity.ToTable("FilterTarget", tb => tb.HasComment("Products where filter options are applicable"));
            ...
            entity.HasOne(d => d.FilterItemNavigation).WithMany(p => p.FilterTargets)
        ...
        modelBuilder.Entity<Forecast>(entity =>
        {
            ...
            entity.ToTable("Forecast", tb => tb.HasComment("Order forecasts"));
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Forecast_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.Forecasts)
                .HasForeignKey(d => d.Customer)
                .HasConstraintName("FK_Forecast_CliGral");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.Forecasts)
                .HasForeignKey(d => d.Sku)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Forecast_Art");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.Forecasts)
                .HasForeignKey(d => d.UsrCreated)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_FRA");

            entity.ToTable("Fra", tb => tb.HasComment("Issued invoices"));

            entity.HasIndex(e => e.CcaGuid, "IX_FRA_CcaGuid");

            entity.HasIndex(e => new { e.CliGuid, e.Yea, e.Serie, e.Fra1 }, "IX_FRA_CliGuidYeaFra");

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Serie, e.Fra1 }, "IX_FRA_EmpYeaFra").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_FRA_Guid");
            entity.Property(e => e.Adr)
            ...
            entity.Property(e => e.Cur)
                ...
                .HasDefaultValue("ESP", "DF_FRA_Cur");
            ...
            entity.Property(e => e.DtoPct)
                ...
                .HasDefaultValue(0m, "DF_FRA_DtoPct")
                .HasColumnType("numeric(4, 2)");
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_FRA_fch")
                .HasColumnType("datetime");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_FRA_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_FRA_FchLastEdited")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.IrpfAmt).HasColumnType("decimal(9, 2)");
            entity.Property(e => e.IrpfBase).HasColumnType("decimal(9, 2)");
            entity.Property(e => e.IrpfPct).HasColumnType("decimal(18, 0)");
            ...
            entity.Property(e => e.TipoFactura)
                ...
                .HasDefaultValue("F1", "DF_Fra_TipoFactura");
            ...
            entity.HasOne(d => d.Cca).WithMany(p => p.Fras)
                .HasForeignKey(d => d.CcaGuid)
                .HasConstraintName("FK_FRA_CCA");

            entity.HasOne(d => d.Cli).WithMany(p => p.Fras)
                .HasForeignKey(d => d.CliGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Fra_CliGral");

            entity.HasOne(d => d.EmailedTo).WithMany(p => p.FraEmailedTos)
                .HasForeignKey(d => d.EmailedToGuid)
                .HasConstraintName("FK_Fra_EmailedTo");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Fras)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Fra_Emp");

            entity.HasOne(d => d.IncotermNavigation).WithMany(p => p.Fras)
                .HasForeignKey(d => d.Incoterm)
                .HasConstraintName("FK_Fra_Incoterm");

            entity.HasOne(d => d.IntrastatNavigation).WithMany(p => p.Fras)
                .HasForeignKey(d => d.Intrastat)
                .HasConstraintName("FK_Fra_Intrastat");

            entity.HasOne(d => d.UsrLastPrinted).WithMany(p => p.FraUsrLastPrinteds)
                .HasForeignKey(d => d.UsrLastPrintedGuid)
                .HasConstraintName("FK_Fra_UsrLastPrinted");

            entity.HasOne(d => d.ZipNavigation).WithMany(p => p.Fras)
                .HasForeignKey(d => d.Zip)
                .HasConstraintName("FK_Fra_Zip");
        });

        modelBuilder.Entity<FraItem>(entity =>
        {
            entity.HasKey(e => new { e.Fra, e.Cod, e.Idx }).HasName("PK_FraItem_1");

            entity.ToTable("FraItem");
            ...
            entity.HasOne(d => d.FraNavigation).WithMany(p => p.FraItems)
                .HasForeignKey(d => d.Fra)
                .HasConstraintName("FK_FraItem_Fra");
        });
        ...
        modelBuilder.Entity<FtpPath>(entity =>
        {
            ...
            entity.ToTable("FtpPath", tb => tb.HasComment("Partner ftp server paths"));
            ...
            entity.HasOne(d => d.OwnerNavigation).WithMany(p => p.FtpPaths)
        ...
        {
            entity.HasKey(e => e.Owner).HasName("PK_Ftp");

            entity.ToTable("FtpServer", tb => tb.HasComment("Partner ftp server with whom we usually connect to interchange documents"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_FtpServer_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.OwnerNavigation).WithOne(p => p.FtpServer)
        ...
        modelBuilder.Entity<Gallery>(entity =>
        {
            ...
            entity.ToTable("Gallery", tb => tb.HasComment("High resolution brand resources, filed in the server by its MD5 hash signature as filename"));

            entity.HasIndex(e => e.FchCreated, "IX_Gallery_FchCreated").IsDescending();
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Gallery_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Hash)
                .HasMaxLength(24)
                .IsUnicode(false)
            ...
            entity.Property(e => e.Nom)
                ...
                .HasDefaultValue("", "DF_Gallery_Nom")
                .HasColumnType("text");
        ...
        modelBuilder.Entity<Holding>(entity =>
        {
            ...
            entity.ToTable("Holding", tb => tb.HasComment("Customers holdings, used for statistics gathering different customers from a unique commercial group"));

            entity.HasIndex(e => new { e.Emp, e.Nom }, "Idx_Holding_Nom").IsUnique();
            ...
            entity.Property(e => e.Emp)
                .HasComment("Company; foreign key for Emp table")
                .HasDefaultValue(1, "DF_Holding_Emp");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Friendly name");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Holdings)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<HourInOut>(entity =>
        {
            ...
            entity.ToTable("HourInOut", tb => tb.HasComment("Defines daily time intervals between hours, for example to register employees workdays"));
        ...
        modelBuilder.Entity<HpLastPurchase>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("HpLastPurchase");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_IBAN_1");

            entity.ToTable("Iban", tb => tb.HasComment("Contacts bank accounts"));

            entity.HasIndex(e => e.BankBranch, "IX_IBAN_BankBranch");

            entity.HasIndex(e => e.ContactGuid, "IX_IBAN_ContactGuid");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_IBAN_Guid");
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this record was created")
                .HasDefaultValueSql("(getdate())", "DF_Iban_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.BankBranchNavigation).WithMany(p => p.Ibans)
                .HasForeignKey(d => d.BankBranch)
                .HasConstraintName("FK_Iban_Bn2");

            entity.HasOne(d => d.Contact).WithMany(p => p.Ibans)
                .HasForeignKey(d => d.ContactGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IBAN_CliGral");

            entity.HasOne(d => d.UsrApprovedNavigation).WithMany(p => p.IbanUsrApprovedNavigations)
                .HasForeignKey(d => d.UsrApproved)
                .HasConstraintName("FK_Iban_UsrApproved");

            entity.HasOne(d => d.UsrDownloadedNavigation).WithMany(p => p.IbanUsrDownloadedNavigations)
                .HasForeignKey(d => d.UsrDownloaded)
                .HasConstraintName("FK_Iban_UsrDownloaded");

            entity.HasOne(d => d.UsrUploadedNavigation).WithMany(p => p.IbanUsrUploadedNavigations)
        ...
        modelBuilder.Entity<IbanStructure>(entity =>
        {
            ...
            entity.ToTable("IbanStructure", tb => tb.HasComment("Structure of Iban digits for each EU country"));
        ...
        modelBuilder.Entity<Immoble>(entity =>
        {
            ...
            entity.ToTable("Immoble", tb => tb.HasComment("Real Estate properties (buildings, offices, appartments...)"));
            ...
            entity.Property(e => e.Adr)
                ...
                .HasDefaultValue("", "DF_Immoble_Address");
            ...
            entity.Property(e => e.Emp)
                ...
                .HasDefaultValue(1, "DF_Immoble_Emp_1");
            entity.Property(e => e.FchFrom).HasComment("Date it was acquired");
            entity.Property(e => e.FchTo).HasComment("Date it was sold");
            entity.Property(e => e.Nom)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasComment("Nickname for this record")
                .HasDefaultValue("", "DF_Immoble_Nom");
            entity.Property(e => e.Obs).IsUnicode(false);
            entity.Property(e => e.Part).HasColumnType("decimal(5, 2)");
            entity.Property(e => e.Registre)
                .HasMaxLength(50)
                .IsUnicode(false);
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Immobles)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Immoble_Emp");

            entity.HasOne(d => d.Zip).WithMany(p => p.Immobles)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_IMPAGATS");

            entity.ToTable(tb => tb.HasComment("Unpayments"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_IMPAGATS_Guid");
            entity.Property(e => e.AsnefAlta).HasComment("Date the unpayment has been notified to credit  insurance company");
            entity.Property(e => e.AsnefBaixa).HasComment("Date the unpayment has been removed from credit insurance company");
            ...
            entity.Property(e => e.RefBanc)
                ...
                .HasDefaultValue("", "DF_IMPAGAT_RefBanc");
            entity.Property(e => e.Status).HasComment("Unpaid status DTOImpagat.StatusCodes");

            entity.HasOne(d => d.CcaIncobrableNavigation).WithMany(p => p.Impagats)
                .HasForeignKey(d => d.CcaIncobrable)
                .HasConstraintName("FK_Impagats_Cca");

            entity.HasOne(d => d.Csb).WithMany(p => p.Impagats)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_IMPORTDTL");

            entity.ToTable("ImportDtl", tb => tb.HasComment("Import consignment documents"));
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_IMPORTDTL_Cur");
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.ImportDtls)
                .HasForeignKey(d => d.Hash)
                .HasConstraintName("FK_ImportDtl_DocFile");

            entity.HasOne(d => d.Header).WithMany(p => p.ImportDtls)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_IMPORTHDR");

            entity.ToTable("ImportHdr", tb => tb.HasComment("Import consignments"));

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Id }, "Ix_ImportHdr_EmpYeaId").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_IMPORTHDR_Guid");
            ...
            entity.Property(e => e.PaisOrigen)
                ...
                .HasDefaultValue("ES", "DF_IMPORTHDR_PaisOrigen");
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.ImportHdrs)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ImportHdr_Emp");

            entity.HasOne(d => d.PlataformaDeCargaNavigation).WithMany(p => p.ImportHdrPlataformaDeCargaNavigations)
                .HasForeignKey(d => d.PlataformaDeCarga)
                .HasConstraintName("FK_ImportHdr_Platf");

            entity.HasOne(d => d.Prv).WithMany(p => p.ImportHdrPrvs)
                .HasForeignKey(d => d.PrvGuid)
                .HasConstraintName("FK_ImportHdr_Prv");

            entity.HasOne(d => d.Trp).WithMany(p => p.ImportHdrTrps)
                .HasForeignKey(d => d.TrpGuid)
        ...
        modelBuilder.Entity<ImportPrevisio>(entity =>
        {
            ...
            entity.ToTable("ImportPrevisio", tb => tb.HasComment("Products and quantities expected to arrive from each import consignment"));

            entity.HasIndex(e => new { e.Importacio, e.Lin }, "Ix_ImportPrevisio").IsUnique();
            ...
            entity.HasOne(d => d.ImportacioNavigation).WithMany(p => p.ImportPrevisios)
                .HasForeignKey(d => d.Importacio)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ImportPrevisio_ImportHdr");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.ImportPrevisios)
                .HasForeignKey(d => d.Sku)
        ...
        modelBuilder.Entity<Incentiu>(entity =>
        {
            ...
            entity.ToTable("Incentiu", tb => tb.HasComment("Commercial promotions"));
            ...
            entity.Property(e => e.CliVisible)
                ...
                .HasDefaultValue(true, "DF_Incentiu_CliVisible");
            ...
            entity.Property(e => e.RepVisible)
                ...
                .HasDefaultValue(true, "DF_Incentiu_RepVisible");
            entity.Property(e => e.Thumbnail)
                .HasComment("Thumbnail image to ilustrate it on a web page list")
                .HasColumnType("image");

            entity.HasOne(d => d.EventoNavigation).WithMany(p => p.Incentius)
                .HasForeignKey(d => d.Evento)
                .HasConstraintName("FK_Incentiu_Noticia");

            entity.HasMany(d => d.DistributionChannels).WithMany(p => p.Incentius)
                .UsingEntity<Dictionary<string, object>>(
                    "IncentiuChannel",
                    r => r.HasOne<DistributionChannel>().WithMany()
                        .HasForeignKey("DistributionChannel")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_Incentiu_Channels_DistributionChannel"),
                    l => l.HasOne<Incentiu>().WithMany()
                        .HasForeignKey("Incentiu")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_Incentiu_Channels_Incentiu"),
                    j =>
                    {
                        j.HasKey("Incentiu", "DistributionChannel");
                        j.ToTable("Incentiu_Channels", tb => tb.HasComment("Channels where a promotion is valid"));
        ...
        {
            entity.HasKey(e => new { e.Incentiu, e.Product }).HasName("PK_Inc_Product");

            entity.ToTable("Incentiu_Product", tb => tb.HasComment("Product range where a promotion is valid"));
            ...
            entity.HasOne(d => d.IncentiuNavigation).WithMany(p => p.IncentiuProducts)
        ...
        modelBuilder.Entity<IncentiuQtyDto>(entity =>
        {
            ...
            entity.ToTable("Incentiu_QtyDto", tb => tb.HasComment("Minimum units to reach the discount"));
            ...
            entity.HasOne(d => d.IncentiuNavigation).WithMany(p => p.IncentiuQtyDtos)
                .HasForeignKey(d => d.Incentiu)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<IncidenciaDocFile>(entity =>
        {
            ...
            entity.ToTable("Incidencia_DocFiles", tb => tb.HasComment("Postsales incidence support documents"));
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.IncidenciaDocFiles)
                .HasForeignKey(d => d.Hash)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Incidencia_DocFiles_DocFile");

            entity.HasOne(d => d.IncidenciaNavigation).WithMany(p => p.IncidenciaDocFiles)
                .HasForeignKey(d => d.Incidencia)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Incidencia_DocFiles_Incidencies");
        });

        modelBuilder.Entity<IncidenciesCod>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_IncidenciesCods_1");

            entity.ToTable(tb => tb.HasComment("Postsales incidence codes"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_IncidenciesCods_Guid");
            entity.Property(e => e.Cat)
                .HasMaxLength(50)
                .IsUnicode(false)
            ...
            entity.Property(e => e.Eng)
                ...
                .HasDefaultValue("", "DF_INCIDENCIESCODS_Eng");
            entity.Property(e => e.Esp)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Name in Spanish language")
                .HasDefaultValue("", "DF_INCIDENCIESCODS_Esp");
            entity.Property(e => e.Por)
                .HasMaxLength(50)
                .IsUnicode(false)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_Incidencies_1");

            entity.ToTable(tb => tb.HasComment("Postsales incidence reports"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_INCIDENCIES_Guid");
            entity.Property(e => e.Asin)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.BoughtFrom).HasColumnType("text");
            ...
            entity.Property(e => e.FchClose)
                ...
                .HasColumnType("datetime");
            entity.Property(e => e.FchCompra).HasComment("Acquisition date");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Incidencies_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_Incidencies_FchLastEdited")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.CodiAperturaNavigation).WithMany(p => p.IncidencyCodiAperturaNavigations)
                .HasForeignKey(d => d.CodiApertura)
                .HasConstraintName("FK_Incidencies_IncidenciesCodsAperturas");

            entity.HasOne(d => d.CodiTancamentNavigation).WithMany(p => p.IncidencyCodiTancamentNavigations)
                .HasForeignKey(d => d.CodiTancament)
                .HasConstraintName("FK_Incidencies_IncidenciesTancaments");

            entity.HasOne(d => d.Spv).WithMany(p => p.Incidencies)
                .HasForeignKey(d => d.SpvGuid)
                .HasConstraintName("FK_Incidencies_Spv");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.IncidencyUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_Incidencies_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.IncidencyUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
        ...
        {
            entity.ToTable("Incoterm", tb => tb.HasComment("pre-defined commercial terms published by the International Chamber of Commerce (ICC)"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_Insolvencias_1");

            entity.ToTable(tb => tb.HasComment("Bad debts"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Insolvencias_Guid");
            entity.Property(e => e.Customer).HasComment("Customer, foreign key for CliGral table");
            entity.Property(e => e.Fch)
                .HasComment("Date ")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.Insolvencia)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Intrastat>(entity =>
        {
            ...
            entity.ToTable("Intrastat", tb => tb.HasComment("Customs monthly declaration of statistics on the exchange of goods between Member States of the European Union "));

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Mes, e.Flujo, e.Ord }, "IX_Intrastat_EmpYeaMes").IsUnique();
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Intrastat_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Ord)
                ...
                .HasDefaultValue(1, "DF_Intrastat_ord");
            entity.Property(e => e.Yea).HasComment("Declaration year");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Intrastats)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Intrastat_Emp");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.Intrastats)
                .HasForeignKey(d => d.Hash)
        ...
        modelBuilder.Entity<IntrastatPartidum>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Intrastat declaration items"));
            ...
            entity.HasOne(d => d.CodiMercanciaNavigation).WithMany(p => p.IntrastatPartida)
                .HasForeignKey(d => d.CodiMercancia)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IntrastatPartida_CodisMercancia");

            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.IntrastatPartidumCountryNavigations)
                .HasForeignKey(d => d.Country)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IntrastatPartida_Country");

            entity.HasOne(d => d.IncotermNavigation).WithMany(p => p.IntrastatPartida)
                .HasForeignKey(d => d.Incoterm)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IntrastatPartida_Incoterm");

            entity.HasOne(d => d.IntrastatNavigation).WithMany(p => p.IntrastatPartida)
                .HasForeignKey(d => d.Intrastat)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_IntrastatPartida_Intrastat");

            entity.HasOne(d => d.MadeInNavigation).WithMany(p => p.IntrastatPartidumMadeInNavigations)
                .HasForeignKey(d => d.MadeIn)
                .HasConstraintName("FK_IntrastatPartida_MadeIn");

            entity.HasOne(d => d.ProvinciaNavigation).WithMany(p => p.IntrastatPartida)
        ...
        modelBuilder.Entity<InventariItem>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Inventory items"));

            entity.HasIndex(e => new { e.Immoble, e.Nom }, "IX_InventariItems_ImmobleNom").IsUnique();
            ...
            entity.Property(e => e.Nom)
                ...
                .HasDefaultValue("", "DF_InventariItems_Nom");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");

            entity.HasOne(d => d.ImmobleNavigation).WithMany(p => p.InventariItems)
        ...
        modelBuilder.Entity<InvoiceReceivedHeader>(entity =>
        {
            ...
            entity.ToTable("InvoiceReceivedHeader", tb => tb.HasComment("Invoices received from suppliers"));
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("ISO 4217 currency code")
                .HasDefaultValue("EUR", "DF_InvoiceReceivedHeader_Cur");
            entity.Property(e => e.DocNum)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasComment("Invoice number");
            entity.Property(e => e.Fch).HasComment("invoice date");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_InvoiceReceivedHeader_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.ImportacioNavigation).WithMany(p => p.InvoiceReceivedHeaders)
                .HasForeignKey(d => d.Importacio)
                .HasConstraintName("FK_InvoiceReceivedHeader_ImportHdr");

            entity.HasOne(d => d.ProveidorNavigation).WithMany(p => p.InvoiceReceivedHeaders)
                .HasForeignKey(d => d.Proveidor)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_InvoiceReceivedItem_1");

            entity.ToTable("InvoiceReceivedItem", tb => tb.HasComment("Invoices line items"));
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.InvoiceReceivedItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_InvoiceReceivedItem_InvoiceReceivedHeader");

            entity.HasOne(d => d.PurchaseOrderNavigation).WithMany(p => p.InvoiceReceivedItems)
                .HasForeignKey(d => d.PurchaseOrder)
        ...
        modelBuilder.Entity<JornadaLaboral>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Staff, e.FchFrom }, "IX_JornadaLaboral_UsrFch").IsUnique();
        ...
        modelBuilder.Entity<JsonLog>(entity =>
        {
            ...
            entity.ToTable("JsonLog", tb => tb.HasComment("Log of Json messages received in our Api  https://matiasmasso-api.azurewebsites.net/api/JsonLog/mailbox"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_JsonLog_Guid");
            entity.Property(e => e.FchCreated)
                .HasComment("Date the message was logged")
                .HasDefaultValueSql("(getdate())", "DF_JsonLog_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.SchemaNavigation).WithMany(p => p.JsonLogs)
        ...
        modelBuilder.Entity<JsonSchema>(entity =>
        {
            ...
            entity.ToTable("JsonSchema", tb => tb.HasComment("Json Schemas for partners iontegration with our Api"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_JsonSchema_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was last edited")
                .HasDefaultValueSql("(getdate())", "DF_JsonSchema_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Json)
            ...
            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.JsonSchemaUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_JsonSchema_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.JsonSchemaUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
        ...
        modelBuilder.Entity<Keyword>(entity =>
        {
            ...
            entity.ToTable("Keyword", tb => tb.HasComment("Keywords from news or blog posts"));
            ...
            entity.Property(e => e.Value)
                ...
                .HasDefaultValue("", "DF_Sinonim_Value");
        });

        modelBuilder.Entity<LangText>(entity =>
        {
            entity.HasKey(e => e.Pkey).HasName("PK_LangResource");

            entity.ToTable("LangText", tb => tb.HasComment("Text resources in different languages"));

            entity.HasIndex(e => new { e.Guid, e.Src, e.Lang }, "IX_GuidSrcLang").IsUnique();

            entity.HasIndex(e => e.Src, "Ix_LangText_Src");

            entity.Property(e => e.Pkey)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_LangText_PKey")
                .HasColumnName("PKey");
            entity.Property(e => e.Fch2).HasDefaultValueSql("(getdate())", "DF_LangText_Fch2");
            entity.Property(e => e.FchCreated)
                .HasComment("Creation date")
                .HasDefaultValueSql("(getdate())", "DF_LangText_FchCreated")
                .HasColumnType("datetime");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_LINIATELEFON");

            entity.ToTable("LiniaTelefon", tb => tb.HasComment("Company phone lines"));
            ...
            entity.Property(e => e.Alias)
                ...
                .IsUnicode(false)
                .HasComment("Friendly name");
            entity.Property(e => e.Alta).HasComment("Start date");
            entity.Property(e => e.Baixa).HasComment("Termination date");
            ...
            entity.Property(e => e.Num)
                ...
                .IsUnicode(false)
                .HasComment("Phone number")
                .HasDefaultValue("", "DF_LINIATELEFON_Num");
        ...
        modelBuilder.Entity<Lloguer>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("Lloguer");

            entity.Property(e => e.Guid).ValueGeneratedNever();
            entity.Property(e => e.Base).HasColumnType("decimal(18, 0)");

            entity.HasOne(d => d.ContractNavigation).WithMany(p => p.Lloguers)
                .HasForeignKey(d => d.Contract)
                .HasConstraintName("FK_Lloguer_Contract");

            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.Lloguers)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Lloguer_CliGral");

            entity.HasOne(d => d.ImmobleNavigation).WithMany(p => p.Lloguers)
                .HasForeignKey(d => d.Immoble)
                .HasConstraintName("FK_Lloguer_Immoble");

            entity.HasMany(d => d.Invoices).WithMany(p => p.Lloguers)
                .UsingEntity<Dictionary<string, object>>(
                    "LloguerQuotum",
                    r => r.HasOne<Fra>().WithMany()
                        .HasForeignKey("Invoice")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_LloguerQuota_Fra"),
                    l => l.HasOne<Lloguer>().WithMany()
                        .HasForeignKey("Lloguer")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_LloguerQuota_Lloguer"),
                    j =>
                    {
                        j.HasKey("Lloguer", "Invoice");
                        j.ToTable("LloguerQuota");
                    });
        });
        ...
        modelBuilder.Entity<Location>(entity =>
        {
            ...
            entity.ToTable("Location", tb => tb.HasComment("Zona locations (towns, cities...)"));

            entity.HasIndex(e => new { e.Zona, e.Nom }, "IX_Location_Zona_Nom").IsUnique();
            ...
            entity.HasOne(d => d.ZonaNavigation).WithMany(p => p.Locations)
                .HasForeignKey(d => d.Zona)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MailingLog>(entity =>
        {
            ...
            entity.ToTable("MailingLog", tb => tb.HasComment("Logs when automated email has been sent to a subscriber"));
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Log_Fch")
                .HasColumnType("datetime");

            entity.HasOne(d => d.UsuariNavigation).WithMany(p => p.MailingLogs)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_MarketPlace_1");

            entity.ToTable("MarketPlace", tb => tb.HasComment("Platforms through which we directly sell to consumers (for example Amazon seller)"));
            ...
            entity.HasOne(d => d.Gu).WithOne(p => p.MarketPlace)
        ...
        modelBuilder.Entity<MediaResource>(entity =>
        {
            ...
            entity.ToTable("MediaResource", tb => tb.HasComment("Product resources like images or videos stored on the server filesystem by its hash signature"));

            entity.HasIndex(e => e.Guid, "IX_MediaResourceGuid").IsUnique();

            entity.HasIndex(e => e.Nom, "IX_MediaResource_Nom");

            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_MediaResource_Guid");
            entity.Property(e => e.Cod).HasComment("Enumerable DTOMediaResource.Cods (1.Product, 2.Features, 3.Life style)");
            entity.Property(e => e.DscCat)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.DscEng)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.DscEsp)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.DscPor)
                .HasMaxLength(100)
                .IsUnicode(false);
            entity.Property(e => e.FchCreated)
                .HasComment("Date the image was uploaded")
                .HasDefaultValueSql("(getdate())", "DF_MediaResource_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.LangSet)
                .HasMaxLength(4)
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("1111", "DF_MediaResource_Langs");
            entity.Property(e => e.Mime).HasComment("Enumerable MatHelperStd.Mimecods");
            entity.Property(e => e.Nom)
                .HasMaxLength(80)
                .IsUnicode(false)
                .HasComment("Descriptive name")
                .HasDefaultValue("", "DF_MediaResource_Nom");
            entity.Property(e => e.Obsoleto).HasComment("True if outdated");
            entity.Property(e => e.Ord).HasComment("Sort order");
        ...
        {
            entity.HasKey(e => new { e.Parent, e.Target });

            entity.ToTable("MediaResourceTarget");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.MediaResourceTargets)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Mem>(entity =>
        {
            ...
            entity.ToTable("Mem", tb => tb.HasComment("Contact comments and visit reports"));

            entity.HasIndex(e => new { e.Contact, e.Fch }, "IX_Mem_Contact");

            entity.HasIndex(e => e.FchCreated, "IX_Mem_FchCreated").IsDescending();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Mem_Guid");
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Entry creation date")
                .HasDefaultValueSql("(getdate())", "DF_MEM_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.ContactNavigation).WithMany(p => p.Mems)
                .HasForeignKey(d => d.Contact)
                .HasConstraintName("FK_Mem_CliGral");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.Mems)
                .HasForeignKey(d => d.UsrCreated)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_MGZ");

            entity.ToTable("Mgz", tb => tb.HasComment("Warehouses, logistic centers"));
            ...
            entity.HasOne(d => d.Gu).WithOne(p => p.Mgz)
                .HasForeignKey<Mgz>(d => d.Guid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Mgz_CliGral");
        });

        modelBuilder.Entity<Miravia2>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("miravia2");

            entity.Property(e => e.Com).HasColumnType("decimal(6, 2)");
            entity.Property(e => e.Fch).HasMaxLength(50);
            entity.Property(e => e.Goods).HasColumnType("decimal(6, 2)");
            entity.Property(e => e.Item).HasMaxLength(20);
            entity.Property(e => e.Pdd).HasMaxLength(20);
            entity.Property(e => e.Ports).HasColumnType("decimal(6, 2)");
            entity.Property(e => e.Subvencio).HasColumnType("decimal(6, 2)");
        });

        modelBuilder.Entity<Miravium>(entity =>
        {
            entity.HasNoKey();

            entity.Property(e => e.Alto).HasMaxLength(50);
            entity.Property(e => e.Ancho).HasMaxLength(50);
            entity.Property(e => e.CategorA)
                .HasMaxLength(50)
                .HasColumnName("Categor_a");
            entity.Property(e => e.CodigoArancelario).HasColumnName("Codigo_arancelario");
            entity.Property(e => e.EanProducto).HasColumnName("EAN_producto");
            entity.Property(e => e.Imagen).HasMaxLength(100);
            entity.Property(e => e.LandingPage)
                .HasMaxLength(150)
                .HasColumnName("Landing_page");
            entity.Property(e => e.Largo).HasMaxLength(50);
            entity.Property(e => e.MadeIn)
                .HasMaxLength(1)
                .HasColumnName("Made_In");
            entity.Property(e => e.Marca).HasMaxLength(50);
            entity.Property(e => e.MiraviaCotegory).HasColumnName("MIRAVIA_COTEGORY");
            entity.Property(e => e.MiraviaCotegoryName)
                .HasMaxLength(50)
                .HasColumnName("MIRAVIA_COTEGORY_NAME");
            entity.Property(e => e.Peso).HasMaxLength(50);
            entity.Property(e => e.Producto).HasMaxLength(50);
            entity.Property(e => e.RefFabricante)
                .HasMaxLength(50)
                .HasColumnName("Ref_fabricante");
            entity.Property(e => e.RefMO).HasColumnName("Ref_M_O");
            entity.Property(e => e.Venta).HasMaxLength(50);
        });

        modelBuilder.Entity<Mr2>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_MR2");

            entity.ToTable("Mr2", tb => tb.HasComment("Amortisation quotes, accounting depreciations"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_MR2_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("ESP", "DF_MR2_cur");
            entity.Property(e => e.Eur)
            ...
            entity.HasOne(d => d.CcaNavigation).WithMany(p => p.Mr2s)
                .HasForeignKey(d => d.Cca)
                .HasConstraintName("FK_MR2_CCA");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.Mr2s)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_MRT");

            entity.ToTable("Mrt", tb => tb.HasComment("Amortisable items"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_MRT_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("ESP", "DF_MRT_cur");
            entity.Property(e => e.Dsc)
                .HasMaxLength(60)
                .IsUnicode(false)
                .HasComment("Item description")
                .HasDefaultValue("", "DF_MRT_dsc");
            entity.Property(e => e.Emp).HasComment("Company, foreign key for Emp table");
            entity.Property(e => e.Eur)
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_MRT_fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Pts)
            ...
            entity.HasOne(d => d.AltaCcaNavigation).WithMany(p => p.MrtAltaCcaNavigations)
                .HasForeignKey(d => d.AltaCca)
                .HasConstraintName("FK_MRT_CCA");

            entity.HasOne(d => d.BaixaCcaNavigation).WithMany(p => p.MrtBaixaCcaNavigations)
                .HasForeignKey(d => d.BaixaCca)
                .HasConstraintName("FK_MRT_CCA1");

            entity.HasOne(d => d.CtaNavigation).WithMany(p => p.Mrts)
                .HasForeignKey(d => d.Cta)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Cod).HasName("PK_MRTTIPOS");

            entity.ToTable(tb => tb.HasComment("Amortisation rates"));
        ...
        modelBuilder.Entity<Msg>(entity =>
        {
            ...
            entity.ToTable("Msg", tb => tb.HasComment("Messages sent by App users"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Creation date")
                .HasDefaultValueSql("(getdate())", "DF_Msg_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Id)
                .HasComment("Message sequential number")
                .HasDefaultValue(0, "DF_Msg_Id");
            entity.Property(e => e.Text)
                .HasComment("Message body")
                .HasColumnType("text");
            entity.Property(e => e.UsrCreated).HasComment("User semding the message");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.Msgs)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Multum>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Penalty fees"));
            ...
            entity.Property(e => e.Fch).HasComment("Infringement date");
            entity.Property(e => e.Pagat).HasComment("Payment date");
            entity.Property(e => e.Subjecte).HasComment("Penalty object, usually a car from the company fleet");
            entity.Property(e => e.Vto).HasComment("Payment deadline");

            entity.HasOne(d => d.EmisorNavigation).WithMany(p => p.Multa)
                .HasForeignKey(d => d.Emisor)
                .HasConstraintName("FK_Multa_CliGral");
        });

        modelBuilder.Entity<N43cca>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("N43Cca");

            entity.Property(e => e.Guid).ValueGeneratedNever();

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.N43ccas)
                .HasForeignKey(d => d.Parent)
                .HasConstraintName("FK_N43Cca_N43Hdr");
        });

        modelBuilder.Entity<N43hdr>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("N43Hdr");

            entity.HasIndex(e => new { e.Ccc, e.Fch }, "IX_N43Hdr_CccFch").IsUnique();
        ...
        modelBuilder.Entity<N43itm>(entity =>
        {
            entity.HasKey(e => new { e.Parent, e.Cod, e.Idx });

            entity.ToTable("N43Itm");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.N43itms)
                .HasForeignKey(d => d.Parent)
                .HasConstraintName("FK_N43Itm_N43Cca");
        });

        modelBuilder.Entity<N43template>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("N43Template");

            entity.HasIndex(e => new { e.Emp, e.Pattern }, "Ix_N43Template_Emp_Pattern").IsUnique();

            entity.Property(e => e.Guid).ValueGeneratedNever();
            entity.Property(e => e.Concepte)
                .HasMaxLength(62)
                .IsUnicode(false);
            entity.Property(e => e.Emp).HasDefaultValue(6, "DF_N43Template_Emp");
        ...
        modelBuilder.Entity<Nav>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_Nav_Guid");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.InverseParentNavigation)
                .HasForeignKey(d => d.Parent)
                .HasConstraintName("FK_Nav_Parent");

            entity.HasMany(d => d.Claims).WithMany(p => p.Navs)
                .UsingEntity<Dictionary<string, object>>(
                    "NavClaim",
                    r => r.HasOne<Claim>().WithMany()
                        .HasForeignKey("Claim")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_NavClaim_Claim"),
                    l => l.HasOne<Nav>().WithMany()
                        .HasForeignKey("Nav")
                        .HasConstraintName("FK_NavClaims_Nav"),
                    j =>
                    {
                        j.HasKey("Nav", "Claim");
                        j.ToTable("NavClaim");
            ...
            entity.HasMany(d => d.Emps).WithMany(p => p.Navs)
                .UsingEntity<Dictionary<string, object>>(
                    "NavEmp",
                    r => r.HasOne<Emp>().WithMany()
                        .HasForeignKey("Emp")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_NavEmp_Emp"),
                    l => l.HasOne<Nav>().WithMany()
                        .HasForeignKey("Nav")
                        .HasConstraintName("FK_NavEmp_Nav"),
                    j =>
                    {
                        j.HasKey("Nav", "Emp");
                        j.ToTable("NavEmp");
        ...
        modelBuilder.Entity<NavRol>(entity =>
        {
            ...
            entity.HasIndex(e => new { e.Rol, e.Nav }, "Idx_NavRol_RolNav").IsUnique();

            entity.HasOne(d => d.NavNavigation).WithMany(p => p.NavRols)
        ...
        modelBuilder.Entity<Newsletter>(entity =>
        {
            ...
            entity.ToTable("Newsletter", tb => tb.HasComment("Newsletters sent to subscribed leads"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Newsletter_Guid");
            entity.Property(e => e.Fch)
        ...
        {
            entity.HasKey(e => new { e.Newsletter, e.Ord }).HasName("PK_NewsletterSource_1");

            entity.ToTable("NewsletterSource", tb => tb.HasComment("Posts referred to on each newsletter"));
            ...
            entity.HasOne(d => d.NewsletterNavigation).WithMany(p => p.NewsletterSources)
        ...
        modelBuilder.Entity<Nomina>(entity =>
        {
            ...
            entity.ToTable("Nomina", tb => tb.HasComment("Employee salary sheets"));
            ...
            entity.Property(e => e.Embargos)
                ...
                .HasColumnType("decimal(9, 0)");
            entity.Property(e => e.Fch).HasComment("Salary date");
            ...
            entity.HasOne(d => d.Cca).WithOne(p => p.Nomina)
                .HasForeignKey<Nomina>(d => d.CcaGuid)
                .HasConstraintName("FK_Nomina_CCA");

            entity.HasOne(d => d.StaffNavigation).WithMany(p => p.Nominas)
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_NOMINA_CONCEPTE");

            entity.ToTable("NominaConcepte", tb => tb.HasComment("Employee salary concepts"));

            entity.Property(e => e.Id).HasComment("Concept cdefined by externalized salary management company");
            entity.Property(e => e.Concepte)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Concept description")
                .HasDefaultValue("", "DF_NOMINA_CONCEPTE_Concepte");
        });

        modelBuilder.Entity<NominaItem>(entity =>
        {
            entity.HasKey(e => new { e.CcaGuid, e.Lin }).HasName("PK_NOMINA_ITEM_1");

            entity.ToTable("NominaItem", tb => tb.HasComment("Employee salary items"));
            ...
            entity.HasOne(d => d.Cca).WithMany(p => p.NominaItems)
                .HasForeignKey(d => d.CcaGuid)
                .HasConstraintName("FK_NominaItem_Nomina");

            entity.HasOne(d => d.CodiConcepteNavigation).WithMany(p => p.NominaItems)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_NEWS");

            entity.ToTable(tb => tb.HasComment("News posts"));

            entity.HasIndex(e => e.Fch, "IX_Noticia_Fch").IsDescending();

            entity.HasIndex(e => e.UrlFriendlySegment, "IX_Noticia_Url");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_NEWS_Guid");
            ...
            entity.Property(e => e.DestacarFrom).HasComment("Date this post should be highlited from");
            entity.Property(e => e.DestacarTo).HasComment("Date this post should no longer be highlited");
            entity.Property(e => e.Emp)
                .HasComment("Company; foreign key for Emp table")
                .HasDefaultValue(1, "DF_Noticia_Emp");
            entity.Property(e => e.Fch)
                .HasComment("News date")
                .HasDefaultValueSql("(getdate())", "DF_NEWS_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Noticia_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchFrom).HasComment("In case of events, start date");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date and time this entry was last edited")
                .HasDefaultValueSql("(getdate())", "DF_Noticia_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.FchTo).HasComment("In case of events, end date");
            ...
            entity.Property(e => e.Visible)
                ...
                .HasDefaultValue(true, "DF_Noticia_Visible");

            entity.HasOne(d => d.CnapNavigation).WithMany(p => p.Noticia)
                .HasForeignKey(d => d.Cnap)
                .HasConstraintName("FK_Noticia_Cnap");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Noticia)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Noticia_Emp");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.NoticiumUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_Noticia_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.NoticiumUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
                .HasConstraintName("FK_Noticia_UsrLastEdited");

            entity.HasMany(d => d.Categoria).WithMany(p => p.Noticia)
                .UsingEntity<Dictionary<string, object>>(
                    "NoticiaCategorium",
                    r => r.HasOne<CategoriaDeNoticium>().WithMany()
                        .HasForeignKey("Categoria")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_NoticiaCategoria_CategoriaDeNoticia"),
                    l => l.HasOne<Noticium>().WithMany()
                        .HasForeignKey("Noticia")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_NoticiaCategoria_Noticia"),
                    j =>
                    {
                        j.HasKey("Noticia", "Categoria");
                        j.ToTable("NoticiaCategoria", tb => tb.HasComment("News posts per category"));
            ...
            entity.HasMany(d => d.Channels).WithMany(p => p.Noticia)
                .UsingEntity<Dictionary<string, object>>(
                    "NoticiaChannel",
                    r => r.HasOne<DistributionChannel>().WithMany()
                        .HasForeignKey("Channel")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_NoticiaChannel_DistributionChannel"),
                    l => l.HasOne<Noticium>().WithMany()
                        .HasForeignKey("Noticia")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_NoticiaChannel_Noticia"),
                    j =>
                    {
                        j.HasKey("Noticia", "Channel");
                        j.ToTable("NoticiaChannel", tb => tb.HasComment("News posts per distribution channel"));
        ...
        modelBuilder.Entity<Offer>(entity =>
        {
            ...
            entity.Property(e => e.FchCreated)
                .HasDefaultValueSql("(getdate())", "DF_Offers_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Price).HasColumnType("decimal(18, 0)");
        });

        modelBuilder.Entity<Otto>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("Otto");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_SermepaConfig");

            entity.ToTable("PaymentGateway", tb => tb.HasComment("Bank online gateways to manage secure payments from customers credit cards"));
            ...
            entity.Property(e => e.FchFrom)
                ...
                .HasDefaultValueSql("(getdate())", "DF_SermepaConfig_FchFrom");
            entity.Property(e => e.FchTo).HasComment("Date the gateway was closed");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PDC");

            entity.ToTable("Pdc", tb => tb.HasComment("Purchase Order header details"));
            ...
            entity.HasIndex(e => new { e.Emp, e.Yea, e.Pdc1 }, "IX_Pdc_EmpYeaPdc").IsUnique();

            entity.HasIndex(e => e.Fch, "IX_Pdc_Fch").IsDescending();
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PDC_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency (ISO 4217)")
                .HasDefaultValue("EUR", "DF_PDC_Cur");
            entity.Property(e => e.CustomerDocUrl)
            ...
            entity.Property(e => e.Fch).HasComment("Official order date");
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time this order was registered")
                .HasDefaultValueSql("(getdate())", "DF_PDC_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Last date this order was edited")
                .HasDefaultValueSql("(getdate())", "DF_PDC_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.FchMax).HasComment("Don't deliver after this date, if any");
            entity.Property(e => e.FchMin).HasComment("Don't deliver before this date, if any");
            entity.Property(e => e.Fpg)
            ...
            entity.HasOne(d => d.Cli).WithMany(p => p.PdcClis)
                .HasForeignKey(d => d.CliGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Pdc_Customer");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Pdcs)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Pdc_Emp");

            entity.HasOne(d => d.FacturarANavigation).WithMany(p => p.PdcFacturarANavigations)
                .HasForeignKey(d => d.FacturarA)
                .HasConstraintName("FK_Pdc_FacturarA");

            entity.HasOne(d => d.PlatformNavigation).WithMany(p => p.PdcPlatformNavigations)
                .HasForeignKey(d => d.Platform)
                .HasConstraintName("FK_Pdc_Platform");

            entity.HasOne(d => d.PromoNavigation).WithMany(p => p.Pdcs)
                .HasForeignKey(d => d.Promo)
                .HasConstraintName("FK_Pdc_Incentiu");

            entity.HasOne(d => d.UsrCreated).WithMany(p => p.PdcUsrCreateds)
                .HasForeignKey(d => d.UsrCreatedGuid)
                .HasConstraintName("FK_Pdc_UsrCreated");

            entity.HasOne(d => d.UsrLastEdited).WithMany(p => p.PdcUsrLastEditeds)
                .HasForeignKey(d => d.UsrLastEditedGuid)
        ...
        modelBuilder.Entity<Pdd>(entity =>
        {
            ...
            entity.ToTable("Pdd", tb => tb.HasComment("Shortcuts for purchase order concepts"));

            entity.HasIndex(e => e.SearchKey, "Pdd_Idx_Searchkey").IsUnique();

            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_Pdd_Guid");
            entity.Property(e => e.Cat)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Concept in Catalan language")
                .HasDefaultValue("", "DF_PDD_CAT");
            entity.Property(e => e.Eng)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Concept in English language")
                .HasDefaultValue("", "DF_PDD_ENG");
            entity.Property(e => e.Esp)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Concept in Spanish language")
                .HasDefaultValue("", "DF_PDD_ESP");
            entity.Property(e => e.Id)
                .HasMaxLength(5)
                .IsUnicode(false)
                .HasComment("Shortcut. A short text the user enters which the system converts into an often used text")
                .HasDefaultValue("", "DF_PDD_Id");
        ...
        modelBuilder.Entity<PgcClass>(entity =>
        {
            ...
            entity.ToTable("PgcClass", tb => tb.HasComment("Recursive account groups"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PgcClass_Guid");
            ...
            entity.HasOne(d => d.PlanNavigation).WithMany(p => p.PgcClasses)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PGCCTA_1");

            entity.ToTable(tb => tb.HasComment("Accounts accounts"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PGCCTA_Guid");
            ...
            entity.Property(e => e.Eng)
                ...
                .HasDefaultValue("", "DF_PGCCTA_Eng");
            entity.Property(e => e.Esp)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasComment("Account name, Spanish language")
                .HasDefaultValue("", "DF_PGCCTA_Esp");
            entity.Property(e => e.Id)
                .HasMaxLength(5)
                .IsUnicode(false)
                .HasComment("Account Id, 5 digits")
                .HasDefaultValue("", "DF_PGCCTA_Id");
            ...
            entity.HasOne(d => d.NextCta).WithMany(p => p.InverseNextCta)
                .HasForeignKey(d => d.NextCtaGuid)
                .HasConstraintName("FK_PgcCta_NextCta");

            entity.HasOne(d => d.PgcClassNavigation).WithMany(p => p.PgcCta)
                .HasForeignKey(d => d.PgcClass)
                .HasConstraintName("FK_PGCCTA_PgcClass");

            entity.HasOne(d => d.PlanNavigation).WithMany(p => p.PgcCta)
                .HasForeignKey(d => d.Plan)
        ...
        modelBuilder.Entity<PgcPlan>(entity =>
        {
            ...
            entity.ToTable("PgcPlan", tb => tb.HasComment("Accounts plan"));
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CustomTemplate");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PNC");

            entity.ToTable("Pnc", tb => tb.HasComment("Purchase order items"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PNC_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .HasDefaultValue("EUR", "DF_Pnc_Cur");
            ...
            entity.HasOne(d => d.Pdc).WithMany(p => p.Pncs)
                .HasForeignKey(d => d.PdcGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Pnd>(entity =>
        {
            ...
            entity.ToTable("Pnd", tb => tb.HasComment("Pending debts and credits"));

            entity.HasIndex(e => new { e.ContactGuid, e.Status, e.Vto, e.Fra }, "IX_PND_ContactGuid");

            entity.HasIndex(e => e.Guid, "IX_PND_Guid").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PND_Guid");
            entity.Property(e => e.Ad)
                .HasMaxLength(1)
                .IsUnicode(false)
                .IsFixedLength()
                .HasComment("Enumerable DTOPnd.Codis (1.debit, 2.credit)")
                .HasDefaultValue("D", "DF_PND_ad");
            ...
            entity.Property(e => e.Div)
                ...
                .IsFixedLength()
                .HasComment("ISO 4217 Currency code")
                .HasDefaultValue("EUR", "DF_PND_Div");
            entity.Property(e => e.Emp)
                .HasComment("Company; key of Emp table")
                .HasDefaultValue((short)1, "DF_PND_Emp");
            entity.Property(e => e.Eur)
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_Pnd_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Fpg)
                .HasMaxLength(255)
                .HasComment("Payment way, free text")
                .HasDefaultValue("", "DF_PND_fpg");
            entity.Property(e => e.Fra)
                .HasMaxLength(18)
                .IsUnicode(false)
                .HasComment("Invoice number, if any")
                .HasDefaultValue("", "DF_PND_fra");
            ...
            entity.Property(e => e.Vto).HasComment("Due date");
            entity.Property(e => e.Yef).HasComment("Year of the invoice, if any");

            entity.HasOne(d => d.Contact).WithMany(p => p.Pnds)
                .HasForeignKey(d => d.ContactGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PortsCondicion>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Transport to customer conditions"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PortsCondicions_Guid");
            ...
            entity.Property(e => e.Fee)
                ...
                .HasDefaultValue(0m, "DF_PORTS_Fee")
                .HasColumnType("numeric(4, 2)");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Friendly name")
                .HasDefaultValue("", "DF_PORTS_nom");
            entity.Property(e => e.Ord)
                .HasComment("Sort order")
                .HasDefaultValue(9999, "DF_PortsCondicions_Ord");
            entity.Property(e => e.PdcMinVal)
                .HasComment("Minimum order value for free of charge transport")
                .HasDefaultValue(0m, "DF_PortsCondicions_PdcMinVal")
        ...
        modelBuilder.Entity<PostComment>(entity =>
        {
            ...
            entity.ToTable("PostComment", tb => tb.HasComment("Comments to website and blog posts"));

            entity.HasIndex(e => new { e.Parent, e.Fch }, "IX_PostComment_ParentFch").IsDescending(false, true);
            ...
            entity.Property(e => e.Lang)
                ...
                .IsFixedLength()
                .HasComment("ISO 639-2 language code")
                .HasDefaultValue("ESP", "DF_PostComment_Lang");
            ...
            entity.Property(e => e.ParentSource)
                ...
                .HasDefaultValue(1, "DF_PostComment_ParentSource");
            entity.Property(e => e.Text)
                .HasComment("Comment text")
                .HasColumnType("text");
            entity.Property(e => e.User).HasComment("User who wrote the comment");

            entity.HasOne(d => d.AnswerRootNavigation).WithMany(p => p.InverseAnswerRootNavigation)
                .HasForeignKey(d => d.AnswerRoot)
                .HasConstraintName("FK_PostComment_AnswerRoot");

            entity.HasOne(d => d.AnsweringNavigation).WithMany(p => p.InverseAnsweringNavigation)
                .HasForeignKey(d => d.Answering)
                .HasConstraintName("FK_PostComment_Answeering");

            entity.HasOne(d => d.UserNavigation).WithMany(p => p.PostComments)
                .HasForeignKey(d => d.User)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PremiumCustomer_1");

            entity.ToTable("PremiumCustomer", tb => tb.HasComment("Customers included/excluded from Premium Line range distribution"));

            entity.HasIndex(e => e.Customer, "IX_PremiumCustomer_Customer");

            entity.HasIndex(e => new { e.Customer, e.PremiumLine }, "IX_PremiumCustomer_PLCustomer").IsUnique();
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_PremiumCustomer_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_PremiumCustomer_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.PremiumCustomers)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PremiumCustomer_CliGral");

            entity.HasOne(d => d.PremiumLineNavigation).WithMany(p => p.PremiumCustomers)
                .HasForeignKey(d => d.PremiumLine)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PremiumCustomer_PremiumLine");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.PremiumCustomerUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PremiumCustomer_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.PremiumCustomerUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<PremiumLine>(entity =>
        {
            ...
            entity.ToTable("PremiumLine", tb => tb.HasComment("Product range with distribution limited to selected customers"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PremiumLine_Guid");
            ...
            entity.Property(e => e.Nom)
                ...
                .HasDefaultValue("", "DF_PremiumLine_Caption");
        });
        ...
        modelBuilder.Entity<PremiumProduct>(entity =>
        {
            ...
            entity.ToTable("PremiumProduct", tb => tb.HasComment("Products included on a PremiumLine range"));
            ...
            entity.Property(e => e.Ord)
                ...
                .HasDefaultValue(999, "DF_PremiumProduct_Ord");

            entity.HasOne(d => d.PremiumLineNavigation).WithMany(p => p.PremiumProducts)
                .HasForeignKey(d => d.PremiumLine)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PremiumProduct_PremiumLine");

            entity.HasOne(d => d.ProductNavigation).WithMany(p => p.PremiumProducts)
        ...
        modelBuilder.Entity<PriceListCustomer>(entity =>
        {
            ...
            entity.ToTable("PriceList_Customer", tb => tb.HasComment("Retail price lists"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_PriceList_Customer_Guid");
            entity.Property(e => e.Concepte)
            ...
            entity.Property(e => e.Currency)
                ...
                .IsFixedLength()
                .HasComment("ISO 4217 currency code")
                .HasDefaultValue("EUR", "DF_PriceList_Customer_Currency");
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_PriceList_Customer_Fch");
            entity.Property(e => e.FchEnd).HasComment("Termination date");
            entity.Property(e => e.Visible)
                .HasComment("If true, visible to customers")
                .HasDefaultValue(true, "DF_PriceList_Customer_Visible");

            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.PriceListCustomers)
                .HasForeignKey(d => d.Customer)
        ...
        modelBuilder.Entity<PriceListItemCustomer>(entity =>
        {
            ...
            entity.ToTable("PriceListItem_Customer", tb => tb.HasComment("Retail prices"));

            entity.HasIndex(e => new { e.Art, e.PriceList }, "IX_PriceListItemCustomer_Art_PriceList").IsUnique();
            ...
            entity.HasOne(d => d.ArtNavigation).WithMany(p => p.PriceListItemCustomers)
                .HasForeignKey(d => d.Art)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PriceListItem_Customer_ART");

            entity.HasOne(d => d.PriceListNavigation).WithMany(p => p.PriceListItemCustomers)
        ...
        modelBuilder.Entity<PriceListItemSupplier>(entity =>
        {
            ...
            entity.ToTable("PriceListItem_Supplier", tb => tb.HasComment("Supplier price list items"));

            entity.HasIndex(e => new { e.PriceList, e.Lin }, "IX_PriceListItem_Supplier_Lin").IsUnique();
            ...
            entity.HasOne(d => d.PriceListNavigation).WithMany(p => p.PriceListItemSuppliers)
                .HasForeignKey(d => d.PriceList)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PriceList");

            entity.ToTable("PriceList_Supplier", tb => tb.HasComment("Supplier price lists"));

            entity.HasIndex(e => new { e.Proveidor, e.Fch }, "IX_PriceList_Supplier_Proveidor_Fch").IsDescending(false, true);
            ...
            entity.Property(e => e.Concepte)
                ...
                .IsUnicode(false)
                .HasComment("Price list description")
                .HasDefaultValue("", "DF_PriceList_Concepte");
            entity.Property(e => e.Currency)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasComment("ISO 4217 currency code")
                .HasDefaultValue("EUR", "DF_PriceList_Cur");
            ...
            entity.Property(e => e.Docfile)
                ...
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Fch).HasComment("Price list date");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength()
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.PriceListSuppliers)
                .HasForeignKey(d => d.Hash)
                .HasConstraintName("FK_PriceList_Supplier_DocFile");

            entity.HasOne(d => d.ProveidorNavigation).WithMany(p => p.PriceListSuppliers)
                .HasForeignKey(d => d.Proveidor)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ProductChannel>(entity =>
        {
            ...
            entity.ToTable("ProductChannel", tb => tb.HasComment("Product range per distribution channel"));

            entity.HasIndex(e => new { e.DistributionChannel, e.Cod }, "IX_ProductChannel_Channel");

            entity.HasIndex(e => new { e.Product, e.DistributionChannel }, "IX_ProductChannel_ProductChannelCod").IsUnique();
            ...
            entity.HasOne(d => d.DistributionChannelNavigation).WithMany(p => p.ProductChannels)
                .HasForeignKey(d => d.DistributionChannel)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<ProductDownload>(entity =>
        {
            ...
            entity.ToTable("ProductDownload", tb => tb.HasComment("Product documents"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_ProductDownload_Guid");
            entity.Property(e => e.Docfile)
                .HasMaxLength(24)
                .IsUnicode(false)
                .IsFixedLength();
            ...
            entity.Property(e => e.Langset)
                ...
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("1111", "DF_ProductDownload_Langset");
            entity.Property(e => e.Obsoleto).HasComment("True if outdated");
            entity.Property(e => e.Ord).HasComment("Sort order");
            ...
            entity.Property(e => e.PublicarAlConsumidor)
                ...
                .HasDefaultValue(true, "DF_ProductDownload_PublicarAlConsumidor");
            entity.Property(e => e.PublicarAlDistribuidor)
                .HasComment("True if visible to proffessional")
                .HasDefaultValue(true, "DF_ProductDownload_PublicarAlDistribuidor");
            ...
            entity.HasOne(d => d.HashNavigation).WithMany(p => p.ProductDownloads)
                .HasForeignKey(d => d.Hash)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_ProductPlugins");

            entity.ToTable("ProductPlugin", tb => tb.HasComment("Website product plugins to include in Html posts"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_ProductPlugins_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_ProductPlugins_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.ProductPluginUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_ProductPlugin_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.ProductPluginUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_ProductPluginSku");

            entity.ToTable("ProductPluginItem", tb => tb.HasComment("Products included on each product plugin"));
            ...
            entity.HasOne(d => d.PluginNavigation).WithMany(p => p.ProductPluginItems)
        ...
        modelBuilder.Entity<Projecte>(entity =>
        {
            ...
            entity.ToTable("Projecte", tb => tb.HasComment("Projects to be referred from other tables"));
            ...
            entity.Property(e => e.FchFrom)
                .HasComment("Start date")
                .HasDefaultValueSql("(getdate())", "DF_Projecte_Fch");
            entity.Property(e => e.FchTo)
                .HasMaxLength(10)
                .IsFixedLength()
                .HasComment("End date");
            entity.Property(e => e.Nom)
                ...
                .HasDefaultValue("", "DF_Projecte_Nom");
        });

        modelBuilder.Entity<PromofarmaFeed>(entity =>
        {
            entity.HasKey(e => new { e.Customer, e.Sku }).HasName("PK_PromofarmaFeed_1");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_PROVINCIA");

            entity.ToTable(tb => tb.HasComment("Region provinces"));

            entity.Property(e => e.Guid)
                .HasComment("Primary Key")
                .HasDefaultValueSql("(newid())", "DF_PROVINCIA_Guid");
            ...
            entity.Property(e => e.Mod347)
                ...
                .HasDefaultValue("", "DF_PROVINCIA_Zip");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Provincia name")
                .HasDefaultValue("", "DF_PROVINCIA_Nom");
            entity.Property(e => e.Regio).HasComment("Foreign key for Region table");

            entity.HasOne(d => d.RegioNavigation).WithMany(p => p.Provincia)
        ...
        modelBuilder.Entity<PrvCliNum>(entity =>
        {
            ...
            entity.ToTable("PrvCliNum", tb => tb.HasComment("Customer numbers assigned by our suppliers to our customers. Used to automate Excel files for example Mayborn requests to supply his Pharma channel distributors"));
            ...
            entity.HasOne(d => d.ProveidorNavigation).WithMany(p => p.PrvCliNums)
                .HasForeignKey(d => d.Proveidor)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Recall>(entity =>
        {
            ...
            entity.ToTable("Recall", tb => tb.HasComment("Manufacturer requests to recall defectuous products"));

            entity.Property(e => e.Guid)
                .ValueGeneratedNever()
                .HasComment("Primary key");
            entity.Property(e => e.Fch).HasComment("Date of alert");
            entity.Property(e => e.Nom)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasComment("Friendly name");
        ...
        modelBuilder.Entity<RecallCli>(entity =>
        {
            ...
            entity.ToTable("RecallCli", tb => tb.HasComment("Customer recall of products"));
            ...
            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.RecallClis)
                .HasForeignKey(d => d.Country)
                .HasConstraintName("FK_RecallCli_Country");

            entity.HasOne(d => d.DeliveryNavigation).WithMany(p => p.RecallClis)
                .HasForeignKey(d => d.Delivery)
                .HasConstraintName("FK_RecallCli_Alb");

            entity.HasOne(d => d.PurchaseOrderNavigation).WithMany(p => p.RecallClis)
                .HasForeignKey(d => d.PurchaseOrder)
                .HasConstraintName("FK_RecallCli_PDC");

            entity.HasOne(d => d.RecallNavigation).WithMany(p => p.RecallClis)
                .HasForeignKey(d => d.Recall)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RecallCli_Recall");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.RecallClis)
                .HasForeignKey(d => d.UsrCreated)
        ...
        {
            entity.HasKey(e => new { e.RecallCli, e.SerialNumber }).HasName("PK_RecallSerial");

            entity.ToTable("RecallProduct", tb => tb.HasComment("Products recalled from customer"));
            ...
            entity.HasOne(d => d.RecallCliNavigation).WithMany(p => p.RecallProducts)
        ...
        {
            entity.ToTable("RedsysErr", tb => tb.HasComment("Errors received from Redsys Api. Redsys is our bank payment gateway platform for customer payments through credit cards"));
        ...
        modelBuilder.Entity<Ref>(entity =>
        {
            ...
            entity.Property(e => e._42112251)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("42112251 ");
        });
        ...
        modelBuilder.Entity<Regio>(entity =>
        {
            ...
            entity.ToTable("Regio", tb => tb.HasComment("Region details. A region belongs to a Country and is split on Provincias"));
            ...
            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.Regios)
                .HasForeignKey(d => d.Country)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<RepCliCom>(entity =>
        {
            ...
            entity.ToTable("RepCliCom", tb => tb.HasComment("Agent customers with specific commission terms "));

            entity.HasIndex(e => new { e.Rep, e.Cli, e.Fch }, "IX_RepCliCom_RepCliFch");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_RepCliCom_Guid");
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_RepCliCom_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
            ...
            entity.HasOne(d => d.CliNavigation).WithMany(p => p.RepCliComs)
                .HasForeignKey(d => d.Cli)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RepCliCom_CliClient");

            entity.HasOne(d => d.RepNavigation).WithMany(p => p.RepCliComs)
                .HasForeignKey(d => d.Rep)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RepCliCom_CliRep");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.RepCliComs)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<RepLiq>(entity =>
        {
            ...
            entity.ToTable("RepLiq", tb => tb.HasComment("Commission statements"));

            entity.HasIndex(e => new { e.RepGuid, e.Yea, e.Id }, "IX_RepGuidYeaId").IsUnique();
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency");
            entity.Property(e => e.Fch).HasComment("Statement date");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_RepProduct");

            entity.ToTable(tb => tb.HasComment("Agent portfolio"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Entry creation date")
                .HasDefaultValueSql("(getdate())", "DF_RepProducts_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchFrom).HasComment("Date of agreement");
            entity.Property(e => e.FchTo).HasComment("Date of termination");
            ...
            entity.HasOne(d => d.DistributionChannelNavigation).WithMany(p => p.RepProducts)
                .HasForeignKey(d => d.DistributionChannel)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RepProducts_DistributionChannel1");

            entity.HasOne(d => d.RepNavigation).WithMany(p => p.RepProducts)
                .HasForeignKey(d => d.Rep)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_RPS");

            entity.ToTable(tb => tb.HasComment("Invoice item that generates a sale commission to a specific rep"));
            ...
            entity.Property(e => e.Liquidable)
                ...
                .HasDefaultValue(true, "DF_RPS_Liquidable");
            entity.Property(e => e.Obs)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Comments")
                .HasDefaultValue("", "DF_RPS_obs");
            entity.Property(e => e.RepGuid).HasComment("Agent. Foreign key for CliGral table");
            entity.Property(e => e.RepLiqGuid).HasComment("Commission statement. Foreign key to RepLiq table");

            entity.HasOne(d => d.Fra).WithMany(p => p.Rps)
                .HasForeignKey(d => d.FraGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_RPS_FRA");

            entity.HasOne(d => d.RepLiq).WithMany(p => p.Rps)
        ...
        modelBuilder.Entity<SalesManager>(entity =>
        {
            ...
            entity.ToTable("SalesManager", tb => tb.HasComment("Sales managers"));
        ...
        modelBuilder.Entity<SatRecall>(entity =>
        {
            ...
            entity.ToTable("SatRecall", tb => tb.HasComment("Manufacturer repairs. The manufacturer picks up the product at customer location, repairs and returns it back"));
            ...
            entity.Property(e => e.ReturnFch).HasComment("Date of return back to customer");
            ...
            entity.HasOne(d => d.IncidenciaNavigation).WithMany(p => p.SatRecalls)
                .HasForeignKey(d => d.Incidencia)
                .HasConstraintName("FK_SatRecall_Incidencies");

            entity.HasOne(d => d.ZipNavigation).WithMany(p => p.SatRecalls)
                .HasForeignKey(d => d.Zip)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_SearchBox");

            entity.ToTable("SearchRequest", tb => tb.HasComment("Logs each time a visitor uses our website search box, registering the search key used"));
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_SearchBox_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.SearchKey)
                .HasMaxLength(100)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.EmailNavigation).WithMany(p => p.SearchRequests)
        ...
        modelBuilder.Entity<SearchResult>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Logs the results found when a user uses the searchbox of our website"));
            ...
            entity.Property(e => e.Pk)
                .HasDefaultValueSql("(newid())", "DF_SearchResults_PK")
                .HasColumnName("PK");
            ...
            entity.HasOne(d => d.SearchRequestNavigation).WithMany(p => p.SearchResults)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CategoriasSegSocial");

            entity.ToTable(tb => tb.HasComment("Social security employees category groups"));

            entity.HasIndex(e => e.Id, "IX_SegSocialGrups_Id").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_SegSocialGrups_Guid");
            entity.Property(e => e.Id).HasComment("Sort order");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Group name")
                .HasDefaultValue("", "DF_CategoriasSegSocial_Nom");
        });

        modelBuilder.Entity<SepaMe>(entity =>
        {
            entity.HasKey(e => e.Guid).HasName("PK_DTOSepaMe");

            entity.ToTable("SepaMe", tb => tb.HasComment("Bank Sepa mandates signed by us to our creditors"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this record was created")
                .HasDefaultValueSql("(getdate())", "DF_DTOSepaMe_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchFrom).HasComment("Date from which this mandate is valid");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this record was edited for last time")
                .HasColumnType("datetime");
            entity.Property(e => e.FchTo).HasComment("Expiration date");
            entity.Property(e => e.Hash)
                .HasMaxLength(10)
                .IsUnicode(false)
                .IsFixedLength()
            ...
            entity.HasOne(d => d.BancNavigation).WithMany(p => p.SepaMes)
                .HasForeignKey(d => d.Banc)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SepaMe_CliBnc");

            entity.HasOne(d => d.HashNavigation).WithMany(p => p.SepaMes)
                .HasForeignKey(d => d.Hash)
                .HasConstraintName("FK_SepaMe_DocFile");

            entity.HasOne(d => d.LliuradorNavigation).WithMany(p => p.SepaMes)
                .HasForeignKey(d => d.Lliurador)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SepaMe_Lliurador");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.SepaMeUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .HasConstraintName("FK_SepaMe_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.SepaMeUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
        ...
        modelBuilder.Entity<SepaText>(entity =>
        {
            ...
            entity.ToTable("Sepa_Texts", tb => tb.HasComment("Texts used to composed Sepa bank mandate in the different languages supported"));
            ...
            entity.Property(e => e.Lang)
                ...
                .HasDefaultValue("ESP", "DF_Sepa_Texts_LangId");
        ...
        modelBuilder.Entity<ShoppingBasket>(entity =>
        {
            ...
            entity.Property(e => e.Fch)
                .HasDefaultValueSql("(getdate())", "DF_ShoppingBasket_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.FchCreated)
                .HasDefaultValueSql("(getdate())", "DF_ShoppingBasket_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.Lang)
                ...
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("ESP", "DF_ShoppingBasket_Lang");
            ...
            entity.Property(e => e.OrderNum)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.Ports).HasColumnType("decimal(7, 2)");
            entity.Property(e => e.Tel)
                .HasMaxLength(20)
                .IsUnicode(false);
            entity.Property(e => e.TpvOrderNum)
                .HasMaxLength(20)
                .IsUnicode(false);
            ...
            entity.HasOne(d => d.UserAccountNavigation).WithMany(p => p.ShoppingBaskets)
                .HasForeignKey(d => d.UserAccount)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ShoppingBasket_Email");
        });
        ...
        modelBuilder.Entity<ShoppingBasketItem>(entity =>
        {
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.ShoppingBasketItems)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_ShoppingBasketItem_ShoppingBasket");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.ShoppingBasketItems)
                .HasForeignKey(d => d.Sku)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SkuBundle>(entity =>
        {
            ...
            entity.ToTable("SkuBundle", tb => tb.HasComment("We call bundle to a product agrupation composed of 2 or more sku product components. This table lists which components define each bundle."));

            entity.HasIndex(e => new { e.Bundle, e.Ord }, "Ix_SkuBundle_BundleOrd").IsUnique();

            entity.HasIndex(e => new { e.Sku, e.Bundle }, "Ix_SkuBundle_SkuBundle").IsUnique();
            ...
            entity.Property(e => e.Qty)
                ...
                .HasDefaultValue(1, "DF_SkuBundle_Qty");

            entity.HasOne(d => d.BundleNavigation).WithMany(p => p.SkuBundleBundleNavigations)
                .HasForeignKey(d => d.Bundle)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SkuBundle_Bundle");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.SkuBundleSkuNavigations)
                .HasForeignKey(d => d.Sku)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SkuMoqLock>(entity =>
        {
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_ART_BLOQUEIG_fch")
                .HasColumnType("datetime");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.SkuMoqLocks)
                .HasForeignKey(d => d.Sku)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Art_Bloqueig_Log_Art");

            entity.HasOne(d => d.UsrNavigation).WithMany(p => p.SkuMoqLocks)
                .HasForeignKey(d => d.Usr)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<SkuWith>(entity =>
        {
            ...
            entity.ToTable("SkuWith", tb => tb.HasComment("Product skus that should also be added to the order when certain products are ordered"));
            ...
            entity.HasOne(d => d.ChildNavigation).WithMany(p => p.SkuWithChildNavigations)
                .HasForeignKey(d => d.Child)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SkuWith_ChildSku");

            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.SkuWithParentNavigations)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_SocialMediaPlatform");

            entity.ToTable("SocialMediaWidget", tb => tb.HasComment("Widget details for social media platforms"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_SocialMediaPlatform_Guid");
            entity.Property(e => e.Brand).HasComment("Product brand; foreign key for Tpa table");
            ...
            entity.HasOne(d => d.BrandNavigation).WithMany(p => p.SocialMediaWidgets)
                .HasForeignKey(d => d.Brand)
                .HasConstraintName("FK_SocialMediaWidget_Tpa");
        });

        modelBuilder.Entity<SonaeTt>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("SonaeTT");
            ...
            entity.Property(e => e.F5).HasMaxLength(100);
        ...
        modelBuilder.Entity<Sorteo>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Raffles for consumers"));
            ...
            entity.Property(e => e.FchDelivery).HasComment("Date the prize was delivered to the distributor");
            entity.Property(e => e.FchDistributorReaction).HasComment("Date the distributor answered our message");
            entity.Property(e => e.FchFrom)
                .HasComment("Initial date the consumers can start to participate")
                .HasColumnType("datetime");
            entity.Property(e => e.FchPicture).HasComment("Date the distributor sent the picture of the winner");
            entity.Property(e => e.FchTo)
                .HasComment("Termination date")
                .HasColumnType("datetime");
            entity.Property(e => e.FchWinnerReaction).HasComment("Date the winner contacted us");
            ...
            entity.Property(e => e.Lang)
                ...
                .HasDefaultValue("ESP", "DF_Sorteos_Lang");
            ...
            entity.Property(e => e.Visible)
                ...
                .HasDefaultValue(true, "DF_Sorteos_Visible");
            ...
            entity.HasOne(d => d.ArtNavigation).WithMany(p => p.Sorteos)
                .HasForeignKey(d => d.Art)
                .HasConstraintName("FK_Sorteos_Art");

            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.Sorteos)
                .HasForeignKey(d => d.Country)
                .HasConstraintName("FK_Sorteos_Country");

            entity.HasOne(d => d.DeliveryNavigation).WithMany(p => p.Sorteos)
                .HasForeignKey(d => d.Delivery)
                .HasConstraintName("FK_Sorteos_Alb");

            entity.HasOne(d => d.WinnerNavigation).WithMany(p => p.Sorteos)
        ...
        modelBuilder.Entity<SorteoLead>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Raffle participants"));
            ...
            entity.Property(e => e.Num)
                ...
                .HasDefaultValue(0, "DF_SorteoLeads_Num");
            entity.Property(e => e.Sorteo).HasComment("Raffle. Foreign key for Sorteos table");

            entity.HasOne(d => d.DistributorNavigation).WithMany(p => p.SorteoLeads)
                .HasForeignKey(d => d.Distributor)
                .HasConstraintName("FK_SorteoLeads_CliGral");

            entity.HasOne(d => d.LeadNavigation).WithMany(p => p.SorteoLeads)
                .HasForeignKey(d => d.Lead)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SorteoLeads_Email");

            entity.HasOne(d => d.SorteoNavigation).WithMany(p => p.SorteoLeads)
        ...
        modelBuilder.Entity<Spv>(entity =>
        {
            ...
            entity.ToTable("Spv", tb => tb.HasComment("Repair reports from workshop"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_SPV_Guid");
            entity.Property(e => e.Adr)
            ...
            entity.Property(e => e.Contacto)
                ...
                .HasDefaultValue("", "DF_SPV_contacto");
            entity.Property(e => e.Cur)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("EUR", "DF_SPV_cur");
            entity.Property(e => e.Emp).HasComment("Company; foreign key for Emp table");
            entity.Property(e => e.FchAvis)
                .HasComment("Date we ask the customer to pick upo the goods to repair")
                .HasDefaultValueSql("(getdate())", "DF_SPV_fchAvis")
                .HasColumnType("datetime");
            ...
            entity.Property(e => e.ObsTecnic)
                ...
                .HasDefaultValue("", "DF_SPV_ObsTecnic")
                .HasColumnType("text");
            ...
            entity.HasOne(d => d.Alb).WithMany(p => p.Spvs)
                .HasForeignKey(d => d.AlbGuid)
                .HasConstraintName("FK_Spv_Alb");

            entity.HasOne(d => d.Cli).WithMany(p => p.Spvs)
                .HasForeignKey(d => d.CliGuid)
                .HasConstraintName("FK_Spv_CliGral");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Spvs)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Spv_Emp");

            entity.HasOne(d => d.IncidenciaNavigation).WithMany(p => p.Spvs)
                .HasForeignKey(d => d.Incidencia)
                .HasConstraintName("FK_Spv_Incidencies");

            entity.HasOne(d => d.SpvInNavigation).WithMany(p => p.Spvs)
                .HasForeignKey(d => d.SpvIn)
                .HasConstraintName("FK_Spv_SpvIn");

            entity.HasOne(d => d.UsrOutOfSpvIn).WithMany(p => p.SpvUsrOutOfSpvIns)
                .HasForeignKey(d => d.UsrOutOfSpvInGuid)
                .HasConstraintName("FK_Spv_UsrOutOfSpvIn");

            entity.HasOne(d => d.UsrOutOfSpvOut).WithMany(p => p.SpvUsrOutOfSpvOuts)
                .HasForeignKey(d => d.UsrOutOfSpvOutGuid)
                .HasConstraintName("FK_Spv_UsrOutOfSpvOut");

            entity.HasOne(d => d.UsrRegister).WithMany(p => p.SpvUsrRegisters)
                .HasForeignKey(d => d.UsrRegisterGuid)
                .HasConstraintName("FK_Spv_UsrRegister");

            entity.HasOne(d => d.UsrTecnic).WithMany(p => p.SpvUsrTecnics)
                .HasForeignKey(d => d.UsrTecnicGuid)
                .HasConstraintName("FK_Spv_UsrTecnic");

            entity.HasOne(d => d.ZipNavigation).WithMany(p => p.Spvs)
                .HasForeignKey(d => d.Zip)
        ...
        modelBuilder.Entity<SpvIn>(entity =>
        {
            ...
            entity.ToTable("SpvIn", tb => tb.HasComment("Workshop reception of products to repair"));

            entity.HasIndex(e => new { e.Emp, e.Yea, e.Id }, "IX_SpvIn_EmpYeaId").IsUnique();

            entity.HasIndex(e => new { e.Emp, e.Fch, e.Expedicio }, "Ix_SpvIn_EmpFchExp");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_SpvIn_Guid");
            ...
            entity.Property(e => e.Expedicio)
                ...
                .HasDefaultValue("", "DF_SpvIn_expedicio");
            entity.Property(e => e.Fch)
                .HasComment("Date of reception")
                .HasDefaultValueSql("(getdate())", "DF_SpvIn_fch")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.SpvIns)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SpvIn_Emp");

            entity.HasOne(d => d.Usr).WithMany(p => p.SpvIns)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_SSC");

            entity.ToTable("Ssc", tb => tb.HasComment("Subscriptions. Automated tasks from Windows service Matsched (table Task) send email notifications to subscribed users"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_SSC_Guid");
            entity.Property(e => e.Emp).HasComment("Company; foreign key for Emp table");
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Sscs)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.SscGuid, e.Email }).HasName("PK_SSCEMAIL");

            entity.ToTable("SscEmail", tb => tb.HasComment("Subscriptors subscribed to subscriptions from Ssc table"));

            entity.HasIndex(e => new { e.Email, e.SscGuid }, "IX_SSCEMAIL_EmailSsc").IsUnique();
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_SSCEMAIL_FchCreated")
                .HasColumnType("datetime");

            entity.HasOne(d => d.EmailNavigation).WithMany(p => p.SscEmails)
                .HasForeignKey(d => d.Email)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SscEmail_Email");

            entity.HasOne(d => d.Ssc).WithMany(p => p.SscEmails)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_SSCLOG");

            entity.ToTable("SscLog", tb => tb.HasComment("Any subscription and unsubscription event is logged in this table"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_SSCLOG_guid");
            entity.Property(e => e.Action).HasComment("1. Subscribed, 0.Unsubscribed");
            entity.Property(e => e.Fch)
                .HasComment("Event date")
                .HasDefaultValueSql("(getdate())", "DF_SSCLOG_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Mail).HasComment("Subscriptor; foreign key for Email table");
            entity.Property(e => e.SscGuid).HasComment("Subscription; foreign key for Ssc table");

            entity.HasOne(d => d.MailNavigation).WithMany(p => p.SscLogs)
                .HasForeignKey(d => d.Mail)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_SscLog_Email");

            entity.HasOne(d => d.Ssc).WithMany(p => p.SscLogs)
                .HasForeignKey(d => d.SscGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => new { e.SscGuid, e.Rol }).HasName("PK_SSCROL");

            entity.ToTable("SscRol", tb => tb.HasComment("User rols available for each subscription"));

            entity.Property(e => e.SscGuid).HasComment("Subscription; foreign key for Ssc table");
            entity.Property(e => e.Rol).HasComment("Enumerable DTORol.Ids");

            entity.HasOne(d => d.Ssc).WithMany(p => p.SscRols)
                .HasForeignKey(d => d.SscGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_LaboralCategories");

            entity.ToTable("StaffCategory", tb => tb.HasComment("Social security employee categories"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_LaboralCategories_Guid");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Category name")
                .HasDefaultValue("", "DF_LaboralCategories_Nom");
            entity.Property(e => e.Ord)
                .HasComment("Sort order")
                .HasDefaultValue(99, "DF_LaboralCategories_Ord");
            entity.Property(e => e.SegSocialGrup).HasComment("Group; foreign key for SegSocialGrups table");

            entity.HasOne(d => d.SegSocialGrupNavigation).WithMany(p => p.StaffCategories)
        ...
        modelBuilder.Entity<StaffHoliday>(entity =>
        {
            ...
            entity.ToTable("StaffHoliday", tb => tb.HasComment("Employees holidays"));
            ...
            entity.HasOne(d => d.StaffNavigation).WithMany(p => p.StaffHolidays)
                .HasForeignKey(d => d.Staff)
        ...
        modelBuilder.Entity<StaffPo>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Employee position"));
        ...
        modelBuilder.Entity<StaffSched>(entity =>
        {
            ...
            entity.ToTable("StaffSched", tb => tb.HasComment("Employees schedule"));
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.StaffScheds)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_StaffSched_Emp");

            entity.HasOne(d => d.StaffNavigation).WithMany(p => p.StaffScheds)
                .HasForeignKey(d => d.Staff)
        ...
        modelBuilder.Entity<StaffSchedItem>(entity =>
        {
            ...
            entity.ToTable("StaffSchedItem", tb => tb.HasComment("Employees workday"));
            ...
            entity.HasOne(d => d.StaffSchedNavigation).WithMany(p => p.StaffSchedItems)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_STP");

            entity.ToTable("Stp", tb => tb.HasComment("Product categories for each commercial brand"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_STP_Guid");
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_STP_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Last date and time when this category was edited")
                .HasDefaultValueSql("(getdate())", "DF_STP_FCHLASTEDITED")
                .HasColumnType("datetime");
            entity.Property(e => e.ForzarInnerPack).HasComment("If true, orders are required to be multiple of InnerPack field value");
            entity.Property(e => e.HideUntil).HasComment("If not null, the category will remain hidden until disclosure date");
            entity.Property(e => e.Image)
            ...
            entity.Property(e => e.Ord)
                ...
                .HasDefaultValue(999, "DF_STP_ord");
            ...
            entity.HasOne(d => d.BrandNavigation).WithMany(p => p.Stps)
                .HasForeignKey(d => d.Brand)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_STP_TPA");

            entity.HasOne(d => d.Cnap).WithMany(p => p.Stps)
                .HasForeignKey(d => d.CnapGuid)
                .HasConstraintName("FK_Stp_Cnap");

            entity.HasOne(d => d.CodiMercanciaNavigation).WithMany(p => p.Stps)
                .HasForeignKey(d => d.CodiMercancia)
                .HasConstraintName("FK_Stp_CodisMercancia");

            entity.HasOne(d => d.MadeInNavigation).WithMany(p => p.Stps)
                .HasForeignKey(d => d.MadeIn)
                .HasConstraintName("FK_Stp_Country");
        });

        modelBuilder.Entity<StringLocalizer>(entity =>
        {
            entity.HasKey(e => new { e.StringKey, e.Lang });

            entity.ToTable("StringLocalizer");
        ...
        modelBuilder.Entity<Tamariu>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("Tamariu");

            entity.Property(e => e.Guid).ValueGeneratedNever();
            entity.Property(e => e.LastKo).HasColumnType("datetime");
            entity.Property(e => e.LastOk).HasColumnType("datetime");
            entity.Property(e => e.LastWarn).HasColumnType("datetime");
        });
        ...
        modelBuilder.Entity<Task>(entity =>
        {
            ...
            entity.ToTable("Task", tb => tb.HasComment("Automatic tasks run at specific schedules by MatSched Windows service"));

            entity.HasIndex(e => e.Cod, "IX_Task_Cod");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Task_Guid");
        ...
        modelBuilder.Entity<TaskLog>(entity =>
        {
            ...
            entity.ToTable("TaskLog", tb => tb.HasComment("Logs event results from tasks run at Matsched Windows Service"));

            entity.HasIndex(e => new { e.Task, e.Fch }, "IX_TaskLog_TaskFch").IsDescending(false, true);
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_TaskLog_Fch");
            ...
            entity.HasOne(d => d.TaskNavigation).WithMany(p => p.TaskLogs)
        ...
        modelBuilder.Entity<TaskSchedule>(entity =>
        {
            ...
            entity.ToTable("TaskSchedule", tb => tb.HasComment("Schedules used by Matsched Windows Service to run automated tasks"));
            ...
            entity.Property(e => e.Weekdays)
                ...
                .HasDefaultValue("0000000", "DF_TaskSchedule_Weekdays");

            entity.HasOne(d => d.TaskNavigation).WithMany(p => p.TaskSchedules)
                .HasForeignKey(d => d.Task)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Tax>(entity =>
        {
            ...
            entity.ToTable("Tax", tb => tb.HasComment("Taxes"));

            entity.Property(e => e.Guid)
                .ValueGeneratedNever()
                .HasComment("Primary key");
            entity.Property(e => e.Codi).HasComment("Enumerable DTOTax.Codis (VAT, Irpf...)");
            entity.Property(e => e.Fch).HasComment("Start date");
            entity.Property(e => e.Tipus)
                .HasComment("Tax rate")
                .HasColumnType("decimal(4, 2)");
        });
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_tmp_1");
        ...
        modelBuilder.Entity<Tmp3>(entity =>
        {
        ...
        modelBuilder.Entity<TmpChild>(entity =>
        {
            entity.HasKey(e => e.Guid);

            entity.ToTable("tmpChild");

            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_tmpChild_Guid");
            entity.Property(e => e.Name)
                .HasMaxLength(50)
                .IsUnicode(false);
        });

        modelBuilder.Entity<TmpParent>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_tmp");

            entity.ToTable("tmpParent");
        ...
        modelBuilder.Entity<TmpParent2>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK_tmp2");

            entity.ToTable("tmpParent2");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_TPA_1");

            entity.ToTable("Tpa", tb => tb.HasComment("Commercial brands"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_TPA_GUID");
            ...
            entity.Property(e => e.Color)
                ...
                .HasDefaultValue(-1, "DF_TPA_COLOR");
            entity.Property(e => e.Emp).HasComment("Company Id, Foreign key to Emp table");
            entity.Property(e => e.FchCreated)
                .HasComment("Date and time this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_TPA_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Last date and time this entry was edited")
                .HasDefaultValueSql("(getdate())", "DF_TPA_FchLastEdited")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.Cnap).WithMany(p => p.Tpas)
                .HasForeignKey(d => d.CnapGuid)
                .HasConstraintName("FK_Tpa_Cnap");

            entity.HasOne(d => d.CodiMercanciaNavigation).WithMany(p => p.Tpas)
                .HasForeignKey(d => d.CodiMercancia)
                .HasConstraintName("FK_Tpa_CodisMercancia");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Tpas)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Tpa_Emp");

            entity.HasOne(d => d.MadeInNavigation).WithMany(p => p.Tpas)
                .HasForeignKey(d => d.MadeIn)
                .HasConstraintName("FK_Tpa_Country");

            entity.HasOne(d => d.ProveidorNavigation).WithMany(p => p.Tpas)
                .HasForeignKey(d => d.Proveidor)
        ...
        modelBuilder.Entity<Tpv>(entity =>
        {
            ...
            entity.Property(e => e.Guid).HasDefaultValueSql("(newid())", "DF_Tpv_Guid");
            entity.Property(e => e.AdminUrlDevelopment).IsUnicode(false);
            entity.Property(e => e.AdminUrlProduction).IsUnicode(false);
            entity.Property(e => e.Emp).HasDefaultValue(1, "DF_Tpv_Emp");
            entity.Property(e => e.Environment).HasDefaultValue(1, "DF_Tpv_Environment");
            entity.Property(e => e.FchCreated)
                .HasDefaultValueSql("(getdate())", "DF_Tpv_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.GatewayUrlDevelopment).HasColumnType("text");
            entity.Property(e => e.GatewayUrlProduction).HasColumnType("text");
            entity.Property(e => e.MerchantCode)
                .HasMaxLength(10)
                .IsUnicode(false);
            entity.Property(e => e.MerchantTerminal).HasDefaultValue(1, "DF_Tpv_MerchantTerminal");
            entity.Property(e => e.MerchantUrl).HasColumnType("text");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Friendly name");
            entity.Property(e => e.PrivateKeyDevelopment).HasColumnType("text");
            entity.Property(e => e.PrivateKeyProduction).HasColumnType("text");
            entity.Property(e => e.SignatureVersion)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasDefaultValue("HMAC_SHA256_V1", "DF_Tpv_SignatureVersion");
            entity.Property(e => e.UrlKo).HasColumnType("text");
            entity.Property(e => e.UrlOk).HasColumnType("text");

            entity.HasOne(d => d.BancNavigation).WithMany(p => p.Tpvs)
                .HasForeignKey(d => d.Banc)
                .HasConstraintName("FK_Tpv_CliBnc");
        });
        ...
        modelBuilder.Entity<TpvLog>(entity =>
        {
            ...
            entity.ToTable("TpvLog", tb => tb.HasComment("Log message sent by bank online payments gateway when a customer tries to issue a payment. Info available at https://canales.redsys.es/canales/ayuda/documentacion/Manual%20integracion%20para%20conexion%20por%20Web%20Service.pdf"));

            entity.HasIndex(e => e.DsOrder, "Ix_TpvLog_Ds_Order").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_TpvLog_Guid");
            ...
            entity.Property(e => e.DsErrorCode)
                .HasMaxLength(20)
                .IsUnicode(false)
                .HasColumnName("Ds_ErrorCode");
            ...
            entity.Property(e => e.FchCreated)
                ...
                .HasDefaultValueSql("(getdate())", "DF_TpvLog_FchCreated")
                .HasColumnType("datetime");
        ...
        modelBuilder.Entity<Tracking>(entity =>
        {
            ...
            entity.ToTable("Tracking", tb => tb.HasComment("Events tracking for reports to customers for example about after sales service  status"));

            entity.HasIndex(e => new { e.Target, e.FchCreated }, "IDX_Tracking_TargetFchCreated");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Tracking_Guid");
            entity.Property(e => e.Cod).HasComment("Foreign key for Cod table describing the event tracked");
            entity.Property(e => e.FchCreated)
                .HasComment("Event date")
                .HasDefaultValueSql("(getdate())", "DF_Tracking_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");
            ...
            entity.HasOne(d => d.CodNavigation).WithMany(p => p.Trackings)
                .HasForeignKey(d => d.Cod)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Tracking_Cod");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.Trackings)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_TRANSM");

            entity.ToTable("Transm", tb => tb.HasComment("Sets of deliveries sent to the logistic center to prepare picking and packing"));

            entity.HasIndex(e => new { e.Transm1, e.Fch }, "IX_Transm_Id_Fch").IsDescending(false, true);

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF__SEUR tran__rowgu__5D0CA0AC");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("ESP", "DF_SEUR transm_cur");
            entity.Property(e => e.Emp)
                .HasComment("Company; foreign key for Emp table")
                .HasDefaultValue(1, "DF_SEUR transm_Emp");
            entity.Property(e => e.Eur)
            ...
            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Transms)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Transm_Transm");

            entity.HasOne(d => d.Mgz).WithMany(p => p.Transms)
                .HasForeignKey(d => d.MgzGuid)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_Trp_1");

            entity.ToTable("Trp", tb => tb.HasComment("Transport companies"));
            ...
            entity.HasOne(d => d.Gu).WithOne(p => p.Trp)
        ...
        modelBuilder.Entity<Tutorial>(entity =>
        {
            ...
            entity.ToTable("Tutorial", tb => tb.HasComment("Tutorials to use certain processes"));
            ...
            entity.Property(e => e.Fch)
                ...
                .HasDefaultValueSql("(getdate())", "DF_Tutorial_Fch");
            ...
            entity.HasOne(d => d.ParentNavigation).WithMany(p => p.Tutorials)
                .HasForeignKey(d => d.Parent)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<TutorialRol>(entity =>
        {
            ...
            entity.ToTable("TutorialRol", tb => tb.HasComment("User rols target for this tutorial"));
            ...
            entity.HasOne(d => d.TutorialNavigation).WithMany(p => p.TutorialRols)
        ...
        modelBuilder.Entity<TutorialSubject>(entity =>
        {
            ...
            entity.ToTable("TutorialSubject", tb => tb.HasComment("Groups different tutorials into subjects"));
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK_TXT");

            entity.ToTable("Txt", tb => tb.HasComment("Text resources in 4 languages accessible programmatically by an integer key"));

            entity.Property(e => e.Id).HasComment("Enumerable DTOTxt.Ids to access the resource programmatically");
            entity.Property(e => e.Cat)
        ...
        {
            entity.HasKey(e => e.Pk).IsClustered(false);

            entity.ToTable("UrlSegment", tb => tb.HasComment("Product url segments"));

            entity.HasIndex(e => e.Segment, "Ix_UrlAlt_UrlSegmenty").IsClustered();

            entity.HasIndex(e => e.Target, "Ix_UrlSegment_Target");

            entity.Property(e => e.Pk).HasDefaultValueSql("(newid())", "DF_UrlSegment_Pk_1");
            ...
            entity.Property(e => e.Lang)
                ...
                .HasDefaultValue("ESP", "DF_UrlSegment_Lang");
            ...
            entity.Property(e => e.Target)
                ...
                .HasDefaultValueSql("(newid())", "DF_UrlSegment_Guid");
        });

        modelBuilder.Entity<UserClaim>(entity =>
        {
            entity.HasKey(e => new { e.Usr, e.Claim });
        ...
        modelBuilder.Entity<UserDefault>(entity =>
        {
            ...
            entity.ToTable("UserDefault", tb => tb.HasComment("User default values"));
            ...
            entity.HasOne(d => d.User).WithMany(p => p.UserDefaults)
                .HasForeignKey(d => d.UserGuid)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<UsrRol>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("User rol names"));
            ...
            entity.Property(e => e.Dsc)
                ...
                .HasDefaultValue("", "DF_UsrRols_Dsc");
            entity.Property(e => e.Nom)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("Name, Spanish language")
                .HasDefaultValue("", "DF_UsrRols_Nom");
            entity.Property(e => e.NomCat)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("Name, Catalan language")
                .HasDefaultValue("", "DF_UsrRols_Nom_CAT")
                .HasColumnName("Nom_CAT");
            entity.Property(e => e.NomEng)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("Name, English language")
                .HasDefaultValue("", "DF_UsrRols_Nom_ENG")
                .HasColumnName("Nom_ENG");
            entity.Property(e => e.NomPor)
                .HasMaxLength(30)
                .IsUnicode(false)
            ...
            entity.HasMany(d => d.WebMenuItems).WithMany(p => p.Rols)
                .UsingEntity<Dictionary<string, object>>(
                    "WebMenuItemsxRol",
                    r => r.HasOne<WebMenuItem>().WithMany()
                        .HasForeignKey("WebMenuItem")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_WebMenuItemsxRol_WebMenuItems"),
                    l => l.HasOne<UsrRol>().WithMany()
                        .HasForeignKey("Rol")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK_WebMenuItemsxRol_UsrRols"),
                    j =>
                    {
                        j.HasKey("Rol", "WebMenuItem");
                        j.ToTable("WebMenuItemsxRol", tb => tb.HasComment("website menu items per user rol"));
        ...
        modelBuilder.Entity<UsrSession>(entity =>
        {
            ...
            entity.ToTable("UsrSession", tb => tb.HasComment("User sessions on our corporate Apps and websites"));
            ...
            entity.Property(e => e.FchFrom)
                ...
                .HasDefaultValueSql("(getdate())", "DF_UsrSession_FchStart")
                .HasColumnType("datetime");
            entity.Property(e => e.FchTo)
            ...
            entity.Property(e => e.Lang)
                ...
                .HasDefaultValue("ESP", "DF_UsrSession_Lang");
            entity.Property(e => e.Usuari).HasComment("Session user; foreign key for Email table");

            entity.HasOne(d => d.UsuariNavigation).WithMany(p => p.UsrSessions)
                .HasForeignKey(d => d.Usuari)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_VEHICLE_FLOTA_1");

            entity.ToTable("Vehicle_Flota", tb => tb.HasComment("Vehicles owned by the company"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_VEHICLE_FLOTA_Guid");
            entity.Property(e => e.Alta)
                .HasComment("Date of acquisition")
                .HasDefaultValueSql("(getdate())", "DF_VEHICLE_FLOTA_fch");
            entity.Property(e => e.Baixa).HasComment("Date of removal from inventory");
            ...
            entity.Property(e => e.Matricula)
                ...
                .HasDefaultValue("", "DF_VEHICLE_FLOTA_matricula");
            ...
            entity.HasOne(d => d.Conductor).WithMany(p => p.VehicleFlotumConductors)
                .HasForeignKey(d => d.ConductorGuid)
                .HasConstraintName("FK_Vehicle_Flota_Driver");

            entity.HasOne(d => d.ContracteNavigation).WithMany(p => p.VehicleFlotumContracteNavigations)
                .HasForeignKey(d => d.Contracte)
                .HasConstraintName("FK_Vehicle_Flota_Contracte");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.VehicleFlota)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Vehicle_Flota_Emp");

            entity.HasOne(d => d.InsuranceNavigation).WithMany(p => p.VehicleFlotumInsuranceNavigations)
                .HasForeignKey(d => d.Insurance)
                .HasConstraintName("FK_Vehicle_Flota_Insurance");

            entity.HasOne(d => d.Model).WithMany(p => p.VehicleFlota)
                .HasForeignKey(d => d.ModelGuid)
                .HasConstraintName("FK_Vehicle_Flota_Vehicle_Models");

            entity.HasOne(d => d.Venedor).WithMany(p => p.VehicleFlotumVenedors)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_VEHICLE_MARCAS");

            entity.ToTable("Vehicle_Marcas", tb => tb.HasComment("Vehicle commercial brands"));

            entity.Property(e => e.Guid)
                .HasComment("Primary kley")
                .HasDefaultValueSql("(newid())", "DF_VEHICLE_MARCAS_Guid");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("''");
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_Vehicle_Models_1");

            entity.ToTable("Vehicle_Models", tb => tb.HasComment("Vehicle brand commercial models"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Vehicle_Models_Guid");
            entity.Property(e => e.MarcaGuid).HasComment("Vehicle brand, foreign key to Vehicle_Marcas");
            entity.Property(e => e.Nom)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Brand model name")
                .HasDefaultValue("", "DF_VEHICLE_MODELS_Nom");

            entity.HasOne(d => d.Marca).WithMany(p => p.VehicleModels)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_CliVisa");

            entity.ToTable("VisaCard", tb => tb.HasComment("Employees credit cards"));

            entity.HasIndex(e => new { e.Titular, e.Caduca, e.FchCanceled }, "IX_CliVisa_Contact");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_CliVisa_Guid");
            entity.Property(e => e.Alias)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Friendly name")
                .HasDefaultValue("", "DF_CliVisa_nom");
            ...
            entity.Property(e => e.Digits)
                ...
                .HasDefaultValue("1111222233334444", "DF_CliVisa_num");
            entity.Property(e => e.Emisor).HasComment("Issuer company");
            entity.Property(e => e.Emp).HasDefaultValue(1, "DF_VisaCard_Emp");
            entity.Property(e => e.FchCanceled).HasComment("Cancelation date, if any");
            entity.Property(e => e.Limit)
                .HasComment("Credit limit")
                .HasColumnType("decimal(9, 2)");
            entity.Property(e => e.Titular).HasComment("Employee. Foreign key for CliGral table");

            entity.HasOne(d => d.BancNavigation).WithMany(p => p.VisaCards)
                .HasForeignKey(d => d.Banc)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_VisaCard_CliBnc");

            entity.HasOne(d => d.EmisorNavigation).WithMany(p => p.VisaCards)
                .HasForeignKey(d => d.Emisor)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_CliVisa_VISA");

            entity.HasOne(d => d.TitularNavigation).WithMany(p => p.VisaCards)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_VISA");

            entity.ToTable("VisaEmisor", tb => tb.HasComment("Credit card issuers"));

            entity.HasIndex(e => e.Nom, "IX_VisaEmisor_Nom").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_VISA_Guid");
        ...
        modelBuilder.Entity<Vw2023sale>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw_2023Sales");
        ...
        modelBuilder.Entity<Vw4momsCategory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw4momsCategories");
        ...
        modelBuilder.Entity<Vw4momsProductRoute>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw4momsProductRoutes");
        ...
        modelBuilder.Entity<Vw4momsSku>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw4momsSkus");
        ...
        modelBuilder.Entity<Vw4momsSkuRetail>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw4momsSkuRetail");

            entity.Property(e => e.Retail).HasColumnType("decimal(10, 2)");
        });

        modelBuilder.Entity<Vw4momsSkuStock>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Vw4momsSkuStocks");
        });
        ...
        modelBuilder.Entity<VwBanc>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwBancs");
        ...
        modelBuilder.Entity<VwBrandVideo>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwBrandVideos");

            entity.Property(e => e.DscCat).IsUnicode(false);
            entity.Property(e => e.DscEng).IsUnicode(false);
            entity.Property(e => e.DscEsp).IsUnicode(false);
            entity.Property(e => e.DscPor).IsUnicode(false);
            entity.Property(e => e.FchCreated).HasColumnType("datetime");
            entity.Property(e => e.FchTo).HasColumnType("datetime");
            entity.Property(e => e.Lang)
                .HasMaxLength(3)
        ...
        modelBuilder.Entity<VwBundleStock>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwBundleStocks");
        });

        modelBuilder.Entity<VwCategoriesOld>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCategoriesOld");
        ...
        modelBuilder.Entity<VwCcasList>(entity =>
        {
            ...
            entity.Property(e => e.Hash)
                ...
                .IsUnicode(false)
                .IsFixedLength();
            entity.Property(e => e.Txt).HasMaxLength(62);
            entity.Property(e => e.UsrNom)
                .HasMaxLength(100)
                .IsUnicode(false);
        });
        ...
        modelBuilder.Entity<VwCliTpaExcludedCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCliTpaExcludedCustomers");
        });
        ...
        modelBuilder.Entity<VwCrr>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCrr");

            entity.Property(e => e.Dsc).HasMaxLength(255);
            entity.Property(e => e.FchCreated).HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited).HasColumnType("datetime");
            entity.Property(e => e.Hash)
                .HasMaxLength(24)
        ...
        modelBuilder.Entity<VwCrrCli>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCrrClis");
        ...
        modelBuilder.Entity<VwCustomerChannelOpenSku>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCustomerChannelOpenSkus");
        });
        ...
        modelBuilder.Entity<VwCustomerChannelSkusExcluded>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCustomerChannelSkusExcluded");
        });
        ...
        modelBuilder.Entity<VwCustomerDeptSku>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCustomerDeptSkus");
        ...
        modelBuilder.Entity<VwCustomerProductGuidsIncluded>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwCustomerProductGuidsIncluded");
        });
        ...
        modelBuilder.Entity<VwMediaResource>(entity =>
        {
            ...
            entity.Property(e => e.Hash)
                .HasMaxLength(24)
                .IsUnicode(false);
            entity.Property(e => e.Hres).HasColumnName("HRes");
            entity.Property(e => e.Lang)
                .HasMaxLength(3)
                .IsUnicode(false)
                .IsFixedLength();
            ...
            entity.Property(e => e.Por).IsUnicode(false);
            entity.Property(e => e.Thumbnail).HasColumnType("image");
            entity.Property(e => e.Vres).HasColumnName("VRes");
        });

        modelBuilder.Entity<VwMediaResourceTarget>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwMediaResourceTargets");
        });
        ...
        modelBuilder.Entity<VwPremiumLineExcludedCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwPremiumLineExcludedCustomers");
        });
        ...
        modelBuilder.Entity<VwPremiumLineExclusiveCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwPremiumLineExclusiveCustomers");
        });
        ...
        modelBuilder.Entity<VwRepCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwRepCustomers");

            entity.Property(e => e.Customer).HasComment("Foreign key to CliGral table");
            entity.Property(e => e.FchFrom).HasComment("Date the customer (indeed his area and channel) was assigned to this agent");
        ...
        modelBuilder.Entity<VwRepPncsLiqPending>(entity =>
        {
            ...
            entity.Property(e => e.Emp).HasComment("Company. Foreign key to Emp table");
            entity.Property(e => e.Fch).HasComment("Order date");
            entity.Property(e => e.FullNom)
                .HasMaxLength(100)
                .IsUnicode(false);
        ...
        modelBuilder.Entity<VwSalesManagerCustomer>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwSalesManagerCustomers");
        });
        ...
        modelBuilder.Entity<VwShopProductText>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwShopProductText");
        ...
        modelBuilder.Entity<VwStoreLocatorRaw>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwStoreLocatorRaw");

            entity.Property(e => e.CcxVal).HasColumnType("decimal(38, 2)");
            entity.Property(e => e.Val).HasColumnType("decimal(38, 2)");
            entity.Property(e => e.ValHistoric).HasColumnType("decimal(38, 2)");
        });
        ...
        modelBuilder.Entity<VwTmpParent>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwTmpParent");
        ...
        modelBuilder.Entity<VwTransm>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwTransms");
        ...
        modelBuilder.Entity<VwYouTube>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("VwYouTube");
        ...
        modelBuilder.Entity<Web>(entity =>
        {
            ...
            entity.ToTable("Web", tb => tb.HasComment("Distributors per product to be published as recommended sale points. They are published depending on recent purchases of each product and availability of sale points on same area. A Windows service updates this table on a daily base"));

            entity.HasIndex(e => new { e.Impagat, e.Blocked, e.Obsoleto }, "IX_Web_Suggested");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Web2_Guid");
            entity.Property(e => e.Adr)
                .HasMaxLength(250)
                .IsUnicode(false)
                .HasComment("Retailer sale point address")
                .HasDefaultValue("", "DF_Web2_Adr");
            ...
            entity.Property(e => e.LastFch).HasComment("Most recent purchase order date");
            ...
            entity.HasOne(d => d.BrandNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.Brand)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Web_Tpa");

            entity.HasOne(d => d.CategoryNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.Category)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Web_Stp");

            entity.HasOne(d => d.CcxNavigation).WithMany(p => p.WebCcxNavigations)
                .HasForeignKey(d => d.Ccx)
                .HasConstraintName("FK_Web_Ccx");

            entity.HasOne(d => d.ClientNavigation).WithMany(p => p.WebClientNavigations)
                .HasForeignKey(d => d.Client)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Web_Client");

            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.Country)
                .HasConstraintName("FK_Web_Country");

            entity.HasOne(d => d.DeptNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.Dept)
                .HasConstraintName("FK_Web_Dept1");

            entity.HasOne(d => d.LocationNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.Location)
                .HasConstraintName("FK_Web_Location");

            entity.HasOne(d => d.PremiumLineNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.PremiumLine)
                .HasConstraintName("FK_Web_PremiumLine");

            entity.HasOne(d => d.ProveidorNavigation).WithMany(p => p.WebProveidorNavigations)
                .HasForeignKey(d => d.Proveidor)
                .HasConstraintName("FK_Web_Proveidor");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.Webs)
                .HasForeignKey(d => d.Sku)
        ...
        modelBuilder.Entity<WebErr>(entity =>
        {
            ...
            entity.ToTable("WebErr", tb => tb.HasComment("Error events on website"));

            entity.HasIndex(e => e.Fch, "Ix_WebErr_Fch").IsDescending();
            ...
            entity.Property(e => e.Fch)
                .HasComment("Date")
                .HasDefaultValueSql("(getdate())", "DF_WebErr_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Ip)
                .HasMaxLength(16)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.UsrNavigation).WithMany(p => p.WebErrs)
                .HasForeignKey(d => d.Usr)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_WebLog3");

            entity.ToTable("WebLogBrowse", tb => tb.HasComment("Logs when visitor browses content on the website like bloog or news"));
        ...
        modelBuilder.Entity<WebMenuGroup>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Menu groups under which are display the different menu items"));

            entity.HasIndex(e => new { e.Ord, e.Guid }, "IX_WebMenuGroups");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_WebMenuGroups_Guid");
            entity.Property(e => e.Cat)
                .HasMaxLength(50)
                .IsUnicode(false)
        ...
        modelBuilder.Entity<WebMenuItem>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Website menu items"));

            entity.HasIndex(e => new { e.WebMenuGroup, e.Ord }, "IX_WebMenuItems_GroupOrd");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_WebMenuItems_Guid");
            entity.Property(e => e.Actiu)
                .HasComment("Displayed if true")
                .HasDefaultValue(true, "DF_WebMenuItems_Actiu");
            entity.Property(e => e.Cat)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Caption, Catalan language");
            ...
            entity.HasOne(d => d.WebMenuGroupNavigation).WithMany(p => p.WebMenuItems)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_WebPageAlias_1");

            entity.ToTable("WebPageAlias", tb => tb.HasComment("Website url redirections"));

            entity.HasIndex(e => e.UrlFrom, "IX_WebPageAlias_UrlFrom").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_WebPageAlias_Guid");
        ...
        modelBuilder.Entity<WinBug>(entity =>
        {
            ...
            entity.ToTable("WinBug", tb => tb.HasComment("Alert events"));
            ...
            entity.Property(e => e.Fch)
                .HasComment("Event date")
                .HasDefaultValueSql("(getdate())", "DF_WinBug_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Obs)
                .HasComment("Comments")
                .HasColumnType("text");
        ...
        modelBuilder.Entity<WinMenuItem>(entity =>
        {
            ...
            entity.ToTable("WinMenuItem", tb => tb.HasComment("Windows desktop ERP menu items"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_MMC_Guid");
            ...
            entity.Property(e => e.Emps)
                ...
                .HasDefaultValue("", "DF_WinMenuItem_Emps");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_WinMenuItem_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Icon)
                .HasComment("489x48px image")
                .HasColumnType("image");
            entity.Property(e => e.Mime).HasDefaultValue(1, "DF_WinMenuItem_Mime");
            entity.Property(e => e.NomCat)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Caption, Catalan language");
        ...
        modelBuilder.Entity<WinMenuItemRol>(entity =>
        {
            ...
            entity.ToTable("WinMenuItemRol", tb => tb.HasComment("Menu items per user rol"));

            entity.HasIndex(e => new { e.Rol, e.MenuItem }, "IX_WinMenuitemRol_RolMenuItem").IsUnique();
            ...
            entity.HasOne(d => d.MenuItemNavigation).WithMany(p => p.WinMenuItemRols)
        ...
        {
            entity.HasKey(e => new { e.Sku, e.Ean });
        ...
        modelBuilder.Entity<WtbolBasket>(entity =>
        {
            ...
            entity.ToTable("WtbolBasket", tb => tb.HasComment("Consumer baskets reported by Wtbol affiliates"));

            entity.Property(e => e.Guid).ValueGeneratedNever();
            entity.Property(e => e.Fch)
                .HasDefaultValueSql("(getdate())", "DF_WtbolBasket_Fch")
                .HasColumnType("datetime");

            entity.HasOne(d => d.SiteNavigation).WithMany(p => p.WtbolBaskets)
        ...
        modelBuilder.Entity<WtbolBasketItem>(entity =>
        {
            ...
            entity.ToTable("WtbolBasketItem", tb => tb.HasComment("Consumer basket items"));

            entity.Property(e => e.Price).HasColumnType("decimal(9, 2)");

            entity.HasOne(d => d.BasketNavigation).WithMany(p => p.WtbolBasketItems)
                .HasForeignKey(d => d.Basket)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WtbolBasketItem_WtbolBasket");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.WtbolBasketItems)
                .HasForeignKey(d => d.Sku)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WtbolCtr>(entity =>
        {
            ...
            entity.ToTable("WtbolCtr", tb => tb.HasComment("Each time a visitor on our website selects an online retailer to purchase the product he was browsing, we log the event in this table so we can calculate the Ctr and build a retailer ranking to prioritize display order"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_WtbolCtr_Guid");
            entity.Property(e => e.Fch)
                .HasComment("Date and time the visitor clicked the affiliate link")
                .HasDefaultValueSql("(getdate())", "DF_WtbolCtr_Fch")
                .HasColumnType("datetime");
            entity.Property(e => e.Ip)
                .HasMaxLength(15)
                .IsUnicode(false)
            ...
            entity.HasOne(d => d.SiteNavigation).WithMany(p => p.WtbolCtrs)
                .HasForeignKey(d => d.Site)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_WtbolLandingPage_1");

            entity.ToTable("WtbolLandingPage", tb => tb.HasComment("Landing page retailers declare where they display each of our products so we can display their link under \"Purchase now\" to consumers browsing our catalog (Wtbol project)"));
            ...
            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_WtbolLandingPage_Guid");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_WtbolLandingPage_FchCreated")
                .HasColumnType("datetime");
            ...
            entity.HasOne(d => d.SiteNavigation).WithMany(p => p.WtbolLandingPages)
                .HasForeignKey(d => d.Site)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WtbolLog>(entity =>
        {
            ...
            entity.ToTable("WtbolLog", tb => tb.HasComment("Logs each time Wtbol external service (Britax through Hash) connects to our website to download affiliated customer stocks"));
        ...
        modelBuilder.Entity<WtbolSerpItem>(entity =>
        {
            ...
            entity.ToTable("WtbolSerpItem", tb => tb.HasComment("Affiliated online commerces and the position they are displayed when recommended to our website visitors"));
            ...
            entity.HasOne(d => d.SerpNavigation).WithMany(p => p.WtbolSerpItems)
                .HasForeignKey(d => d.Serp)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WtbolSerpItem_WtbolSerp");

            entity.HasOne(d => d.SiteNavigation).WithMany(p => p.WtbolSerpItems)
                .HasForeignKey(d => d.Site)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WtbolSite>(entity =>
        {
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_WtbolSite_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchLastEdited)
                .HasComment("Date this entry was edited for last time")
                .HasDefaultValueSql("(getdate())", "DF_WtbolSite_FchLastEdited")
                .HasColumnType("datetime");
            entity.Property(e => e.Logo)
            ...
            entity.HasOne(d => d.CustomerNavigation).WithMany(p => p.WtbolSites)
                .HasForeignKey(d => d.Customer)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WtbolSite_CliGral");

            entity.HasOne(d => d.UsrCreatedNavigation).WithMany(p => p.WtbolSiteUsrCreatedNavigations)
                .HasForeignKey(d => d.UsrCreated)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WtbolSite_UsrCreated");

            entity.HasOne(d => d.UsrLastEditedNavigation).WithMany(p => p.WtbolSiteUsrLastEditedNavigations)
                .HasForeignKey(d => d.UsrLastEdited)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<WtbolStock>(entity =>
        {
            ...
            entity.ToTable("WtbolStock", tb => tb.HasComment("Stocks declared daily by affiliated online retailers"));
            ...
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_WtbolStock_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.Price)
            ...
            entity.HasOne(d => d.SiteNavigation).WithMany(p => p.WtbolStocks)
                .HasForeignKey(d => d.Site)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_WtbolStock_WtbolSite");

            entity.HasOne(d => d.SkuNavigation).WithMany(p => p.WtbolStocks)
                .HasForeignKey(d => d.Sku)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Xec>(entity =>
        {
            ...
            entity.ToTable("Xec", tb => tb.HasComment("Bank checks from debtors"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_TLN_Guid");
            ...
            entity.Property(e => e.Cur)
                ...
                .IsFixedLength()
                .HasComment("Currency")
                .HasDefaultValue("ESP", "DF_TLN_cur");
            entity.Property(e => e.Eur)
                .HasComment("Amount, in Euro")
                .HasColumnType("decimal(9, 2)");
            entity.Property(e => e.FchRecepcio).HasComment("Date the check was received");
            entity.Property(e => e.Iban)
                .HasMaxLength(30)
                .IsUnicode(false)
                .HasComment("Check account number")
                .HasDefaultValue("", "DF_TLN_IBAN");
            ...
            entity.Property(e => e.Vto).HasComment("Due date, in case of deferred amount");
            entity.Property(e => e.XecNum)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasComment("Check number")
                .HasDefaultValue("", "DF_TLN_tln");

            entity.HasOne(d => d.CcaPresentacioNavigation).WithMany(p => p.XecCcaPresentacioNavigations)
                .HasForeignKey(d => d.CcaPresentacio)
                .HasConstraintName("FK_Xec_CcaPresentacio");

            entity.HasOne(d => d.CcaRebutNavigation).WithMany(p => p.XecCcaRebutNavigations)
                .HasForeignKey(d => d.CcaRebut)
                .HasConstraintName("FK_Xec_CcaRebut");

            entity.HasOne(d => d.CcaVtoNavigation).WithMany(p => p.XecCcaVtoNavigations)
                .HasForeignKey(d => d.CcaVto)
                .HasConstraintName("FK_Xec_CcaVto");

            entity.HasOne(d => d.Contact).WithMany(p => p.Xecs)
                .HasForeignKey(d => d.ContactGuid)
                .HasConstraintName("FK_XecHeader_Lliurador");

            entity.HasOne(d => d.Nbanc).WithMany(p => p.Xecs)
                .HasForeignKey(d => d.NbancGuid)
                .HasConstraintName("FK_Xec_NBanc");

            entity.HasOne(d => d.SbankBranchNavigation).WithMany(p => p.Xecs)
        ...
        {
            entity.HasKey(e => e.Guid).HasName("PK_XecDetail_1");

            entity.ToTable("XecDetail", tb => tb.HasComment("Debtor debts paid by check"));

            entity.HasIndex(e => e.Xec, "IX_XecDetail_Parent");

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_XecDetail_Guid");
            ...
            entity.HasOne(d => d.Pnd).WithMany(p => p.XecDetails)
                .HasForeignKey(d => d.PndGuid)
                .HasConstraintName("FK_XecDetail_Pnd");

            entity.HasOne(d => d.XecNavigation).WithMany(p => p.XecDetails)
        ...
        modelBuilder.Entity<Yea>(entity =>
        {
            ...
            entity.ToTable("Yea", tb => tb.HasComment("Assigns a Guid number to each combination of Company and year"));

            entity.HasIndex(e => new { e.Emp, e.Yea1 }, "IX_Yea_EmpYear").IsUnique();

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_Yea_Guid");
            entity.Property(e => e.Emp)
                .HasComment("Company. Foreign key for Emp table")
                .HasDefaultValue(1, "DF_Yea_Emp");
            entity.Property(e => e.Yea1)
                .HasComment("Year")
                .HasColumnName("Yea");

            entity.HasOne(d => d.EmpNavigation).WithMany(p => p.Yeas)
                .HasForeignKey(d => d.Emp)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<YouTube>(entity =>
        {
            ...
            entity.ToTable("YouTube", tb => tb.HasComment("Product videos stored on Youtube"));

            entity.Property(e => e.Guid)
                .HasComment("Primary key")
                .HasDefaultValueSql("(newid())", "DF_YouTube_Guid");
            entity.Property(e => e.Dsc)
                .HasComment("Video description")
                .HasColumnType("text");
            entity.Property(e => e.FchCreated)
                .HasComment("Date this entry was created")
                .HasDefaultValueSql("(getdate())", "DF_YouTube_FchCreated")
                .HasColumnType("datetime");
            entity.Property(e => e.FchTo).HasColumnType("datetime");
            entity.Property(e => e.Lang)
                .HasMaxLength(3)
            ...
            entity.Property(e => e.LangSet)
                ...
                .IsUnicode(false)
                .IsFixedLength()
                .HasDefaultValue("1111", "DF_YouTube_Langs");
            entity.Property(e => e.Nom)
                .HasMaxLength(70)
                .IsUnicode(false)
                .HasComment("Video name")
                .HasDefaultValue("", "DF_YouTube_Nom");
        ...
        modelBuilder.Entity<YouTubeProduct>(entity =>
        {
            ...
            entity.ToTable(tb => tb.HasComment("Videos per product"));
            ...
            entity.Property(e => e.Ord)
                ...
                .HasDefaultValue(99, "DF_YouTubeProducts_Ord");

            entity.HasOne(d => d.YouTube).WithMany(p => p.YouTubeProducts)
        ...
        modelBuilder.Entity<Zip>(entity =>
        {
            ...
            entity.ToTable("Zip", tb => tb.HasComment("Postal codes"));
            ...
            entity.HasOne(d => d.LocationNavigation).WithMany(p => p.Zips)
                .HasForeignKey(d => d.Location)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<Zona>(entity =>
        {
            ...
            entity.ToTable("Zona", tb => tb.HasComment("Country Areas"));

            entity.HasIndex(e => new { e.Country, e.Nom }, "IX_Zona_Country").IsUnique();
            ...
            entity.HasOne(d => d.CountryNavigation).WithMany(p => p.Zonas)
                .HasForeignKey(d => d.Country)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Zona_Country");

            entity.HasOne(d => d.PortsCondicionsNavigation).WithMany(p => p.Zonas)
                .HasForeignKey(d => d.PortsCondicions)
                .HasConstraintName("FK_Zona_PortsCondicions");

            entity.HasOne(d => d.ProvinciaNavigation).WithMany(p => p.Zonas)
                .HasForeignKey(d => d.Provincia)
