...
public partial class Tpa
{
    ...
    public virtual ICollection<BrandArea> BrandAreas { get; set; } = new List<BrandArea>();
    ...
    public virtual ICollection<SocialMediaWidget> SocialMediaWidgets { get; set; } = new List<SocialMediaWidget>();

    public virtual ICollection<Stp> Stps { get; set; } = new List<Stp>();

    public virtual ICollection<Web> Webs { get; set; } = new List<Web>();

    public virtual ICollection<CliApertura> Aperturas { get; set; } = new List<CliApertura>();
}
