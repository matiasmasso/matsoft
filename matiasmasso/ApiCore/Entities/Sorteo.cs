...
public partial class Sorteo
{
    ...
    /// </summary>
    public DateOnly? FchWinnerReaction { get; set; }

    /// <summary>
    /// Date the distributor answered our message
    /// </summary>
    public DateOnly? FchDistributorReaction { get; set; }

    /// <summary>
    /// Date the prize was delivered to the distributor
    /// </summary>
    public DateOnly? FchDelivery { get; set; }

    /// <summary>
    /// Date the distributor sent the picture of the winner
    /// </summary>
    public DateOnly? FchPicture { get; set; }
