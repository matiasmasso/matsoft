...
public partial class Fra
{
    ...
    public decimal? IrpfAmt { get; set; }
    ...
    public virtual Cca? Cca { get; set; }

    public virtual CliGral Cli { get; set; } = null!;

    public virtual Email? EmailedTo { get; set; }

    public virtual Emp EmpNavigation { get; set; } = null!;

    public virtual ICollection<FraItem> FraItems { get; set; } = new List<FraItem>();

    public virtual Incoterm? IncotermNavigation { get; set; }

    public virtual Intrastat? IntrastatNavigation { get; set; }

    public virtual ICollection<Rp> Rps { get; set; } = new List<Rp>();

    public virtual Email? UsrLastPrinted { get; set; }
