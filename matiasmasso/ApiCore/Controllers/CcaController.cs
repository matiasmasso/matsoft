...
namespace Api.Controllers
{
    ...
    public class CcaController : ControllerBase
    {
        ...
        [HttpGet("doc/{cca}.pdf")]
        public IActionResult PdfWithExtension(Guid cca)
        {
            IActionResult retval;
            try
            {
        ...
        //[HttpGet("pdf/{cca}.pdf")]
        //public IActionResult CompactPdf(string cca)
        //{
        //    IActionResult retval;
        //    try
        //    {
    ...
    public class CcasController : ControllerBase
    {
        ...
        [HttpGet("Search/{emp}/{value}")]
        public IActionResult Search(int emp, decimal value)
        {
            IActionResult retval;
            try
            {
                var values = CcasService.Search(emp,value);
                retval = Ok(values);
            }
            catch (Exception ex)
            {
        ...
        [HttpGet("NoCuadran/{emp}/{year}")]
        public IActionResult NoCuadran(EmpModel.EmpIds emp, int year)
        {
            IActionResult retval;
            try
            {
                retval = Ok(CcasService.NoCuadran(emp, year));
            }
            catch (Exception ex)
            {
                retval = BadRequest(ex.ProblemDetails());
